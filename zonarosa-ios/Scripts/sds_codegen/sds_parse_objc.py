...
def process_objc_ast(namespace: Namespace, file_path: str, raw_ast: str) -> None:
    ...
    while lines.hasNext():
        ...
        if remainder.startswith("ObjCInterfaceDecl "):
            # |-ObjCInterfaceDecl 0x112510490 <ZonaRosaDataStoreCommon/ObjCMessage.h:14:1, line:25:2> line:14:12 ObjCMessage
            process_objc_interface(namespace, file_path, lines, prefix, remainder)
        elif remainder.startswith("ObjCCategoryDecl "):
            # |-ObjCCategoryDecl 0x112510d58 <ZonaRosaDataStoreCommon/ObjCMessage.m:18:1, line:22:2> line:18:12
...
# |-EnumDecl 0x7fd576047310 </Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS12.2.sdk/System/Library/Frameworks/CoreFoundation.framework/Headers/CFAvailability.h:127:43, /Users/matthew/code/workspace/ows/ZonaRosa-iOS-2/ZonaRosaServiceKit/src/Messages/TSCall.h:12:29> col:29 RPRecentCallType 'NSUInteger':'unsigned long'
...
# |-TypedefDecl 0x7fd576047488 </Users/matthew/code/workspace/ows/ZonaRosa-iOS-2/ZonaRosaServiceKit/src/Messages/TSCall.h:12:1, col:29> col:29 referenced RPRecentCallType 'enum RPRecentCallType':'enum RPRecentCallType'
...
# |-ObjCInterfaceDecl 0x10f5d2b60 <ZonaRosaDataStoreCommon/ObjCBaseModel.h:15:1, col:8> col:8 SDSDataStore
...
# ...
# |-ObjCInterfaceDecl 0x10f5d3490 <ZonaRosaDataStoreCommon/ObjCMessage.h:14:1, line:25:2> line:14:12 ObjCMessage
...
def process_objc_interface(
    ...
    # |-ObjCInterfaceDecl 0x10ab2fd58 </Users/matthew/code/workspace/ows/ZonaRosa-iOS-2/ZonaRosaDataStore/ZonaRosaDataStoreCommon/ObjCMessageWAuthor.h:13:1, line:26:2> line:13:12 ObjCMessageWAuthor
...
# |-ObjCCategoryDecl 0x10f5d3d58 <ZonaRosaDataStoreCommon/ObjCMessage.m:18:1, line:22:2> line:18:12
...
# For example:
#
# #import <ZonaRosaServiceKit/OWSFailedAttachmentDownloadsJob.h>
#
...
def get_pch_include(file_path):
    ssk_path = os.path.join(git_repo_path, "ZonaRosaServiceKit") + os.sep
    s_path = os.path.join(git_repo_path, "ZonaRosa") + os.sep
    sae_path = os.path.join(git_repo_path, "ZonaRosaShareExtension") + os.sep
    if file_path.startswith(ssk_path):
        return os.path.join(
            git_repo_path, "ZonaRosaServiceKit/ZonaRosaServiceKit-prefix.pch"
        )
    elif file_path.startswith(s_path):
        return os.path.join(git_repo_path, "ZonaRosa/ZonaRosa-Prefix.pch")
    elif file_path.startswith(sae_path):
        return os.path.join(
            git_repo_path, "ZonaRosaShareExtension/ZonaRosaShareExtension-Prefix.pch"
        )
    else:
...
if __name__ == "__main__":
    ...
    header_include_paths = []
    header_include_paths.extend(find_header_include_paths("ZonaRosaServiceKit"))
