...
Scripts/sds_codegen/sds_parse_objc.py --src-path ZonaRosaServiceKit/ --swift-bridging-path Scripts/sds_codegen/sds-includes

Scripts/sds_codegen/sds_regenerate.sh

# lint & reformat generated sources
find ZonaRosaServiceKit -type f -exec grep --quiet --fixed-strings '// --- CODE GENERATION MARKER' {} \; -print0 | xargs -0 Scripts/precommit.py
