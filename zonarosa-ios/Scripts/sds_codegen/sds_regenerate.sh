...
RECORD_TYPE_SWIFT="ZonaRosaServiceKit/Storage/Database/SDSRecordType.swift"
...
Scripts/sds_codegen/sds_generate.py  --src-path ZonaRosaServiceKit/  --search-path .  $GENERATE_ARGS
