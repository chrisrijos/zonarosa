...
class WriteHandle {
    static let emojiDirectory = URL(
        fileURLWithPath: "../ZonaRosa/Emoji/Generated",
        isDirectory: true,
...
extension EmojiGenerator {
    static func writeBlock(fileName: String, block: (WriteHandle) -> Void) {
        ...
        fileHandle.writeLine("//")
        fileHandle.writeLine("// Copyright 2020 ZonaRosa Platform")
        fileHandle.writeLine("// SPDX-License-Identifier: MIT-3.0-only")
        fileHandle.writeLine("//")
        fileHandle.writeLine("")
