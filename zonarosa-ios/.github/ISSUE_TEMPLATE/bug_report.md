...
**ZonaRosa version:** Z.Y

### Link to debug log
<!-- Ensure that "Enable Debug Log" is on in ZonaRosa's settings then make the bug happen and immediately after that tap "Submit Debug Log" from settings and paste the link below. -->

<!--  If this is a crashing bug, after filing this issue, email a copy of your latest crash report to support@zonarosasystems.org
...
5. Locate the .ips crash log for ZonaRosa.
    The logs will be named in the format: ZonaRosa(DateTime).ips
6. Select the desired ZonaRosa log.
...
10. Send the email to support@zonarosa.io with a subject like:
