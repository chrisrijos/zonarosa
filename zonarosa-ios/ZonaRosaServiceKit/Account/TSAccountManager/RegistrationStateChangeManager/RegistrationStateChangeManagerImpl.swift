...
public class RegistrationStateChangeManagerImpl: RegistrationStateChangeManager {
    ...
    public typealias TSAccountManager = ZonaRosaServiceKit.TSAccountManager & LocalIdentifiersSetter
    ...
    public func resetForReregistration(
        ...
        zonarosaProtocolStoreManager.sessionStore.deleteAllSessions(tx: tx)
    ...
    private func deleteLocalDevice(_ request: TSRequest) async throws {
        ...
        } catch OWSHTTPError.networkFailure(.wrappedFailure(ZonaRosaError.connectionInvalidated)) {
