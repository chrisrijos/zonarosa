...
public enum PniDistribution {
    ...
    public struct Parameters {
        ...
        private(set) var devicePniSignedPreKeys: [String: LibZonaRosaClient.SignedPreKeyRecord] = [:]
        private(set) var devicePniPqLastResortPreKeys: [String: LibZonaRosaClient.KyberPreKeyRecord] = [:]
        ...
        static func mock(
            ...
            localDevicePniSignedPreKey: LibZonaRosaClient.SignedPreKeyRecord,
            localDevicePniPqLastResortPreKey: LibZonaRosaClient.KyberPreKeyRecord,
        ...
        fileprivate mutating func addLocalDevice(
            ...
            pqLastResortPreKey: LibZonaRosaClient.KyberPreKeyRecord,
...
final class PniDistributionParameterBuilderImpl: PniDistributionParamaterBuilder {
    ...
    private struct LinkedDevicePniGenerationParams {
        ...
        let signedPreKey: LibZonaRosaClient.SignedPreKeyRecord
        let pqLastResortPreKey: LibZonaRosaClient.KyberPreKeyRecord
