...
public final class LocalIdentifiers {
    ...
    public func contains(address: ZonaRosaServiceAddress) -> Bool {
        ...
        // in production because we populate `ZonaRosaServiceAddressCache` with our
        // own identifiers.)
    ...
    public func isAciAddressEqualToAddress(_ address: ZonaRosaServiceAddress) -> Bool {
        if let serviceId = address.serviceId {
...
public extension LocalIdentifiers {
    var aciAddress: ZonaRosaServiceAddress {
        ZonaRosaServiceAddress(serviceId: aci, phoneNumber: phoneNumber)
    }
}
