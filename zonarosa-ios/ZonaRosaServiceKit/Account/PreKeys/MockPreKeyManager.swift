...
class MockPreKeyManager: PreKeyManager {
    func isAppLockedDueToPreKeyUpdateFailures(tx: ZonaRosaServiceKit.DBReadTransaction) -> Bool { false }
    ...
    func generateLastResortKyberPreKey(signedBy identityKey: PrivateKey) -> LibZonaRosaClient.KyberPreKeyRecord {
