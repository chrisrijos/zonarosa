...
struct PreKeyTaskManager {
    ...
    private let protocolStoreManager: ZonaRosaProtocolStoreManager
    ...
    private func generateKeysForProvisioning(
        ...
        let protocolStore = self.protocolStoreManager.zonarosaProtocolStore(for: identity)
    ...
    private func createAndPersistPartialBundle(
        ...
        let protocolStore = self.protocolStoreManager.zonarosaProtocolStore(
            for: identity,
        )
        ...
        var signedPreKey: LibZonaRosaClient.SignedPreKeyRecord?
        var preKeyRecords: [LibZonaRosaClient.PreKeyRecord]?
        var lastResortPreKey: LibZonaRosaClient.KyberPreKeyRecord?
    ...
    private func persistKeysPriorToUpload(
        ...
        let protocolStore = protocolStoreManager.zonarosaProtocolStore(for: bundle.identity)
