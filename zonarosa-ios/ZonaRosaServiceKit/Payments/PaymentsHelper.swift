...
public protocol PaymentsHelper: AnyObject {
    ...
    func arePaymentsEnabled(for address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> Bool
...
extension MockPaymentsHelper: PaymentsHelperSwift, PaymentsHelper {
    ...
    public func arePaymentsEnabled(for address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> Bool {
