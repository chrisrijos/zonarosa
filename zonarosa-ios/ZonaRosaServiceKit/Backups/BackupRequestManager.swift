...
public protocol BackupRequestManager {
    ...
    func fetchSVRBAuthCredential(
        ...
        forceRefresh: Bool,
    ) async throws -> LibZonaRosaClient.Auth
}
...
public class BackupRequestManagerMock: BackupRequestManager {
    ...
    public func fetchBackupServiceAuth(
        for key: ZonaRosaServiceKit.BackupKeyMaterial,
        localAci: LibZonaRosaClient.Aci,
        auth: ZonaRosaServiceKit.ChatServiceAuth,
        forceRefreshUnlessCachedPaidCredential: Bool,
    ) async throws -> ZonaRosaServiceKit.BackupServiceAuth {
        return BackupServiceAuth.mock(type: .media, backupLevel: .paid)
    }

    public func fetchBackupUploadForm(
        backupByteLength: UInt32,
        auth: ZonaRosaServiceKit.BackupServiceAuth,
    ) async throws -> ZonaRosaServiceKit.Upload.Form {
    ...
    public func fetchMediaTierCdnRequestMetadata(
        cdn: Int32,
        auth: ZonaRosaServiceKit.BackupServiceAuth,
    ) async throws -> ZonaRosaServiceKit.MediaTierReadCredential {
        fatalError("Unimplemented")
    }

    public func fetchBackupRequestMetadata(
        auth: ZonaRosaServiceKit.BackupServiceAuth,
    ) async throws -> ZonaRosaServiceKit.BackupReadCredential {
        fatalError("Unimplemented")
    }

    public func copyToMediaTier(
        item: ZonaRosaServiceKit.BackupArchive.Request.MediaItem,
        auth: ZonaRosaServiceKit.BackupServiceAuth,
        logger: PrefixedLogger? = nil,
    ) async throws -> UInt32 {
        fatalError("Unimplemented")
    ...
    public func copyToMediaTier(
        items: [ZonaRosaServiceKit.BackupArchive.Request.MediaItem],
        auth: ZonaRosaServiceKit.BackupServiceAuth,
    ) async throws -> [ZonaRosaServiceKit.BackupArchive.Response.BatchedBackupMediaResult] {
        fatalError("Unimplemented")
    }
    ...
    public func listMediaObjects(
        ...
        limit: UInt32?,
        auth: ZonaRosaServiceKit.BackupServiceAuth,
    ) async throws -> ZonaRosaServiceKit.BackupArchive.Response.ListMediaResult {
        return listMediaResults.popFirst()!
    }

    public func deleteMediaObjects(
        objects: [ZonaRosaServiceKit.BackupArchive.Request.DeleteMediaTarget],
        auth: ZonaRosaServiceKit.BackupServiceAuth,
    ) async throws {
        fatalError("Unimplemented")
    }
    ...
    public func fetchSVRBAuthCredential(
        key: ZonaRosaServiceKit.MessageRootBackupKey,
        chatServiceAuth auth: ZonaRosaServiceKit.ChatServiceAuth,
        forceRefresh: Bool,
    ) async throws -> LibZonaRosaClient.Auth {
        return LibZonaRosaClient.Auth(username: "", password: "")
    }
}
