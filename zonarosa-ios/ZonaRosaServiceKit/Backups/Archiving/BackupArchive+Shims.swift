...
public protocol _MessageBackup_BlockingManagerShim {
    ...
    func blockedRecipientIds(tx: DBReadTransaction) -> Set<ZonaRosaRecipient.RowId>
    func blockedGroupIds(tx: DBReadTransaction) -> [Data]

    func addBlockedAddress(_ address: ZonaRosaServiceAddress, tx: DBWriteTransaction)
...
public class _MessageBackup_BlockingManagerWrapper: _MessageBackup_BlockingManagerShim {
    ...
    public func blockedRecipientIds(tx: DBReadTransaction) -> Set<ZonaRosaRecipient.RowId> {
    ...
    public func addBlockedAddress(_ address: ZonaRosaServiceAddress, tx: DBWriteTransaction) {
...
public protocol _MessageBackup_ContactManagerShim {
    func displayName(_ address: ZonaRosaServiceAddress, tx: DBWriteTransaction) -> String
    func fetchZonaRosaAccount(_ address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> ZonaRosaAccount?
    func insertZonaRosaAccount(_ account: ZonaRosaAccount, tx: DBWriteTransaction)
}
...
public class _MessageBackup_ContactManagerWrapper: _MessageBackup_ContactManagerShim {
    ...
    public func displayName(_ address: ZonaRosaServiceAddress, tx: DBWriteTransaction) -> String {
        return contactManager.displayName(for: address, tx: tx).resolvedValue()
    }

    public func fetchZonaRosaAccount(_ address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> ZonaRosaAccount? {
        return contactManager.fetchZonaRosaAccount(for: address, transaction: tx)
    }

    public func insertZonaRosaAccount(_ account: ZonaRosaAccount, tx: DBWriteTransaction) {
...
public protocol _MessageBackup_ProfileManagerShim {
    ...
    func getUserProfile(for address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> OWSUserProfile?

    func getUserProfileForLocalUser(tx: DBReadTransaction) -> OWSUserProfile?

    func allWhitelistedAddresses(tx: DBReadTransaction) -> [ZonaRosaServiceAddress]

    func isGroupId(inProfileWhitelist groupId: Data, tx: DBReadTransaction) -> Bool

    func addRecipientToProfileWhitelist(_ recipient: inout ZonaRosaRecipient, tx: DBWriteTransaction)
...
public class _MessageBackup_ProfileManagerWrapper: _MessageBackup_ProfileManagerShim {
    ...
    public func getUserProfile(for address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> OWSUserProfile? {
    ...
    public func allWhitelistedAddresses(tx: DBReadTransaction) -> [ZonaRosaServiceAddress] {
    ...
    public func addRecipientToProfileWhitelist(_ recipient: inout ZonaRosaRecipient, tx: DBWriteTransaction) {
