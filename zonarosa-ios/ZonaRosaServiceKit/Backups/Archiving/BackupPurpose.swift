...
// MARK: - Libzonarosa.MessageBackupPurpose

extension BackupImportSource {
    var libzonarosaPurpose: LibZonaRosaClient.MessageBackupPurpose {
        switch self {
        case .linkNsync:
...
extension BackupImportSource {
    ...
    private func fetchForwardSecrecyTokenFromSvr(
        ...
        let svrBAuth: LibZonaRosaClient.Auth
        do {
        ...
        let svrB = libzonarosaNet.svrB(auth: svrBAuth)
        ...
        do {
            ...
            switch error as? LibZonaRosaClient.ZonaRosaError {
