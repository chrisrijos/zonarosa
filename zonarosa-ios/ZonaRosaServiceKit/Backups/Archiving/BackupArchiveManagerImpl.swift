...
public class BackupArchiveManagerImpl: BackupArchiveManager {
    ...
    private let libzonarosaNet: LibZonaRosaClient.Net
    ...
    init(
        ...
        libzonarosaNet: LibZonaRosaClient.Net,
    ...
    public func exportEncryptedBackup(
        ...
        let includedContentFilter = BackupArchive.IncludedContentFilter(
            backupPurpose: backupPurpose.libzonarosaPurpose,
        )
    ...
    private func _exportBackup(
        ...
        let result = Result<Void, Error>(catching: {
            ...
            guard
                let localZonaRosaRecipientRowId = localRecipientArchiver.fetchLocalRecipientRowId(
                    localIdentifiers: localIdentifiers,
                    tx: tx,
                )
            else {
            ...
            let recipientArchivingContext = BackupArchive.RecipientArchivingContext(
                ...
                localZonaRosaRecipientRowId: localZonaRosaRecipientRowId,
                localIdentifiers: localIdentifiers,
                startDate: startDate,
                remoteConfig: remoteConfig,
                bencher: bencher,
    ...
    public func importEncryptedBackup(
        ...
        try await _importBackup(
            ...
            backupPurpose: source.libzonarosaPurpose,
    ...
    private func validateEncryptedBackup(
        ...
        do {
            ...
            case ZonaRosaError.ioError(let description):
