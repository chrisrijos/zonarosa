...
extension BackupArchive {
     ...
     *
     * For example, we will assign a ``BackupRecipientId`` to each ``ZonaRosaRecipient`` as we
    ...
    public class RecipientArchivingContext: ArchivingContext {
        ...
        let localZonaRosaRecipientRowId: ZonaRosaRecipient.RowId
        ...
        private let recipientDbRowIdMap = SharedMap<ZonaRosaRecipient.RowId, RecipientId>()
        private let callLinkIdMap = SharedMap<CallLinkRecordId, RecipientId>()

        init(
            localRecipientId: RecipientId,
            localZonaRosaRecipientRowId: ZonaRosaRecipient.RowId,
            ...
            self.localZonaRosaRecipientRowId = localZonaRosaRecipientRowId
        ...
        func associateRecipientId(_ recipientId: RecipientId, withRecipientDbRowId recipientDbRowId: ZonaRosaRecipient.RowId) {
        ...
        func recipientId(forRecipientDbRowId recipientDbRowId: ZonaRosaRecipient.RowId) -> RecipientId? {
            if localZonaRosaRecipientRowId == recipientDbRowId {
    ...
    public class RecipientRestoringContext: RestoringContext {
        ...
        var localZonaRosaRecipientRowId: ZonaRosaRecipient.RowId?

        private let map = SharedMap<RecipientId, Address>()
        private let recipientDbRowIdCache = SharedMap<RecipientId, ZonaRosaRecipient.RowId>()
        ...
        func recipientDbRowId(forBackupRecipientId recipientId: RecipientId) -> ZonaRosaRecipient.RowId? {
            return recipientDbRowIdCache[recipientId]
        }

        func setRecipientDbRowId(_ recipientDbRowId: ZonaRosaRecipient.RowId, forBackupRecipientId recipientId: RecipientId) {
        ...
        public struct PostFrameRestoreActions {
            ...
            /// inserted for the `ZonaRosaRecipient` with the given proto ID.
            ///
