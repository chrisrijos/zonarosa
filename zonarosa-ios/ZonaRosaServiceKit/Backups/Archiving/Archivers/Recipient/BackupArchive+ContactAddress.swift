...
extension BackupArchive {
    ...
    /// ZonaRosaServiceAddress has all kinds of problems with caching and such.
    ///
    ...
    /// 2) makes it easy to track down backup's usages of ZonaRosaServiceAddress
    ///
    /// Both of which make it easier to one day remove usages of ZonaRosaServiceAddresses
    /// from backup code once all the things it depends on stop taking them as input.
    public typealias InteropAddress = ZonaRosaServiceAddress
}
...
extension BackupArchive.InteropAddress {
    ...
    /// know both. This is because the ZonaRosaServiceAddress only keeps one.
    /// If you want an aci and a pni in the ContactAddress, construct it from the ZonaRosaRecipient.
