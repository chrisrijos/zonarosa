...
extension BackupArchive {
    ...
    enum RestoredMessageContents {
        ...
        /// Note: not a "Contact" in the ZonaRosa sense (not a Recipient or ZonaRosaAccount), just a message
