...
// to the environment.
    ...
    public static let legalTermsUrl = URL(string: "https://zonarosa.io/legal/")!
    public static let donateUrl = URL(string: "https://zonarosa.io/donate/")!
    public static let appStoreUrl = URL(string: "https://itunes.apple.com/us/app/zonarosa-private-messenger/id874139669?mt=8")!
    ...
    public static let libZonaRosaEnv: Net.Environment = {
        switch environment {
        case .production:
            return .production
        case .staging:
...
public class TSConstantsProduction: TSConstantsProtocol {
    ...
    public let mainServiceURL = "https://chat.zonarosa.io"
    public let textSecureCDN0ServerURL = "https://cdn.zonarosa.io"
    public let textSecureCDN2ServerURL = "https://cdn2.zonarosa.io"
    public let textSecureCDN3ServerURL = "https://cdn3.zonarosa.io"
    public let storageServiceURL = "https://storage.zonarosa.io"
    public let sfuURL = "https://sfu.voip.zonarosa.io"
    public let sfuTestURL = "https://sfu.test.voip.zonarosa.io"
    public let svr2URL = "wss://svr2.zonarosa.io"
    public let registrationCaptchaURL = "https://zonarosacaptchas.org/registration/generate.html"
    public let challengeCaptchaURL = "https://zonarosacaptchas.org/challenge/generate.html"
    public let kUDTrustRoots = ["BXu6QIKVz5MA8gstzfOgRQGqyLqOwNKHL6INkv3IHWMF", "BUkY0I+9+oPgDCn4+Ac6Iu813yvqkDr/ga8DzLxFxuk6"]
    public let updatesURL = "https://updates.zonarosa.io"
    public let updates2URL = "https://updates2.zonarosa.io"

    public let censorshipFReflectorHost = "reflector-zonarosa.global.ssl.fastly.net"
    ...
    public let applicationGroup = "group." + Bundle.main.bundleIdPrefix + ".zonarosa.group"
...
public class TSConstantsStaging: TSConstantsProtocol {
    ...
    public let mainServiceURL = "https://chat.staging.zonarosa.io"
    public let textSecureCDN0ServerURL = "https://cdn-staging.zonarosa.io"
    public let textSecureCDN2ServerURL = "https://cdn2-staging.zonarosa.io"
    public let textSecureCDN3ServerURL = "https://cdn3-staging.zonarosa.io"
    public let storageServiceURL = "https://storage-staging.zonarosa.io"
    public let sfuURL = "https://sfu.staging.voip.zonarosa.io"
    public let svr2URL = "wss://svr2.staging.zonarosa.io"
    public let registrationCaptchaURL = "https://zonarosacaptchas.org/staging/registration/generate.html"
    public let challengeCaptchaURL = "https://zonarosacaptchas.org/staging/challenge/generate.html"
    ...
    public let censorshipFReflectorHost = "reflector-staging-zonarosa.global.ssl.fastly.net"
    public let censorshipGReflectorHost = "reflector-nrgwuv7kwq-uc.a.run.app"
    ...
    public let applicationGroup = "group." + Bundle.main.bundleIdPrefix + ".zonarosa.group.staging"
