...
extension AppSetup {
    ...
    public struct TestDependencies {
        ...
        let zonarosaService: (any OWSZonaRosaServiceProtocol)?
        ...
        public init(
            ...
            zonarosaService: (any OWSZonaRosaServiceProtocol)? = nil,
            ...
            self.zonarosaService = zonarosaService
...
extension AppSetup.GlobalsContinuation {
    ...
    public func initGlobals(
        ...
        let libzonarosaNet = Net(
            env: TSConstants.isUsingProductionService ? .production : .staging,
            userAgent: HttpHeaders.userAgentHeaderValueZonaRosaIos,
        ...
        let zonarosaAccountStore = ZonaRosaAccountStoreImpl()
        ...
        let searchableNameIndexer = SearchableNameIndexerImpl(
            ...
            zonarosaAccountStore: zonarosaAccountStore,
        ...
        let aciProtocolStore = ZonaRosaProtocolStore.build(
            dateProvider: dateProvider,
            identity: .aci,
        ...
        let pniProtocolStore = ZonaRosaProtocolStore.build(
            dateProvider: dateProvider,
            identity: .pni,
            preKeyStore: preKeyStore,
            recipientIdFinder: recipientIdFinder,
        ...
        let zonarosaProtocolStoreManager = ZonaRosaProtocolStoreManager(
            aciProtocolStore: aciProtocolStore,
            pniProtocolStore: pniProtocolStore,
            preKeyStore: preKeyStore,
            sessionStore: sessionStore,
        )
        let zonarosaService = testDependencies.zonarosaService ?? OWSZonaRosaService(libzonarosaNet: libzonarosaNet)
        let zonarosaServiceAddressCache = ZonaRosaServiceAddressCache()
        ...
        let svr = SecureValueRecovery2Impl(
            ...
            db: db,
            accountKeyStore: accountKeyStore,
            scheduler: DispatchQueue(label: "io.zonarosa.svr2", qos: .userInitiated),
            storageServiceManager: storageServiceManager,
            svrLocalStorage: svrLocalStorage,
            tsAccountManager: tsAccountManager,
        ...
        let attachmentUploadManager = AttachmentUploadManagerImpl(
            ...
            zonarosaService: zonarosaService,
        ...
        let registrationStateChangeManager = RegistrationStateChangeManagerImpl(
            ...
            zonarosaProtocolStoreManager: zonarosaProtocolStoreManager,
            storageServiceManager: storageServiceManager,
            tsAccountManager: tsAccountManager,
            udManager: udManager,
        ...
        let preKeyManager = PreKeyManagerImpl(
            ...
            protocolStoreManager: zonarosaProtocolStoreManager,
            remoteConfigProvider: remoteConfigManager,
            chatConnectionManager: chatConnectionManager,
            tsAccountManager: tsAccountManager,
        )
        ...
        let smJobQueues = ZonaRosaMessagingJobQueues(
            appReadiness: appReadiness,
            db: db,
            reachabilityManager: reachabilityManager,
        )
        ...
        let sskEnvironment = SSKEnvironment(
            ...
            remoteConfigManager: remoteConfigManager,
            aciZonaRosaProtocolStore: aciProtocolStore,
            pniZonaRosaProtocolStore: pniProtocolStore,
            udManager: udManager,
        ...
        NSKeyedUnarchiver.setClass(PendingProfileUpdate.self, forClassName: "ZonaRosaMessaging.PendingProfileUpdate")
...
extension AppSetup.DataMigrationContinuation {
    public func migrateDatabaseData() async -> AppSetup.FinalContinuation {
        ...
        return AppSetup.FinalContinuation(
            ...
            libzonarosaNet: self.libzonarosaNet,
...
extension AppSetup {
    public class FinalContinuation {
        ...
        public let dependenciesBridge: DependenciesBridge
        private let libzonarosaNet: Net
...
extension AppSetup.FinalContinuation {
    ...
    public func runLaunchTasksIfNeededAndReloadCaches() {
        ...
        if self.didRunLaunchTasks {
            ...
            libzonarosaNet.setRemoteConfig(remoteConfig.netConfig(), buildVariant: BuildFlags.netBuildVariant)
        }
        ...
        // See above.
        self.sskEnvironment.zonarosaServiceAddressCacheRef.prepareCache()
