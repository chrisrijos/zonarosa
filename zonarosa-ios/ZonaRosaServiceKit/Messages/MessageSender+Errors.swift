...
public class MessageSenderNoSuchZonaRosaRecipientError: CustomNSError, UserErrorDescriptionProvider {
    // NSError bridging: the domain of the error.
    public static let errorDomain = OWSError.errorDomain

    // NSError bridging: the error code within the given domain.
    public var errorCode: Int { OWSErrorCode.noSuchZonaRosaRecipient.rawValue }
    ...
    public class func isNoSuchZonaRosaRecipientError(_ error: Error?) -> Bool {
        error is MessageSenderNoSuchZonaRosaRecipientError
    }
...
public class UntrustedIdentityError: CustomNSError, UserErrorDescriptionProvider {
    ...
    public var localizedDescription: String {
        ...
        return String(format: format, SSKEnvironment.shared.databaseStorageRef.read { tx in
            return SSKEnvironment.shared.contactManagerRef.displayName(for: ZonaRosaServiceAddress(serviceId), tx: tx).resolvedValue()
        })
    }
