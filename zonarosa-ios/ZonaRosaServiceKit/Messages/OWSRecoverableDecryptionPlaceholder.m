...
{
    ZonaRosaServiceAddress *sender = [[ZonaRosaServiceAddress alloc] initWithServiceIdObjC:sourceAci];
    TSThread *thread;
             ...
             storyAuthorUuidString:(nullable NSString *)storyAuthorUuidString
                ...
                wasRemotelyDeleted:(BOOL)wasRemotelyDeleted
                         errorType:(TSErrorMessageType)errorType
                              read:(BOOL)read
                  recipientAddress:(nullable ZonaRosaServiceAddress *)recipientAddress
                            sender:(nullable ZonaRosaServiceAddress *)sender
