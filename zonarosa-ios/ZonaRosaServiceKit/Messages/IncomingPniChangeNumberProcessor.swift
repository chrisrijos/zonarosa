...
public class IncomingPniChangeNumberProcessorImpl: IncomingPniChangeNumberProcessor {
    ...
    private struct PniChangePhoneNumberData {
        ...
        let lastResortKyberPreKey: LibZonaRosaClient.KyberPreKeyRecord?
    ...
    private func deserializeIncomingPniChangePhoneNumber(
        ...
        do {
            ...
            let pniSignedPreKey = try LibZonaRosaClient.SignedPreKeyRecord(bytes: pniSignedPreKeyData)
            let pniLastResortKyberPreKey = try proto.lastResortKyberPreKey.map { try LibZonaRosaClient.KyberPreKeyRecord(bytes: $0) }
