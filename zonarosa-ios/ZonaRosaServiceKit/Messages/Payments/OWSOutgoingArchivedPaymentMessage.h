...
#import <ZonaRosaServiceKit/ZonaRosaServiceKit.h>
...
- (instancetype)initOutgoingMessageWithBuilder:(TSOutgoingMessageBuilder *)outgoingMessageBuilder
                        recipientAddressStates:
                            (NSDictionary<ZonaRosaServiceAddress *, TSOutgoingMessageRecipientState *> *)
...
- (instancetype)initWithGrdbId:(int64_t)grdbId
    ...
    isSmsMessageRestoredFromBackup:(BOOL)isSmsMessageRestoredFromBackup
      ...
      storedShouldStartExpireTimer:(BOOL)storedShouldStartExpireTimer
            ...
            recipientAddressStates:(nullable NSDictionary<ZonaRosaServiceAddress *, TSOutgoingMessageRecipientState *> *)
                                       recipientAddressStates
    ...
    storedShouldStartExpireTimer:(BOOL)storedShouldStartExpireTimer
           ...
           hasLegacyMessageState:(BOOL)hasLegacyMessageState
             hasSyncedTranscript:(BOOL)hasSyncedTranscript
              ...
              legacyWasDelivered:(BOOL)legacyWasDelivered
           mostRecentFailureText:(nullable NSString *)mostRecentFailureText
          recipientAddressStates:(nullable NSDictionary<ZonaRosaServiceAddress *,TSOutgoingMessageRecipientState *> *)recipientAddressStates
              storedMessageState:(TSOutgoingMessageState)storedMessageState
