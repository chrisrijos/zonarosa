...
public enum DisplayableGroupUpdateItem {
    ...
    case genericUpdateByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case genericUpdateByUnknownUser

    case createdByLocalUser
    case createdByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case createdByUnknownUser

    case nameChangedByLocalUser(newGroupName: String)
    case nameChangedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, newGroupName: String)
    case nameChangedByUnknownUser(newGroupName: String)

    case nameRemovedByLocalUser
    case nameRemovedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case nameRemovedByUnknownUser

    case avatarChangedByLocalUser
    case avatarChangedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case avatarChangedByUnknownUser

    case avatarRemovedByLocalUser
    case avatarRemovedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case avatarRemovedByUnknownUser

    case descriptionChangedByLocalUser(newDescription: String)
    case descriptionChangedByOtherUser(newDescription: String, updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case descriptionChangedByUnknownUser(newDescription: String)

    case descriptionRemovedByLocalUser
    case descriptionRemovedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case descriptionRemovedByUnknownUser

    case membersAccessChangedByLocalUser(newAccess: GroupV2Access)
    case membersAccessChangedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, newAccess: GroupV2Access)
    ...
    case attributesAccessChangedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, newAccess: GroupV2Access)
    case attributesAccessChangedByUnknownUser(newAccess: GroupV2Access)

    case announcementOnlyEnabledByLocalUser
    case announcementOnlyEnabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case announcementOnlyEnabledByUnknownUser

    case announcementOnlyDisabledByLocalUser
    case announcementOnlyDisabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    ...
    case localUserWasGrantedAdministratorByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case localUserWasGrantedAdministratorByUnknownUser

    case otherUserWasGrantedAdministratorByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserWasGrantedAdministratorByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserWasGrantedAdministratorByUnknownUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserWasRevokedAdministratorByLocalUser
    case localUserWasRevokedAdministratorByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case localUserWasRevokedAdministratorByUnknownUser

    case otherUserWasRevokedAdministratorByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserWasRevokedAdministratorByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserWasRevokedAdministratorByUnknownUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserLeft
    case localUserRemoved(removerName: String, removerAddress: ZonaRosaServiceAddress)
    case localUserRemovedByUnknownUser

    case otherUserLeft(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserRemovedByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserRemoved(removerName: String, removerAddress: ZonaRosaServiceAddress, userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserRemovedByUnknownUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserWasInvitedByLocalUser
    case localUserWasInvitedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case localUserWasInvitedByUnknownUser

    case otherUserWasInvitedByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case unnamedUsersWereInvitedByLocalUser(count: UInt)
    case unnamedUsersWereInvitedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, count: UInt)
    case unnamedUsersWereInvitedByUnknownUser(count: UInt)

    case localUserAcceptedInviteFromInviter(inviterName: String, inviterAddress: ZonaRosaServiceAddress)
    case localUserAcceptedInviteFromUnknownUser
    case otherUserAcceptedInviteFromLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserAcceptedInviteFromInviter(userName: String, userAddress: ZonaRosaServiceAddress, inviterName: String, inviterAddress: ZonaRosaServiceAddress)
    case otherUserAcceptedInviteFromUnknownUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserJoined
    case otherUserJoined(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserAddedByLocalUser
    case localUserAddedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case localUserAddedByUnknownUser

    case otherUserAddedByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserAddedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserAddedByUnknownUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserDeclinedInviteFromInviter(inviterName: String, inviterAddress: ZonaRosaServiceAddress)
    case localUserDeclinedInviteFromUnknownUser
    case localUserInviteRevoked(revokerName: String, revokerAddress: ZonaRosaServiceAddress)
    case localUserInviteRevokedByUnknownUser

    case otherUserInviteRevokedByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserDeclinedInviteFromLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserDeclinedInviteFromInviter(inviterName: String, inviterAddress: ZonaRosaServiceAddress)
    case otherUserDeclinedInviteFromUnknownUser

    case unnamedUserInvitesWereRevokedByLocalUser(count: UInt)
    case unnamedUserInvitesWereRevokedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, count: UInt)
    case unnamedUserInvitesWereRevokedByUnknownUser(count: UInt)

    case localUserRequestedToJoin
    case otherUserRequestedToJoin(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserRequestApproved(approverName: String, approverAddress: ZonaRosaServiceAddress)
    case localUserRequestApprovedByUnknownUser
    case otherUserRequestApprovedByLocalUser(userName: String, userAddress: ZonaRosaServiceAddress)
    case otherUserRequestApproved(userName: String, userAddress: ZonaRosaServiceAddress, approverName: String, approverAddress: ZonaRosaServiceAddress)
    case otherUserRequestApprovedByUnknownUser(userName: String, userAddress: ZonaRosaServiceAddress)

    case localUserRequestCanceledByLocalUser
    case localUserRequestRejectedByUnknownUser

    case otherUserRequestRejectedByLocalUser(requesterName: String, requesterAddress: ZonaRosaServiceAddress)
    case otherUserRequestRejectedByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, requesterName: String, requesterAddress: ZonaRosaServiceAddress)
    case otherUserRequestCanceledByOtherUser(requesterName: String, requesterAddress: ZonaRosaServiceAddress)
    case otherUserRequestRejectedByUnknownUser(requesterName: String, requesterAddress: ZonaRosaServiceAddress)

    case disappearingMessagesEnabledByLocalUser(durationMs: UInt64)
    case disappearingMessagesEnabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress, durationMs: UInt64)
    case disappearingMessagesEnabledByUnknownUser(durationMs: UInt64)

    case disappearingMessagesDisabledByLocalUser
    case disappearingMessagesDisabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case disappearingMessagesDisabledByUnknownUser

    case inviteLinkResetByLocalUser
    case inviteLinkResetByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case inviteLinkResetByUnknownUser

    case inviteLinkEnabledWithoutApprovalByLocalUser
    case inviteLinkEnabledWithoutApprovalByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case inviteLinkEnabledWithoutApprovalByUnknownUser

    case inviteLinkEnabledWithApprovalByLocalUser
    case inviteLinkEnabledWithApprovalByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case inviteLinkEnabledWithApprovalByUnknownUser

    case inviteLinkDisabledByLocalUser
    case inviteLinkDisabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case inviteLinkDisabledByUnknownUser

    case inviteLinkApprovalDisabledByLocalUser
    case inviteLinkApprovalDisabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case inviteLinkApprovalDisabledByUnknownUser

    case inviteLinkApprovalEnabledByLocalUser
    case inviteLinkApprovalEnabledByOtherUser(updaterName: String, updaterAddress: ZonaRosaServiceAddress)
    case inviteLinkApprovalEnabledByUnknownUser

    case localUserJoinedViaInviteLink
    case otherUserJoinedViaInviteLink(userName: String, userAddress: ZonaRosaServiceAddress)

    case sequenceOfInviteLinkRequestAndCancels(userName: String, userAddress: ZonaRosaServiceAddress, count: UInt, isTail: Bool)
...
extension DisplayableGroupUpdateItem {
    enum FormatArg {
        ...
        case name(_ string: String, _ address: ZonaRosaServiceAddress)
...
public extension NSAttributedString.Key {
    /// An attribute keying to the `ZonaRosaServiceAddress` of a user whose name
    /// is being displayed in the associated range in the string.
    static let addressOfName = NSAttributedString.Key(rawValue: "io.zonarosa.zonarosa.addressOfName")
}
...
public extension NSAttributedString {
    func enumerateAddressesOfNames(
        ...
        handler: (ZonaRosaServiceAddress?, NSRange, UnsafeMutablePointer<ObjCBool>) -> Void,
    ) {
        enumerateAttribute(
            .addressOfName,
            in: range ?? entireRange,
            options: [],
        ) { handler($0 as? ZonaRosaServiceAddress, $1, $2) }
    }
}
