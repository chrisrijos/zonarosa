...
- (instancetype)initWithTimestamp:(uint64_t)timestamp
                    authorAddress:(ZonaRosaServiceAddress *)authorAddress
...
{
    ZonaRosaServiceAddress *authorAddress = self.authorAddress;
...
- (nullable instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    self->_authorAddress = [coder decodeObjectOfClass:[ZonaRosaServiceAddress class] forKey:@"authorAddress"];
    ...
    if (_authorAddress == nil) {
        ...
        _authorAddress = [ZonaRosaServiceAddress legacyAddressWithServiceIdString:nil phoneNumber:phoneNumber];
