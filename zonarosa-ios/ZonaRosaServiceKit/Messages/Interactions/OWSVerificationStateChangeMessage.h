...
@property (nonatomic, readonly) ZonaRosaServiceAddress *recipientAddress;
             ...
             storyAuthorUuidString:(nullable NSString *)storyAuthorUuidString
               ...
               infoMessageUserInfo:(nullable NSDictionary<InfoMessageUserInfoKey, id> *)infoMessageUserInfo
                       messageType:(TSInfoMessageType)messageType
                              read:(BOOL)read
                        serverGuid:(nullable NSString *)serverGuid
               unregisteredAddress:(nullable ZonaRosaServiceAddress *)unregisteredAddress NS_UNAVAILABLE;

- (instancetype)initWithThread:(TSThread *)thread
                     timestamp:(uint64_t)timestamp
              recipientAddress:(ZonaRosaServiceAddress *)recipientAddress
