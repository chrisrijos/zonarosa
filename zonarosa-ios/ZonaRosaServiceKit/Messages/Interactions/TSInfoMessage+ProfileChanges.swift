...
public extension TSInfoMessage {
    ...
    var profileChangeAddress: ZonaRosaServiceAddress? {
...
public final class ProfileChanges: NSObject, NSSecureCoding, NSCopying {
    ...
    public init?(coder: NSCoder) {
        self.address = coder.decodeObject(of: ZonaRosaServiceAddress.self, forKey: "address")
    ...
    init(address: ZonaRosaServiceAddress, oldNameLiteral: String, newNameLiteral: String) {
    ...
    init(address: ZonaRosaServiceAddress, oldProfile: OWSUserProfile, newProfile: OWSUserProfile) {
        self.address = address
