...
typedef NS_CLOSED_ENUM(NSInteger, TSInfoMessageType) {
    ...
    TSInfoMessageUserJoinedZonaRosa,
...
@property (nonatomic, readonly, nullable) ZonaRosaServiceAddress *unregisteredAddress;
           ...
           storyAuthorUuidString:(nullable NSString *)storyAuthorUuidString
             ...
             infoMessageUserInfo:(nullable NSDictionary<InfoMessageUserInfoKey, id> *)infoMessageUserInfo
                     messageType:(TSInfoMessageType)messageType
                            read:(BOOL)read
                      serverGuid:(nullable NSString *)serverGuid
             unregisteredAddress:(nullable ZonaRosaServiceAddress *)unregisteredAddress
