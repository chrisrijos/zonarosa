...
extension TSInteraction {
    ...
    class func fromRecord(_ record: InteractionRecord) throws -> TSInteraction {
        ...
        case .addToContactsOfferMessage:
            ...
            let unregisteredAddress: ZonaRosaServiceAddress? = try unregisteredAddressSerialized.map({ try SDSDeserialization.unarchivedObject(ofClass: ZonaRosaServiceAddress.self, from: $0) })
        ...
        case .outgoingArchivedPaymentMessage:
            ...
            let recipientAddressStates: [ZonaRosaServiceAddress: TSOutgoingMessageRecipientState]? = try recipientAddressStatesSerialized.map({ try SDSDeserialization.unarchivedDictionary(ofKeyClass: ZonaRosaServiceAddress.self, objectClass: TSOutgoingMessageRecipientState.self, from: $0) })
        ...
        case .recoverableDecryptionPlaceholder:
            ...
            let recipientAddress: ZonaRosaServiceAddress? = try recipientAddressSerialized.map({ try SDSDeserialization.unarchivedObject(ofClass: ZonaRosaServiceAddress.self, from: $0) })
            let senderSerialized: Data? = record.sender
            let sender: ZonaRosaServiceAddress? = try senderSerialized.map({ try SDSDeserialization.unarchivedObject(ofClass: ZonaRosaServiceAddress.self, from: $0) })
        ...
        case .verificationStateChangeMessage:
            ...
            let recipientAddress: ZonaRosaServiceAddress = try SDSDeserialization.unarchivedObject(ofClass: ZonaRosaServiceAddress.self, from: recipientAddressSerialized)
...
extension TSInteraction: DeepCopyable {
    ...
    public func deepCopy() throws -> AnyObject {
        ...
        if let modelToCopy = self as? OWSOutgoingPaymentMessage {
            ...
            let recipientAddressStates: [ZonaRosaServiceAddress: TSOutgoingMessageRecipientState]?
        ...
        if let modelToCopy = self as? OWSVerificationStateChangeMessage {
            ...
            let unregisteredAddress: ZonaRosaServiceAddress?
            ...
            let recipientAddress: ZonaRosaServiceAddress = try DeepCopies.deepCopy(modelToCopy.recipientAddress)
        ...
        if let modelToCopy = self as? OWSUnknownProtocolVersionMessage {
            ...
            let sender: ZonaRosaServiceAddress?
