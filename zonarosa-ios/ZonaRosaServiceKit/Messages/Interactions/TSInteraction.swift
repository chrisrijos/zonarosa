...
extension TSInteraction {
    ...
    private func updatePlaceholder(
        from sender: ZonaRosaServiceAddress,
    ...
    @objc
    public func insertOrReplacePlaceholder(from sender: ZonaRosaServiceAddress, transaction: DBWriteTransaction) {
...
extension TSInteraction {
    ...
    private static func shouldInfoMessageAppearInInbox(
        ...
        case .userJoinedZonaRosa: return true
