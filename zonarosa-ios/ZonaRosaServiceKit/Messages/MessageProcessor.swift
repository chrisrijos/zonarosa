...
public class MessageProcessor {
    ...
    private let queueForEnqueueing = DispatchQueue(label: "io.zonarosa.message-processor-enqueue")
    private let queueForProcessing = DispatchQueue(label: "io.zonarosa.message-processor-process", autoreleaseFrequency: .workItem)
...
private struct ProcessingRequestBuilder {
    ...
    private func processingRequest(
        ...
        let sourceAddress = ZonaRosaServiceAddress(decryptedEnvelope.sourceAci)
