...
public class BlockingManager {
    ...
    public func isAddressBlocked(_ address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> Bool {
    ...
    public func isRecipientBlocked(recipientId: ZonaRosaRecipient.RowId, tx: DBReadTransaction) -> Bool {
    ...
    public func blockedAddresses(transaction: DBReadTransaction) -> Set<ZonaRosaServiceAddress> {
        let recipientDatabaseTable = DependenciesBridge.shared.recipientDatabaseTable
    ...
    public func addBlockedAci(_ aci: Aci, blockMode: BlockMode, tx: DBWriteTransaction) {
        self.addBlockedAddress(ZonaRosaServiceAddress(aci), blockMode: blockMode, transaction: tx)
    }
    ...
    public func addBlockedAddress(
        ...
        let recipient: ZonaRosaRecipient
    ...
    public func processIncomingSync(
        ...
        var blockedRecipientIds = Set<ZonaRosaRecipient.RowId>()
        let recipientFetcher = DependenciesBridge.shared.recipientFetcher
