...
public class OWSIncomingSentMessageTranscript: SentMessageTranscript {
    ...
    public let recipientStates: [ZonaRosaServiceAddress: TSOutgoingMessageRecipientState]
    ...
    public static func from(
        ...
        for statusProto in sentProto.unidentifiedStatus {
            ...
            recipientStates[ZonaRosaServiceAddress(serviceId)] = recipientState
        }
    ...
    private init(
        ...
        timestamp: UInt64,
        recipientStates: [ZonaRosaServiceAddress: TSOutgoingMessageRecipientState],
    ) {
        self.type = type
