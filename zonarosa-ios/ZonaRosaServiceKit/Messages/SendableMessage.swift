...
protocol SendableMessage {
    ...
    func sendingRecipientAddresses() -> [ZonaRosaServiceAddress]

    func sentRecipientAddresses() -> [ZonaRosaServiceAddress]
    ...
    func updateWithSkippedRecipients(_ skippedRecipients: some Sequence<ZonaRosaServiceAddress>, tx: DBWriteTransaction)
