...
public class ContactThreadFactory: Factory {
    ...
    public var contactAddressBuilder: () -> ZonaRosaServiceAddress = {
...
public class IncomingMessageFactory: Factory {
    ...
    public var authorAciBuilder: (TSThread) -> Aci = { thread in
        return { () -> ZonaRosaServiceAddress in
            switch thread {
...
public class CommonGenerator {
    ...
    public static func address() -> ZonaRosaServiceAddress {
    ...
    public static func address(hasAci: Bool = true, hasPhoneNumber: Bool = true) -> ZonaRosaServiceAddress {
