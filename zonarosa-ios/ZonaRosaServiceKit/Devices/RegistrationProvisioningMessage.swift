...
public struct RegistrationProvisioningMessage {
    ...
    public let lastBackupForwardSecrecyToken: LibZonaRosaClient.BackupForwardSecrecyToken?
    ...
    public init(
        ...
        lastBackupForwardSecrecyToken: LibZonaRosaClient.BackupForwardSecrecyToken?,
    ...
    public init(plaintext: Data) throws {
        ...
        if let data = proto.lastBackupForwardSecrecyToken.nilIfEmpty {
            self.lastBackupForwardSecrecyToken = try LibZonaRosaClient.BackupForwardSecrecyToken(contents: data)
        } else {
