...
final class OutgoingViewOnceOpenSyncMessage: OutgoingSyncMessage {
    ...
    init(
        ...
        self.senderAddress = ZonaRosaServiceAddress(senderAci)
    ...
    required init?(coder: NSCoder) {
        ...
        let modernAddress = coder.decodeObject(of: ZonaRosaServiceAddress.self, forKey: "senderAddress")
        self.senderAddress = modernAddress ?? ZonaRosaServiceAddress.legacyAddress(
            serviceIdString: nil,
