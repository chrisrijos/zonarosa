...
public enum ZonaRosaIOSProtoError: Error {
    case invalidProtobuf(description: String)
}

// MARK: - ZonaRosaIOSProtoDeviceName

@objc
public class ZonaRosaIOSProtoDeviceName: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate convenience init(_ proto: IOSProtos_DeviceName) throws {
        guard proto.hasEphemeralPublic else {
            throw ZonaRosaIOSProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: ephemeralPublic")
        }
        let ephemeralPublic = proto.ephemeralPublic

        guard proto.hasSyntheticIv else {
            throw ZonaRosaIOSProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: syntheticIv")
        }
        let syntheticIv = proto.syntheticIv

        guard proto.hasCiphertext else {
            throw ZonaRosaIOSProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: ciphertext")
        }
...
extension ZonaRosaIOSProtoDeviceName {
    @objc
    public static func builder(ephemeralPublic: Data, syntheticIv: Data, ciphertext: Data) -> ZonaRosaIOSProtoDeviceNameBuilder {
        return ZonaRosaIOSProtoDeviceNameBuilder(ephemeralPublic: ephemeralPublic, syntheticIv: syntheticIv, ciphertext: ciphertext)
    }

    // asBuilder() constructs a builder that reflects the proto's contents.
    @objc
    public func asBuilder() -> ZonaRosaIOSProtoDeviceNameBuilder {
        let builder = ZonaRosaIOSProtoDeviceNameBuilder(ephemeralPublic: ephemeralPublic, syntheticIv: syntheticIv, ciphertext: ciphertext)
...
@objc
public class ZonaRosaIOSProtoDeviceNameBuilder: NSObject {
    ...
    @objc
    public func build() throws -> ZonaRosaIOSProtoDeviceName {
        return try ZonaRosaIOSProtoDeviceName(proto)
    }

    @objc
    public func buildSerializedData() throws -> Data {
        return try ZonaRosaIOSProtoDeviceName(proto).serializedData()
    }
}
...
extension ZonaRosaIOSProtoDeviceNameBuilder {
    @objc
    public func buildIgnoringErrors() -> ZonaRosaIOSProtoDeviceName? {
