...
public struct BackupProto_MessageAttachment: @unchecked Sendable {
  ...
  /// owning message. See: ZonaRosaService.AttachmentPointer.clientUuid.
  ...
  /// Similar to ZonaRosaService.AttachmentPointer.Flags,
...
fileprivate let _protobuf_package = "zonarosa.backup"
