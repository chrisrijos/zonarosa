...
public enum AppNotificationAction: String {
    case callBack = "ZonaRosa.AppNotifications.Action.callBack"
    case markAsRead = "ZonaRosa.AppNotifications.Action.markAsRead"
    case reply = "ZonaRosa.AppNotifications.Action.reply"
    case showThread = "ZonaRosa.AppNotifications.Action.showThread"
    case reactWithThumbsUp = "ZonaRosa.AppNotifications.Action.reactWithThumbsUp"
}

/// Represents "default" notification actions. These happen when you tap a
/// notification to launch ZonaRosa. These are a ZonaRosa concept -- they are
...
public struct AppNotificationUserInfo {
    ...
    private enum UserInfoKey {
        static let callBackAciString = "ZonaRosa.AppNotificationsUserInfoKey.callBackUuid"
        static let callBackPhoneNumber = "ZonaRosa.AppNotificationsUserInfoKey.callBackPhoneNumber"
        static let defaultAction = "ZonaRosa.AppNotificationsUserInfoKey.defaultAction"
        static let isMissedCall = "ZonaRosa.AppNotificationsUserInfoKey.isMissedCall"
        static let messageId = "ZonaRosa.AppNotificationsUserInfoKey.messageId"
        static let reactionId = "ZonaRosa.AppNotificationsUserInfoKey.reactionId"
        static let roomId = "ZonaRosa.AppNotificationsUserInfoKey.roomId"
        static let storyMessageId = "ZonaRosa.AppNotificationsUserInfoKey.storyMessageId"
        static let storyTimestamp = "ZonaRosa.AppNotificationsUserInfoKey.storyTimestamp"
        static let threadId = "ZonaRosa.AppNotificationsUserInfoKey.threadId"
        static let voteAuthorServiceIdBinary = "ZonaRosa.AppNotificationsUserInfoKey.voteAuthorServiceIdBinary"
    }
...
public enum AppNotificationCategory: String, CaseIterable {
    case incomingMessageWithActions_CanReply = "ZonaRosa.AppNotificationCategory.incomingMessageWithActions"
    case incomingMessageWithActions_CannotReply = "ZonaRosa.AppNotificationCategory.incomingMessageWithActionsNoReply"
    case incomingMessageWithoutActions = "ZonaRosa.AppNotificationCategory.incomingMessage"
    case incomingMessageFromNoLongerVerifiedIdentity = "ZonaRosa.AppNotificationCategory.incomingMessageFromNoLongerVerifiedIdentity"
    case incomingReactionWithActions_CanReply = "ZonaRosa.AppNotificationCategory.incomingReactionWithActions"
    case incomingReactionWithActions_CannotReply = "ZonaRosa.AppNotificationCategory.incomingReactionWithActionsNoReply"
    case infoOrErrorMessage = "ZonaRosa.AppNotificationCategory.infoOrErrorMessage"
    case missedCallWithActions = "ZonaRosa.AppNotificationCategory.missedCallWithActions"
    case missedCallWithoutActions = "ZonaRosa.AppNotificationCategory.missedCall"
    case missedCallFromNoLongerVerifiedIdentity = "ZonaRosa.AppNotificationCategory.missedCallFromNoLongerVerifiedIdentity"
    case internalError = "ZonaRosa.AppNotificationCategory.internalError"
    case incomingGroupStoryReply = "ZonaRosa.AppNotificationCategory.incomingGroupStoryReply"
    case failedStorySend = "ZonaRosa.AppNotificationCategory.failedStorySend"
    case transferRelaunch = "ZonaRosa.AppNotificationCategory.transferRelaunch"
    case deregistration = "ZonaRosa.AppNotificationCategory.authErrorLogout"
    case newDeviceLinked = "ZonaRosa.AppNotificationCategory.newDeviceLinked"
    case backupsEnabled = "ZonaRosa.AppNotificationCategory.backupsEnabled"
    case backupsMediaTierQuotaConsumed = "ZonaRosa.AppNotificationCategory.backupsMediaTierQuotaConsumed"
    case listMediaIntegrityCheckFailure = "ZonaRosa.AppNotificationCategory.listMediaIntegrityCheckFailure"
    case pollEndNotification = "ZonaRosa.AppNotificationCategory.pollEndNotification"
    case pollVoteNotification = "ZonaRosa.AppNotificationCategory.pollVoteNotification"
...
public class NotificationPresenterImpl: NotificationPresenter {
    ...
    public func notifyUserOfPollVote(
        ...
        let notificationTitle = self.notificationTitle(
            for: notifiableThread,
            senderAddress: ZonaRosaServiceAddress(voteAuthor),
            isGroupStoryReply: false,
            previewType: previewType,
            tx: transaction,
        )
        ...
        let voteAuthorName = SSKEnvironment.shared.contactManagerRef.nameForAddress(
            ZonaRosaServiceAddress(voteAuthor),
            localUserDisplayMode: .noteToSelf,
            short: false,
            transaction: transaction,
        )
        ...
        let intent = thread.generateSendMessageIntent(context: .senderAddress(ZonaRosaServiceAddress(voteAuthor)), transaction: transaction)
    ...
    private func notificationTitle(
        ...
        senderAddress: ZonaRosaServiceAddress?,
    ...
    private func resolvableValue(
        withDisplayNameForAddress address: ZonaRosaServiceAddress,
        ...
        if previewType != .noNameNoPreview {
            if let infoMessage = tsInteraction as? TSInfoMessage {
                ...
                case .typeGroupUpdate:
                    let groupUpdateAuthor: ZonaRosaServiceAddress?
                ...
                intent = thread.generateSendMessageIntent(context: .senderAddress(ZonaRosaServiceAddress(callCreator)), transaction: transaction)
            }
        }
    ...
    public func notifyUserToRelaunchAfterTransfer(completion: @escaping () -> Void) {
        let notificationBody = OWSLocalizedString(
            ...
            comment: "Notification prompting the user to relaunch ZonaRosa after a device transfer completed.",
        )
        var userInfo = AppNotificationUserInfo()
