...
public final class DebugLogger {
    ...
    public static func registerLibzonarosa() {
        LibzonarosaLoggerImpl().setUpLibzonarosaLogging(level: { () -> LibzonarosaLogLevel in
            if ShouldLogVerbose() {
                return .trace
            }
            if ShouldLogDebug() {
...
private extension LibzonarosaLogLevel {
...
final class LibzonarosaLoggerImpl: LibzonarosaLogger {
