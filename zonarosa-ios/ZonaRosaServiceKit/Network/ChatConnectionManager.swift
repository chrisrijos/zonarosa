...
public protocol ChatConnectionManager {
    ...
    /// Access a libzonarosa "service" on the active unauthenticated connection.
    ///
...
public class ChatConnectionManagerImpl: ChatConnectionManager {
    private let connectionIdentified: OWSAuthConnectionUsingLibZonaRosa
    private let connectionUnidentified: OWSUnauthConnectionUsingLibZonaRosa
    ...
    public init(
        ...
        self.connectionIdentified = OWSAuthConnectionUsingLibZonaRosa(
        ...
        self.connectionUnidentified = OWSUnauthConnectionUsingLibZonaRosa(
            libzonarosaNet: libzonarosaNet,
            appExpiry: appExpiry,
            appReadiness: appReadiness,
            db: db,
    ...
    public func keyTransparencyClient() async throws -> KeyTransparency.Client {
        return try await connectionUnidentified.withLibzonarosaConnection { connection in
    ...
    public func withUnauthService<Service, Output>(
        ...
        try await connectionUnidentified.withLibzonarosaConnection { connection in
