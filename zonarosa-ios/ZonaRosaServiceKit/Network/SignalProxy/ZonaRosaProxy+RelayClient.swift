...
extension ZonaRosaProxy {
    /// Represents a connection to the `RelayServer`. Establishes a `ProxyClient` to interact with the zonarosa service.
    class RelayClient {
        ...
        private lazy var queue = DispatchQueue(label: "io.zonarosa.proxy.relay-client", attributes: .concurrent)
