...
public enum OWSRequestFactory {
    ...
    static func submitMessageRequest(
        ...
        // the ZonaRosa Web Service.
        // See
        // <https://github.com/zonarosa/ZonaRosa-Server/blob/65da844d70369cb8b44966cfb2d2eb9b925a6ba4/service/src/main/java/io/zonarosa/zonarosagcm/entities/IncomingMessageList.java>.
    ...
    static func submitMultiRecipientMessageRequest(
        ...
        request.headers["Content-Type"] = "application/vnd.zonarosa-messenger.mrm"
        request.auth = .sealedSender(auth)
    ...
    static func preKeyRequestParameters(_ preKeyRecord: LibZonaRosaClient.PreKeyRecord) -> [String: Any] {
        [
    ...
    static func signedPreKeyRequestParameters(_ signedPreKeyRecord: LibZonaRosaClient.SignedPreKeyRecord) -> [String: Any] {
        [
    ...
    static func pqPreKeyRequestParameters(_ pqPreKeyRecord: LibZonaRosaClient.KyberPreKeyRecord) -> [String: Any] {
        [
...
extension DeviceMessage {
    ...
    ///
    /// See <https://github.com/zonarosa/ZonaRosa-Server/blob/ab26a65/service/src/main/java/io/zonarosa/zonarosagcm/entities/IncomingMessage.java>.
