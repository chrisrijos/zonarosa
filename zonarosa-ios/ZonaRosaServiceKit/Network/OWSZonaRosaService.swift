...
public class OWSZonaRosaService: OWSZonaRosaServiceProtocol {
    private let keyValueStore = KeyValueStore(collection: "kTSStorageManager_OWSZonaRosaService")
    ...
    @Atomic public private(set) var isCensorshipCircumventionActive: Bool = false {
        didSet {
            ...
            // Update libzonarosa's Net instance first, so that connections can be recreated by notification observers.
            libzonarosaNet?.setCensorshipCircumventionEnabled(isCensorshipCircumventionActive)
    ...
    public func buildUrlEndpoint(for zonarosaServiceInfo: ZonaRosaServiceInfo) -> OWSURLSessionEndpoint {
        return buildUrlEndpoint(
            censorshipConfigurationParams: self.censorshipConfigurationParamsWithMaybeSneakyTransaction(
                censorshipCircumventionSupportedForService: zonarosaServiceInfo.censorshipCircumventionSupported,
            ),
            baseUrl: zonarosaServiceInfo.baseUrl,
            censorshipCircumventionPathPrefix: zonarosaServiceInfo.censorshipCircumventionPathPrefix,
            shouldUseZonaRosaCertificate: zonarosaServiceInfo.shouldUseZonaRosaCertificate,
        )
    }
    ...
    private func buildUrlEndpoint(
        ...
        shouldUseZonaRosaCertificate: Bool,
        ...
        if let censorshipConfigurationParams {
            ...
            if shouldUseZonaRosaCertificate {
    ...
    public func buildUrlSession(
        ...
        return buildUrlSession(
            ...
            shouldHandleRemoteDeprecation: zonarosaServiceInfo.shouldHandleRemoteDeprecation,
    ...
    private func buildUrlSession(
        ...
        let urlSession = OWSURLSession(
            ...
            maxResponseSize: maxResponseSize,
            canUseZonaRosaProxy: endpoint.frontingInfo == nil,
    ...
    public init(libzonarosaNet: Net?) {
    ...
    private func observeNotifications() {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(isZonaRosaProxyReadyDidChange),
    ...
    @objc
    private func isZonaRosaProxyReadyDidChange() {
