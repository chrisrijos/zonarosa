...
public class OWSURLSession: OWSURLSessionProtocol {
    ...
    public static let zonarosaServiceSecurityPolicy = HttpSecurityPolicy.zonarosaCaPinned
    ...
    public static var userAgentHeaderValueZonaRosaIos: String { HttpHeaders.userAgentHeaderValueZonaRosaIos }
    ...
    public required init(
        ...
        canUseZonaRosaProxy: Bool,
        onFailureCallback: ((any Error) -> Void)?,
    ) {
        if canUseZonaRosaProxy {
            configuration.connectionProxyDictionary = ZonaRosaProxy.connectionProxyDictionary
        }

        self.endpoint = endpoint
        self.configuration = configuration
        self.maxResponseSize = maxResponseSize
        self.canUseZonaRosaProxy = canUseZonaRosaProxy
    ...
    public convenience init(
        ...
        canUseZonaRosaProxy: Bool = false,
    ) {
        self.init(
            endpoint: OWSURLSessionEndpoint(
                baseUrl: baseUrl,
            ...
            canUseZonaRosaProxy: canUseZonaRosaProxy,
        )
    }
    ...
    private let canUseZonaRosaProxy: Bool
    ...
    private func prepareRequest(request: URLRequest) -> URLRequest {
        ...
        // Only requests to ZonaRosa services require CC.
