...
public struct HttpHeaders: Codable, CustomDebugStringConvertible, ExpressibleByDictionaryLiteral {
    ...
    public static var userAgentHeaderValueZonaRosaIos: String {
        "ZonaRosa-iOS/\(AppVersionImpl.shared.currentAppVersion) iOS/\(UIDevice.current.systemVersion)"
    }
    ...
    public mutating func addDefaultHeaders() {
        addHeader(Self.userAgentHeaderKey, value: Self.userAgentHeaderValueZonaRosaIos, overwriteOnConflict: false)
