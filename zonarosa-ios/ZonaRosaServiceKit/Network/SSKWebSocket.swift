...
public struct WebSocketRequest {
    /// The ZonaRosa service associated with this request.
    public let zonarosaService: ZonaRosaServiceType
...
public class WebSocketFactoryNative: NSObject, WebSocketFactory {
    public func buildSocket(request: WebSocketRequest, callbackScheduler: Scheduler) -> SSKWebSocket? {
        return SSKWebSocketNative(request: request, zonarosaService: SSKEnvironment.shared.zonarosaServiceRef, callbackScheduler: callbackScheduler)
    }
}
...
public class SSKWebSocketNative: SSKWebSocket {
    ...
    public init?(
        ...
        let zonarosaServiceInfo = request.zonarosaService.zonarosaServiceInfo()

        let endpoint = zonarosaService.buildUrlEndpoint(for: zonarosaServiceInfo)
        ...
        self.urlSession = zonarosaService.buildUrlSession(
