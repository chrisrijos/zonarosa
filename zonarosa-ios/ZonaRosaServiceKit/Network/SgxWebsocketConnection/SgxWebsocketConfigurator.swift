...
/// and creation of the LibZonaRosa-provided `SgxClient`.
public protocol SgxWebsocketConfigurator {
    ...
    /// ZonaRosaServiceType to use for the websocket connection, e.g. which
    /// root url to hit. (See information in `ZonaRosaServiceInfo`)
    static var zonarosaServiceType: ZonaRosaServiceType { get }
