...
public class BaseOWSURLSessionMock: OWSURLSessionProtocol {
    ...
    public static let zonarosaServiceSecurityPolicy = OWSURLSession.zonarosaServiceSecurityPolicy
    ...
    public static var userAgentHeaderValueZonaRosaIos: String = OWSURLSession.userAgentHeaderValueZonaRosaIos
