...
public protocol OWSURLSessionProtocol: AnyObject {
    ...
    static var zonarosaServiceSecurityPolicy: HttpSecurityPolicy { get }
    ...
    static var userAgentHeaderValueZonaRosaIos: String { get }
...
extension OWSURLSessionProtocol {
    ...
    public func performMultiPartUpload(
        ...
        request.setValue(Self.userAgentHeaderValueZonaRosaIos, forHTTPHeaderField: Self.userAgentHeaderKey)
