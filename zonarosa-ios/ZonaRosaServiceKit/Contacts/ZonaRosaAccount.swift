...
@objc(ZonaRosaAccount)
public final class ZonaRosaAccount: NSObject, SDSCodableModel, Decodable {
    public static let databaseTableName = "model_ZonaRosaAccount"
    public static var recordType: UInt { SDSRecordType.zonarosaAccount.rawValue }
...
// MARK: - ZonaRosaServiceAddress

extension ZonaRosaAccount {
    public var recipientAddress: ZonaRosaServiceAddress {
        ZonaRosaServiceAddress(serviceId: recipientServiceId, phoneNumber: recipientPhoneNumber)
    }
}
...
extension ZonaRosaAccount {
    ...
    public func hasSameContent(_ otherAccount: ZonaRosaAccount) -> Bool {
    ...
    public func hasSameName(_ otherAccount: ZonaRosaAccount) -> Bool {
        return
