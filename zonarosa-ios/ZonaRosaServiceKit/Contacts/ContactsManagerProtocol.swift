...
public protocol ContactsManagerProtocol {
    ...
    func displayNameString(for address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> String
    ...
    func shortDisplayNameString(for address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> String
}
