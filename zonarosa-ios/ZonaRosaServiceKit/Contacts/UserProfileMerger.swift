...
class UserProfileMerger: RecipientMergeObserver {
    ...
    private func mergeUserProfiles(for recipient: ZonaRosaRecipient, tx: DBWriteTransaction) {
    ...
    private func fetchAndExpungeUserProfiles(for recipient: ZonaRosaRecipient, tx: DBWriteTransaction) -> [OWSUserProfile] {
