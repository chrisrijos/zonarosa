...
public class StoryRecipientManager {
    ...
    public func setRecipientIds(
        _ recipientIds: [ZonaRosaRecipient.RowId],
    ...
    /// (e.g., custom stories, "My ZonaRosa Connections Except..."). Doesn't
    /// remove it from already-deleted custom stories.
    public func removeRecipientIdFromAllPrivateStoryThreads(_ recipientId: ZonaRosaRecipient.RowId, shouldUpdateStorageService: Bool, tx: DBWriteTransaction) {
