...
// wrap libzonarosa stuff that we will _always_ need to wrap.
...
class SVR2ClientWrapperImpl: SVR2ClientWrapper {
    ...
    func hashPin(
        ...
        let pinHash = try LibZonaRosaClient.PinHash(normalizedPin: utf8NormalizedPin, username: username, mrenclave: connection.mrEnclave.dataValue)
