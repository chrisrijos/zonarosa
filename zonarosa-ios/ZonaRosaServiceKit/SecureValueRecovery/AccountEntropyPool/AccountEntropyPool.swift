...
public struct AccountEntropyPool: Codable, Equatable {
    ...
    /// The raw representation of the AEP, suitable for passing to LibZonaRosa and
    /// other APIs.
    ...
    public init() {
        let generatedKey: String = LibZonaRosaClient.AccountEntropyPool.generate()
    ...
    public init(key: String) throws {
        ...
        guard LibZonaRosaClient.AccountEntropyPool.isValid(normalizedKey) else {
    ...
    public func getMasterKey() -> MasterKey {
        ...
        // LibZonaRosa on init, or generated by LibZonaRosa, so should correctly generate a MasterKey.
        return try! MasterKey(data: try! LibZonaRosaClient.AccountEntropyPool.deriveSvrKey(rawString))
    }

    public func getBackupKey() -> BackupKey {
        return try! LibZonaRosaClient.AccountEntropyPool.deriveBackupKey(rawString)
    }
