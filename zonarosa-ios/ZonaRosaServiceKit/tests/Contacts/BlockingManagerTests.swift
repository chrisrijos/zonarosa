...
class BlockingManagerTests: SSKBaseTest {
    ...
    func testAddBlockedAddress() {
        ...
        SSKEnvironment.shared.databaseStorageRef.read { tx in
            ...
            XCTAssertTrue(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(aci), transaction: tx))
    ...
    func testRemoveBlockedAddress() {
        ...
        // Test
        SSKEnvironment.shared.databaseStorageRef.write { tx in
            blockingManager.removeBlockedAddress(ZonaRosaServiceAddress(unblockedAci), wasLocallyInitiated: true, transaction: tx)
        }

        // Verify
        SSKEnvironment.shared.databaseStorageRef.read { tx in
            XCTAssertTrue(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(blockedAci), transaction: tx))
            XCTAssertFalse(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(unblockedAci), transaction: tx))
    ...
    func testIncomingSyncMessage() throws {
        ...
        try SSKEnvironment.shared.databaseStorageRef.write { tx in
            blockingManager.addBlockedAddress(
                ZonaRosaServiceAddress(noLongerBlockedAci),
                blockMode: .localShouldNotLeaveGroups,
                transaction: tx,
            )
            blockingManager.addBlockedAddress(
                ZonaRosaServiceAddress(noLongerBlockedPhoneNumber),
                blockMode: .localShouldNotLeaveGroups,
                transaction: tx,
            )
            ...
            blockingManager.addBlockedAddress(
                ZonaRosaServiceAddress(stillBlockedAci),
                blockMode: .localShouldNotLeaveGroups,
                transaction: tx,
            )
            blockingManager.addBlockedAddress(
                ZonaRosaServiceAddress(stillBlockedPhoneNumber),
                blockMode: .localShouldNotLeaveGroups,
                transaction: tx,
            )
            TSGroupThread.forUnitTest(
        ...
        try SSKEnvironment.shared.databaseStorageRef.read { readTx in
            ...
            XCTAssertFalse(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(noLongerBlockedAci), transaction: readTx))
            XCTAssertFalse(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(noLongerBlockedPhoneNumber), transaction: readTx))
            ...
            XCTAssertTrue(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(stillBlockedAci), transaction: readTx))
            XCTAssertTrue(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(stillBlockedPhoneNumber), transaction: readTx))
            ...
            XCTAssertTrue(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(newlyBlockedAci), transaction: readTx))
            XCTAssertTrue(blockingManager.isAddressBlocked(ZonaRosaServiceAddress(newlyBlockedPhoneNumber), transaction: readTx))
            ...
            let expectedBlockedAddresses = [
                ZonaRosaServiceAddress(stillBlockedAci),
                ZonaRosaServiceAddress(stillBlockedPhoneNumber),
                ZonaRosaServiceAddress(newlyBlockedAci),
                ZonaRosaServiceAddress(newlyBlockedPhoneNumber),
            ]
