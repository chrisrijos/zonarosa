...
private class MockGroupMemberUpdaterTemporaryShims: GroupMemberUpdaterTemporaryShims {
    ...
    func fetchLatestInteractionTimestamp(
        groupThreadId: String,
        groupMemberAddress: ZonaRosaServiceAddress,
...
class GroupMemberUpdaterTest: XCTestCase {
    ...
    private lazy var mockZonaRosaServiceAddressCache = ZonaRosaServiceAddressCache(phoneNumberVisibilityFetcher: mockPhoneNumberVisibilityFetcher)
    ...
    private lazy var groupMemberUpdater = GroupMemberUpdaterImpl(
        ...
        zonarosaServiceAddressCache: mockZonaRosaServiceAddressCache,
    )
    ...
    func testUpdateRecords() {
        ...
        var zonarosaRecipients = [(aci: String, pni: String?, phoneNumber: String)]()
        ...
        zonarosaRecipients.append(("00000000-0000-4000-8000-000000000002", nil, "+16505550100"))
        ...
        zonarosaRecipients.append(("00000000-0000-4000-8000-000000000005", nil, "+16505550101"))
        ...
        // ZonaRosaRecipient), we should remove it.
        ...
        zonarosaRecipients.append(("00000000-0000-4000-8000-000000000007", nil, "+16505550104"))
        ...
        zonarosaRecipients.append(("00000000-0000-4000-8000-000000000009", "PNI:00000000-0000-4000-8000-00000000000A", "+16505550105"))
        ...
        mockDB.write { tx in
            for zonarosaRecipient in zonarosaRecipients {
                mockZonaRosaServiceAddressCache.updateRecipient(
                    try! ZonaRosaRecipient.insertRecord(
                        aci: Aci.constantForTesting(zonarosaRecipient.aci),
                        phoneNumber: E164(zonarosaRecipient.phoneNumber),
                        pni: zonarosaRecipient.pni.map { Pni.constantForTesting($0) },
                        tx: tx,
                    ),
                    tx: tx,
                )
    ...
    private func makeAddress(serviceId: String?, phoneNumber: String?) -> ZonaRosaServiceAddress {
        return ZonaRosaServiceAddress(
            serviceId: serviceId.map { try! ServiceId.parseFrom(serviceIdString: $0) },
            phoneNumber: phoneNumber,
            cache: mockZonaRosaServiceAddressCache,
        )
    }
}
