...
final class TSMessageStorageTest: SSKBaseTest {
    ...
    var localAddress: ZonaRosaServiceAddress { return ZonaRosaServiceAddress(localAci) }

    var otherAci: Aci { return Aci.parseFrom(aciString: "00000000-0000-4000-8000-000000000001")! }
    var otherAddress: ZonaRosaServiceAddress { return ZonaRosaServiceAddress(otherAci) }
