...
class TestProtocolRunnerTest: SSKBaseTest {
    ...
    var aliceClient: FakeZonaRosaClient!
    var bobClient: FakeZonaRosaClient!

    override func setUp() {
        super.setUp()
        aliceClient = FakeZonaRosaClient.generate(e164Identifier: "+122233alice")
        bobClient = FakeZonaRosaClient.generate(e164Identifier: "+12223334bob")
