...
// https://github.com/zonarosa/libzonarosa-metadata-java/blob/4a0e0c87ea733d5c007488671b74ace0dc5dcbef/tests/src/test/java/io/zonarosa/libzonarosa/metadata/SealedSessionCipherTest.java
...
class SMKSecretSessionCipherTest: SSKBaseTest {
    ...
    func testEncryptDecrypt() {
        ...
        // byte[] ciphertext = aliceCipher.encrypt(new ZonaRosaProtocolAddress("+14152222222", 1),
        ...
        // SealedSessionCipher bobCipher = new SealedSessionCipher(bobStore, new ZonaRosaProtocolAddress("+14152222222", 1));
        let bobCipher: SMKSecretSessionCipher = bobMockClient.createSecretSessionCipher()

        // Pair<ZonaRosaProtocolAddress, byte[]> plaintext = bobCipher.decrypt(new CertificateValidator(trustRoot.getPublicKey()), ciphertext, 31335);
    ...
    func testGroupEncryptDecrypt_Failure() {
        ...
        do {
            ...
            if case ZonaRosaError.sessionNotFound = knownSenderError.underlyingError {
                // Expected
            } else {
    ...
    // private void initializeSessions(TestInMemoryZonaRosaProtocolStore aliceStore, TestInMemoryZonaRosaProtocolStore bobStore)
