...
class OWSUDManagerTest: SSKBaseTest {
    ...
    func testMode_withProfileKey() {
        ...
        let bobRecipientAci = Aci.randomForTesting()
        profileManager.fakeUserProfiles![ZonaRosaServiceAddress(bobRecipientAci)] = OWSUserProfile(address: .otherUser(ZonaRosaServiceAddress(bobRecipientAci)), profileKey: Aes256Key.generateRandom())
