...
class NSAttributedStringInGroupUpdateCopyTest: SSKBaseTest {
    ...
    /// which is done in the guts of ZonaRosa using the "current locale".
...
private extension NSMutableAttributedString {
    func addAddress(_ address: ZonaRosaServiceAddress, toRange range: NSRange) {
...
private extension ZonaRosaServiceAddress {
    static let alice = ZonaRosaServiceAddress(phoneNumber: "+17735550100")
    static let aliceH = ZonaRosaServiceAddress(phoneNumber: "+17735550101")
    static let bob = ZonaRosaServiceAddress(phoneNumber: "+17735550102")
    static let made = ZonaRosaServiceAddress(phoneNumber: "+17735550103")
    static let anotherAlice = ZonaRosaServiceAddress(phoneNumber: "+17735550104")
    static let singleArgFormatSpecifier = ZonaRosaServiceAddress(phoneNumber: "+17735550105")
    static let multiArgFormatSpecifier = ZonaRosaServiceAddress(phoneNumber: "+17735550106")
    static let empty = ZonaRosaServiceAddress(phoneNumber: "+17735550107")
    static let fatima = ZonaRosaServiceAddress(phoneNumber: "+17735550108")
    static let qi = ZonaRosaServiceAddress(phoneNumber: "+17735550109")
}
...
private struct ReferencedUser {
    ...
    let name: String
    let address: ZonaRosaServiceAddress
}
