...
extension OWSLinkPreview {
    static let constants: [(OWSLinkPreview, base64NSArchiverData: Data, jsonData: Data)] = [
        ...
        (
            ...
            Data(#"{"imageAttachmentId":"1234","urlString":"https:\/\/zonarosa.io","title":"Some Title"}"#.utf8),
        ),
        (
            OWSLinkPreview(
                urlString: "https://zonarosa.io",
            ...
            Data(#"{"urlString":"https:\/\/zonarosa.io","title":"Some Title"}"#.utf8),
        ),
    ]
