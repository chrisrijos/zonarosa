...
class MockClient {
    ...
    let sessionStore: InMemoryZonaRosaProtocolStore
    let preKeyStore: InMemoryZonaRosaProtocolStore
    let signedPreKeyStore: InMemoryZonaRosaProtocolStore
    let kyberPreKeyStore: InMemoryZonaRosaProtocolStore
    let identityStore: InMemoryZonaRosaProtocolStore
    let senderKeyStore: InMemoryZonaRosaProtocolStore
    ...
    func generateMockPreKey() -> LibZonaRosaClient.PreKeyRecord {
    ...
    func generateMockSignedPreKey() -> LibZonaRosaClient.SignedPreKeyRecord {
    ...
    func generateMockKyberPreKey() -> LibZonaRosaClient.KyberPreKeyRecord {
    ...
    func initializeSession(with bobMockClient: MockClient) {
        ...
        // SessionBuilder aliceSessionBuilder = new SessionBuilder(aliceStore, new ZonaRosaProtocolAddress("+14152222222", 1));
