...
class MessageProcessingIntegrationTest: SSKBaseTest {
    ...
    var aliceClient: TestZonaRosaClient!

    let bobE164Identifier = "+18083235555"
    var bobClient: TestZonaRosaClient!
    var linkedClient: TestZonaRosaClient!
    ...
    override func setUp() {
        ...
        bobClient = FakeZonaRosaClient.generate(e164Identifier: bobE164Identifier)
        aliceClient = FakeZonaRosaClient.generate(e164Identifier: aliceE164Identifier)
    ...
    func testPniMessage() {
        ...
        let localPniClient = LocalZonaRosaClient(identity: .pni)
        write { transaction in
