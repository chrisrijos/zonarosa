...
final class PreKeyTaskTests: SSKBaseTest {
    ...
    private var mockAciProtocolStore: ZonaRosaProtocolStore!
    private var mockPniProtocolStore: ZonaRosaProtocolStore!
    private var mockProtocolStoreManager: ZonaRosaProtocolStoreManager!
    private var mockPreKeyStore: ZonaRosaServiceKit.PreKeyStore!
    ...
    override func setUp() {
        ...
        mockProtocolStoreManager = ZonaRosaProtocolStoreManager(
