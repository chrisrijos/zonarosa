...
public class InteractionFinder: NSObject {
    ...
    public class func existsIncomingMessage(
        ...
        let arguments: StatementArguments = [
            ...
            ZonaRosaServiceAddress(sourceAci).phoneNumber,
        ]
        return failIfThrows {
    ...
    func latestInteraction(
        from address: ZonaRosaServiceAddress,
        transaction: DBReadTransaction,
    ) -> TSInteraction? {
        let sql = """
        SELECT *
    ...
    static func sqlClauseForUnreadInteractionCounts(
        ...
        AND (
            ...
            OR (
                ...
                AND \(columnPrefix)\(interactionColumn: .messageType) IS \(TSInfoMessageType.userJoinedZonaRosa.rawValue)
            )
        )
        """
    }
