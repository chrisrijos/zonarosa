...
public class PreKeyStoreImpl {
    ...
    static func generatePreKeyRecords(forPreKeyIds keyIds: ClosedRange<UInt32>) -> [LibZonaRosaClient.PreKeyRecord] {
        ...
        return keyIds.map {
            ...
            return try! LibZonaRosaClient.PreKeyRecord(
                id: $0,
    ...
    func storePreKeyRecords(_ preKeyRecords: [LibZonaRosaClient.PreKeyRecord], tx: DBWriteTransaction) {
