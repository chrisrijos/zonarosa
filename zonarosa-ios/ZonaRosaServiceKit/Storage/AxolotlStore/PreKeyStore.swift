...
extension PreKeyStoreForIdentity: LibZonaRosaClient.PreKeyStore {
    func loadPreKey(id: UInt32, context: any StoreContext) throws -> LibZonaRosaClient.PreKeyRecord {
        return try LibZonaRosaClient.PreKeyRecord(bytes: fetchSerializedRecord(in: .oneTime, for: id, tx: context.asTransaction))
    }
    ...
    func storePreKey(_ record: LibZonaRosaClient.PreKeyRecord, id: UInt32, context: any StoreContext) throws {
        // This is currently unused (and needs `replacedAt` support).
        owsFail("Not supported.")
    }
}

extension PreKeyStoreForIdentity: LibZonaRosaClient.SignedPreKeyStore {
    func loadSignedPreKey(id: UInt32, context: any StoreContext) throws -> LibZonaRosaClient.SignedPreKeyRecord {
        return try LibZonaRosaClient.SignedPreKeyRecord(bytes: fetchSerializedRecord(in: .signed, for: id, tx: context.asTransaction))
    }

    func storeSignedPreKey(_ record: LibZonaRosaClient.SignedPreKeyRecord, id: UInt32, context: any StoreContext) throws {
        // This is currently unused (and needs `replacedAt` support).
        owsFail("Not supported.")
    }
}

extension PreKeyStoreForIdentity: LibZonaRosaClient.KyberPreKeyStore {
    func loadKyberPreKey(id: UInt32, context: any StoreContext) throws -> LibZonaRosaClient.KyberPreKeyRecord {
        return try LibZonaRosaClient.KyberPreKeyRecord(bytes: fetchSerializedRecord(in: .kyber, for: id, tx: context.asTransaction))
    }
    ...
    func storeKyberPreKey(_ record: LibZonaRosaClient.KyberPreKeyRecord, id: UInt32, context: any StoreContext) throws {
...
protocol WritablePreKeyStore {
    func storePreKey(_ record: LibZonaRosaClient.PreKeyRecord, replacedAt: Date?, context: any StoreContext) throws
}

extension WritablePreKeyStore where Self: LibZonaRosaClient.PreKeyStore {
    func storePreKey(_ record: LibZonaRosaClient.PreKeyRecord, replacedAt: Date?, context: any StoreContext) throws {
...
protocol WritableSignedPreKeyStore {
    func storeSignedPreKey(_ record: LibZonaRosaClient.SignedPreKeyRecord, replacedAt: Date?, context: any StoreContext) throws
}

extension WritableSignedPreKeyStore where Self: LibZonaRosaClient.SignedPreKeyStore {
    func storeSignedPreKey(_ record: LibZonaRosaClient.SignedPreKeyRecord, replacedAt: Date?, context: any StoreContext) throws {
        owsPrecondition(replacedAt == nil)
...
protocol WritableKyberPreKeyStore {
    func storeKyberPreKey(_ record: LibZonaRosaClient.KyberPreKeyRecord, isOneTime: Bool, replacedAt: Date?, context: any StoreContext) throws
}

extension WritableKyberPreKeyStore where Self: LibZonaRosaClient.KyberPreKeyStore {
    func storeKyberPreKey(_ record: LibZonaRosaClient.KyberPreKeyRecord, isOneTime: Bool, replacedAt: Date?, context: any StoreContext) throws {
