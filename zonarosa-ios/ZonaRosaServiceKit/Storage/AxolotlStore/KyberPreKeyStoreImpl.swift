...
struct KyberPreKeyRecord: Codable {
    ...
    var replacedAt: Date?
    let libZonaRosaRecord: LibZonaRosaClient.KyberPreKeyRecord
    let isLastResort: Bool

    init(
        replacedAt: Date?,
        libZonaRosaRecord: LibZonaRosaClient.KyberPreKeyRecord,
        isLastResort: Bool,
    ) {
        self.replacedAt = replacedAt
        self.libZonaRosaRecord = libZonaRosaRecord
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(libZonaRosaRecord.serialize(), forKey: .keyData)
    ...
    init(from decoder: Decoder) throws {
        ...
        self.replacedAt = replacedAt
        self.libZonaRosaRecord = try LibZonaRosaClient.KyberPreKeyRecord(bytes: keyData)
        self.isLastResort = isLastResort
    }
}
...
public class KyberPreKeyStoreImpl {
    ...
    static func generatePreKeyRecord(
        ...
        return try! LibZonaRosaClient.KyberPreKeyRecord(
            id: keyId,
    ...
    func generateLastResortKyberPreKeyForChangeNumber(signedBy identityKey: PrivateKey) -> LibZonaRosaClient.KyberPreKeyRecord {
        return Self.generatePreKeyRecord(keyId: PreKeyId.random(), now: dateProvider(), signedBy: identityKey)
    }

    func storePreKeyRecords(
        _ preKeyRecords: [LibZonaRosaClient.KyberPreKeyRecord],
        isLastResort: Bool,
    ...
    func storeLastResortPreKeyFromChangeNumber(_ lastResortPreKey: LibZonaRosaClient.KyberPreKeyRecord, tx: DBWriteTransaction) {
