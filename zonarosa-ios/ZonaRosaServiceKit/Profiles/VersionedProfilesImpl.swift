...
public class VersionedProfilesImpl: VersionedProfiles {
    ...
    public func didFetchProfile(profile: ZonaRosaServiceProfile, profileRequest: VersionedProfileRequest) async {
        do {
            ...
            try await SSKEnvironment.shared.databaseStorageRef.awaitableWrite { tx throws in
                ...
                let userProfile = profileManager.userProfile(for: ZonaRosaServiceAddress(profileRequest.aci), tx: tx)
