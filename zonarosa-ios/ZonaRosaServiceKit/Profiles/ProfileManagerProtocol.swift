...
public protocol ProfileManagerProtocol {
    ...
    func userProfile(for address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> OWSUserProfile?
...
extension ProfileManagerProtocol {
    public func isUser(inProfileWhitelist address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> Bool {
