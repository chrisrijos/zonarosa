...
public class ZonaRosaServiceProfile {
    ...
    public static func fromResponse(serviceId: ServiceId, params: ParamParser) throws -> ZonaRosaServiceProfile {
        do {
