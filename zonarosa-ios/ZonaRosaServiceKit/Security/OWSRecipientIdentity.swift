...
public final class OWSRecipientIdentity: NSObject, SDSCodableModel, Decodable {
    ...
    private class func sqlQueryToFetchIdentityKeys(
        ...
        let recipient_id = "\(zonarosaRecipientColumnFullyQualified: .id)"
        let recipient_phoneNumber = "\(zonarosaRecipientColumnFullyQualified: .phoneNumber)"
        let recipient_aciString = "\(zonarosaRecipientColumnFullyQualified: .aciString)"
        let recipient_pniString = "\(zonarosaRecipientColumnFullyQualified: .pni)"
        let recipient_uniqueID = "\(zonarosaRecipientColumnFullyQualified: .uniqueId)"
        ...
        let sql =
            """
                ...
                FROM
                    \(ZonaRosaRecipient.databaseTableName),
    ...
    private class func groupMemberIdentityKeys(
        ...
        do {
            ...
            var result = [ZonaRosaServiceAddress: Data]()
