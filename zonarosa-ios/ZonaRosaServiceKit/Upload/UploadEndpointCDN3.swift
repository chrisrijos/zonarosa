...
struct UploadEndpointCDN3: UploadEndpoint {
    ...
    enum Constants {
        static let checksumHeaderKey = "x-zonarosa-checksum-sha256"
    }
    ...
    func getResumableUploadProgress<Metadata: UploadMetadata>(attempt: Upload.Attempt<Metadata>) async throws -> Upload.ResumeProgress {
        ...
        let urlSession = await zonarosaService.sharedUrlSessionForCdn(cdnNumber: uploadForm.cdnNumber, maxResponseSize: nil)
