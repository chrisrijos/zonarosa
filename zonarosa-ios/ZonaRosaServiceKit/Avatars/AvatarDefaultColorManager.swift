...
public struct AvatarDefaultColorManager {
    public enum UseCase {
        case contact(recipient: ZonaRosaRecipient)
        case contactWithoutRecipient(address: ZonaRosaServiceAddress)
    ...
    func persistDefaultColor(
        ...
        recipientRowId: ZonaRosaRecipient.RowId,
...
private struct AvatarDefaultColorRecord: Codable, PersistableRecord, FetchableRecord {
    ...
    /// A ``ZonaRosaRecipient/id``, whose contact's default avatar color this
    /// record describes.
