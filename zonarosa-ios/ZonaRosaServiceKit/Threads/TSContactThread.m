...
- (ZonaRosaServiceAddress *)contactAddress
{
    return [[ZonaRosaServiceAddress alloc] initWithServiceIdString:self.contactUUID phoneNumber:self.contactPhoneNumber];
}

- (NSArray<ZonaRosaServiceAddress *> *)recipientAddressesWithTransaction:(DBReadTransaction *)transaction
{
...
+ (nullable ZonaRosaServiceAddress *)contactAddressFromThreadId:(NSString *)threadId
