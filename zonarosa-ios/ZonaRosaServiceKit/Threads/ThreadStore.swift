...
public protocol ThreadStore {
    ...
    func getOrCreateContactThread(with address: ZonaRosaServiceAddress, tx: DBWriteTransaction) -> TSContactThread
...
extension ThreadStore {
    ...
    public func fetchContactThread(recipient: ZonaRosaRecipient, tx: DBReadTransaction) -> TSContactThread? {
...
public class ThreadStoreImpl: ThreadStore {
    ...
    public func getOrCreateContactThread(with address: ZonaRosaServiceAddress, tx: DBWriteTransaction) -> TSContactThread {
