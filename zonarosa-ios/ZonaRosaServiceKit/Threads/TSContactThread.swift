...
extension TSContactThread {
    ...
    @objc
    public convenience init(contactAddress: ZonaRosaServiceAddress) {
    ...
    public static func getOrCreateThread(
        withContactAddress contactAddress: ZonaRosaServiceAddress,
    ...
    public static func getOrCreateThread(contactAddress: ZonaRosaServiceAddress) -> TSContactThread {
        owsAssertDebug(contactAddress.isValid)
    ...
    public static func getWithContactAddress(
        _ contactAddress: ZonaRosaServiceAddress,
