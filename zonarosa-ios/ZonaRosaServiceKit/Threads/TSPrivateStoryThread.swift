...
extension TSPrivateStoryThread {
    ...
    override public func recipientAddresses(with tx: DBReadTransaction) -> [ZonaRosaServiceAddress] {
    ...
    public func updateWithStoryViewMode(
        ...
        storyRecipientIds storyRecipientIdsChange: OptionalChange<[ZonaRosaRecipient.RowId]>,
        updateStorageService: Bool,
