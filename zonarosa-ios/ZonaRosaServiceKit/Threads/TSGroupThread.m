...
#ifdef DEBUG
    for (ZonaRosaServiceAddress *address in groupModel.groupMembers) {
...
{
    NSMutableArray<ZonaRosaServiceAddress *> *groupMembers = [self.groupModel.groupMembers mutableCopy];
    if (groupMembers == nil) {
        return @[];
    }
