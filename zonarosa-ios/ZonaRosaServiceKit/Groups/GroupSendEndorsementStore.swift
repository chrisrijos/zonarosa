...
protocol GroupSendEndorsementStore {
    ...
    func fetchIndividualEndorsement(groupThreadId: Int64, recipientId: ZonaRosaRecipient.RowId, tx: DBReadTransaction) throws -> IndividualGroupSendEndorsementRecord?
