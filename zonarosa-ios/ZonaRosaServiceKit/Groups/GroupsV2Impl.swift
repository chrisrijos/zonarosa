...
public class GroupsV2Impl: GroupsV2 {
    private var urlSession: OWSURLSessionProtocol {
        return SSKEnvironment.shared.zonarosaServiceRef.urlSessionForStorageService()
    }
...
private extension HttpHeaders {
    private static let forbiddenKey: String = "X-ZonaRosa-Forbidden-Reason"
