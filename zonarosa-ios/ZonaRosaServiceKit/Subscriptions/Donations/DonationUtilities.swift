...
public class DonationUtilities {
    ...
    private static func donationToZonaRosa() -> String {
        OWSLocalizedString(
            "DONATION_VIEW_DONATION_TO_ZONAROSA",
            comment: "Text describing to the user that they're going to pay a donation to ZonaRosa",
        )
    }

    private static func monthlyDonationToZonaRosa() -> String {
        OWSLocalizedString(
            "DONATION_VIEW_MONTHLY_DONATION_TO_ZONAROSA",
            comment: "Text describing to the user that they're going to pay a monthly donation to ZonaRosa",
        )
    }
    ...
    public static func newPaymentRequest(for amount: FiatMoney, isRecurring: Bool) -> PKPaymentRequest {
        ...
        if isRecurring {
            ...
            paymentSummaryItem = PKPaymentSummaryItem(label: donationToZonaRosa(), amount: nsValue)
        }
...
/// with ZonaRosa-server values fetched from a configuration endpoint like
