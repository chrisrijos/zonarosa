...
public protocol TypingIndicators: AnyObject {
    ...
    func typingAddress(forThread thread: TSThread) -> ZonaRosaServiceAddress?
...
public class TypingIndicatorsImpl: NSObject, TypingIndicators {
    ...
    public func typingAddress(forThread thread: TSThread) -> ZonaRosaServiceAddress? {
        AssertIsOnMainThread()
        ...
        var firstAddress: ZonaRosaServiceAddress?
        ...
        for incomingIndicators in deviceMap.values {
            ...
            firstAddress = ZonaRosaServiceAddress(incomingIndicators.senderAci)
            firstTimestamp = startedTypingTimestamp
        }
        return firstAddress
    }
