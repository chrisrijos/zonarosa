...
public extension StandardSound {
    ...
    var displayName: String {
        ...
        case .zonarosaClassic: return "ZonaRosa Classic"
        // Calls
...
public class Sounds {
    ...
    // This name is specified in the payload by the ZonaRosa Service when requesting fallback push notifications.
