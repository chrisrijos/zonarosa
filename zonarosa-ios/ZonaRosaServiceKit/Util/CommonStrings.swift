...
public enum CommonStrings {
    ...
    public static var contactSupport: String {
        OWSLocalizedString(
            "CONTACT_SUPPORT",
            comment: "Button text to initiate an email to zonarosa support staff",
        )
    }
...
public enum CallStrings {
    ...
    public static var zonarosaCall: String {
        return OWSLocalizedString(
            "ZONAROSA_CALL",
    ...
    public static var callLinkDescription: String {
        return OWSLocalizedString(
            ...
            comment: "Shown in a message bubble when you send a call link in a ZonaRosa chat",
        )
    }
}
