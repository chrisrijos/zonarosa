...
public class DateUtil {
    ...
    public static func daysFrom(firstDate: Date, toSecondDate secondDate: Date) -> Int {
        ...
        guard
            let days = calendar.dateComponents(
                ...
                to: calendar.startOfDay(for: secondDate),
            ).day
        else {
    ...
    public static func formatMessageTimestampForCVC(
        _ timestamp: UInt64,
        ...
        if minutesDiff < 1 {
            ...
            let shortFormat = OWSLocalizedString(
                "DATE_MINUTES_AGO_%d",
            ...
            let longFormat = OWSLocalizedString(
                "DATE_MINUTES_AGO_LONG_%d",
                tableName: "PluralAware",
    ...
    public static func isSameDay(timestamp timestamp1: UInt64, timestamp timestamp2: UInt64) -> Bool {
        isSameDay(
            date: Date(millisecondsSince1970: timestamp1),
