...
public class ShareViewController: OWSNavigationController, ShareViewDelegate, SAEFailedViewDelegate {
    ...
    private func buildAndValidateAttachments(
        ...
        guard typedItems.count <= ZonaRosaAttachment.maxAttachmentsAllowed else {
    ...
    private func presentAttachmentError(_ error: any Error) {
        ...
        case ShareViewControllerError.tooManyAttachments:
            ...
            let alertTitle = String(format: format, OWSFormat.formatInt(ZonaRosaAttachment.maxAttachmentsAllowed))
        ...
        default:
            ...
            let alertTitle = OWSLocalizedString(
                ...
                comment: "Shown when trying to share content to a ZonaRosa user for the share extension. Followed by failure details.",
            )
            OWSActionSheets.showActionSheet(
                title: alertTitle,
    ...
    private nonisolated func buildAttachments(
        ...
        // FIXME: does not use a task group because ZonaRosaAttachment likes to load things into RAM and resize them; doing this in parallel can exhaust available RAM
