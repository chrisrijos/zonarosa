...
public final class AttachmentApprovalViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, OWSNavigationChildController {
    ...
    /// Returns a new ZonaRosaAttachment that reflects changes made in the editor.
        ...
        Task { @MainActor in
            do {
                ...
                OWSActionSheets.showErrorAlert(message: OWSLocalizedString(
                    ...
                    comment: "alert text when ZonaRosa was unable to save a copy of the attachment to the system photo library",
                ))
            }
        }
    }
            ...
            do {
                ...
                modalVC.dismiss {
                    let actionSheet = ActionSheetController(
                        ...
                        message: (
                            (error as? ZonaRosaAttachmentError)?.localizedDescription
