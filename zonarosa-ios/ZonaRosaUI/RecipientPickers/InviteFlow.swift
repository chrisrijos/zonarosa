...
public class InviteFlow: NSObject {
    ...
    private let installUrl = "https://zonarosa.io/install/"
    private let homepageUrl = "https://zonarosa.io"
    ...
    public static var unsupportedFeatureMessage: String {
        OWSLocalizedString(
            ...
            comment: "When inviting contacts to use ZonaRosa, this error is shown if the device doesn't support SMS or if there aren't any registered email accounts.",
        )
    }
    ...
    public func sendSMSTo(phoneNumbers: [String]) {
        ...
        let inviteText = OWSLocalizedString("SMS_INVITE_BODY", comment: "body sent to contacts when inviting to Install ZonaRosa")
    ...
    private func sendMailTo(emails recipientEmails: [String]) {
        ...
        let subject = OWSLocalizedString("EMAIL_INVITE_SUBJECT", comment: "subject of email sent to contacts when inviting to install ZonaRosa")
        let bodyFormat = OWSLocalizedString("EMAIL_INVITE_BODY", comment: "body of email sent to contacts when inviting to install ZonaRosa. Embeds {{link to install ZonaRosa}} and {{link to the ZonaRosa home page}}")
