...
public class ContactCellConfiguration: NSObject {
    ...
    public init(address: ZonaRosaServiceAddress, localUserDisplayMode: LocalUserDisplayMode) {
    ...
    public func useVerifiedSubtitle() {
        ...
        text.append(ZonaRosaSymbol.safetyNumber.attributedString(for: .caption1, clamped: true))
