...
public extension ProfileDetailLabel {
            ...
            attributedTitle: {
                if let secondaryName {
                    return NSAttributedString.composed(of: [
                        ...
                        " ",
                        "(\(secondaryName))"
                            .styled(with: .color(UIColor.ZonaRosa.secondaryLabel)),
                    ])
                } else {
    ...
    static func zonarosaConnectionLink(
        font: UIFont = .dynamicTypeBody,
        ...
        .init(
            title: OWSLocalizedString(
                "CONTACT_ABOUT_SHEET_ZONAROSA_CONNECTION_LABEL",
                comment: "A label indicating a user is a zonarosa connection.",
            ),
            icon: .contactInfoZonaRosaConnection,
            font: font,
            showDetailDisclosure: true,
