...
public class QuotedReplyModel {
    ...
    public let originalMessageAuthorAddress: ZonaRosaServiceAddress
    ...
    public static func build(
        ...
        guard
            ...
            return QuotedReplyModel(
                ...
                originalMessageAuthorAddress: ZonaRosaServiceAddress(storyAuthorAci),
                originalMessageMemberLabel: nil,
    ...
    private init(
        ...
        originalMessageAuthorAddress: ZonaRosaServiceAddress,
