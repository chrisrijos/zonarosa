...
public class AllZonaRosaConnectionsViewController: OWSTableViewController2 {
    let collation = UILocalizedIndexedCollation.current()

    override public func viewDidLoad() {
        super.viewDidLoad()

        title = OWSLocalizedString("ALL_ZONAROSA_CONNECTIONS_TITLE", comment: "Title for the view of all your zonarosa connections")
