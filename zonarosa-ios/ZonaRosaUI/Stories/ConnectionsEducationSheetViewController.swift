...
public class ConnectionsEducationSheetViewController: StackSheetViewController {
    ...
    override public var sheetBackgroundColor: UIColor {
        UIColor.ZonaRosa.secondaryBackground
    }

    override public var handleBackgroundColor: UIColor {
        UIColor.ZonaRosa.transparentSeparator
    }
    ...
    let header: UILabel = {
        ...
        label.attributedText = OWSLocalizedString(
            ...
            comment: "Header for the explainer sheet for zonarosa connections",
        ).styled(
    ...
    let bulletPoints: [UIView] = {
        return [
            OWSLocalizedString(
                ...
                comment: "First bullet point for the explainer sheet for zonarosa connections",
            ),
            OWSLocalizedString(
                "STORY_SETTINGS_LEARN_MORE_SHEET_BULLET_2",
                comment: "Second bullet point for the explainer sheet for zonarosa connections",
            ),
            OWSLocalizedString(
                "STORY_SETTINGS_LEARN_MORE_SHEET_BULLET_3",
                comment: "Third bullet point for the explainer sheet for zonarosa connections",
            ),
        ].map { text in
    ...
    let footer: UILabel = {
        ...
        label.text = OWSLocalizedString(
            ...
            comment: "Footer for the explainer sheet for zonarosa connections",
        )
        label.textColor = .label
    ...
    private class ListPointView: UIStackView {
        init(text: String) {
            ...
            bulletPoint.backgroundColor = UIColor.ZonaRosa.tertiaryLabel
