...
public struct PreviewableAttachment {
    public let rawValue: ZonaRosaAttachment
    ...
    public static func imageAttachment(dataSource: DataSourcePath, dataUTI: String, canBeBorderless: Bool = false) throws -> Self {
        ...
        guard ZonaRosaAttachment.inputImageUTISet.contains(dataUTI) else {
            throw ZonaRosaAttachmentError.invalidFileFormat
        }
        ...
        guard let fileSize = try? dataSource.readLength(), fileSize > 0 else {
            ...
            throw ZonaRosaAttachmentError.invalidData
        }
        ...
        if isAnimated {
            ...
            let rawValue = ZonaRosaAttachment(dataSource: dataSource, dataUTI: dataUTI)
                ...
                dataUTI == UTType.jpeg.identifier as String
            {
                ...
                // .HEIC extension. Since HEIC isn't a valid output format for ZonaRosa,
    ...
    public static func imageAttachmentForNormalizedImage(_ normalizedImage: NormalizedImage, isBorderless: Bool = false) -> Self {
        let rawValue = ZonaRosaAttachment(dataSource: normalizedImage.dataSource, dataUTI: normalizedImage.dataUTI)
        rawValue.isBorderless = isBorderless
        return Self(
            rawValue: rawValue,
    ...
    public static func videoAttachment(
        ...
        return try newAttachment(
            ...
            dataUTI: dataUTI,
            validUTISet: ZonaRosaAttachment.videoUTISet,
    ...
    public static func compressVideoAsMp4(
        ...
        guard let exportSession = AVAssetExportSession(asset: asset, presetName: AVAssetExportPreset640x480) else {
            throw ZonaRosaAttachmentError.couldNotConvertToMpeg4
        }
    ...
    public static func audioAttachment(
        ...
        dataUTI: String,
        attachmentLimits: OutgoingAttachmentLimits,
    ) throws(ZonaRosaAttachmentError) -> Self {
        return try newAttachment(
            dataSource: dataSource,
            dataUTI: dataUTI,
            validUTISet: ZonaRosaAttachment.audioUTISet,
    ...
    public static func genericAttachment(
        ...
        owsPrecondition(!ZonaRosaAttachment.videoUTISet.contains(dataUTI))
        owsPrecondition(!ZonaRosaAttachment.inputImageUTISet.contains(dataUTI))
        return try newAttachment(
            dataSource: dataSource,
            dataUTI: dataUTI,
            validUTISet: nil,
    ...
    public static func buildAttachment(
        ...
        if ZonaRosaAttachment.inputImageUTISet.contains(dataUTI) {
            guard types.contains(.image) else {
                throw ZonaRosaAttachmentError.invalidFileFormat
            }
            return try imageAttachment(dataSource: dataSource, dataUTI: dataUTI)
        }
        if ZonaRosaAttachment.videoUTISet.contains(dataUTI) {
        ...
        if ZonaRosaAttachment.audioUTISet.contains(dataUTI) {
    ...
    private static func newAttachment(
        ...
        let attachment = ZonaRosaAttachment(dataSource: dataSource, dataUTI: dataUTI)
