...
public struct SendableAttachment {
    ...
    var defaultFilename: String {
        let kDefaultAttachmentName = "zonarosa"
    ...
    public func segmentedIfNecessary(
        ...
        guard ZonaRosaAttachment.videoUTISet.contains(self.dataUTI) else {
        ...
        let segments = try segmentFileUrls.map { url in
            ...
            // [15M] TODO: This doesn't transfer all ZonaRosaAttachment fields.
    ...
    fileprivate static func trimAsset(
        ...
        /// This is hardcoded here and in our media editor. That's in zonarosaUI, so hard to link the two.
