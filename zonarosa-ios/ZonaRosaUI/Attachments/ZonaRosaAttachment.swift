...
public enum ZonaRosaAttachmentError: Error {
    case missingData
...
extension ZonaRosaAttachmentError: LocalizedError, UserErrorDescriptionProvider {
...
//
// ZonaRosa attachments are subject to validation and, in some cases, file
// format conversion.
//
...
public class ZonaRosaAttachment: CustomDebugStringConvertible {
    ...
    public var debugDescription: String {
        return "[ZonaRosaAttachment mimeType: \(mimeType)]"
    }
    ...
    public var isImage: Bool {
        return ZonaRosaAttachment.outputImageUTISet.contains(dataUTI)
    }
    ...
    public var isVideo: Bool {
        return ZonaRosaAttachment.videoUTISet.contains(dataUTI)
    }
    ...
    public var isAudio: Bool {
        return ZonaRosaAttachment.audioUTISet.contains(dataUTI)
    }
