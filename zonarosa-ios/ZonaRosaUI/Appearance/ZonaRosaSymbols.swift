...
public enum ZonaRosaSymbol: Character {
    ...
    public static var leave: ZonaRosaSymbol {
    ...
    public static var chevronTrailing: ZonaRosaSymbol {
        localizedSymbol(ltr: .chevronRight, rtl: .chevronLeft)
    }

    private static func localizedSymbol(ltr: ZonaRosaSymbol, rtl: ZonaRosaSymbol) -> ZonaRosaSymbol {
    ...
    public static func chevronTrailing(for string: String) -> ZonaRosaSymbol {
    ...
    public enum Weight {
        ...
        fileprivate var fontName: String {
            switch self {
            case .light:
                return "ZonaRosaSymbols-Light"
            case .regular:
                return "ZonaRosaSymbols-Regular"
            case .bold:
                return "ZonaRosaSymbols-Bold"
            case .medium:
                return "ZonaRosaSymbols-Medium"
            case .thin:
                return "ZonaRosaSymbols-Thin"
            }
        }
    ...
    ///
    /// ```swift
    /// ZonaRosaSymbol.arrowUp.text(dynamicTypeBaseSize: 16) +
    /// Text(" Share")
    /// ```
    /// - Parameters:
