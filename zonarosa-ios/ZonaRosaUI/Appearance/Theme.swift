...
public final class Theme {
    ...
    public class func setupZonaRosaAppearance() {
        ...
        UINavigationBar.appearance().barTintColor = UIColor.ZonaRosa.background
        UINavigationBar.appearance().tintColor = primaryIconColor
        UIToolbar.appearance().barTintColor = UIColor.ZonaRosa.background
        ...
        let cursorColor = UIColor(
            light: .ZonaRosa.accent,
            lightHighContrast: .ZonaRosa.accent,
            dark: .white,
    ...
    public class var secondaryBackgroundColor: UIColor {
        UIColor.ZonaRosa.secondaryBackground.resolvedColor(
    ...
    public class var accentBlueColor: UIColor {
        UIColor.ZonaRosa.accent.resolvedColor(with: currentThemeTraitCollection)
    }
    ...
    public class var tableCell2BackgroundColor: UIColor {
        isDarkThemeEnabled
            ...
            : UIColor.ZonaRosa.secondaryGroupedBackground.resolvedColor(with: lightTraitCollection)
    }

    public class var tableCell2PresentedBackgroundColor: UIColor {
        isDarkThemeEnabled
            ? darkThemeTableCell2PresentedBackgroundColor
            : UIColor.ZonaRosa.secondaryGroupedBackground.resolvedColor(with: elevatedLightTraitCollection)
    }
    ...
    public class var tableView2BackgroundColor: UIColor {
        isDarkThemeEnabled
            ...
            : UIColor.ZonaRosa.groupedBackground.resolvedColor(with: lightTraitCollection)
    }

    public class var tableView2PresentedBackgroundColor: UIColor {
        isDarkThemeEnabled
            ? darkThemeTableView2PresentedBackgroundColor
            : UIColor.ZonaRosa.groupedBackground.resolvedColor(with: elevatedLightTraitCollection)
    }
    ...
    public class var lightThemeBackgroundColor: UIColor {
        UIColor.ZonaRosa.background.resolvedColor(with: lightTraitCollection)
    }

    public class var lightThemePrimaryColor: UIColor {
        UIColor.ZonaRosa.label.resolvedColor(with: lightTraitCollection)
    }
    ...
    public class var lightThemeSecondaryTextAndIconColor: UIColor {
        UIColor.ZonaRosa.secondaryLabel.resolvedColor(with: lightTraitCollection)
    }

    // MARK: - Dark Theme Colors

    public class var darkThemeBackgroundColor: UIColor {
        UIColor.ZonaRosa.background.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemePrimaryColor: UIColor {
        UIColor.ZonaRosa.label.resolvedColor(with: darkTraitCollection)
    }
    ...
    public class var darkThemeSecondaryTextAndIconColor: UIColor {
        UIColor.ZonaRosa.secondaryLabel.resolvedColor(with: darkTraitCollection)
    }
    ...
    public class var darkThemeTableCell2BackgroundColor: UIColor {
        UIColor.ZonaRosa.secondaryGroupedBackground.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemeTableCell2PresentedBackgroundColor: UIColor {
        UIColor.ZonaRosa.secondaryGroupedBackground.resolvedColor(with: elevatedDarkTraitCollection)
    }

    public class var darkThemeTableView2BackgroundColor: UIColor {
        UIColor.ZonaRosa.groupedBackground.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemeTableView2PresentedBackgroundColor: UIColor {
        UIColor.ZonaRosa.groupedBackground.resolvedColor(with: elevatedDarkTraitCollection)
    }
