...
class FingerprintScanViewController: OWSViewController, OWSNavigationChildController {
    ...
    init(
        ...
        self.contactName = SSKEnvironment.shared.databaseStorageRef.read { tx in
            return SSKEnvironment.shared.contactManagerRef.displayName(for: ZonaRosaServiceAddress(recipientAci), tx: tx).resolvedValue()
        }
    ...
    override func viewDidLoad() {
        ...
        footerView.backgroundColor = .ZonaRosa.secondaryBackground
        ...
        cameraInstructionLabel.textColor = .ZonaRosa.secondaryLabel
