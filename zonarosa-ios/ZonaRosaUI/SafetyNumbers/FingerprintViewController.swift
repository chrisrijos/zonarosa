...
public class FingerprintViewController: OWSViewController, OWSNavigationChildController {
    ...
    public class func present(
        ...
        (
            ...
            let theirAddress = ZonaRosaServiceAddress(theirAci)
    ...
    private lazy var instructionsTextView: UITextView = {
        ...
        let learnMore = CommonStrings.learnMore.styled(with: .link(URL(string: "https://zonarosa.io")!))
        ...
        textView.attributedText = NSAttributedString.composed(of: [
            ...
            .color(.ZonaRosa.secondaryLabel),
            .alignment(.center),
        )
        textView.linkTextAttributes = [.foregroundColor: UIColor.ZonaRosa.label]
    ...
    private final class FingerprintCard: UIView {
        ...
        private lazy var qrCodeView: UIView = {
            ...
            scanLabel.textColor = .ZonaRosa.label.resolvedColor(with: UITraitCollection(userInterfaceStyle: .light))
        ...
        private lazy var verifyUnverifyButton: UIButton = {
            ...
            configuration.baseBackgroundColor = .ZonaRosa.background.resolvedColor(with: lightTheme)
            configuration.baseForegroundColor = .ZonaRosa.label.resolvedColor(with: lightTheme)
    ...
    fileprivate final class KeyTransparencyView: UIView {
        ...
        private func updateForCurrentState() {
            ...
            case .readyToVerify:
                ...
                foregroundColor = .ZonaRosa.label
                showChevron = false
            case .verifying:
            ...
            case .verifiedFailure, .unableToVerify:
                ...
                foregroundColor = .ZonaRosa.secondaryLabel
                showChevron = true
            }
        ...
        private lazy var verifyButtonLeadingViewKey: UIImageView = {
            ...
            imageView.tintColor = .ZonaRosa.label
            return imageView
        }()
        ...
        private lazy var verifyButton: UIButton = {
            ...
            configuration.baseBackgroundColor = .ZonaRosa.tertiaryBackground
            configuration.cornerStyle = .capsule
        ...
        private lazy var footerTextView: LinkingTextView = {
            ...
            let learnMoreLink = CommonStrings.learnMore.styled(with: .link(URL(string: "https://zonarosa.io")!))
    ...
    fileprivate func didTapVerifyUnverify() {
        ...
        deps.db.write { tx in
            ...
            _ = deps.identityManager.setVerificationState(
                ...
                for: ZonaRosaServiceAddress(recipientAci),
...
private final class KeyTransparencyNotAvailableHeroSheet: HeroSheetViewController {
    init() {
        super.init(
            hero: .image(UIImage(named: "info")!, tintColor: .ZonaRosa.label),
...
private final class KeyTransparencySuccessHeroSheet: HeroSheetViewController {
    init() {
        super.init(
            hero: .image(UIImage(named: "check-circle")!, tintColor: .ZonaRosa.label),
            title: OWSLocalizedString(
