...
extension MobileCoinAPI {
    ...
    public enum Environment: CustomStringConvertible {
        ...
        case zonarosaTestNet
        case mobileCoinTestNet
        case zonarosaMainNet
        case mobileCoinMainNet

        public static var current: Environment {
            if TSConstants.isUsingProductionService {
                return .zonarosaMainNet
            } else {
                return .zonarosaTestNet
            }
        }
    ...
    struct MobileCoinNetworkConfig {
        ...
        static var zonarosaMainNet: MobileCoinNetworkConfig {
            let consensusUrls = [
        ...
        static var zonarosaTestNet: MobileCoinNetworkConfig {
            let consensusUrls = [
        ...
        static func networkConfig(environment: Environment) -> MobileCoinNetworkConfig {
            ...
            case .zonarosaTestNet:
                return MobileCoinNetworkConfig.zonarosaTestNet
            case .mobileCoinMainNet:
                return MobileCoinNetworkConfig.mobileCoinMainNet
            case .zonarosaMainNet:
                return MobileCoinNetworkConfig.zonarosaMainNet
            }
        }
    }
    ...
    private struct OWSAttestationConfig {
        ...
        static var zonarosaMainNet: OWSAttestationConfig {
        ...
        static var zonarosaTestNet: OWSAttestationConfig {
            // We need the old and new enclave values here.
            let mrEnclaveConsensus: [AttestationRawInfo] = [
                // ~May 6, 2024
    ...
    struct MobileCoinAccount {
        ...
        fileprivate func authorization(zonarosaAuthorization: OWSAuthorization) -> OWSAuthorization {
            switch environment {
            case .zonarosaTestNet, .zonarosaMainNet:
                return zonarosaAuthorization
            case .mobileCoinAlphaNet:
        ...
        func buildClient(zonarosaAuthorization: OWSAuthorization) throws -> MobileCoinClient {
            Logger.info("Environment: \(environment)")
            let networkConfig = MobileCoinNetworkConfig.networkConfig(environment: environment)
            let authorization = self.authorization(zonarosaAuthorization: zonarosaAuthorization)
    ...
    private static func fogAuthoritySpki(environment: Environment) -> Data {
        ...
        case .zonarosaTestNet, .mobileCoinTestNet:
            return Data(
                base64Encoded:
                """
        ...
        case .mobileCoinMainNet, .zonarosaMainNet:
...
extension LibMobileCoin.HTTPMethod {
    var sskHTTPMethod: ZonaRosaServiceKit.HTTPMethod {
        switch self {
        case .GET:
            return .get
        case .POST:
