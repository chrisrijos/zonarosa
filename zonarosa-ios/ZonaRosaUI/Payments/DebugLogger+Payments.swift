...
public extension DebugLogger {
    ...
    private struct CLForwardingLogHandler: LogHandler {
        ...
        public func log(
            ...
            switch level {
            case .trace:
                ZonaRosaServiceKit.Logger.verbose(message, file: file, function: function, line: line)
            case .debug:
                ZonaRosaServiceKit.Logger.debug(message, file: file, function: function, line: line)
            case .info,
                 .notice:
                ZonaRosaServiceKit.Logger.info(message, file: file, function: function, line: line)
            case .warning:
                ZonaRosaServiceKit.Logger.warn(message, file: file, function: function, line: line)
            case .error,
                 .critical:
                ZonaRosaServiceKit.Logger.error(message, file: file, function: function, line: line)
            }
        }
