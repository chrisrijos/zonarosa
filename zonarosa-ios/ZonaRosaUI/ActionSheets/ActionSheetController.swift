...
open class ActionSheetController: OWSViewController {
    ...
    private func createBackgroundView() -> UIView {
        if #available(iOS 26, *) {
            ...
            glassEffect.tintColor = UIColor.ZonaRosa.background.withAlphaComponent(2 / 3)
        ...
        if let message {
            let messageView: UIView = {
                ...
                case let .text(text):
                    ...
                    result.textColor = UIColor.ZonaRosa.label
...
public class ActionSheetAction: NSObject {
    ...
    public enum Style: Int {
        ...
        fileprivate var textColor: UIColor {
            switch self {
            case .default, .cancel:
                UIColor.ZonaRosa.label
            case .destructive:
                UIColor.ZonaRosa.red
            }
        }
    }
    ...
    public class Button: UIButton {
        ...
        init(action: ActionSheetAction) {
            ...
            config.baseBackgroundColor = UIColor.ZonaRosa.secondaryFill
...
private class ActionSheetPresentationController: UIPresentationController {
    ...
    override init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?) {
        ...
        backdropView.backgroundColor = .ZonaRosa.backdrop
    }
...
private func buildPreview(
    ...
    navController.view.backgroundColor = .ZonaRosa.groupedBackground
