...
open class HeroSheetViewController: StackSheetViewController {
    ...
    public struct Body {
        ...
        public init(
            ...
            textColor: UIColor = .ZonaRosa.secondaryLabel,
    ...
    public struct Button {
        ...
        fileprivate var configuration: UIButton.Configuration {
            ...
            case .secondaryDestructive:
                ...
                config.baseForegroundColor = .ZonaRosa.red
                return config
            }
        }
    }
    ...
    private func viewForBulletPoint(
        ...
        iconImageView.tintColor = .ZonaRosa.secondaryLabel
    ...
    private func viewForToggle(_ toggle: Body.Toggle) -> UIView {
        ...
        containerView.backgroundColor = .ZonaRosa.tertiaryBackground
...
#Preview("Image") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        ...
        body: LocalizationNotNeeded("Finish linking ZonaRosa on your other device."),
...
#Preview("Body w/ bullets") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        ...
        body: HeroSheetViewController.Body(
            text: "As an independent nonprofit, ZonaRosa is committed to private messaging and calls. No ads, no trackers, no surveillance. Donate today to support ZonaRosa.",
            textAlignment: .left,
            ...
            bulletPoints: [
                ...
                HeroSheetViewController.Body.BulletPoint(
                    ...
                    text: "ZonaRosa is a 501c3 nonprofit. US donations are tax deductible.",
                ),
            ],
        ),
        primary: nil,
...
#Preview("Circle icon") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        ...
        body: LocalizationNotNeeded("Backups can’t be recovered without their 64-digit recovery code. If you’ve lost your recovery key ZonaRosa can’t help restore your backup.\n\nIf you have your old device you can view your recovery key in Settings > Chats > ZonaRosa Backups. Then tap View recovery key."),
