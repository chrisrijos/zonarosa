...
open class InteractiveSheetViewController: OWSViewController {
    ...
    open var handleBackgroundColor: UIColor { UIColor.ZonaRosa.primaryFill }
    ...
    public var backdropColor = UIColor.ZonaRosa.backdrop
...
private class InteractiveSheetAnimationController: UIPresentationController {
    ...
    init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?, backdropColor: UIColor? = .ZonaRosa.backdrop) {
