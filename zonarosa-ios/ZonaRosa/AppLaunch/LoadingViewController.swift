...
class LoadingViewController: UIViewController {
    ...
    override func loadView() {
        ...
        self.logoView = UIImageView(image: #imageLiteral(resourceName: "zonarosa-logo-128-launch-screen"))
        ...
        percentCompleteLabel.textColor = .ZonaRosa.secondaryLabel
        ...
        unitCountLabel.textColor = .ZonaRosa.secondaryLabel
        ...
        cancelButton.setTitleColor(.ZonaRosa.ultramarine, for: .normal)
