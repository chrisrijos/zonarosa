...
public class ZonaRosaApp {
    public static let shared = ZonaRosaApp()
    ...
    func showTransferCompleteAndExit() {
        ...
        actionSheet.addAction(.init(
            title: OWSLocalizedString(
                ...
                comment: "Button for action sheet shown when device transfer completes; quits the ZonaRosa app immediately (does not automatically relaunch, but the user may choose to relaunch).",
            ),
            style: .destructive,
            handler: { _ in
                exit(0)
    ...
    public func showExportDatabaseUI(from parentVC: UIViewController, completion: @escaping () -> Void = {}) {
        ...
        let alert = UIAlertController(
            ...
            message: "This contains all your contacts, groups, and messages. "
                ...
                + "NO ONE AT ZONAROSA CAN MAKE YOU DO THIS! Don't do it if you're not comfortable.",
