...
class MemberLabelViewController: OWSViewController, UITextFieldDelegate {
    ...
    private let groupMemberLabelsWithoutLocalUser: [ZonaRosaServiceAddress: MemberLabelForRendering]
    ...
    init(
        ...
        groupMemberLabelsWithoutLocalUser: [ZonaRosaServiceAddress: MemberLabelForRendering],
        groupName: String,
    ) {
        ...
        view.backgroundColor = UIColor.ZonaRosa.groupedBackground
        ...
        navigationItem.rightBarButtonItem?.tintColor = UIColor.ZonaRosa.ultramarine
    ...
    func addNavigationTitleView(groupName: String) {
        ...
        titleLabel.textColor = UIColor.ZonaRosa.label
        titleLabel.textAlignment = .center

        let subtitleLabel = UILabel()
        subtitleLabel.text = groupName
        subtitleLabel.font = .dynamicTypeCaption1.semibold()
        subtitleLabel.textColor = UIColor.ZonaRosa.secondaryLabel
    ...
    private func createInitialViews() {
        ...
        textFieldStack.backgroundColor = UIColor.ZonaRosa.tertiaryBackground
        ...
        if let initialEmoji {
            ...
            addEmojiButton.tintColor = UIColor.ZonaRosa.secondaryLabel
        }
        ...
        if let count = initialMemberLabel?.count {
            ...
            characterCountLabel.textColor = UIColor.ZonaRosa.tertiaryLabel.withAlphaComponent(0.3)
        ...
        clearButton.tintColor = UIColor.ZonaRosa.tertiaryLabel
    ...
    func messageBubblePreviewContainer(renderItem: CVRenderItem) -> UIStackView? {
        ...
        cellContainer.backgroundColor = UIColor.ZonaRosa.tertiaryBackground
    ...
    private func reloadMessagePreview() {
        ...
        characterCountLabel.textColor = charsRemaining > 5 ? UIColor.ZonaRosa.tertiaryLabel.withAlphaComponent(0.3) : UIColor.ZonaRosa.red
    ...
    private func buildGroupMembershipSection() {
        ...
        contactListStackView.backgroundColor = UIColor.ZonaRosa.tertiaryBackground
        ...
        for (memberAddress, memberLabel) in groupMemberLabelsWithoutLocalUser {
            ...
            SSKEnvironment.shared.databaseStorageRef.read { tx in
                ...
                let isSystemContact = SSKEnvironment.shared.contactManagerRef.fetchZonaRosaAccount(
                    for: memberAddress,
                    transaction: tx,
                ) != nil
                ...
                if cellCount > 0 {
                    ...
                    separator.backgroundColor = UIColor.ZonaRosa.tertiaryLabel
...
extension MemberLabelViewController: CVComponentDelegate {
    var spoilerState: ZonaRosaUI.SpoilerRenderState {
    ...
    func didTapPreviouslyVerifiedIdentityChange(_ address: ZonaRosaServiceAddress) {}

    func didTapUnverifiedIdentityChange(_ address: ZonaRosaServiceAddress) {}
    ...
    func didTapShowFingerprint(_ address: ZonaRosaServiceAddress) {}
