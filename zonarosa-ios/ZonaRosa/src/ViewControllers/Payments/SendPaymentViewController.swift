...
public class SendPaymentViewController: OWSViewController {
    ...
    private static func present(
        ...
        recipientAddress: ZonaRosaServiceAddress,
                    ...
                    actionSheet.addAction(ActionSheetAction(
                        ...
                        handler: { [weak fromViewController] _ in
                            ...
                            rootViewController?.dismiss(animated: true) {
                                ZonaRosaApp.shared.presentConversationForAddress(recipientAddress, action: .compose, animated: true)
                            }
                        },
                    ))
                }
    ...
    private static func showRecipientNotEnabledAlert(recipientAddress: ZonaRosaServiceAddress) {
    ...
    private static func sendActivationRequest(recipientAddress: ZonaRosaServiceAddress) {
    ...
    private func didTapAddMoneyButton() {
        ...
        case .fromConversationView:
            dismiss(animated: true) {
                ...
                ZonaRosaApp.shared.showAppSettings(mode: .paymentsTransferIn)
            }
        case .fromPaymentSettings:
