...
class MediaPageViewController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationBar.tintColor = .ZonaRosa.label
    ...
    private func showOrHideTopAndBottomPanelsAsNecessary(animated: Bool) {
        ...
        if #available(iOS 26, *) {
            let targetColor = shouldHideToolbars ? UIColor.black : UIColor.ZonaRosa.background
            if animated {
...
extension MediaPageViewController: MediaPresentationContextProvider {
    ...
    func mediaPresentationContext(item: Media, in coordinateSpace: UICoordinateSpace) -> MediaPresentationContext? {
        ...
        let backgroundColor: UIColor = if #available(iOS 26, *) { .ZonaRosa.background } else { .black }
