...
class RecentPhotosCollectionView: UICollectionView {
    ...
    private func noAccessToPhotosView() -> UIView {
        let textLabel = textLabel(text: OWSLocalizedString(
            ...
            comment: "Text in chat attachment panel explaining that user needs to give ZonaRosa permission to access photos.",
        ))
        let button = UIButton(
            configuration: .smallSecondary(title: OWSLocalizedString(
                "ATTACHMENT_KEYBOARD_OPEN_SETTINGS",
                comment: "Button in chat attachment panel to let user open Settings app and give ZonaRosa persmission to access photos.",
            )),
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        Task {
            ...
            do {
                ...
                Logger.warn("\(error)")
                switch error {
                case ZonaRosaAttachmentError.fileSizeTooLarge:
