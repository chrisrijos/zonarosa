...
public class PinSetupViewController: OWSViewController, OWSNavigationChildController {
    ...
    private lazy var explanationLabel: LinkingTextView = {
        ...
        let attributedString = NSMutableAttributedString(
            ...
            attributes: [
                .font: font,
                .foregroundColor: UIColor.ZonaRosa.secondaryLabel,
            ],
        )
        ...
        if addLearnMoreLink {
            ...
            if #available(iOS 26, *) {
                ...
                linkColor = .ZonaRosa.label
            } else {
                linkFont = font
                linkColor = UIColor.ZonaRosa.link
            }
    ...
    private let recommendationLabel: UILabel = {
        ...
        recommendationLabel.textColor = .ZonaRosa.secondaryLabel
    ...
    public var navbarBackgroundColorOverride: UIColor? {
        return .ZonaRosa.groupedBackground
    }
