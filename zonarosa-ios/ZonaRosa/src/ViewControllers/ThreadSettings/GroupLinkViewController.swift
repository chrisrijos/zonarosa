...
public class GroupLinkViewUtils {
    ...
    public static func showShareLinkAlert(
        ...
        actionSheet.addAction(ActionSheetAction(
            title: OWSLocalizedString(
                "GROUP_LINK_VIEW_SHARE_LINK_VIA_ZONAROSA",
                comment: "Label for the 'share group link via ZonaRosa' button in the 'group link' view.",
            ),
            style: .default,
        ) { _ in
            Self.shareLinkViaZonaRosa(
                groupModelV2: groupModelV2,
                fromViewController: fromViewController,
                sendMessageController: sendMessageController,
            )
    ...
    private static func shareLinkViaZonaRosa(
        groupModelV2: TSGroupModelV2,
        fromViewController: UIViewController,
        sendMessageController: SendMessageController,
    ) {
