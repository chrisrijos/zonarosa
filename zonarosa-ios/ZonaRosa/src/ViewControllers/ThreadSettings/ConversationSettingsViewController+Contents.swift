            ...
            section.add(OWSTableItem(customCellBlock: { [weak self] in
                ...
                SSKEnvironment.shared.databaseStorageRef.read { transaction in
                    ...
                    if showAddMemberLabel {
                        ...
                        ) + ZonaRosaSymbol.chevronRight.attributedString(
                    ...
                    let isSystemContact = SSKEnvironment.shared.contactManagerRef.fetchZonaRosaAccount(for: memberAddress, transaction: transaction) != nil
    ...
    private func buildGroupSettingsSection(
        ...
        if BuildFlags.MemberLabel.send {
            ...
            if canEditMemberLabel {
                ...
                iconColor = UIColor.ZonaRosa.label.withAlphaComponent(0.3)
                textColor = UIColor.ZonaRosa.label.withAlphaComponent(0.3)
            }
            section.add(
                OWSTableItem.disclosureItem(
                    icon: .memberLabel,
