...
class ContactAboutSheet: StackSheetViewController {
    ...
    private func loadContents() {
        ...
        case .connection:
            stackView.addArrangedSubview(ProfileDetailLabel.zonarosaConnectionLink(
    ...
    private func updateIsInSystemContacts(tx: DBReadTransaction) {
        ...
        isInSystemContacts = self.context.contactManager.fetchZonaRosaAccount(for: thread.contactAddress, transaction: tx) != nil
    }
...
extension ContactAboutSheet: DatabaseChangeDelegate {
    func databaseChangesDidUpdate(databaseChanges: ZonaRosaServiceKit.DatabaseChanges) {
