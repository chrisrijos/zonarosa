...
public class CLVBackupDownloadProgressView {
    ...
    init() {
        ...
        backupDownloadProgressViewCell.backgroundColor = .ZonaRosa.background
...
private class BackupAttachmentDownloadProgressView: UIView {
    ...
    private lazy var dismissButton: OWSButton = {
        let button = OWSButton(imageName: "x-28", tintColor: UIColor.ZonaRosa.secondaryLabel) { [weak self] in
            guard let self else { return }
    ...
    private lazy var detailsButton: OWSButton = {
        ...
        button.setTitleColor(UIColor.ZonaRosa.label, for: .normal)
    ...
    private func initialRender() {
        ...
        backgroundView.backgroundColor = UIColor.ZonaRosa.secondaryBackground
    ...
    private func renderIcon() {
        ...
        case .restoring, .wifiNotReachable, .paused, nil:
            ("backup-bold", UIColor.ZonaRosa.label)
        case .outOfDiskSpace:
            ("backup-error-bold", UIColor.ZonaRosa.orange)
        case .complete:
            ("check-circle", UIColor.ZonaRosa.ultramarine)
        }
        ...
        case .outOfDiskSpace(let spaceRequired):
            ...
            sheet = HeroSheetViewController(
                hero: .circleIcon(
                    ...
                    iconSize: 40,
                    tintColor: UIColor.ZonaRosa.orange,
