...
extension ConversationSearchViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .contactThreads:
            ...
            ZonaRosaApp.shared.presentConversationForThread(threadUniqueId: threadViewModel.threadUniqueId, action: .compose, animated: true)
        case .groupThreads:
        ...
        case .contacts:
            ...
            ZonaRosaApp.shared.presentConversationForAddress(searchResult.recipientAddress, action: .compose, animated: true)
        case .messages:
...
class EmptySearchResultCell: UITableViewCell {
    ...
    func configure(searchText: String) {
        if searchText.isEmpty {
            ...
            messageLabel.textColor = .ZonaRosa.label
