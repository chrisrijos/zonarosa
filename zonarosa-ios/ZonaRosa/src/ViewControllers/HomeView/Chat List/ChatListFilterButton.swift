...
extension UIButton.Configuration {
    ...
    static func chatListFilter(compatibleWith traitCollection: UITraitCollection? = nil) -> Self {
        ...
        configuration.baseBackgroundColor = .ZonaRosa.secondaryBackground
...
struct ChatListFilterButtonPreviews: PreviewProvider {
    ...
    struct ChatListFilterButton: UIViewRepresentable {
        ...
        func makeUIView(context: Context) -> ZonaRosa.ChatListFilterButton {
            ZonaRosa.ChatListFilterButton()
        }

        func updateUIView(_ button: ZonaRosa.ChatListFilterButton, context: Context) {
