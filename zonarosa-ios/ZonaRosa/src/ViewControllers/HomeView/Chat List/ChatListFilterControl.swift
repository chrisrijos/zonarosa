...
private extension UIImage.Configuration {
    ...
    static var filterIconBackground: UIImage.SymbolConfiguration {
        filterIconBase.applying(UIImage.SymbolConfiguration(paletteColors: [.ZonaRosa.secondaryBackground]))
    }

    static var filterIconIncrementing: UIImage.SymbolConfiguration {
        filterIconBase.applying(UIImage.SymbolConfiguration(paletteColors: [.ZonaRosa.label, .ZonaRosa.secondaryBackground]))
    }
...
private extension UIColor {
    ...
    static var filterIconActiveBackground: UIColor {
        UIColor(
            light: .ZonaRosa.secondaryUltramarineBackground,
            dark: .ZonaRosa.ultramarine,
        )
    }
}
