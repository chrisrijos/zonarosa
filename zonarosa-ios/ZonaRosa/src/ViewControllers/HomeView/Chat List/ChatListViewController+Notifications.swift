...
extension ChatListViewController {
    ...
    public func observeNotifications() {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(zonarosaAccountsDidChange),
    ...
    @objc
    private func zonarosaAccountsDidChange(_ notification: NSNotification) {
        AssertIsOnMainThread()
    ...
    private func profileWhitelistDidChange(_ notification: NSNotification) {
        ...
        let address: ZonaRosaServiceAddress? = notification.userInfo?[UserProfileNotifications.profileAddressKey] as? ZonaRosaServiceAddress
