...
public class ChatListViewController: OWSViewController, HomeTabViewController {
    ...
    override public func viewDidLoad() {
        ...
        tableView.backgroundColor = .ZonaRosa.background
        ...
        let barButtonItem = createSettingsBarButtonItem(
            ...
            buildActions: { settingsAction -> [UIMenuElement] in
                ...
                if viewState.settingsButtonCreator.showBackupsFailedMenuItem {
                    var image = Theme.iconImage(.backup).withTintColor(.ZonaRosa.label)
                    if viewState.settingsButtonCreator.showBackupsFailedMenuItemBadge {
                        image = image.withBadge(color: .ZonaRosa.yellow)
                    }
                    ...
                    let image = Theme.iconImage(.backup)
                        .withTintColor(.ZonaRosa.label)
                        .withBadge(color: .ZonaRosa.yellow)
    ...
    // If the user has *just* launched ZonaRosa they intend to do something, we don't want to interrupt them.
    ...
    func configureUnreadPaymentsBannerSingle(
        ...
        let address = ZonaRosaServiceAddress(senderAci)
        ...
        let formatString = { () -> String in
            ...
            case 0:
                return OWSLocalizedString(
                    ...
                    comment: "A label offering to start a new conversation with your contacts, if you have no ZonaRosa contacts.",
                )
            case 1:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_1_CONTACT_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have 1 ZonaRosa contact.  Embeds {{The name of 1 of your ZonaRosa contacts}}.",
                )
            case 2:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_2_CONTACTS_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have 2 ZonaRosa contacts.  Embeds {{The names of 2 of your ZonaRosa contacts}}.",
                )
            case 3:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_3_CONTACTS_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have at least 3 ZonaRosa contacts.  Embeds {{The names of 3 of your ZonaRosa contacts}}.",
                )
            default:
