...
private class NoSelectedConversationViewController: OWSViewController {
    ...
    override func loadView() {
        ...
        logoImageView.image = #imageLiteral(resourceName: "zonarosa-logo-128").withRenderingMode(.alwaysTemplate)
        logoImageView.tintColor = UIColor.ZonaRosa.quaternaryLabel
