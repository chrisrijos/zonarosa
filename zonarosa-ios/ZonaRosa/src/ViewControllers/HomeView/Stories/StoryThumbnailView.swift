...
class StoryThumbnailView: UIView {
    ...
    private static let thumbnailCache = LRUCache<ZonaRosaServiceKit.Attachment.IDType, UIImage>(maxSize: 64, shouldEvacuateInBackground: true)
    ...
    private func buildBlurHashImageViewIfAvailable(attachment: ZonaRosaServiceKit.Attachment) -> UIView? {
