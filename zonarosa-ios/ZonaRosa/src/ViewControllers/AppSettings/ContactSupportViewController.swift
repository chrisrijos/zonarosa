...
extension ContactSupportViewController {
    ...
    private func constructContents() -> OWSTableContents {
        ...
        let faqPromptText = OWSLocalizedString(
            "SUPPORT_FAQ_PROMPT",
            comment: "Label in support request informing user about ZonaRosa FAQ",
        )
            ...
            OWSTableSection(title: contactHeaderText, items: [
                ...
                OWSTableItem(
                    customCellBlock: {
                        ...
                        cell.textLabel?.textColor = .ZonaRosa.accent
                        return cell
                    },
                    actionBlock: { [weak self] in
    ...
    private func createDebugLogCell() -> UITableViewCell {
        ...
        let infoButton = OWSButton(imageName: "help", tintColor: .ZonaRosa.secondaryLabel) { [weak self] in
