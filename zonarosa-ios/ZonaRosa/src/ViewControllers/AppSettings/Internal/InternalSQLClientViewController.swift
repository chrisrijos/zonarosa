...
class InternalSQLClientViewController: UIViewController {
    ...
    let outputTextView: UITextView = {
        ...
        textView.backgroundColor = .ZonaRosa.secondaryBackground
        textView.textColor = .ZonaRosa.secondaryLabel
    ...
    let queryTextField: UITextField = {
        ...
        textField.backgroundColor = .ZonaRosa.secondaryBackground
        textField.textColor = .ZonaRosa.secondaryLabel
