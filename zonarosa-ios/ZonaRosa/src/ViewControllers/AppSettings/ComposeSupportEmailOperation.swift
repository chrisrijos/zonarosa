...
struct SupportEmailModel {
    ...
    init(
        ...
        self.zonarosaAppVersion = AppVersionImpl.shared.currentAppVersion
        ...
        self.supportFilter = supportFilter ?? "ZonaRosa iOS Support Request"
...
final class ComposeSupportEmailOperation: NSObject {
    ...
    private var emailBody: String {
        ...
        let bodyComponents: [String?] = [
            ...
            "ZonaRosa Version: \(model.zonarosaAppVersion)",
            {
