...
class LinkOrSyncPickerSheet: StackSheetViewController {
    ...
    override var sheetBackgroundColor: UIColor {
        UIColor.ZonaRosa.groupedBackground
    }
    ...
    override func viewDidLoad() {
        ...
        closeButtonConfig.baseForegroundColor = UIColor.ZonaRosa.label
        closeButtonConfig.baseBackgroundColor = UIColor.ZonaRosa.tertiaryFill
    ...
    private func actionRow(
        ...
        stackView.backgroundColor = UIColor.ZonaRosa.secondaryGroupedBackground
        ...
        chevron.setTemplateImageName(
            "chevron-right-20",
            tintColor: UIColor.ZonaRosa.tertiaryLabel,
        )
