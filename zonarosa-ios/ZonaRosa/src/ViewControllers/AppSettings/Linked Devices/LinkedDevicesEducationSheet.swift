...
class LinkedDevicesEducationSheet: StackSheetViewController {
    ...
    override func viewDidLoad() {
        ...
        let iPadDownloadLinkString = "zonarosa.io/install"
        let iPadDownloadURL = URL(string: "https://zonarosa.io/install/")!
        let desktopDownloadLinkString = "zonarosa.io/download"
        let desktopDownloadURL = URL(string: "https://zonarosa.io/download/")!
