    ...
    var body: some View {
        ZonaRosaList {
            ...
            ZonaRosaSection {
                if viewModel.displayableDevices.isEmpty {
                    ZStack(alignment: .center) {
                        ...
                        if viewModel.isLoading {
                            // [Device Linking] TODO: ZonaRosa spinner
                            ProgressView()
                        } else {
                            Text(OWSLocalizedString(
                ...
                (
                    ZonaRosaSymbol.lock.text(dynamicTypeBaseSize: 16).baselineOffset(-1) +
                        Text(" ") +
                        Text(OWSLocalizedString(
        ...
        private var lastSeenDateString: String {
            ...
            return dateFormattedString(
                format: OWSLocalizedString(
                    ...
                    comment: "{{Short Date}} when device last communicated with ZonaRosa Server.",
                ),
