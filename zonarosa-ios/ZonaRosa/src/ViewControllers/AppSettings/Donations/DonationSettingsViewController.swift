...
class DonationSettingsViewController: OWSTableViewController2 {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setUpAvatarView()
        title = OWSLocalizedString("DONATION_VIEW_TITLE", comment: "Title on the 'Donate to ZonaRosa' screen")
    }
    ...
    private func showGiftBadgeExpirationSheetIfNeeded() {
        ...
        firstly {
            DonationSubscriptionManager.getCachedBadge(level: .giftBadge(.zonarosaGift)).fetchIfNeeded()
