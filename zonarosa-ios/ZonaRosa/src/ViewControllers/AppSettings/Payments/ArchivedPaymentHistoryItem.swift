...
public struct ArchivedPaymentHistoryItem: PaymentsHistoryItem {
    ...
    public let address: ZonaRosaServiceKit.ZonaRosaServiceAddress?
    ...
    public func markAsRead(tx: ZonaRosaServiceKit.DBWriteTransaction) { }
    ...
    public func reload(tx: ZonaRosaServiceKit.DBReadTransaction) -> Self? {
        return self
    }
}
