...
class StickerPackViewController: OWSViewController {
    ...
    override func viewDidLoad() {
        ...
        // Loading indicator
        loadingIndicator.tintColor = .ZonaRosa.label
    ...
    func present(from fromViewController: UIViewController, animated: Bool) {
        ...
        fromViewController.presentFormSheet(self, animated: animated) {
            ...
            // an issue only when opening zonarosa from a universal link in
            // an external app
    ...
    private let defaultPackIconView: UIImageView = {
        ...
        imageView.tintColor = .ZonaRosa.accent
    ...
    private lazy var uninstallButton: UIButton = {
        ...
        button.configuration?.baseBackgroundColor = .ZonaRosa.red
        return button
    }()
    ...
    private func updateContent() {
        ...
        authorLabel.textColor = isDefaultStickerPack ? .ZonaRosa.accent : .ZonaRosa.label
