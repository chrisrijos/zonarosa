    ...
    private class ContextMenuActionRow: UIView {
                ...
                if oldValue != isHighlighted {
                    if isHighlighted {
                        if highlightedView == nil {
                            ...
                            view.backgroundColor = .ZonaRosa.secondaryFill
        ...
        init(
            ...
            if attributes.contains(.destructive) {
                titleLabel.textColor = UIColor.ZonaRosa.red
                makeLabelSubviewOfVisualEffectsView = false
            } else if attributes.contains(.disabled) {
                titleLabel.textColor = .ZonaRosa.secondaryLabel
                makeLabelSubviewOfVisualEffectsView = false
            } else {
            ...
            if let hostBlurEffect {
                ...
                separatorView.backgroundColor = .ZonaRosa.transparentSeparator
