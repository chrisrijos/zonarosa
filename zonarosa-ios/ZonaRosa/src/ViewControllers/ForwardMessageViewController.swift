    ...
    class func present(
        ...
        do {
            let attachments = try attachmentStreams.map { attachmentStream in
                try ZonaRosaAttachmentCloner.cloneAsZonaRosaAttachment(attachment: attachmentStream, attachmentLimits: attachmentLimits)
            }
            present(
    ...
    class func present(
        ...
        case .media:
            ...
            do {
                ...
                let zonarosaAttachment = try ZonaRosaAttachmentCloner.cloneAsZonaRosaAttachment(attachment: attachment, attachmentLimits: attachmentLimits)
                attachments = [zonarosaAttachment]
            } catch let error {
                ForwardMessageViewController.showAlertForForwardError(
                    error: error,
                    forwardedInteractionCount: 1,
