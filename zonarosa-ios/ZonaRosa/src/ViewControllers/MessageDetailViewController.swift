...
class MessageDetailViewController: OWSTableViewController2 {
    ...
    private func contactItem(for address: ZonaRosaServiceAddress, accessoryText: String, displayUDIndicator: Bool) -> OWSTableItem {
        return .init(
    ...
    private func buildAccessoryView(
        ...
        let labelConfig = CVLabelConfig.unstyledText(
            ...
            textColor: .ZonaRosa.tertiaryLabel,
        )
        ...
        imageView.setTemplateImageName(Theme.iconName(.sealedSenderIndicator), tintColor: .ZonaRosa.tertiaryLabel)
        ...
        DispatchQueue.sharedUserInitiated.async { [weak self] in
            ...
            let (hasBodyAttachments, messageRecipientAddressesSorted) = SSKEnvironment.shared.databaseStorageRef.read { transaction in
                return (
                    ...
                    SSKEnvironment.shared.contactManagerImplRef.sortZonaRosaServiceAddresses(
