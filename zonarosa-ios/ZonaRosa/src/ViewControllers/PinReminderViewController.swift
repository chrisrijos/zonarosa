...
public class PinReminderViewController: OWSViewController {
    ...
    private lazy var pinTextField: UITextField = {
        ...
        textField.textColor = .ZonaRosa.label
        if #available(iOS 26, *) {
            textField.tintColor = .ZonaRosa.label
        }
        textField.font = .systemFont(ofSize: 22)
        textField.textAlignment = .center
        textField.isSecureTextEntry = true
        textField.backgroundColor = .ZonaRosa.secondaryGroupedBackground
    ...
    override public func viewDidLoad() {
        ...
        explanationLabel.textColor = .ZonaRosa.secondaryLabel
        ...
        if #available(iOS 26.0, *) {
            ...
            buttonImageColor = .ZonaRosa.label
        } else {
