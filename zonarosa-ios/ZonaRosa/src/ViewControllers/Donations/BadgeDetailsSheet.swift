            ...
            let buttonSection = OWSTableSection(items: [.init(customCellBlock: { [weak self] in
                ...
                let button = UIButton(
                    configuration: .largePrimary(title: OWSLocalizedString(
                        "BADGE_DETAILS_DONATE_TO_ZONAROSA",
                        comment: "When viewing someone else's badge, you'll see a sheet. If they got the badge by donating, a \"Donate to ZonaRosa\" button will be shown. This is the text in that button.",
                    )),
