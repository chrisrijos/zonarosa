    ...
    private func preparePaypalSubscriptionBehindActivityIndicator(
        ...
        return try await ModalActivityIndicatorViewController.presentAndPropagateResult(
            ...
            wrappedAsyncBlock: {
                ...
                Logger.info("[Donations] Creating ZonaRosa payment method for new monthly subscription with PayPal")
                let createParams = try await Paypal.createZonaRosaPaymentMethodForSubscription(subscriberId: subscriberId)
