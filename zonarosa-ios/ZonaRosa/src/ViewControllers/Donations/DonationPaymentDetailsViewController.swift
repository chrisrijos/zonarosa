...
class DonationPaymentDetailsViewController: OWSTableViewController2 {
    ...
    private func render() {
        ...
        case .card:
            subheaderText = OWSLocalizedString(
                ...
                comment: "On the credit/debit card donation screen, a small amount of information text is shown. This is that text. It should (1) instruct users to enter their credit/debit card information (2) tell them that ZonaRosa does not collect or store their personal information.",
            )
        case .sepa, .ideal:
            subheaderText = OWSLocalizedString(
                "BANK_DONATION_SUBHEADER_TEXT",
                comment: "On the bank transfer donation screen, a small amount of information text is shown. This is that text. It should (1) instruct users to enter their bank information (2) tell them that ZonaRosa does not collect or store their personal information.",
            )
        }
        ...
        ]).styled(with: .color(.ZonaRosa.secondaryLabel), .font(.dynamicTypeFootnoteClamped))
        subheaderTextView.linkTextAttributes = [.foregroundColor: UIColor.ZonaRosa.label]
        ...
        cardNumberView.render(errorMessage: {
            ...
            return OWSLocalizedString(
                ...
                comment: "Users can donate to ZonaRosa with a credit or debit card. If their card number is invalid, this generic error message will be shown. Try to use a short string to make space in the UI.",
            )
        }())
        expirationView.render(errorMessage: {
            ...
            return OWSLocalizedString(
                ...
                comment: "Users can donate to ZonaRosa with a credit or debit card. If their expiration date is invalid, this generic error message will be shown. Try to use a short string to make space in the UI.",
            )
        }())
        cvvView.render(errorMessage: {
            ...
            if cvvView.text.count > cardType.cvvCount {
                return OWSLocalizedString(
                    ...
                    comment: "Users can donate to ZonaRosa with a credit or debit card. If their card verification code (CVV) is too long, this error will be shown. Try to use a short string to make space in the UI.",
                )
            } else {
                return OWSLocalizedString(
                    "CARD_DONATION_CVV_GENERIC_ERROR",
                    comment: "Users can donate to ZonaRosa with a credit or debit card. If their card verification code (CVV) is invalid for reasons we cannot determine, this generic error message will be shown. Try to use a short string to make space in the UI.",
                )
            }
        }())
            ...
            .map { invalidity in
                ...
                case .invalidCharacters:
                    return OWSLocalizedString(
                        ...
                        comment: "Users can donate to ZonaRosa with a bank account. If their internation bank account number (IBAN) contains characters other than letters and numbers, this error will be shown. Try to use a short string to make space in the UI.",
                    )
                case .invalidCheck:
                    return OWSLocalizedString(
                        "SEPA_DONATION_IBAN_INVALID_CHECK_ERROR",
                        comment: "Users can donate to ZonaRosa with a bank account. If their internation bank account number (IBAN) does not pass validation, this error will be shown. Try to use a short string to make space in the UI.",
                    )
                case .invalidCountry:
                    return OWSLocalizedString(
                        "SEPA_DONATION_IBAN_INVALID_COUNTRY_ERROR",
                        comment: "Users can donate to ZonaRosa with a bank account. If their internation bank account number (IBAN) has an unsupported country code, this error will be shown. Try to use a short string to make space in the UI.",
                    )
                case .tooLong:
                    return OWSLocalizedString(
                        "SEPA_DONATION_IBAN_TOO_LONG_ERROR",
                        comment: "Users can donate to ZonaRosa with a bank account. If their internation bank account number (IBAN) is too long, this error will be shown. Try to use a short string to make space in the UI.",
                    )
                case .tooShort:
                    return OWSLocalizedString(
    ...
    private static let cardNumberTitle = OWSLocalizedString(
        ...
        comment: "Users can donate to ZonaRosa with a credit or debit card. This is the label for the card number field on that screen.",
    )
    ...
    private static let expirationTitle = OWSLocalizedString(
        ...
        comment: "Users can donate to ZonaRosa with a credit or debit card. This is the label for the expiration date field on that screen. Try to use a short string to make space in the UI. (For example, the English text uses \"Exp. Date\" instead of \"Expiration Date\").",
    )

    private static let cvvTitle = OWSLocalizedString(
        "CARD_DONATION_CVV_LABEL",
        comment: "Users can donate to ZonaRosa with a credit or debit card. This is the label for the card verification code (CVV) field on that screen.",
    )

    private static let ibanTitle = OWSLocalizedString(
        "SEPA_DONATION_IBAN_LABEL",
        comment: "Users can donate to ZonaRosa with a bank account. This is the label for IBAN (internation bank account number) field on that screen.",
    )
    ...
    private static let nameTitle = OWSLocalizedString(
        ...
        comment: "Users can donate to ZonaRosa with a bank account. This is the label for name field on that screen.",
    )

    private static let emailTitle = OWSLocalizedString(
        "SEPA_DONATION_EMAIL_LABEL",
        comment: "Users can donate to ZonaRosa with a bank account. This is the label for email field on that screen.",
    )
    ...
    private lazy var expirationView = {
        ...
        return FormFieldView(
            ...
            placeholder: OWSLocalizedString(
                ...
                comment: "Users can donate to ZonaRosa with a credit or debit card. This is the label for the card expiration date field on that screen.",
            ),
            style: .formatted(
    ...
    private lazy var nameView = FormFieldView(
        ...
        placeholder: OWSLocalizedString(
            ...
            comment: "Users can donate to ZonaRosa with a bank account. This is placeholder text for the name field before the user starts typing.",
        ),
    ...
    private lazy var emailView = FormFieldView(
        ...
        placeholder: OWSLocalizedString(
            ...
            comment: "Users can donate to ZonaRosa with a bank account. This is placeholder text for the email field before the user starts typing.",
        ),
        ...
        let title = {
            ...
            case .oneTime, .gift:
                format = OWSLocalizedString(
                    "DONATE_BUTTON",
                    comment: "Users can donate to ZonaRosa with a credit or debit card. This is the heading on that screen, telling them how much they'll donate. Embeds {{formatted amount of money}}, such as \"$20\".",
                )
            case .monthly:
                format = OWSLocalizedString(
                    "DONATE_BUTTON_MONTHLY",
                    comment: "Users can donate to ZonaRosa with a credit or debit card. This is the heading on that screen, telling them how much they'll donate every month. Embeds {{formatted amount of money}}, such as \"$20\".",
                )
            }
