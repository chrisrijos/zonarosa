    ...
    func paymentAuthorizationControllerForMonthly(
        ...
        Task {
            ...
            do {
                ...
                Logger.info("[Donations] Creating ZonaRosa payment method for new monthly subscription with Apple Pay")
                let clientSecret = try await Stripe.createZonaRosaPaymentMethodForSubscription(subscriberId: subscriberId)
