...
class BadgeThanksSheet: OWSTableSheetViewController {
    ...
    private var titleText: String {
        ...
        case .badgeRedeemedViaNonBankPayment:
            return OWSLocalizedString(
                "BADGE_THANKS_TITLE",
                comment: "When you make a donation to ZonaRosa, you will receive a badge. A thank-you sheet appears when this happens. This is the title of that sheet.",
            )
    ...
    private var bodyText: String {
        ...
        case .badgeRedeemedViaNonBankPayment:
            let formatText = OWSLocalizedString(
                "BADGE_THANKS_BODY",
                comment: "When you make a donation to ZonaRosa, you will receive a badge. A thank-you sheet appears when this happens. This is the body text on that sheet.",
            )
    ...
    override func tableContents() -> OWSTableContents {
        ...
        headerSection.add(.init(customCellBlock: { [weak self] in
            ...
            bodyLabel.textColor = .ZonaRosa.secondaryLabel
