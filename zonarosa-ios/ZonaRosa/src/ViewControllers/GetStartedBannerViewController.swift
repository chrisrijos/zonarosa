...
private class GetStartedCardCellContentView: UIView, UIContentView {
    ...
    private lazy var closeButton: UIButton = {
        ...
        button.tintColor = .ZonaRosa.secondaryLabel
        return button
    }()
    ...
    private func updateBackgroundColor(using card: GetStartedCard) {
        ...
        let baseBackgroundColor = UIColor.ZonaRosa.background.resolvedColor(with: traitCollection)
...
class GetStartedBannerViewController: OWSViewController {
    ...
    private func updateGradientColors() {
        let backgroundColor = UIColor.ZonaRosa.background.resolvedColor(with: traitCollection)
