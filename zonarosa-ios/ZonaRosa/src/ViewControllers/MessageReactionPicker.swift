...
class MessageReactionPicker: UIStackView {
    ...
    init(
        ...
        case (.configure, false), (.contextMenu(allowGlass: _), _):
            backgroundView = addBackgroundView(
                withBackgroundColor: .ZonaRosa.secondaryGroupedBackground,
            ...
            shadowView.backgroundColor = .ZonaRosa.secondaryGroupedBackground
        ...
        for (index, emoji) in emojiSet.enumerated() {
            ...
            if self.selectedEmoji == emoji {
                ...
                selectedBackgroundView.backgroundColor = .ZonaRosa.secondaryFill
        ...
        if addAnyButton {
            ...
            imageBackground.backgroundColor = .ZonaRosa.primaryFill
            ...
            backgroundBackground.backgroundColor = .ZonaRosa.background
    ...
    func replaceEmojiReaction(_ oldEmoji: String, newEmoji: String, inPosition position: Int) {
        ...
        button.setTitle(title: newEmoji, font: .systemFont(ofSize: reactionFontSize), titleColor: .ZonaRosa.label)
