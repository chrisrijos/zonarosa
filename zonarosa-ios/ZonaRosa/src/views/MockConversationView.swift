...
class MockConversationView: UIView {
    ...
    fileprivate static let mockAddress = ZonaRosaServiceAddress(try! ServiceId.parseFrom(serviceIdString: "00000000-0000-5000-8000-000000000000"))
...
public class MockOutgoingMessage: TSOutgoingMessage {
    ...
    override public func readRecipientAddresses() -> [ZonaRosaServiceAddress] {
        // makes message appear as read
        return [MockConversationView.mockAddress]
    }

    override public func recipientState(for recipientAddress: ZonaRosaServiceAddress) -> TSOutgoingMessageRecipientState? {
