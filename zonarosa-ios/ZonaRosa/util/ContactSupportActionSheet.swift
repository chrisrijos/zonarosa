...
enum ContactSupportActionSheet {
    enum EmailFilter: Equatable {
        ...
        fileprivate var asString: String {
            return switch self {
            case .registrationPINMode(.v2NoReglock): "ZonaRosa PIN - iOS (V2 PIN without RegLock)"
            case .registrationPINMode(.v2WithReglock): "ZonaRosa PIN - iOS (V2 PIN)"
            case .registrationPINMode(.v2WithUnknownReglockState): "ZonaRosa PIN - iOS (V2 PIN with unknown reglock)"
            case .deviceTransfer: "ZonaRosa iOS Transfer"
