...
public class RegistrationCoordinatorImpl: RegistrationCoordinator {
    ...
    public func updateAccountEntropyPool(_ accountEntropyPool: ZonaRosaServiceKit.AccountEntropyPool) -> Guarantee<RegistrationStep> {
    ...
    private func restoreFromMessageBackup(
        ...
        accountEntropyPool: ZonaRosaServiceKit.AccountEntropyPool,
    ...
    private struct InMemoryState {
        ...
        var accountEntropyPool: ZonaRosaServiceKit.AccountEntropyPool?
    ...
    struct PersistedState: Codable {
        ...
        var backupKeyAccountEntropyPool: ZonaRosaServiceKit.AccountEntropyPool?
    ...
    private func fetchBackupServiceAuth(
        ...
        } catch ZonaRosaError.verificationFailed {
    ...
    private func makeSVR2AuthCredentialCheckRequest(
        ...
        let response = await Service.makeSVR2AuthCheckRequest(
            ...
            zonarosaService: deps.zonarosaService,
        )
    ...
    private func nextStepForProfileSetup(
        ...
        let accountEntropyPool: ZonaRosaServiceKit.AccountEntropyPool
    ...
    @MainActor
    private func getOrGenerateAccountEntropyPool() -> ZonaRosaServiceKit.AccountEntropyPool {
        // If the AccountEntropyPool doesn't exist yet, create one.
    ...
    private func makeCreateAccountRequestAndFinalizePreKeys(
        ...
        let zonarosaService = self.deps.zonarosaService
