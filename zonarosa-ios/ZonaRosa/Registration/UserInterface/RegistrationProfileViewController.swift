...
class RegistrationProfileViewController: OWSViewController {
    ...
    private lazy var explanationView: LinkingTextView = {
        ...
        result.textColor = .ZonaRosa.secondaryLabel
    ...
    private lazy var cameraIconButton: UIButton = {
        ...
        if buttonConfiguration == nil {
            ...
            buttonConfiguration?.baseBackgroundColor = .ZonaRosa.background
            buttonConfiguration?.baseForegroundColor = .ZonaRosa.secondaryLabel
        }
    ...
    private func textField(
        ...
        result.textColor = .ZonaRosa.label
        if #available(iOS 26, *) {
        ...
        result.attributedPlaceholder = NSAttributedString(string: placeholder, attributes: [.foregroundColor: UIColor.ZonaRosa.secondaryLabel])
    ...
    private lazy var nameStackView: UIView = {
        ...
        if #available(iOS 26, *) {
            ...
            strokeView.backgroundColor = .ZonaRosa.opaqueSeparator
            ...
            stackView.backgroundColor = .ZonaRosa.secondaryBackground
            ...
            firstTextField.addBottomStroke(color: .ZonaRosa.opaqueSeparator, strokeWidth: .hairlineWidth)
            secondTextField.addBottomStroke(color: .ZonaRosa.opaqueSeparator, strokeWidth: .hairlineWidth)
        }
        return stackView
    }()
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem?.tintColor = .ZonaRosa.accent
...
extension RegistrationProfileViewController {
    ...
    private class PhoneNumberPrivacyButton: UIButton {
        ...
        init(phoneNumberDiscoverability: PhoneNumberDiscoverability) {
            ...
            configuration?.baseBackgroundColor = .ZonaRosa.background
    ...
    private class PhoneNumberPrivacyButtonContentView: UIView, UIContentView {
        ...
        init(configuration: PhoneNumberPrivacyButtonContentConfiguration) {
            ...
            disclosureView.setTemplateImage(
                ...
                tintColor: .ZonaRosa.tertiaryLabel,
            )
        ...
        private lazy var iconView: UIImageView = {
            ...
            iconView.tintColor = .ZonaRosa.label
        ...
        private lazy var titleLabel: UILabel = {
            ...
            titleLabel.textColor = .ZonaRosa.label
        ...
        private lazy var subTitleLabel: UILabel = {
            ...
            subTitleLabel.textColor = .ZonaRosa.secondaryLabel
