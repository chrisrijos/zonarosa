    ...
    override public func viewDidLoad() {
        ...
        let nonprofitAwarenessLabel = UILabel.explanationLabelForRegistration(
            text: OWSLocalizedString(
                ...
                comment: "Text indicating ZonaRosa is a nonprofit on the 'onboarding splash' view. For non-English languages, exclude the word '501c3'.",
            ),
        )
        ...
        tosPPButton.configuration?.baseForegroundColor = .ZonaRosa.secondaryLabel
...
private class RestoreOrTransferPickerController: StackSheetViewController {
    ...
    override open var sheetBackgroundColor: UIColor { .ZonaRosa.secondaryBackground }
