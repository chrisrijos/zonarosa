...
class RegistrationPhoneNumberInputView: UIView {
    ...
    init(initialPhoneNumber: RegistrationPhoneNumber) {
        ...
        backgroundView.backgroundColor = .ZonaRosa.secondaryBackground
        ...
        dividerView.backgroundColor = .ZonaRosa.secondaryLabel
    ...
    private lazy var countryCodeView: UIView = {
        ...
        chevronIcon.tintColor = .ZonaRosa.secondaryLabel
