...
class RegistrationVerificationCodeView: UIView {
    ...
    private func createSubviews() {
        ...
        textfield.tintColor = .ZonaRosa.label // caret color
    ...
    func updateColors() {
        let strokeColor = (hasError ? UIColor.ZonaRosa.red : UIColor.ZonaRosa.secondaryLabel)
    ...
    private func makeCellView(text: String) -> (UIView, UILabel, UIView) {
        ...
        digitLabel.textColor = .ZonaRosa.label
