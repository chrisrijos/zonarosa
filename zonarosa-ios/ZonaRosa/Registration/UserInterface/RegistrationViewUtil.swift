...
extension UIButton {
    class func registrationChoiceButton(
        ...
        button.configuration?.baseBackgroundColor = .ZonaRosa.quaternaryFill
...
private class RegistrationChoiceButtonContentView: UIView, UIContentView {
    ...
    private func setupViews() {
        ...
        iconView.tintColor = .ZonaRosa.ultramarine
        ...
        disclosureView.tintColor = .ZonaRosa.tertiaryLabel
