...
struct ChooseBackupPlanView: View {
    ...
    private func termsAndConditionsLink() -> some View {
        let label = OWSLocalizedString(
            ...
            comment: "Title for a label allowing users to view ZonaRosa's Terms & Conditions.",
        )
        return Text(" [\(label)](https://support.zonarosa.io/)")
            ...
            .foregroundStyle(Color.ZonaRosa.secondaryLabel)
            .tint(Color.ZonaRosa.secondaryLabel)
    }
}
        ...
        Button(action: onTap) {
            HStack(alignment: .top) {
                VStack(alignment: .leading) {
                    ...
                    Text(subtitle).foregroundStyle(Color.ZonaRosa.secondaryLabel)
                    ...
                    ForEach(bullets, id: \.iconKey) { bullet in
                        Label {
                            ...
                            Image(bullet.iconKey)
                                .foregroundStyle(
                                    isSelected
                                        ? Color.ZonaRosa.ultramarine
                                        : Color.ZonaRosa.label,
                                )
                        }
                        .padding(.leading, 20)
                        .padding(.vertical, 2)
                ...
                Group {
                    if isSelected {
                        Circle()
                            .fill(Color.ZonaRosa.ultramarine)
                            .overlay {
                        ...
                        Circle()
                            .stroke(Color.ZonaRosa.secondaryLabel, lineWidth: 2)
                            .opacity(0.3)
                    }
                }
            ...
            .padding(.leading, 20)
            .padding(.trailing, 16)
            .background(Color.ZonaRosa.secondaryGroupedBackground)
            .cornerRadius(16)
            .overlay {
