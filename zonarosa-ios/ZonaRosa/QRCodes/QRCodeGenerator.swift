...
/// ZonaRosa logo and rounded "pixels". They are scaled up so as to appropriately
...
struct QRCodeGenerator {
    ...
    /// Generates a styled, ZonaRosa-branded QR code image encoding the given URL.
...
private struct QRCodeStyler {
    ...
    func styleQRCode(
        ...
        if let deadzone {
            ...
            let logo = UIImage(named: "zonarosa-logo-40")!
