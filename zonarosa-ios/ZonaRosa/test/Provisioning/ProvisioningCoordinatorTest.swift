...
public class ProvisioningCoordinatorTest: XCTestCase {
    ...
    private var zonarosaServiceMock: OWSZonaRosaServiceMock!
    ...
    override public func setUp() async throws {
        ...
        self.provisioningCoordinator = ProvisioningCoordinatorImpl(
            ...
            zonarosaService: zonarosaServiceMock,
    ...
    public func testProvisioning() async throws {
        ...
        zonarosaServiceMock.mockUrlSessionBuilder = { zonarosaServiceInfo, _, _ in
            XCTAssertEqual(
                zonarosaServiceInfo.baseUrl,
                ZonaRosaServiceType.mainZonaRosaService.zonarosaServiceInfo().baseUrl,
            )
            return mockSession
        }
