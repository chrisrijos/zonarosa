...
class InfoMessageGroupUpdateMigratorTest: ZonaRosaBaseTest {
        ...
        await db.awaitableWrite { tx in
            ...
            insertInfoMessage(
                infoMessageUserInfo: [
                    ...
                    .groupUpdateSourceLegacyAddress: ZonaRosaServiceAddress.isolatedRandomForTesting(),
                ],
                tx: tx,
            )
            insertInfoMessage(infoMessageUserInfo: nil, tx: tx)
...
private extension TSGroupModelV2 {
    static func forMigrationTest(
        ...
        return TSGroupModelV2(
            ...
            groupMembership: GroupMembership(membersForTest: [ZonaRosaServiceAddress.isolatedForTesting(serviceId: localAci)]),
