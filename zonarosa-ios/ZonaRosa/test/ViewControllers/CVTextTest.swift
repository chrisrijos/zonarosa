...
//    }
    ...
    func testLinkifyWithTruncation() {
        let fullText = NSMutableAttributedString(string: "https://zonarosa.io/foo https://zonarosa.io/bar/baz")
        let truncatedText = NSMutableAttributedString(string: "https://zonarosa.io/foo https://zonarosa.io/ba…")
        ...
        XCTAssertEqual(["https://zonarosa.io/foo"], values)
        ...
        XCTAssertEqual(["https://zonarosa.io/foo", "https://zonarosa.io/bar/baz"], values)
        XCTAssertEqual([NSRange(location: 0, length: 22), NSRange(location: 23, length: 26)], ranges)

        // Should work on more than just URLs.
        let fullEmail = NSMutableAttributedString(string: "moxie@example.com moxie@zonarosa.io")
        let truncatedEmail = NSMutableAttributedString(string: "moxie@example.com moxie@zonarosa.or…")
        dataItems = CVComponentBodyText.detectItems(
