...
private final class FakeGalleryStore: MediaGallerySectionLoader {
    func rowIdsAndDatesOfItemsInSection(
        ...
        offset: Int,
        ascending: Bool,
        transaction: ZonaRosaServiceKit.DBReadTransaction,
...
class MediaGallerySectionsFakeStoreTest: ZonaRosaBaseTest {
    func testFakeItem() {
...
class MediaGallerySectionsTest: ZonaRosaBaseTest {
