...
public class RegistrationCoordinatorTest {
    ...
    typealias AccountEntropyPool = ZonaRosaServiceKit.AccountEntropyPool
    ...
    init() {
        ...
        let mockZonaRosaService = OWSZonaRosaServiceMock()
        mockZonaRosaService.mockUrlSessionBuilder = { _, _, _ in
        ...
        let dependencies = RegistrationCoordinatorDependencies(
            ...
            zonarosaService: mockZonaRosaService,
