...
public class ConversationScrollButton: UIButton {
    ...
    var badgeTintColor: UIColor! {
        get { unreadBadge.backgroundColor ?? UIColor.ZonaRosa.accent }
        set { unreadBadge.backgroundColor = newValue ?? UIColor.ZonaRosa.accent }
    }
    ...
    private lazy var unreadBadge: UIView = {
        ...
        view.backgroundColor = .ZonaRosa.accent
