...
struct CVItemModelBuilder: CVItemBuilding {
    ...
    private static func configureItemViewState(
        ...
        if let outgoingMessage = interaction as? TSOutgoingMessage {
            ...
            let incomingSenderAddress: ZonaRosaServiceAddress = incomingMessage.authorAddress
            ...
            if thread.isGroupThread {
                    ...
                    let senderAci = incomingSenderAddress.aci
                {
                    ...
                    memberLabel = memberLabel?
                        ...
                        .joined(separator: ZonaRosaSymbol.LeadingCharacter.nonBreakingSpace.rawValue)
                ...
                if
                    ...
                    let nextIncomingMessage = nextItem.interaction as? TSIncomingMessage
                {
                    let nextIncomingSenderAddress: ZonaRosaServiceAddress = nextIncomingMessage.authorAddress
...
class DisplayNameCache {
    ...
    private func _displayName(for address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> DisplayName {
    ...
    func shortDisplayName(address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> String {
        return _displayName(for: address, tx: transaction).resolvedValue(useShortNameIfAvailable: true)
    }

    func displayName(address: ZonaRosaServiceAddress, transaction: DBReadTransaction) -> String {
