...
extension ConversationViewController {
    ...
    func noLongerVerifiedIdentityKeys(tx: DBReadTransaction) -> [ZonaRosaServiceAddress: Data] {
    ...
    func resetVerificationStateToDefault(noLongerVerifiedIdentityKeys: [ZonaRosaServiceAddress: Data]) {
        AssertIsOnMainThread()
    ...
    func showNoLongerVerifiedUI(noLongerVerifiedIdentityKeys: [ZonaRosaServiceAddress: Data]) {
        AssertIsOnMainThread()
    ...
    func showMemberActionSheet(forAddress address: ZonaRosaServiceAddress, withHapticFeedback: Bool) {
        AssertIsOnMainThread()
