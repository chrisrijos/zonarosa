...
struct CVMessageAction: Equatable {
    ...
    enum Action: Equatable {
        case none
        case didTapPreviouslyVerifiedIdentityChange(address: ZonaRosaServiceAddress)
        case didTapUnverifiedIdentityChange(address: ZonaRosaServiceAddress)
        ...
        case didTapUpdateSystemContact(address: ZonaRosaServiceAddress, newNameComponents: PersonNameComponents)
