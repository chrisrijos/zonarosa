...
public class CVComponentLinkPreview: CVComponentBase, CVComponent {
    ...
    public func configureForRendering(
        ...
        case (true, true): UIColor.ZonaRosa.MaterialBase.fillSecondary
        case (_, true): UIColor.ZonaRosa.LightBase.fillSecondary
        case (_, false): UIColor.ZonaRosa.ColorBase.fillSecondary
        }
