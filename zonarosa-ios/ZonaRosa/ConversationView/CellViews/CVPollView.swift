    ...
    fileprivate struct Configurator {
        fileprivate struct ColorConfigurator {
            ...
            init(state: CVPollView.State) {
                ...
                if state.isIncoming {
                    self.checkboxOutlineColor = UIColor.ZonaRosa.tertiaryLabel
                    self.voteProgressBackgroundColor = UIColor.ZonaRosa.label.withAlphaComponent(0.1)
                    self.voteProgressForegroundColor = UIColor.ZonaRosa.ultramarine
                    self.checkboxSelectedColor = UIColor.ZonaRosa.ultramarine
                } else {
