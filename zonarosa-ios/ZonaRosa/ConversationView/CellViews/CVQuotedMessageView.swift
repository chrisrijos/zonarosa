...
public class CVQuotedMessageView: ManualStackViewWithLayer {
    ...
    private struct Configurator {
        ...
        var stripeColor: UIColor {
            ...
            case (true, true): .ZonaRosa.MaterialBase.fillPrimary
            case (true, _): .ZonaRosa.LightBase.fillPrimary
            case (false, _): .ZonaRosa.ColorBase.fillPrimary
            }
        }

        var backgroundTint: UIColor {
            switch (isIncoming, conversationStyle.hasWallpaper) {
            case (true, true): .ZonaRosa.MaterialBase.fillTertiary
            case (true, _): .ZonaRosa.LightBase.fillSecondary
            case (false, _): .ZonaRosa.ColorBase.fillSecondary
            }
        }

        private var textColor: UIColor {
            isIncoming ? .ZonaRosa.label : .ZonaRosa.ColorBase.labelInverted
        }
        ...
        var mimeTypeWithThumbnail: String? {
            ...
            guard mimeType != MimeType.textXZonaRosaPlain.rawValue else {
                return nil
            }
            return mimeType
        }
        ...
        var quotedTextLabelConfig: CVLabelConfig {
            ...
            case nil:
                ...
                {
                    let iconPrefix = ZonaRosaSymbol.audioSquare.attributedString(
                        dynamicTypeBaseSize: quotedTextFont.pointSize,
                    )
