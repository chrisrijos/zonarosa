...
public class ConversationInputToolbar: UIView, QuotedReplyPreviewDelegate {
    ...
    public enum Style {
        ...
        static var secondaryTextColor: UIColor {
            .ZonaRosa.secondaryLabel
        }

        static var buttonTintColor: UIColor {
            if #available(iOS 26, *) {
                return .ZonaRosa.label
            }
            return UIColor(
    ...
    private enum Buttons {
        ...
        static func addAttachmentButton(
            ...
            button.tintColor = .ZonaRosa.glassBackgroundTint
    ...
    private func setupContentView() {
        ...
        if #available(iOS 26, *) {
            ...
            if UIAccessibility.isReduceTransparencyEnabled {
                backgroundView.backgroundColor = .ZonaRosa.background
            } else {
    ...
    private func createContentsWithMessageDraft(
        ...
        if #available(iOS 26, *) {
            ...
            backgroundView.backgroundColor = UIColor.ZonaRosa.tertiaryFill
    ...
    private func updateBackgroundColors(backgroundView: UIView, backgroundBlurView: UIVisualEffectView) {
        let backgroundColor = UIColor.ZonaRosa.background
    ...
    private lazy var voiceMemoRedRecordingCircle: UIView = {
        ...
        circleView.backgroundColor = .ZonaRosa.red
    ...
    private lazy var voiceMemoDeleteButton: UIButton = {
        ...
        button.configuration?.image = UIImage(imageLiteralResourceName: "trash-fill")
        button.configuration?.baseForegroundColor = .ZonaRosa.red
        return button
    }()
    ...
    func showVoiceMemoUI() {
        ...
        redMicIconImageView.tintColor = .ZonaRosa.red
    ...
    func lockVoiceMemoUI() {
        ...
        cancelButton.configuration?.baseForegroundColor = .ZonaRosa.red
