...
private class ConversationBannerView: UIView {
    ...
    private class ConversationBannerContentView: UIStackView, UIContentView {
        ...
        private func buildTitleLabel(text: String) -> UILabel {
            ...
            _titleLabel.textColor = .ZonaRosa.label
        ...
        private func buildBodyLabel(text: NSAttributedString) -> UILabel {
            ...
            _bodyLabel.textColor = .ZonaRosa.label
        ...
        private func rebuildContent() {
            ...
            if configuration.totalPinnedMessageCount > 0, let title = configuration.title {
                ...
                bodyLabel.textColor = .ZonaRosa.label
                ...
                let viewButtonAction = configuration.viewButtonAction
            {
                ...
                button.configuration?.baseForegroundColor = .ZonaRosa.label
                button.configuration?.baseBackgroundColor = .ZonaRosa.secondaryFill
            ...
            if let dismissButtonAction = configuration.dismissButtonAction {
                ...
                button.tintColor = .ZonaRosa.label
    ...
    init(configuration: ContentConfiguration) {
        ...
        if #available(iOS 26, *) {
            ...
            glassEffect.tintColor = .ZonaRosa.glassBackgroundTint
...
private extension ConversationViewController {
    ...
    private func fetchAvatar(for address: ZonaRosaServiceAddress, tx: DBReadTransaction) -> UIImage? {
    ...
    private class DoubleProfileImageView: UIView {
        ...
        private let primaryImageView: UIImageView = {
            let imageView = UIImageView.withTemplateImageName("info", tintColor: .ZonaRosa.secondaryLabel)
...
private extension ConversationViewController {
    ...
    private var pendingMemberRequests: Set<ZonaRosaServiceAddress>? {
        guard let groupThread = thread as? TSGroupThread else { return nil }
...
private extension ConversationViewController {
    ...
    private func noLongerVerifiedBannerViewWasTapped(noLongerVerifiedIdentityKeys: [ZonaRosaServiceAddress: Data]) {
        AssertIsOnMainThread()
