...
class QuotedReplyPreview: UIView, QuotedMessageSnippetViewDelegate {
    ...
    init(
        ...
        if #available(iOS 26, *) {
            ...
            dimmingView.backgroundColor = .ZonaRosa.secondaryFill
            ...
            backgroundView.backgroundColor = .ZonaRosa.secondaryFill
        }
...
private class QuotedMessageSnippetView: UIView {
    ...
    private lazy var quotedTextLabel: UILabel = {
        ...
        {
            let iconPrefix = ZonaRosaSymbol.audioSquare.attributedString(dynamicTypeBaseSize: Layout.fileTypeFont.pointSize)
            ...
            case .poll(let pollQuestion):
                let pollIcon = ZonaRosaSymbol.poll.attributedString(dynamicTypeBaseSize: Layout.fileTypeFont.pointSize) + " "
    ...
    private func createViewContents() {
        ...
        stripeView.backgroundColor = .ZonaRosa.quaternaryLabel
    ...
    private func createAttachmentView(_ attachment: Attachment, thumbnailImage: UIImage?) -> UIView {
        ...
        if let thumbnailImage {
            ...
            refreshIcon.tintColor = .ZonaRosa.tertiaryLabel
