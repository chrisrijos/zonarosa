...
extension ConversationViewController {
            ...
            if canCall {
                if isGroupConversation {
                    ...
                    if conversationViewModel.groupCallInProgress {
                        ...
                        if #available(iOS 26, *) {
                            videoCallButton.tintColor = UIColor.ZonaRosa.green
    ...
    public func updateNavigationBarSubtitleLabel() {
        ...
        if isVerified {
            ...
            subtitleText.append(ZonaRosaSymbol.safetyNumber.attributedString(staticFontSize: subtitleFont.pointSize))
