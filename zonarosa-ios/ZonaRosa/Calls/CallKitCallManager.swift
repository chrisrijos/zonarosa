...
final class CallKitCallManager {
    ...
    static let kAnonymousCallHandlePrefix = "ZonaRosa:"
    static let kGroupThreadCallHandlePrefix = "ZonaRosaGroup:"
    static let kCallLinkCallHandlePrefix = "ZonaRosaCall:"
    ...
    func createCallHandleWithSneakyTransaction(for call: ZonaRosaCall) -> CXHandle {
    ...
    @MainActor
    func startOutgoingCall(_ call: ZonaRosaCall) {
    ...
    func localHangup(call: ZonaRosaCall) {
    ...
    func setHeld(call: ZonaRosaCall, onHold: Bool) {
    ...
    private(set) var calls = [ZonaRosaCall]()

    func callWithLocalId(_ localId: UUID) -> ZonaRosaCall? {
    ...
    func addCall(_ call: ZonaRosaCall) {
        call.commonState.markReportedToSystem()
        calls.append(call)
    }

    func removeCall(_ call: ZonaRosaCall) {
