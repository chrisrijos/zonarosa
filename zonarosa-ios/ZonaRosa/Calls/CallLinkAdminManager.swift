...
class CallLinkAdminManager {
    typealias CallLinkState = ZonaRosaServiceKit.CallLinkState
    ...
    private func updateCallLink(
        _ performUpdate: (CallLinkManager, ZonaRosaServiceKit.CallLinkAuthCredential) async throws -> CallLinkState,
    ) async throws {
