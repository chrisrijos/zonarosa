...
public class IndividualCall: CustomDebugStringConvertible {
    ...
    var remoteAddress: ZonaRosaServiceAddress { thread.contactAddress }
    ...
    private init(
        ...
        self.commonState = CommonCallState(
            audioActivity: AudioActivity(
                audioDescription: "[ZonaRosaCall] with individual \(thread.contactAddress)",
                behavior: .call,
            ),
        )
    ...
    public var debugDescription: String {
        return "IndividualCall: {\(remoteAddress), zonarosaingId: \(callId as Optional)))}"
    }
