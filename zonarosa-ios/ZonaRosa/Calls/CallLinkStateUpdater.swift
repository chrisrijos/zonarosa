...
actor CallLinkStateUpdater {
    ...
    func updateExclusively(
        ...
        updateAndFetch: (CallLinkAuthCredential) async throws -> ZonaRosaServiceKit.CallLinkState,
    ...
    private enum UpdateAction {
        case update(ZonaRosaServiceKit.CallLinkState)
        case notFound
        case delete
    }
    ...
    private func _updateExclusively(
        rootKey: CallLinkRootKey,
        updateAndFetch: (CallLinkAuthCredential) async throws -> ZonaRosaServiceKit.CallLinkState?,
    ) async throws -> Result<ZonaRosaServiceKit.CallLinkState, CallLinkNotFoundError>? {
        ...
        let returnResult: Result<ZonaRosaServiceKit.CallLinkState, CallLinkNotFoundError>?
    ...
    func readCallLink(rootKey: CallLinkRootKey) async throws -> Result<ZonaRosaServiceKit.CallLinkState, CallLinkNotFoundError> {
