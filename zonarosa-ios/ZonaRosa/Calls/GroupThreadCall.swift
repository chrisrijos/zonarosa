...
final class GroupThreadCall: ZonaRosa.GroupCall {
    ...
    init?(
        ...
        super.init(
            audioDescription: "[ZonaRosaCall] with group \(groupId)",
    ...
    override func groupCall(onLocalDeviceStateChanged groupCall: ZonaRosaRingRTC.GroupCall) {
    ...
    override func groupCall(onRemoteDeviceStatesChanged groupCall: ZonaRosaRingRTC.GroupCall) {
    ...
    override func groupCall(onPeekChanged groupCall: ZonaRosaRingRTC.GroupCall) {
    ...
    override func groupCall(requestMembershipProof groupCall: ZonaRosaRingRTC.GroupCall) {
        super.groupCall(requestMembershipProof: groupCall)

        delegate?.groupThreadCallRequestMembershipProof(self)
    }

    override func groupCall(requestGroupMembers groupCall: ZonaRosaRingRTC.GroupCall) {
...
extension ZonaRosaRingRTC.GroupCall {
    var isFull: Bool {
