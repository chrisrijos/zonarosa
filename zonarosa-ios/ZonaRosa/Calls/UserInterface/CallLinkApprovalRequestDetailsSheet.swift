...
class CallLinkApprovalRequestDetailsSheet: OWSTableSheetViewController {
        ...
        contents.add(.init(
            items: [
                ...
                .item(
                    ...
                    textColor: UIColor.ZonaRosa.label,
                ) { [weak self] in
    ...
    private func buildHeader() -> UIView {
        ...
        let (contactTitle, mutualThreads): (NSAttributedString, [TSGroupThread]) = self.deps.db.read { tx in
            ...
            let isSystemContact = self.deps.contactsManager.fetchZonaRosaAccount(
        ...
        mutualGroupsLabel.textColor = UIColor.ZonaRosa.secondaryLabel
