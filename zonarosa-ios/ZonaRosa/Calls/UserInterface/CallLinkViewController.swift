...
final class CallLinkViewController: OWSTableViewController2 {
    ...
    private func buildTableContents() -> OWSTableContents {
        ...
        let sharingSection = OWSTableSection(items: [
            .item(
                icon: .buttonForward,
                name: CallStrings.shareLinkViaZonaRosa,
                actionBlock: { [unowned self] in self.shareCallLinkViaZonaRosa() },
            ),
            .item(
                icon: .buttonCopy,
...
private class CallLinkCardView: UIView {
    ...
    private lazy var textStack: UIStackView = {
        ...
        linkLabel.textColor = .ZonaRosa.secondaryLabel
...
private extension Theme {
    class var joinButtonTextColor: UIColor {
        ...
        let darkThemeColor = UIColor.ZonaRosa.ultramarine.resolvedColor(with: darkThemeTraits)
        let lightThemeColor = UIColor.ZonaRosa.ultramarine.resolvedColor(with: UITraitCollection(userInterfaceStyle: .light))
