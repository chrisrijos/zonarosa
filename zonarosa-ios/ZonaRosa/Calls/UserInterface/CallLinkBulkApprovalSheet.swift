...
class CallLinkBulkApprovalSheet: InteractiveSheetViewController {
    fileprivate enum Constants {
        static let backgroundColor = UIColor.ZonaRosa.secondaryBackground
        ...
        static let denyButtonColor = UIColor.ZonaRosa.red
        static let approveButtonColor = UIColor.ZonaRosa.green
        static let selectedButtonColor = UIColor.ZonaRosa.primaryFill
    ...
    private func bulkActionButton(
        ...
        configuration.baseForegroundColor = .ZonaRosa.label
