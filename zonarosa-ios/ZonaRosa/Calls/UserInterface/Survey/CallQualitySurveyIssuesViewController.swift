...
final class CallQualitySurveyIssuesViewController: CallQualitySurveySheetViewController {
    ...
    override func viewDidLoad() {
        ...
        headerLabel.textColor = .ZonaRosa.secondaryLabel
    ...
    private func customIssueButtonConfig(customText: String?) -> UIButton.Configuration {
        ...
        config.baseBackgroundColor = .ZonaRosa.secondaryGroupedBackground

        if let customText {
            config.title = customText
            config.baseForegroundColor = .ZonaRosa.label
        } else {
            config.title = CallQualitySurveyCustomIssueViewController.placeholderText
            config.baseForegroundColor = .ZonaRosa.secondaryLabel
        }
...
private final class CapsuleCell: UICollectionViewCell {
    ...
    private func updateAppearance() {
        ...
        if isHighlighted {
            ...
            contentView.backgroundColor = .ZonaRosa.accent
            titleLabel.textColor = .white
            iconView.tintColor = .white
        } else {
            contentView.backgroundColor = .ZonaRosa.secondaryGroupedBackground
            titleLabel.textColor = .ZonaRosa.label
            iconView.tintColor = .ZonaRosa.label
        }
    }
