...
final class CallKitCallUIAdaptee: NSObject, CallUIAdaptee, @preconcurrency CXProviderDelegate {
    ...
    class func buildProviderConfiguration(useSystemCallLog: Bool) -> CXProviderConfiguration {
        ...
        let iconMaskImage = #imageLiteral(resourceName: "zonarosa-logo-128")
    ...
    private func localizedCallerNameWithSneakyTransaction(for call: ZonaRosaCall) -> String {
        switch call.mode {
    ...
    @MainActor
    private func endCallOnceReported(_ call: ZonaRosaCall, reason: CXCallEndedReason) {
    ...
    func provider(_ provider: CXProvider, perform action: CXEndCallAction) {
        ...
        // ZonaRosa to the system that the action has been successfully performed.
        action.fulfill()
