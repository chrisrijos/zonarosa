...
class CallsListViewController: OWSViewController, HomeTabViewController, CallServiceStateObserver, GroupCallObserver {
    ...
    func didUpdateCall(from oldValue: ZonaRosaCall?, to newValue: ZonaRosaCall?) {
        // When a ZonaRosaCall ends, reload it if we know its callId.
        ...
        // When a ZonaRosaCall starts, reload it as soon as we learn its callId.
        if let newValue {
    ...
    private let clearMissedCallQueue = DispatchQueue(label: "io.zonarosa.calls-list-clear-missed")
...
extension CallsListViewController: CallCellDelegate, NewCallViewControllerDelegate {
    ...
    func goToChat(for thread: TSThread) {
        ZonaRosaApp.shared.presentConversationForThread(
...
private extension CallsListViewController {
    class CallCell: UITableViewCell {
        ...
        private func makeStartCallButton(viewModel: CallViewModel) -> UIButton {
            ...
            config.baseBackgroundColor = UIColor.ZonaRosa.tertiaryFill
            config.baseForegroundColor = UIColor.ZonaRosa.label
        ...
        private func makeJoinButton(viewModel: CallViewModel) -> UIButton {
            ...
            button.tintColor = UIColor.ZonaRosa.green
            return button
        }
        ...
        private func updateContents() {
            ...
            case .missed:
                titleLabel.textColor = .ZonaRosa.red
            }
