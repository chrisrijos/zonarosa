...
class EmojiPickerSectionToolbar: UIView, UICollectionViewDelegate {
    ...
    private class EmojiSectionCellContentView: UIView, UIContentView {
        ...
        init(configuration: EmojiSectionCellContentViewConfiguration) {
            ...
            backgroundView.backgroundColor = UIColor.ZonaRosa.secondaryFill
        ...
        private func configure() {
            ...
            if #available(iOS 26, *) {
                imageView.tintColor = UIColor.ZonaRosa.label
            } else {
                imageView.tintColor = UIColor.ZonaRosa.secondaryLabel
            }
        }
    }
    ...
    init(
        ...
        if !backgroundConfigured {
            ...
            if UIAccessibility.isReduceTransparencyEnabled {
                ...
                backgroundView.backgroundColor = UIColor.ZonaRosa.background
                addSubview(backgroundView)
