...
class ProvisioningPrepViewController: ProvisioningBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let dontHaveZonaRosaButton = UIButton(
            ...
            primaryAction: UIAction { [weak self] _ in
                self?.didTapNoZonaRosaApp()
            },
        )
        dontHaveZonaRosaButton.enableMultilineLabel()
        dontHaveZonaRosaButton.accessibilityIdentifier = "onboarding.prelink.explanationLabel"
        dontHaveZonaRosaButton.isHidden = isTransferring
        ...
        let stackView = addStaticContentStackView(arrangedSubviews: [
            ...
            bottomSpacer,
            [dontHaveZonaRosaButton, nextButton].enclosedInVerticalStackView(isFullWidthButtons: true),
        ])
