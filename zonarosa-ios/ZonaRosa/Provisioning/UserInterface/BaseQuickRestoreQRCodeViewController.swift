...
private struct TutorialStack: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            Label(
                OWSLocalizedString(
                    "REGISTRATION_SCAN_QR_CODE_TUTORIAL_OPEN_ZONAROSA",
                    comment: "Tutorial text describing the first step to scanning the restore/transfer QR code with your old phone: opening ZonaRosa",
                ),
                image: "device-phone",
            )
            .fixedSize(horizontal: false, vertical: true)
...
#Preview {
    ...
    let url1 = URL(string: "https://zonarosa.io")!
    let url2 = URL(string: "https://support.zonarosa.io")!
