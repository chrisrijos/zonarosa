...
class ProvisioningCoordinatorImpl: ProvisioningCoordinator {
    ...
    private let zonarosaProtocolStoreManager: ZonaRosaProtocolStoreManager
    private let zonarosaService: OWSZonaRosaServiceProtocol
    ...
    init(
        ...
        self.zonarosaProtocolStoreManager = zonarosaProtocolStoreManager
    ...
    private func completeProvisioning_updateCensorshipCircumvention(
        ...
        zonarosaService.updateHasCensoredPhoneNumberDuringProvisioning(phoneNumber)
        ...
        return try await completeProvisioning_createPrekeys(
            ...
            self.zonarosaService.resetHasCensoredPhoneNumberFromProvisioning()
        }
    }
    ...
    private func completeProvisioning_finalizePrekeys(
        ...
        return CompleteProvisioningStepResult(
            ...
            undoBlock: {
                await self.db.awaitableWrite { tx in
                    self.zonarosaProtocolStoreManager.removeAllKeys(tx: tx)
                }
            },
        )
    }
    ...
    private func verifyAndLinkOnServer(
        ...
        let rawVerifyDeviceResponse = await Self.Service.makeVerifySecondaryDeviceRequest(
            ...
            apnRegistrationId: apnRegistrationId,
            prekeyBundles: prekeyBundles,
            zonarosaService: self.zonarosaService,
        )
