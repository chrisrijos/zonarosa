...
to be done by ZonaRosa-iOS maintainers.
...
Some ZonaRosa Pods have prebuilt artifacts that need a checksum to be downloaded as part of the build.
These are provided by the CallingCore team.

## Translations

Read more about translations in [TRANSLATIONS.md](ZonaRosa/translations/TRANSLATIONS.md)
