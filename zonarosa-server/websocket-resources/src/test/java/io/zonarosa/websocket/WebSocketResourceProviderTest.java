...
class WebSocketResourceProviderTest {
  ...
  private static final String REMOTE_ADDRESS_PROPERTY_NAME = "io.zonarosa.weboscket.test.remoteAddress";
  ...
  void testShouldIncludeUpgradeRequestHeader() {
    ...
    assertThat(WebSocketResourceProvider.shouldIncludeUpgradeRequestHeader("X-ZonaRosa-Receive-Stories")).isTrue();
  }
  ...
  void testShouldIncludeRequestMessageHeader() {
    ...
    assertThat(WebSocketResourceProvider.shouldIncludeRequestMessageHeader("X-ZonaRosa-Receive-Stories")).isTrue();
  }
