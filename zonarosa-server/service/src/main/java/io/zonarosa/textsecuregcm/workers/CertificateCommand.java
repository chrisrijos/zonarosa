...
public class CertificateCommand extends Command {
  ...
  private static final Set<Integer> RESERVED_CERTIFICATE_IDS = Set.of(
    // Reserved for testing in libzonarosa.
  ...
  private void runCertificateCommand(Namespace namespace) throws InvalidKeyException, io.zonarosa.libzonarosa.protocol.InvalidKeyException {
