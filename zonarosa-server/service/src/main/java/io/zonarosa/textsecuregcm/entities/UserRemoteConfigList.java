...
import io.zonarosa.server.util.InstantAdapter;
...
public class UserRemoteConfigList {
  ...
  @Schema(description = """
    Timestamp when the configuration was generated. Deprecated in favor of `X-ZonaRosa-Timestamp` response header.
    """, deprecated = true)
  @Deprecated
