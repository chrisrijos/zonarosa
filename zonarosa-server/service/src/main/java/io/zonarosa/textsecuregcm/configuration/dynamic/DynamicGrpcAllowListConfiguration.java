...
///                        `io.zonarosa.chat.account.AccountsAnonymous` would enable all RPCs on that service, regardless
...
///                        `io.zonarosa.chat.account.AccountsAnonymous/LookupUsernameHash` would enable the
