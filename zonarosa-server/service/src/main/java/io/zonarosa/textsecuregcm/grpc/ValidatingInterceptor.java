...
import io.zonarosa.server.grpc.validators.E164FieldValidator;
import io.zonarosa.server.grpc.validators.EnumSpecifiedFieldValidator;
import io.zonarosa.server.grpc.validators.ExactlySizeFieldValidator;
import io.zonarosa.server.grpc.validators.FieldValidationException;
import io.zonarosa.server.grpc.validators.FieldValidator;
import io.zonarosa.server.grpc.validators.NonEmptyFieldValidator;
import io.zonarosa.server.grpc.validators.PresentFieldValidator;
import io.zonarosa.server.grpc.validators.RangeFieldValidator;
import io.zonarosa.server.grpc.validators.SizeFieldValidator;
...
public class ValidatingInterceptor implements ServerInterceptor {
  ...
  private final Map<String, FieldValidator> fieldValidators = Map.of(
      "io.zonarosa.chat.require.nonEmpty", new NonEmptyFieldValidator(),
      "io.zonarosa.chat.require.present", new PresentFieldValidator(),
      "io.zonarosa.chat.require.specified", new EnumSpecifiedFieldValidator(),
      "io.zonarosa.chat.require.e164", new E164FieldValidator(),
      "io.zonarosa.chat.require.exactlySize", new ExactlySizeFieldValidator(),
      "io.zonarosa.chat.require.range", new RangeFieldValidator(),
      "io.zonarosa.chat.require.size", new SizeFieldValidator()
  );
