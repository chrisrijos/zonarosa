 ...
 * an existing ZonaRosa account to a new device. To send a provisioning message, a primary device generally scans a QR
 ...
 *
 * @see io.zonarosa.server.websocket.ProvisioningConnectListener
 */
