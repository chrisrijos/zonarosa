...
public final class HeaderUtils {
  ...
  public static final String X_ZONAROSA_AGENT = "X-ZonaRosa-Agent";

  public static final String X_ZONAROSA_KEY = "X-ZonaRosa-Key";

  public static final String TIMESTAMP_HEADER = "X-ZonaRosa-Timestamp";
