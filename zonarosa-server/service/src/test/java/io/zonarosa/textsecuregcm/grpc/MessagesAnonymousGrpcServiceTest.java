...
import io.zonarosa.chat.messages.ChallengeRequired;
import io.zonarosa.chat.messages.IndividualRecipientMessageBundle;
import io.zonarosa.chat.messages.MessagesAnonymousGrpc;
import io.zonarosa.chat.messages.MismatchedDevices;
import io.zonarosa.chat.messages.MultiRecipientMessage;
import io.zonarosa.chat.messages.MultiRecipientMismatchedDevices;
import io.zonarosa.chat.messages.MultiRecipientSuccess;
import io.zonarosa.chat.messages.SendMessageResponse;
import io.zonarosa.chat.messages.SendMultiRecipientMessageRequest;
import io.zonarosa.chat.messages.SendMultiRecipientMessageResponse;
import io.zonarosa.chat.messages.SendMultiRecipientStoryRequest;
import io.zonarosa.chat.messages.SendSealedSenderMessageRequest;
import io.zonarosa.chat.messages.SendStoryMessageRequest;
...
import io.zonarosa.server.tests.util.MultiRecipientMessageHelper;
import io.zonarosa.server.tests.util.TestRecipient;
...
class MessagesAnonymousGrpcServiceTest extends
  ...
  class SingleRecipient {
    ...
    void mismatchedDevices() throws MessageTooLargeException, MismatchedDevicesException {
      ...
      doThrow(new MismatchedDevicesException(new io.zonarosa.server.controllers.MismatchedDevices(
  ...
  class MultiRecipient {
    ...
    void mismatchedDevices() throws MessageTooLargeException, MultiRecipientMismatchedDevicesException {
      ...
      doThrow(new MultiRecipientMismatchedDevicesException(Map.of(serviceIdentifier,
          new io.zonarosa.server.controllers.MismatchedDevices(
              Set.of(missingDeviceId), Set.of(extraDeviceId), Set.of(staleDeviceId)))))
