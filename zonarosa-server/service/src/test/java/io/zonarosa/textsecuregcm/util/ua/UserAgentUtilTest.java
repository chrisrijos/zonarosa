...
class UserAgentUtilTest {
  ...
  private static Stream<Arguments> argumentsForTestParseStandardUserAgentString() {
    return Stream.of(
        ...
        Arguments.of("ZonaRosa-Android/4.68.3 Android/25",
            new UserAgent(ClientPlatform.ANDROID, new Semver("4.68.3"), "Android/25")),
        Arguments.of("ZonaRosa-Android/4.68.3", new UserAgent(ClientPlatform.ANDROID, new Semver("4.68.3"), null)),
        Arguments.of("ZonaRosa-Desktop/1.2.3 Linux", new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), "Linux")),
        Arguments.of("ZonaRosa-Desktop/1.2.3 macOS", new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), "macOS")),
        Arguments.of("ZonaRosa-Desktop/1.2.3 Windows",
            new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), "Windows")),
        Arguments.of("ZonaRosa-Desktop/1.2.3", new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), null)),
        Arguments.of("ZonaRosa-Desktop/1.32.0-beta.3",
            new UserAgent(ClientPlatform.DESKTOP, new Semver("1.32.0-beta.3"), null)),
        Arguments.of("ZonaRosa-iOS/3.9.0 (iPhone; iOS 12.2; Scale/3.00)",
            new UserAgent(ClientPlatform.IOS, new Semver("3.9.0"), "(iPhone; iOS 12.2; Scale/3.00)")),
        Arguments.of("ZonaRosa-iOS/3.9.0 iOS/14.2", new UserAgent(ClientPlatform.IOS, new Semver("3.9.0"), "iOS/14.2")),
        Arguments.of("ZonaRosa-iOS/3.9.0", new UserAgent(ClientPlatform.IOS, new Semver("3.9.0"), null)),
        Arguments.of("ZonaRosa-Android/7.11.23-nightly-1982-06-28-07-07-07 tonic/0.31",
            new UserAgent(ClientPlatform.ANDROID, new Semver("7.11.23-nightly-1982-06-28-07-07-07"), "tonic/0.31")),
        Arguments.of("ZonaRosa-Android/7.11.23-nightly-1982-06-28-07-07-07 Android/42 tonic/0.31",
            new UserAgent(ClientPlatform.ANDROID, new Semver("7.11.23-nightly-1982-06-28-07-07-07"), "Android/42 tonic/0.31")),
        Arguments.of("ZonaRosa-Android/7.6.2 Android/34 libzonarosa/0.46.0",
            new UserAgent(ClientPlatform.ANDROID, new Semver("7.6.2"), "Android/34 libzonarosa/0.46.0")));
  }
}
