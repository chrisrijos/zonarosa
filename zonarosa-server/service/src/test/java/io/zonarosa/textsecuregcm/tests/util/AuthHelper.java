...
import io.zonarosa.libzonarosa.zkgroup.groupsend.GroupSendEndorsementsResponse.ReceivedEndorsements;
...
public class AuthHelper {
  ...
  public static byte[] validGroupSendToken(ServerSecretParams serverSecretParams, List<ServiceIdentifier> recipients, Instant expiration) throws Exception {
    ...
    List<ServiceId> groupPlaintexts = Stream.concat(Stream.of(sender), recipients.stream().map(ServiceIdentifier::toLibzonarosa)).toList();
