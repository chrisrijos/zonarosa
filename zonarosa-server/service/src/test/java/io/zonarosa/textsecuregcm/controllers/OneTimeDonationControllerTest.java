...
class OneTimeDonationControllerTest extends AbstractV1SubscriptionControllerTest {
  ...
  void setUp() {
    ...
    when(PAYPAL_ONE_TIME_DONATION_LINE_ITEM_TRANSLATOR.translate(any(), any())).thenReturn("Donation to ZonaRosa Technology Foundation");
