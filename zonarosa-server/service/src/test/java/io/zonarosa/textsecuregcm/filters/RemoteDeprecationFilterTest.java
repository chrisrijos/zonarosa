...
import io.zonarosa.server.configuration.dynamic.DynamicRemoteDeprecationConfiguration;
import io.zonarosa.server.grpc.EchoServiceImpl;
import io.zonarosa.server.grpc.GrpcExceptions;
import io.zonarosa.server.grpc.MockRequestAttributesInterceptor;
import io.zonarosa.server.grpc.RequestAttributes;
...
class RemoteDeprecationFilterTest {
  ...
  void testEmptyMap() throws IOException, ServletException {
    ...
    when(servletRequest.getHeader("UserAgent")).thenReturn("ZonaRosa-Android/4.68.3");
  ...
  private static Stream<Arguments> testFilter() {
    return Stream.of(
        ...
        Arguments.of("ZonaRosa-Android/4.68.3", false),
        Arguments.of("ZonaRosa-iOS/3.9.0", false),
        Arguments.of("ZonaRosa-Desktop/1.2.3", false),
        Arguments.of("ZonaRosa-Android/0.68.3", true),
        Arguments.of("ZonaRosa-iOS/0.9.0", true),
        Arguments.of("ZonaRosa-Desktop/0.2.3", true),
        Arguments.of("ZonaRosa-Desktop/8.0.0-beta.2", true),
        Arguments.of("ZonaRosa-Desktop/8.0.0-beta.1", false),
        Arguments.of("ZonaRosa-iOS/8.0.0-beta.2", false));
  }
