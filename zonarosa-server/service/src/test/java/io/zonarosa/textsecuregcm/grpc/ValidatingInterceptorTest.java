...
import io.zonarosa.chat.rpc.Color;
import io.zonarosa.chat.rpc.NestedMessage;
import io.zonarosa.chat.rpc.ReactorAnonymousServiceGrpc;
import io.zonarosa.chat.rpc.ReactorAuthServiceGrpc;
import io.zonarosa.chat.rpc.ReactorValidationTestServiceGrpc;
import io.zonarosa.chat.rpc.RecursiveMessage;
import io.zonarosa.chat.rpc.ValidationTestServiceGrpc;
import io.zonarosa.chat.rpc.ValidationsRequest;
import io.zonarosa.chat.rpc.ValidationsResponse;
import io.zonarosa.server.grpc.validators.ValidatorUtils;
...
public class ValidatingInterceptorTest {
  ...
  public void testServiceExtensionValueExtraction() throws Exception {
    ...
    assertEquals(Map.of(
        "io.zonarosa.chat.rpc.ValidationTestService", Optional.empty(),
        "io.zonarosa.chat.rpc.AuthService", Optional.of(Auth.AUTH_ONLY_AUTHENTICATED),
        "io.zonarosa.chat.rpc.AnonymousService", Optional.of(Auth.AUTH_ONLY_ANONYMOUS)
    ), authValues);
  }
