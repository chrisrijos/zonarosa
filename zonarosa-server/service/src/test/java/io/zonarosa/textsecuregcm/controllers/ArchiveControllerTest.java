...
public class ArchiveControllerTest {
  ...
  public void anonymousAuthOnly(final String method, final String path, final String body)
    ...
    final Invocation.Builder request = resources.getJerseyTest()
        ...
        .header("X-ZonaRosa-ZK-Auth", Base64.getEncoder().encodeToString(presentation.serialize()))
        .header("X-ZonaRosa-ZK-Auth-Signature",
  ...
  public void setBadPublicKey() throws VerificationFailedException {
    ...
    final Response response = resources.getJerseyTest()
        ...
        .request()
        .header("X-ZonaRosa-ZK-Auth", Base64.getEncoder().encodeToString(presentation.serialize()))
        .header("X-ZonaRosa-ZK-Auth-Signature", "aaa")
        .put(Entity.entity("""
  ...
  public void getCredentials() throws BackupNotFoundException {
    ...
    expectedCredentialsByType.forEach((libzonarosaCredentialType, expectedCredentials) -> {
      final ArchiveController.BackupAuthCredentialsResponse.CredentialType credentialType =
          ArchiveController.BackupAuthCredentialsResponse.CredentialType.fromLibzonarosaType(libzonarosaCredentialType);
