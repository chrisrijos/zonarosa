...
type NativeFunctions = {
  ...
  ZonaRosaMessage_Deserialize: (data: Uint8Array) => ZonaRosaMessage;
  ZonaRosaMessage_GetBody: (obj: Wrapper<ZonaRosaMessage>) => Uint8Array;
  ZonaRosaMessage_GetSerialized: (obj: Wrapper<ZonaRosaMessage>) => Uint8Array;
  ZonaRosaMessage_GetCounter: (obj: Wrapper<ZonaRosaMessage>) => number;
  ZonaRosaMessage_GetMessageVersion: (obj: Wrapper<ZonaRosaMessage>) => number;
  ZonaRosaMessage_GetPqRatchet: (msg: Wrapper<ZonaRosaMessage>) => Uint8Array;
  ZonaRosaMessage_New: (messageVersion: number, macKey: Uint8Array, senderRatchetKey: Wrapper<PublicKey>, counter: number, previousCounter: number, ciphertext: Uint8Array, senderIdentityKey: Wrapper<PublicKey>, receiverIdentityKey: Wrapper<PublicKey>, pqRatchet: Uint8Array) => ZonaRosaMessage;
  ZonaRosaMessage_VerifyMac: (msg: Wrapper<ZonaRosaMessage>, senderIdentityKey: Wrapper<PublicKey>, receiverIdentityKey: Wrapper<PublicKey>, macKey: Uint8Array) => boolean;
  PreKeyZonaRosaMessage_New: (messageVersion: number, registrationId: number, preKeyId: number | null, signedPreKeyId: number, baseKey: Wrapper<PublicKey>, identityKey: Wrapper<PublicKey>, zonarosaMessage: Wrapper<ZonaRosaMessage>) => PreKeyZonaRosaMessage;
  PreKeyZonaRosaMessage_Deserialize: (data: Uint8Array) => PreKeyZonaRosaMessage;
  PreKeyZonaRosaMessage_Serialize: (obj: Wrapper<PreKeyZonaRosaMessage>) => Uint8Array;
  PreKeyZonaRosaMessage_GetRegistrationId: (obj: Wrapper<PreKeyZonaRosaMessage>) => number;
  PreKeyZonaRosaMessage_GetSignedPreKeyId: (obj: Wrapper<PreKeyZonaRosaMessage>) => number;
  PreKeyZonaRosaMessage_GetPreKeyId: (obj: Wrapper<PreKeyZonaRosaMessage>) => number | null;
  PreKeyZonaRosaMessage_GetVersion: (obj: Wrapper<PreKeyZonaRosaMessage>) => number;
  ...
  SessionCipher_DecryptZonaRosaMessage: (message: Wrapper<ZonaRosaMessage>, protocolAddress: Wrapper<ProtocolAddress>, sessionStore: SessionStore, identityKeyStore: IdentityKeyStore) => Promise<Uint8Array>;
  SessionCipher_DecryptPreKeyZonaRosaMessage: (message: Wrapper<PreKeyZonaRosaMessage>, protocolAddress: Wrapper<ProtocolAddress>, sessionStore: SessionStore, identityKeyStore: IdentityKeyStore, prekeyStore: PreKeyStore, signedPrekeyStore: SignedPreKeyStore, kyberPrekeyStore: KyberPreKeyStore) => Promise<Uint8Array>;
  ...
  ZonaRosaMedia_CheckAvailable: () => void;
...
const { registerErrors, 
  ...
  ZonaRosaMessage_Deserialize,
  ZonaRosaMessage_GetBody,
  ZonaRosaMessage_GetSerialized,
  ZonaRosaMessage_GetCounter,
  ZonaRosaMessage_GetMessageVersion,
  ZonaRosaMessage_GetPqRatchet,
  ZonaRosaMessage_New,
  ZonaRosaMessage_VerifyMac,
  PreKeyZonaRosaMessage_New,
  PreKeyZonaRosaMessage_Deserialize,
  PreKeyZonaRosaMessage_Serialize,
  PreKeyZonaRosaMessage_GetRegistrationId,
  PreKeyZonaRosaMessage_GetSignedPreKeyId,
  PreKeyZonaRosaMessage_GetPreKeyId,
  PreKeyZonaRosaMessage_GetVersion,
  ...
  SessionCipher_DecryptZonaRosaMessage,
  SessionCipher_DecryptPreKeyZonaRosaMessage,
...
export interface PreKeyZonaRosaMessage { readonly __type: unique symbol; }
...
export interface ZonaRosaMessage { readonly __type: unique symbol; }
