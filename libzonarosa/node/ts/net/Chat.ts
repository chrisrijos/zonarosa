...
import { LibZonaRosaError } from '../Errors.js';
...
export interface ConnectionEventsListener {
   ...
   * will be provided.
   */
  onConnectionInterrupted: (cause: LibZonaRosaError | null) => void;
}
  ...
  private static makeNativeProvisioningListener(
    ...
    return {
      ...
      connectionInterrupted(cause: Error | null): void {
        listener.onConnectionInterrupted(cause as LibZonaRosaError | null);
      },
    };
  }
...
function makeNativeChatListener(
  ...
  return {
    ...
    connectionInterrupted(cause: Error | null): void {
      listener.onConnectionInterrupted(cause as LibZonaRosaError);
    },
  };
}
