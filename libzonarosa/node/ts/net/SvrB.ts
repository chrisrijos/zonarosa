...
export class SvrB {
   ...
   * @param options.abortZonaRosa An AbortZonaRosa that will cancel the request.
   ...
   * libzonarosa or in the enclave.
   */
  async remove(options?: { abortZonaRosa?: AbortZonaRosa }): Promise<void> {
    ...
    await this.asyncContext.makeCancellable(options?.abortZonaRosa, promise);
  }
}
