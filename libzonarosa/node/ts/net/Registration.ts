...
import { LibZonaRosaError, RateLimitedError } from '../Errors.js';
...
/**
 * A client for the ZonaRosa registration service.
 *
...
export class RegistrationService {
   ...
   * resumption is successful, otherwise a {@link LibZonaRosaError}.
   */
   ...
   * "quality weighting" can be left out; the ZonaRosa server will always consider the list to be in
   * priority order.
   */
