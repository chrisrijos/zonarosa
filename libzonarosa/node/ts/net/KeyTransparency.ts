 ...
 *
 * abortZonaRosa, if present, can be used to cancel long-running network IO.
 */
export type Options = { abortZonaRosa?: AbortZonaRosa };
...
export class ClientImpl implements Client {
  ...
  private async updateDistinguished(
    store: Store,
    { abortZonaRosa }: Readonly<Options>
  ): Promise<Uint8Array> {
