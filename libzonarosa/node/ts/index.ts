...
export class ZonaRosaMessage {
  readonly _nativeHandle: Native.ZonaRosaMessage;

  private constructor(handle: Native.ZonaRosaMessage) {
    this._nativeHandle = handle;
  }
  ...
  static _new(
    ...
    return new ZonaRosaMessage(
      Native.ZonaRosaMessage_New(
        messageVersion,
        macKey,
        senderRatchetKey,
        counter,
  ...
  static deserialize(buffer: Uint8Array): ZonaRosaMessage {
    return new ZonaRosaMessage(Native.ZonaRosaMessage_Deserialize(buffer));
  }

  body(): Uint8Array {
    return Native.ZonaRosaMessage_GetBody(this);
  }

  pqRatchet(): Uint8Array {
    return Native.ZonaRosaMessage_GetPqRatchet(this);
  }

  counter(): number {
    return Native.ZonaRosaMessage_GetCounter(this);
  }

  messageVersion(): number {
    return Native.ZonaRosaMessage_GetMessageVersion(this);
  }

  serialize(): Uint8Array {
    return Native.ZonaRosaMessage_GetSerialized(this);
  }
  ...
  verifyMac(
    ...
    return Native.ZonaRosaMessage_VerifyMac(
      this,
      senderIdentityKey,
      recevierIdentityKey,
      macKey
...
export class PreKeyZonaRosaMessage {
  readonly _nativeHandle: Native.PreKeyZonaRosaMessage;

  private constructor(handle: Native.PreKeyZonaRosaMessage) {
    this._nativeHandle = handle;
  }
  ...
  ): PreKeyZonaRosaMessage {
    return new PreKeyZonaRosaMessage(
      Native.PreKeyZonaRosaMessage_New(
        messageVersion,
        registrationId,
        preKeyId,
        signedPreKeyId,
  ...
  static deserialize(buffer: Uint8Array): PreKeyZonaRosaMessage {
    return new PreKeyZonaRosaMessage(
      Native.PreKeyZonaRosaMessage_Deserialize(buffer)
    );
  }

  preKeyId(): number | null {
    return Native.PreKeyZonaRosaMessage_GetPreKeyId(this);
  }

  registrationId(): number {
    return Native.PreKeyZonaRosaMessage_GetRegistrationId(this);
  }

  signedPreKeyId(): number {
    return Native.PreKeyZonaRosaMessage_GetSignedPreKeyId(this);
  }

  version(): number {
    return Native.PreKeyZonaRosaMessage_GetVersion(this);
  }

  serialize(): Uint8Array {
    return Native.PreKeyZonaRosaMessage_Serialize(this);
  }
}
...
export async function zonarosaEncrypt(
  message: Uint8Array,
  address: ProtocolAddress,
  sessionStore: SessionStore,
  identityStore: IdentityKeyStore,
...
export function zonarosaDecrypt(
  message: ZonaRosaMessage,
  address: ProtocolAddress,
  sessionStore: SessionStore,
  identityStore: IdentityKeyStore
): Promise<Uint8Array> {
  return Native.SessionCipher_DecryptZonaRosaMessage(
    message,
    address,
    sessionStore,
    identityStore
...
export function zonarosaDecryptPreKey(
  ...
  return Native.SessionCipher_DecryptPreKeyZonaRosaMessage(
    message,
    address,
    sessionStore,
    identityStore,
...
export async function sealedSenderEncryptMessage(
  ...
  const ciphertext = await zonarosaEncrypt(
    message,
    address,
    sessionStore,
    identityStore
