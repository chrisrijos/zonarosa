...
public class FutureTest {
  ...
  public void testFutureThrowsUnloadedException() throws Exception {
    ...
    ExecutionException e = assertThrows(ExecutionException.class, () -> future.get());
    assertTrue(e.getCause() instanceof io.zonarosa.libzonarosa.internal.TestingException);
  }
  ...
  public void testFutureThrowsInvalidException() throws Exception {
    ...
    assertTrue(
        ...
        e.getCause()
            .getMessage()
            .startsWith(
                "failed to convert error \"TestingError(io.zonarosa.libzonarosa.internal.GuaranteedNonexistentException)\": "
                    + "exception in method call 'io.zonarosa.libzonarosa.internal.GuaranteedNonexistentException': exception "));
  }

  @Test
  public void testFutureFromRustCancel() {
    TokioAsyncContext context = new TokioAsyncContext();
    io.zonarosa.libzonarosa.internal.CompletableFuture<Integer> testFuture =
        context
            .guardedMap(
                (nativeContextHandle) ->
  ...
  public void testFutureOnlyCompletesByCancellation() throws Exception {
    ...
    io.zonarosa.libzonarosa.internal.CompletableFuture<Void> testFuture =
        context
            .guardedMap(
                (nativeContextHandle) ->
                    counter.guardedMap(
