  ...
  public class Enforcement {
    public companion object {
      ...
      public fun checkConstructor(constructor: Constructor<*>) {
        ...
        // conservative subset of the retention rules in `libzonarosa.pro`.
        ...
        // Special-case kotlin.Pair; we mention its constructor manually in libzonarosa.pro.
        ...
        // Special-case constructors of libzonarosa exception types. These are
        // kept even without annotations!
        if (declaringClass.getPackage()?.name?.startsWith("io.zonarosa.libzonarosa") == true &&
      ...
      public fun checkCalledMethod(method: Method) {
        ...
        // retention rules in `libzonarosa.pro`.
