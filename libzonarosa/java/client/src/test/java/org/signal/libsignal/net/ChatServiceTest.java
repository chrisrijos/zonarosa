...
import io.zonarosa.libzonarosa.util.Base64;
...
public class ChatServiceTest {
  ...
  public void testInvalidProxyRejected() throws Exception {
    ...
    check.accept(() -> net.setProxy("zonarosafoundation.org", 0));
    check.accept(() -> net.setProxy("zonarosafoundation.org", 100_000));
    check.accept(() -> net.setProxy("zonarosafoundation.org", -1));

    check.accept(() -> net.setProxy("socks+shoes", "zonarosafoundation.org", null, null, null));
