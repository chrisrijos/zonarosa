...
class SecureValueRecoveryBackupTest {
  ...
  fun setUp() {
    ...
    val authSecret = System.getenv("LIBZONAROSA_TESTING_SVRB_ENCLAVE_SECRET")
    if (authSecret != null) {
      ...
      testUsername = System.getenv("LIBZONAROSA_TESTING_SVRB_USERNAME") ?: ""
      testPassword = System.getenv("LIBZONAROSA_TESTING_SVRB_PASSWORD") ?: ""
    }
  ...
  private fun checkNonHermetic() {
    val enableTest = TestEnvironment.get("LIBZONAROSA_TESTING_RUN_NONHERMETIC_TESTS")
