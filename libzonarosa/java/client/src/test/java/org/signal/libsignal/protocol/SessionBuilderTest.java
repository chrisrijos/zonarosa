...
public class SessionBuilderTest {
  static final ZonaRosaProtocolAddress ALICE_ADDRESS =
      filterExceptions(() -> new ZonaRosaProtocolAddress("+14151111111", 1));
  static final ZonaRosaProtocolAddress BOB_ADDRESS =
      filterExceptions(() -> new ZonaRosaProtocolAddress("+14152222222", 1));
  static final ZonaRosaProtocolAddress MALLORY_ADDRESS =
      filterExceptions(() -> new ZonaRosaProtocolAddress("+14153333333", 1));
  ...
  public static class Versioned {
    ...
    Pair<ZonaRosaProtocolStore, ZonaRosaProtocolStore> initializeSessions() {
      try {
        ...
        PreKeyZonaRosaMessage incomingMessage = new PreKeyZonaRosaMessage(outgoingMessage.serialize());
        ...
        byte[] alicePlaintext =
            aliceSessionCipher.decrypt(new ZonaRosaMessage(bobOutgoingMessage.serialize()));
    ...
    public void testBasicPreKey()
      ...
      ZonaRosaProtocolStore aliceStore = stores.getFirst();
      ZonaRosaProtocolStore bobStore = stores.getSecond();

      runInteraction(aliceStore, bobStore);

      aliceStore = new TestInMemoryZonaRosaProtocolStore();
      ...
      try {
        bobSessionCipher.decrypt(new PreKeyZonaRosaMessage(outgoingMessage.serialize()));
        fail("shouldn't be trusted!");
      } catch (UntrustedIdentityException uie) {
        bobStore.saveIdentity(
            ALICE_ADDRESS, new PreKeyZonaRosaMessage(outgoingMessage.serialize()).getIdentityKey());
      }
    ...
    public void testRepeatBundleMessage()
      ...
      PreKeyZonaRosaMessage incomingMessage = new PreKeyZonaRosaMessage(outgoingMessageOne.serialize());
      ...
      PreKeyZonaRosaMessage incomingMessageTwo =
          new PreKeyZonaRosaMessage(outgoingMessageTwo.serialize());

      plaintext = bobSessionCipher.decrypt(new PreKeyZonaRosaMessage(incomingMessageTwo.serialize()));
      assertTrue(originalMessage.equals(new String(plaintext)));
    ...
    public void testExpiresUnacknowledgedSessions()
      ...
      final ZonaRosaProtocolStore bobStore = new TestInMemoryZonaRosaProtocolStore();
  ...
  public static class VersionAgnostic {
    ...
    public void testBadMessageBundle()
      ...
      PreKeyZonaRosaMessage incomingMessage = new PreKeyZonaRosaMessage(badMessage);
      SessionCipher bobSessionCipher = new SessionCipher(bobStore, ALICE_ADDRESS);
      ...
      plaintext = bobSessionCipher.decrypt(new PreKeyZonaRosaMessage(goodMessage));
    ...
    public void testBadSignedPreKeyStore()
        throws InvalidKeyException,
            ...
            LegacyMessageException,
            NoSessionException {
      ZonaRosaProtocolStore aliceStore = new TestNoSignedPreKeysStore();
      SessionBuilder aliceSessionBuilder = new SessionBuilder(aliceStore, BOB_ADDRESS);

      ZonaRosaProtocolStore bobStore = new TestNoSignedPreKeysStore();
      BundleFactory bundleFactory = new PQXDHBundleFactory();
      PreKeyBundle bobPreKey = bundleFactory.createBundle(bobStore);
    ...
    public void testBadSignedPreKeyStoreError()
        throws InvalidKeyException,
            ...
            LegacyMessageException,
            NoSessionException {
      ZonaRosaProtocolStore aliceStore = new TestBadSignedPreKeysStore();
      SessionBuilder aliceSessionBuilder = new SessionBuilder(aliceStore, BOB_ADDRESS);

      ZonaRosaProtocolStore bobStore = new TestBadSignedPreKeysStore();
      BundleFactory bundleFactory = new PQXDHBundleFactory();
      PreKeyBundle bobPreKey = bundleFactory.createBundle(bobStore);
      ...
      try {
        ...
        fail("libzonarosa swallowed the exception");
  ...
  private static void runInteraction(ZonaRosaProtocolStore aliceStore, ZonaRosaProtocolStore bobStore)
    ...
    byte[] plaintext = bobSessionCipher.decrypt(new ZonaRosaMessage(aliceMessage.serialize()));
    assertTrue(new String(plaintext).equals(originalMessage));
    ...
    plaintext = aliceSessionCipher.decrypt(new ZonaRosaMessage(bobMessage.serialize()));
    assertTrue(new String(plaintext).equals(originalMessage));
    ...
    for (int i = 0; i < 10; i++) {
      ...
      byte[] loopingPlaintext =
          bobSessionCipher.decrypt(new ZonaRosaMessage(aliceLoopingMessage.serialize()));
    ...
    for (int i = 0; i < 10; i++) {
      ...
      byte[] loopingPlaintext =
          aliceSessionCipher.decrypt(new ZonaRosaMessage(bobLoopingMessage.serialize()));
      assertTrue(new String(loopingPlaintext).equals(loopingMessage));
    }
    ...
    for (Pair<String, CiphertextMessage> aliceOutOfOrderMessage : aliceOutOfOrderMessages) {
      byte[] outOfOrderPlaintext =
          bobSessionCipher.decrypt(
              new ZonaRosaMessage(aliceOutOfOrderMessage.getSecond().serialize()));
