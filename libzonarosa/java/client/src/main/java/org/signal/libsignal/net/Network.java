...
import io.zonarosa.libzonarosa.internal.BridgedStringMap;
...
public class Network {
  ...
  /**
   * The "scheme" for ZonaRosa TLS proxies. See {@link #setProxy(String, String, Integer, String,
   * String)}.
   */
  public static final String ZONAROSA_TLS_PROXY_SCHEME = "io.zonarosa.tls";
   ...
   *
   * <p>To specify a ZonaRosa transparent TLS proxy, use {@link ZONAROSA_TLS_PROXY_SCHEME}, or the
   ...
   *     that scheme (e.g. ZonaRosa TLS proxies don't support authentication)
   */
   ...
   *
   * <p>Sets a domain name and port to be used to proxy all new outgoing connections, using a ZonaRosa
  ...
  public void setProxy(String host, int port) throws IOException {
    ...
    this.connectionManager.setProxy(ZONAROSA_TLS_PROXY_SCHEME, host, port, username, null);
  }
   ...
   * ZonaRosa servers. Existing connections and services will continue with the setting they were
  ...
  /**
   * Updates libzonarosa's remote configuration settings with the specified build variant.
   *
   ...
   *       enabled.
   *   <li>Keys must have had the platform-specific prefix (e.g., "android.libzonarosa.") removed.
   ...
   * </ul>
   *
   * <p>These constraints ensure configurations passed to libzonarosa precisely reflect enabled
   ...
   *
   * @param remoteConfig a map containing preprocessed libzonarosa configuration keys and their
   *     associated values
  ...
  /**
   * Updates libzonarosa's remote configuration settings using Production build variant.
   *
  ...
  /**
   * Try to load several libzonarosa classes asynchronously, using the same mechanism as native (Rust)
   * code.
   *
   * <p>This should only be called in tests, and can be used to ensure at test time that libzonarosa
  ...
  public static void checkClassesCanBeLoadedAsyncForTest() {
    ...
    final String[] classesToLoad = {
      "io.zonarosa.libzonarosa.net.CdsiLookupResponse$Entry",
      "io.zonarosa.libzonarosa.net.NetworkException",
      "io.zonarosa.libzonarosa.net.ChatServiceException",
      "io.zonarosa.libzonarosa.protocol.ServiceId",
    };
