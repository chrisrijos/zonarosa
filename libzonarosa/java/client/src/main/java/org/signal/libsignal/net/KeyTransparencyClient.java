...
public class KeyTransparencyClient {
   ...
   *   <li>{@link io.zonarosa.libzonarosa.keytrans.KeyTransparencyException} for errors related to key
   ...
   *   <li>{@link io.zonarosa.libzonarosa.keytrans.VerificationFailedException} indicates a failure to
