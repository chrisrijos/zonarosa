...
/**
 * Compares the basic behavior of libzonarosa's CompletableFuture with the JDK's.
 *
  ...
  public static Object[][] parameters() {
    return new Object[][] {
      ...
      },
      {
        ...
        (Supplier)
            () -> {
              final var libzonarosaFuture = new CompletableFuture<Integer>();
              return new Input(
                  libzonarosaFuture,
                  libzonarosaFuture::complete,
                  libzonarosaFuture::completeExceptionally);
            }
      },
    };
  }
