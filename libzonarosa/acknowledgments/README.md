This directory contains pre-generated acknowledgments for the Rust dependencies of libzonarosa. CI enforces that they are kept up to date.

## Updating

If you update libzonarosa's dependencies, you'll need to update this listing. Install [cargo-about][] if you haven't already:
