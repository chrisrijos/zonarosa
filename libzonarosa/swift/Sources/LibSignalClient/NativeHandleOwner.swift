...
public protocol ZonaRosaMutPointer {
    associatedtype ConstPointer: ZonaRosaConstPointer
...
public protocol ZonaRosaConstPointer {
    func toOpaque() -> OpaquePointer?
}

public struct NonNull<PointerType: ZonaRosaMutPointer> {
...
extension OpaquePointer?: ZonaRosaMutPointer, ZonaRosaConstPointer {
...
public class NativeHandleOwner<PointerType: ZonaRosaMutPointer> {
    ...
    internal class func destroyNativeHandle(_ handle: NonNull<PointerType>) -> ZonaRosaFfiErrorRef? {
...
public class ClonableHandleOwner<PointerType: ZonaRosaMutPointer>: NativeHandleOwner<PointerType> {
    internal required init(owned handle: NonNull<PointerType>) {
