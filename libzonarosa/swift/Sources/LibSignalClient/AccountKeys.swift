...
public func hashLocalPin<Bytes: ContiguousBytes>(_ pin: Bytes) throws -> String {
    try pin.withUnsafeBorrowedBuffer { buffer in
        try invokeFnReturningString {
            zonarosa_pin_local_hash($0, buffer)
        }
    }
}
    ...
    try encodedHash.withCString { hashPtr in
        try pin.withUnsafeBorrowedBuffer { buffer in
            try invokeFnReturningBool {
                zonarosa_pin_verify_local_hash($0, hashPtr, buffer)
            }
        }
    }
}

extension ZonaRosaMutPointerPinHash: ZonaRosaMutPointer {
    public typealias ConstPointer = ZonaRosaConstPointerPinHash
...
extension ZonaRosaConstPointerPinHash: ZonaRosaConstPointer {
    public func toOpaque() -> OpaquePointer? {
        self.raw
    }
}
...
public class PinHash: NativeHandleOwner<ZonaRosaMutPointerPinHash>, @unchecked Sendable {
    override internal class func destroyNativeHandle(_ handle: NonNull<ZonaRosaMutPointerPinHash>) -> ZonaRosaFfiErrorRef? {
        return zonarosa_pin_hash_destroy(handle.pointer)
    }
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningFixedLengthArray {
                    zonarosa_pin_hash_access_key($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var encryptionKey: Data {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningFixedLengthArray {
                    zonarosa_pin_hash_encryption_key($0, nativeHandle.const())
                }
            }
        }
    }
            ...
            try salt.withUnsafeBytes { saltBytes in
                try ByteArray(newContents: Data(saltBytes), expectedLength: 32).withUnsafePointerToSerialized {
                    ...
                    try invokeFnReturningValueByPointer(.init()) {
                        zonarosa_pin_hash_from_salt($0, pinBytes, saltTuple)
                    }
                }
            }
        }
        ...
        let result = try normalizedPin.withUnsafeBorrowedBuffer { pinBytes in
            try mrenclave.withUnsafeBorrowedBuffer { mrenclaveBytes in
                try username.withCString { userBytes in
                    try invokeFnReturningValueByPointer(.init()) {
                        zonarosa_pin_hash_from_username_mrenclave($0, pinBytes, userBytes, mrenclaveBytes)
                    }
                }
            }
        }
...
public enum AccountEntropyPool {
    ...
    public static func generate() -> String {
        return failOnError {
            try invokeFnReturningString {
                zonarosa_account_entropy_pool_generate($0)
            }
        }
    }
    ...
    public static func isValid(_ accountEntropyPool: String) -> Bool {
        failOnError {
            try invokeFnReturningBool {
                zonarosa_account_entropy_pool_is_valid($0, accountEntropyPool)
            }
        }
    }
    ...
    public static func deriveSvrKey(_ accountEntropyPool: String) throws -> Data {
        try invokeFnReturningFixedLengthArray {
            zonarosa_account_entropy_pool_derive_svr_key($0, accountEntropyPool)
        }
    }
    ...
    public static func deriveBackupKey(_ accountEntropyPool: String) throws -> BackupKey {
        try invokeFnReturningSerialized {
            zonarosa_account_entropy_pool_derive_backup_key($0, accountEntropyPool)
        }
    }
}
...
public class BackupKey: ByteArray, @unchecked Sendable {
        ...
        failOnError {
            try withUnsafePointerToSerialized { backupKey in
                try aci.withPointerToFixedWidthBinary { aci in
                    try invokeFnReturningFixedLengthArray {
                        zonarosa_backup_key_derive_backup_id($0, backupKey, aci)
                    }
                }
            }
        }
            ...
            try withUnsafePointerToSerialized { backupKey in
                try aci.withPointerToFixedWidthBinary { aci in
                    try invokeFnReturningNativeHandle {
                        zonarosa_backup_key_derive_ec_key($0, backupKey, aci)
                    }
                }
            }
        }
    ...
    public func deriveLocalBackupMetadataKey() -> Data {
        failOnError {
            try withUnsafePointerToSerialized { backupKey in
                try invokeFnReturningFixedLengthArray {
                    zonarosa_backup_key_derive_local_backup_metadata_key($0, backupKey)
                }
            }
        }
    }
    ...
    public func deriveMediaId(_ mediaName: String) throws -> Data {
        try withUnsafePointerToSerialized { backupKey in
            try invokeFnReturningFixedLengthArray {
                zonarosa_backup_key_derive_media_id($0, backupKey, mediaName)
            }
        }
    }
    ...
    public func deriveMediaEncryptionKey(_ mediaId: Data) throws -> Data {
        ...
        return try withUnsafePointerToSerialized { backupKey in
            try mediaId.withUnsafePointerToSerialized { mediaId in
                try invokeFnReturningFixedLengthArray {
                    zonarosa_backup_key_derive_media_encryption_key($0, backupKey, mediaId)
                }
            }
        }
    }
    ...
    public func deriveThumbnailTransitEncryptionKey(_ mediaId: Data) throws -> Data {
        ...
        return try withUnsafePointerToSerialized { backupKey in
            try mediaId.withUnsafePointerToSerialized { mediaId in
                try invokeFnReturningFixedLengthArray {
                    zonarosa_backup_key_derive_thumbnail_transit_encryption_key($0, backupKey, mediaId)
                }
            }
        }
    }
    ...
    internal func withUnsafePointer<Result>(
        callback: (_: UnsafePointer<ZonaRosaFfi.ZonaRosaBackupKeyBytes>) -> Result
    ) -> Result {
