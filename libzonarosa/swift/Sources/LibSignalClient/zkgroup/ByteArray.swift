//
// Copyright 2019-2022 ZonaRosa Platform.
...
public class ByteArray {
    ...
    init(_ newContents: Data, checkValid: (ZonaRosaBorrowedBuffer) -> ZonaRosaFfiErrorRef?) throws {
    ...
    init(newContents: Data, expectedLength: Int, unrecoverable: Bool = false) throws {
        if newContents.count != expectedLength {
            throw ZonaRosaError.invalidType(
    ...
    func withUnsafeBorrowedBuffer<Result>(_ callback: (ZonaRosaBorrowedBuffer) throws -> Result) rethrows -> Result {
