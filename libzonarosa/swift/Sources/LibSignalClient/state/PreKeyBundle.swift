...
public class PreKeyBundle: NativeHandleOwner<ZonaRosaMutPointerPreKeyBundle> {
    override internal class func destroyNativeHandle(
        _ handle: NonNull<ZonaRosaMutPointerPreKeyBundle>
    ) -> ZonaRosaFfiErrorRef? {
        return zonarosa_pre_key_bundle_destroy(handle.pointer)
    }
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    zonarosa_pre_key_bundle_get_registration_id($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var deviceId: UInt32 {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    zonarosa_pre_key_bundle_get_device_id($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var signedPreKeyId: UInt32 {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    zonarosa_pre_key_bundle_get_signed_pre_key_id($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var preKeyId: UInt32? {
        let prekey_id = withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    zonarosa_pre_key_bundle_get_pre_key_id($0, nativeHandle.const())
                }
            }
        }
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningOptionalNativeHandle {
                    zonarosa_pre_key_bundle_get_pre_key_public($0, nativeHandle.const())
                }
            }
        }
    }
        ...
        let pk: PublicKey = withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningNativeHandle {
                    zonarosa_pre_key_bundle_get_identity_key($0, nativeHandle.const())
                }
            }
        }
    ...
    public var signedPreKeyPublic: PublicKey {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningNativeHandle {
                    zonarosa_pre_key_bundle_get_signed_pre_key_public($0, nativeHandle.const())
                }
            }
        }
    }
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningData {
                    zonarosa_pre_key_bundle_get_signed_pre_key_signature($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var kyberPreKeyId: UInt32 {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    zonarosa_pre_key_bundle_get_kyber_pre_key_id($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var kyberPreKeyPublic: KEMPublicKey {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningNativeHandle {
                    zonarosa_pre_key_bundle_get_kyber_pre_key_public($0, nativeHandle.const())
                }
            }
        }
    }
    ...
    public var kyberPreKeySignature: Data {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningData {
                    zonarosa_pre_key_bundle_get_kyber_pre_key_signature($0, nativeHandle.const())
                }
            }
        }
    }
...
extension ZonaRosaMutPointerPreKeyBundle: ZonaRosaMutPointer {
    public typealias ConstPointer = ZonaRosaConstPointerPreKeyBundle
...
extension ZonaRosaConstPointerPreKeyBundle: ZonaRosaConstPointer {
    public func toOpaque() -> OpaquePointer? {
        self.raw
    }
}
