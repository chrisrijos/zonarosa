...
class UsernameTests: TestCaseBase {
    ...
    func testInvalidHash() throws {
        let username = try Username("hello_zonarosa.42")
        var hash = username.hash
        let proof = username.generateProof()
    ...
    func testSpecificErrorType() throws {
        ...
        } catch ZonaRosaError.badNicknameCharacter {
        } catch {
    ...
    func testCorrectErrorsForInvalidUsernamesFromParts() throws {
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.nicknameCannotBeEmpty {
        } catch {
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.nicknameCannotStartWithDigit {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.nicknameTooShort {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.nicknameTooLong {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.usernameDiscriminatorCannotBeEmpty {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.usernameDiscriminatorCannotBeZero {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.usernameDiscriminatorCannotHaveLeadingZeros {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.badDiscriminatorCharacter {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
        ...
        do {
            ...
            XCTFail("should have failed")
        } catch ZonaRosaError.usernameDiscriminatorTooLarge {
        } catch {
            XCTFail("unexpected error: \(error)")
        }
    }
    ...
    func testUsernameLinkInvalidEntropySize() throws {
        do {
            ...
            XCTFail("Should have failed")
        } catch ZonaRosaError.usernameLinkInvalidEntropyDataLength {
        } catch {
            XCTFail("Unexpected error thrown")
        }
    }
    ...
    func testUsernameLinkInvalidLinkBytes() throws {
        do {
            ...
            _ = try Username(fromLink: linkBytes, withRandomness: randomness)
            XCTFail("Should have failed")
        } catch ZonaRosaError.usernameLinkInvalid {
        } catch {
            XCTFail("Unexpected error thrown")
        }
    }
