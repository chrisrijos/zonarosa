...
impl ServerSecretParams {
    pub fn generate(randomness: RandomnessBytes) -> Self {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Random_ServerSecretParams_Generate",
            &randomness,
        );
    ...
    pub fn sign(&self, randomness: RandomnessBytes, message: &[u8]) -> NotarySignatureBytes {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Random_ServerSecretParams_Sign",
            &randomness,
        );
    ...
    {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20220508_Random_ServerSecretParams_IssueExpiringProfileKeyCredential",
            &randomness,
        );
    ...
    pub fn issue_receipt_credential(
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20210919_Random_ServerSecretParams_IssueReceiptCredential",
            &randomness,
        );
...
impl ServerPublicParams {
    ...
    pub fn create_profile_key_credential_request_context(
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Random_ServerPublicParams_CreateProfileKeyCredentialRequestContext",
            &randomness,
        );
    ...
    pub fn create_expiring_profile_key_credential_presentation(
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20220508_Random_ServerPublicParams_CreateExpiringProfileKeyCredentialPresentation",
            &randomness,
        );
    ...
    pub fn create_receipt_credential_request_context(
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20210919_Random_ServerPublicParams_CreateReceiptCredentialRequestContext",
            &randomness,
        );
    ...
    pub fn create_receipt_credential_presentation(
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20210919_Random_ServerPublicParams_CreateReceiptCredentialPresentation",
            &randomness,
        );
