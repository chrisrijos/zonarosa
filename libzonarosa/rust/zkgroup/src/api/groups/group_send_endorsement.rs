...
impl GroupSendDerivedKeyPair {
    ...
    fn tag_info(expiration: Timestamp) -> impl poksho::ShoApi + Clone {
        let mut sho = poksho::ShoHmacSha256::new(b"20240215_ZonaRosa_GroupSendEndorsement");
...
impl GroupSendEndorsementsResponse {
    ...
    fn sort_points(points: &mut [(usize, curve25519_dalek_zonarosa::RistrettoPoint)]) {
        debug_assert!(points.iter().enumerate().all(|(i, (j, _))| i == *j));
        let sort_keys = curve25519_dalek_zonarosa::RistrettoPoint::double_and_compress_batch(
    ...
    pub fn issue(
        ...
        let mut points_to_sign: Vec<(usize, curve25519_dalek_zonarosa::RistrettoPoint)> =
            member_ciphertexts
                .into_iter()
    ...
    pub fn receive_with_service_ids_single_threaded(
        self,
        user_ids: impl IntoIterator<Item = libzonarosa_core::ServiceId>,
        now: Timestamp,
        ...
        let mut member_points: Vec<(usize, curve25519_dalek_zonarosa::RistrettoPoint)> = user_ids
            .into_iter()
            .map(|user_id| {
    ...
    where
        T: rayon::iter::IntoParallelIterator<
                Item = libzonarosa_core::ServiceId,
...
///
/// `Storage` is usually [`curve25519_dalek_zonarosa::RistrettoPoint`], but the `receive` APIs on
...
#[partial_default(bound = "Storage: curve25519_dalek_zonarosa::traits::Identity")]
#[derive_where(PartialEq; Storage: subtle::ConstantTimeEq)]
pub struct GroupSendEndorsement<Storage = curve25519_dalek_zonarosa::RistrettoPoint> {
    reserved: ReservedByte,
    endorsement: zkcredential::endorsements::Endorsement<Storage>,
}

impl Debug for GroupSendEndorsement<curve25519_dalek_zonarosa::RistrettoPoint> {
...
impl Debug for GroupSendEndorsement<curve25519_dalek_zonarosa::ristretto::CompressedRistretto> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("GroupSendEndorsement")
            .field("reserved", &self.reserved)
            .field("endorsement", &self.endorsement)
...
pub struct ReceivedEndorsement {
    ...
    pub compressed: GroupSendEndorsement<curve25519_dalek_zonarosa::ristretto::CompressedRistretto>,
    pub decompressed: GroupSendEndorsement,
}

impl GroupSendEndorsement<curve25519_dalek_zonarosa::ristretto::CompressedRistretto> {
    ...
    pub fn decompress(
        ...
        GroupSendEndorsement<curve25519_dalek_zonarosa::RistrettoPoint>,
...
impl GroupSendEndorsement<curve25519_dalek_zonarosa::RistrettoPoint> {
    ...
    pub fn compress(
        self,
    ) -> GroupSendEndorsement<curve25519_dalek_zonarosa::ristretto::CompressedRistretto> {
...
impl GroupSendFullToken {
    ...
    pub fn verify(
        ...
        let uid_sho_seed = crypto::uid_struct::UidStruct::seed_M1();
        let user_id_sum: curve25519_dalek_zonarosa::RistrettoPoint = user_ids
            .into_iter()
