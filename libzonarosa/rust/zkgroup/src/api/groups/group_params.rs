...
impl GroupSecretParams {
    pub fn generate(randomness: RandomnessBytes) -> Self {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Random_GroupSecretParams_Generate",
            &randomness,
        );
    ...
    pub fn derive_from_master_key(master_key: GroupMasterKey) -> Self {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_GroupMasterKey_GroupSecretParams_DeriveFromMasterKey",
            &master_key.bytes,
        );
    ...
    pub fn encrypt_service_id(
        &self,
        service_id: libzonarosa_core::ServiceId,
    ...
    pub fn encrypt_blob(&self, randomness: RandomnessBytes, plaintext: &[u8]) -> Vec<u8> {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Random_GroupSecretParams_EncryptBlob",
            &randomness,
        );
