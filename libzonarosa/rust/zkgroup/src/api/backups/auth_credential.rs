...
use curve25519_dalek_zonarosa::ristretto::RistrettoPoint;
...
impl BackupIdPoint {
    fn new(backup_id: &libzonarosa_account_keys::BackupId) -> Self {
        Self(Sho::new(b"20231003_ZonaRosa_BackupId", &backup_id.0).get_point())
    }
}
...
const CREDENTIAL_LABEL: &[u8] = b"20231003_ZonaRosa_BackupAuthCredential";
...
impl BackupAuthCredentialRequestContext {
    pub fn new<const VERSION: u8>(
        ...
        let mut sho = poksho::ShoHmacSha256::new(b"20231003_ZonaRosa_BackupAuthCredentialRequest");
...
impl BackupAuthCredential {
    ...
    pub fn backup_id(&self) -> libzonarosa_account_keys::BackupId {
        self.backup_id
    }
...
mod tests {
    ...
    const KEY: libzonarosa_account_keys::BackupKey = libzonarosa_account_keys::BackupKey([0x42u8; 32]);
    ...
    fn test_server_verify_wrong_backup_id() {
        ...
        let invalid_presentation = BackupAuthCredentialPresentation {
            backup_id: libzonarosa_account_keys::BackupId(*b"a fake backup-id"),
            ..valid_presentation
        };
