...
impl CallLinkRoomIdPoint {
    fn new(room_id: &[u8]) -> Self {
        Self(Sho::new(b"20230413_ZonaRosa_CallLinkRoomId", room_id).get_point())
    }
}
...
const CREDENTIAL_LABEL: &[u8] = b"20230413_ZonaRosa_CreateCallLinkCredential";
...
impl CreateCallLinkCredentialRequestContext {
    pub fn new(room_id: &[u8], randomness: RandomnessBytes) -> Self {
        let mut sho =
            poksho::ShoHmacSha256::new(b"20230413_ZonaRosa_CreateCallLinkCredentialRequest");
