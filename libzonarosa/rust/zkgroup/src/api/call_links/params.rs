...
impl CallLinkSecretParams {
    ...
    pub fn derive_from_root_key(root_key: &[u8]) -> Self {
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20230419_CallLinkSecretParams_DeriveFromRootKey",
            &root_key[..byte_count],
        );
    ...
    pub fn encrypt_uid(&self, user_id: libzonarosa_core::Aci) -> api::groups::UuidCiphertext {
    ...
    ) -> Result<libzonarosa_core::Aci, ZkGroupVerificationFailure> {
