...
///
/// Note that it is not a "*profile* version"; a ZonaRosa user can change their profile without
...
impl ProfileKey {
    ...
    pub fn get_profile_key_version(
        ...
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_ProfileKeyAndUid_ProfileKey_GetProfileKeyVersion",
            &combined_array,
        );
