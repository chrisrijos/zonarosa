...
impl SystemParams {
    pub fn generate() -> Self {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Constant_ProfileKeyCommitment_SystemParams_Generate",
            b"",
        );
...
impl CommitmentWithSecretNonce {
    ...
    pub fn calc_j3(profile_key_bytes: ProfileKeyBytes, uid_bytes: UidBytes) -> Scalar {
        ...
        Sho::new(
            b"ZonaRosa_ZKGroup_20200424_ProfileKeyAndUid_ProfileKeyCommitment_Calcj3",
            &combined_array,
        )
        .get_scalar()
    }
