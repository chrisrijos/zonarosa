...
use const_str::hex;
use curve25519_dalek_zonarosa::constants::RISTRETTO_BASEPOINT_POINT;
use curve25519_dalek_zonarosa::ristretto::RistrettoPoint;
use curve25519_dalek_zonarosa::scalar::Scalar;
...
impl SystemParams {
    ...
    fn generate() -> Self {
        let mut sho = Sho::new(
            b"ZonaRosa_ZKGroup_20200424_Constant_Credentials_SystemParams_Generate",
            b"",
        );
