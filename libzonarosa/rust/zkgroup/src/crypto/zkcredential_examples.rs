...
fn test_mac_generic() {
    ...
    let aci = libzonarosa_core::Aci::from_uuid_bytes(uid_bytes);
...
impl zkcredential::attributes::Domain for InverseUidDecryptionKey {
    ...
    fn G_a() -> [curve25519_dalek_zonarosa::RistrettoPoint; 2] {
        static STORAGE: std::sync::OnceLock<[curve25519_dalek_zonarosa::RistrettoPoint; 2]> =
