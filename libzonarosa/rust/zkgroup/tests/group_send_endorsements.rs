...
fn test_endorsement() {
    ...
    let client_user_id = libzonarosa_core::Aci::from_uuid_bytes([0x04u8; UUID_LEN]);

    let moxie_user_id =
        libzonarosa_core::Aci::from(uuid::uuid!("e36fdce7-36da-4c6f-a21b-9afe2b754650"));
    let brian_user_id =
        libzonarosa_core::Aci::from(uuid::uuid!("8c78cd2a-16ff-427d-83dc-1a5e36ce713d"));
