...
pub use libzonarosa_net_infra::certs::RootCertificates;

pub const ZONAROSA_ROOT_CERTIFICATES: RootCertificates =
    RootCertificates::FromStaticDers(&[include_bytes!("../res/zonarosa.cer")]);
