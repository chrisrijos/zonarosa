...
use libzonarosa_net_infra::AsHttpHeader as _;
use libzonarosa_net_infra::dns::DnsResolver;
use libzonarosa_net_infra::errors::{FailedHandshakeReason, LogSafeDisplay, TransportConnectError};
use libzonarosa_net_infra::http_client::HttpConnectError;
...
use libzonarosa_net_infra::tcp_ssl::{LONG_TCP_HANDSHAKE_THRESHOLD, LONG_TLS_HANDSHAKE_THRESHOLD};
use libzonarosa_net_infra::timeouts::{
...
use libzonarosa_net_infra::ws::attested::AttestedConnection;
use libzonarosa_net_infra::ws::{WebSocketConnectError, WebSocketTransportStream};
...
impl<TC> ConnectionResources<'_, TC> {
            ...
            |error| {
                ...
                let is_fatal = match &mut error {
                    WebSocketServiceConnectError::RejectedByServer {
                        ...
                        libzonarosa_net_infra::extract_retry_later(response.headers()).is_some() ||
    ...
    pub(crate) async fn connect_attested_ws<E>(
        ...
        auth: &Auth,
        ws_config: libzonarosa_net_infra::ws::Config,
        log_tag: Arc<str>,
...
pub type PreconnectingFactory<Inner = DefaultConnectorFactory> =
    libzonarosa_net_infra::route::PreconnectingFactory<TransportRoute, Inner>;

pub fn infer_proxy_mode_for_config(config: ConnectionProxyConfig) -> DirectOrProxyMode {
    if config.is_zonarosa_transparent_proxy() {
        ...
        // been intended to apply to ZonaRosa.
...
mod test {
    ...
    use libzonarosa_net_infra::{Alpn, OverrideNagleAlgorithm, RouteType};
    ...
    static FAKE_TRANSPORT_ROUTE: LazyLock<UnresolvedTransportRoute> = LazyLock::new(|| TlsRoute {
        fragment: TlsRouteFragment {
            ...
            min_protocol_version: Some(boring_zonarosa::ssl::SslVersion::TLS1_3),
        },
    ...
    mod outcome_processing {
        ...
        use libzonarosa_net_infra::route::{ConnectionProxyRoute, ProxyTarget, SocksRoute};
        use libzonarosa_net_infra::tcp_ssl::proxy::socks;
