...
use libzonarosa_net_infra::ws::{StreamWithResponseHeaders, WebSocketTransportStream};
...
const RECEIVE_STORIES_HEADER_NAME: &str = "x-zonarosa-receive-stories";
...
pub mod test_support {
    ...
    use libzonarosa_net_infra::route::DirectOrProxyMode;
    ...
    pub async fn simple_chat_connection(
        ...
        let user_agent = UserAgent::with_libzonarosa_version("test_simple_chat_connection");
...
pub(crate) mod test {
    ...
    use libzonarosa_net_infra::errors::{RetryLater, TransportConnectError};
    ...
    use libzonarosa_net_infra::utils::no_network_change_events;
    use libzonarosa_net_infra::ws::WebSocketConnectError;
    ...
    fn proto_into_response_works_with_valid_data() {
        ...
        let expected_host_value = "char.zonarosa.io";
    ...
    fn proto_into_response_works_and_headers_parsed_correctly() {
        let proto = ResponseProto {
            ...
            headers: vec![
                ...
                format!("{}: {}", http::header::HOST.as_str(), " chat.zonarosa.io "),
    ...
    const CONFIRMATION_HEADER: &str = "x-really-zonarosa";
    ...
    async fn html_status_tests(
        ...
        const CHAT_DOMAIN: &str = "test.zonarosa.io";
        let connection_resources = ConnectionResources {
        ...
        let err = ChatConnection::start_connect_with_transport(
            ...
            CHAT_WEBSOCKET_PATH,
            &UserAgent::with_libzonarosa_version("test"),
            ws::Config {
