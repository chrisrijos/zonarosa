...
use libzonarosa_net_infra::dns::dns_transport_udp::UdpTransportConnector;
use libzonarosa_net_infra::route::{ErrorHandling, NoDelay, UdpRoute};
...
async fn main() {
    ...
    let udp_transport = libzonarosa_net_infra::route::connect_resolved(
