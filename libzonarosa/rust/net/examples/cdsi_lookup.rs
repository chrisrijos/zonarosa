...
use libzonarosa_net::cdsi::{CdsiConnection, LookupError, LookupRequest, LookupResponse};
...
async fn cdsi_lookup(
    ...
    let (_token, remaining_response) = libzonarosa_net::infra::utils::timeout(
        timeout,
...
async fn main() {
    ...
    let cdsi_env = match environment {
        Environment::Prod => libzonarosa_net::env::PROD.cdsi,
        Environment::Staging => libzonarosa_net::env::STAGING.cdsi,
    };
