...
use libzonarosa_net::infra::OverrideNagleAlgorithm;
...
use libzonarosa_net::infra::tcp_ssl::proxy::socks::Protocol;
...
async fn main() {
    ...
    let mut connection = {
        ...
        let resolved = libzonarosa_net::infra::route::resolve_route(&dns_resolver, unresolved_route)
            .await
            .expect("failed to resolve");
        let connector = libzonarosa_net::infra::route::ComposedConnector::new(
            libzonarosa_net::infra::tcp_ssl::StatelessTls,
            libzonarosa_net::infra::tcp_ssl::proxy::StatelessProxied,
        );
