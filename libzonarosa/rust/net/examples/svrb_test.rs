...
use libzonarosa_net::svrb;
use libzonarosa_net::svrb::direct::direct_connect;
use libzonarosa_net::svrb::traits::*;
...
async fn single_request(args: &Args, sem: &tokio::sync::Semaphore) {
    ...
    let env = if args.prod {
        &libzonarosa_net::env::PROD.svr_b
    } else {
        &libzonarosa_net::env::STAGING.svr_b
    };
