...
use libzonarosa_net::infra::dns::custom_resolver::DnsTransport;
use libzonarosa_net::infra::dns::dns_lookup::DnsLookupRequest;
use libzonarosa_net::infra::dns::dns_transport_doh::DohTransportConnector;
...
use libzonarosa_net::infra::{Alpn, OverrideNagleAlgorithm};
...
struct Args {
    ...
    no_ipv6: bool,
    /// domain to lookup
    #[arg(long, default_value = "chat.zonarosa.io")]
    domain: String,
...
async fn main() {
    ...
    let doh_transport = libzonarosa_net_infra::route::connect_resolved(
        vec![route.clone()],
        NoDelay,
        DohTransportConnector::default(),
        (),
        "dns_over_https",
        |_| libzonarosa_net_infra::route::ErrorHandling::Continue::<std::convert::Infallible>,
    )
    .await
    .0
