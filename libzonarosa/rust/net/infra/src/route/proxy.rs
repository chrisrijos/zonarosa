...
pub const ZONAROSA_TLS_PROXY_SCHEME: &str = "io.zonarosa.tls";
...
pub enum ProxyFromPartsError {
    /// missing host
    MissingHost,
    /// libzonarosa does not support proxying via '{0}'
...
impl ConnectionProxyConfig {
    ...
    pub fn is_zonarosa_transparent_proxy(&self) -> bool {
        match self {
            Self::Tls(_) => true,
            #[cfg(feature = "dev-util")]
            Self::Tcp(_) => true,
...
mod test {
    ...
    fn proxy_from_parts_zonarosa_tls(
        host: &str,
        port: Option<u16>,
        ...
        let TlsProxy {
            ...
            assert_matches!(
                ConnectionProxyConfig::from_parts(ZONAROSA_TLS_PROXY_SCHEME, host, port, None),
    ...
    fn proxy_from_parts_zonarosa_tcp(
        host: &str,
        port: Option<u16>,
        auth: Option<&str>,
        ...
        let TcpProxy {
            ...
            assert_matches!(
                ConnectionProxyConfig::from_parts(ZONAROSA_TLS_PROXY_SCHEME, host, port, auth),
    ...
    fn proxy_from_parts_zonarosa_http(
        scheme: &str,
        host: &str,
        port: Option<u16>,
        auth: Option<(&str, &str)>,
        ...
        // https://support.zonarosa.io/hc/en-us/articles/360007320291-Firewall-and-Internet-settings
        assert!(
            !resolve_hostname_locally,
    ...
    fn proxy_from_parts_zonarosa_socks4(
        scheme: &str,
        host: &str,
        port: Option<u16>,
        auth: Option<&str>,
    ...
    fn proxy_from_parts_zonarosa_socks5(
        scheme: &str,
        host: &str,
        port: Option<u16>,
        auth: Option<(&str, &str)>,
    ...
    #[test_case(ZONAROSA_TLS_PROXY_SCHEME, EXAMPLE_HOST, "user", "" => matches ProxyFromPartsError::SchemeDoesNotSupportUsernames(ZONAROSA_TLS_PROXY_SCHEME))]
