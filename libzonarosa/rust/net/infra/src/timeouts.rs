...
///   network usage.
/// See: ZonaRosa-Android's KEEPALIVE_FREQUENCY_SECONDS OkHttpWebSocketConnection.java:58, and
///      ZonaRosa-Desktop's KEEPALIVE_INTERVAL_MS at WebSocketResources.ts:1085,
