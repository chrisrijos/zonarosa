        ...
        HttpsTlsRoute {
            ...
            inner: TlsRoute {
                fragment: TlsRouteFragment {
                    ...
                    min_protocol_version: Some(boring_zonarosa::ssl::SslVersion::TLS1_2),
                },
                inner: TcpRoute {
                    address: ip_addr,
...
mod test {
    ...
    const CUSTOM_DOMAIN: &str = "custom.zonarosa.io";
    const IPV4_ONLY_DOMAIN: &str = "ipv4.zonarosa.io";
    const IPV6_ONLY_DOMAIN: &str = "ipv6.zonarosa.io";
    const DUAL_STACK_DOMAIN: &str = "dual.zonarosa.io";
    const TIMING_OUT_DOMAIN: &str = "time.zonarosa.io";
    const FALLBACK_ONLY_DOMAIN: &str = "fallback.zonarosa.io";
