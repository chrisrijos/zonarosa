...
pub(crate) mod testutil {
    ...
    use boring_zonarosa::pkey::PKey;
    use boring_zonarosa::ssl::{SslAcceptor, SslMethod};
    ...
    pub(crate) const PROXY_HOSTNAME: &str = "test-proxy.zonarosa.io.local";
    ...
    impl TlsServer {
        ...
        pub(super) async fn accept(
            ...
            let ssl_stream = tokio_boring_zonarosa::accept(&self.ssl_acceptor, tcp_stream)
                .await
