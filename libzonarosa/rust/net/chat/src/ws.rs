...
//! websocket, as implemented in [`libzonarosa_net::chat`].
...
use libzonarosa_net::infra::{AsHttpHeader, extract_retry_later};
...
impl WsConnection for chat::ChatConnection {
    async fn send(
        ...
        // TODO: Figure out timeouts for libzonarosa-net-chat APIs.
...
#[cfg(test)]
mod test {
    use libzonarosa_net::infra::AsStaticHttpHeader as _;
