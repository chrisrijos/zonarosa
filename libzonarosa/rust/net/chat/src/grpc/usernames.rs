...
use libzonarosa_net_grpc::proto::chat::account::accounts_anonymous_client::AccountsAnonymousClient;
use libzonarosa_net_grpc::proto::chat::account::*;
use libzonarosa_net_grpc::proto::chat::errors;
...
mod test {
    ...
    use libzonarosa_net_grpc::proto::chat::common::{IdentityType, ServiceIdentifier};
    ...
    fn test_hash_lookup(
        ...
        let validator = RequestValidator {
            expected: req(
                "/io.zonarosa.chat.account.AccountsAnonymous/LookupUsernameHash",
    ...
    fn test_link_lookup(
        ...
        let validator = RequestValidator {
            expected: req(
                "/io.zonarosa.chat.account.AccountsAnonymous/LookupUsernameLink",
