...
use libzonarosa_net::env::KeyTransConfig;
...
pub enum Error {
    ...
    VerificationFailed(#[from] libzonarosa_keytrans::Error),
    /// Invalid response: {0}
...
pub(crate) mod test_support {
    ...
    use const_str::hex;
    use libzonarosa_keytrans::{StoredAccountData, TreeHead};
    ...
    pub(crate) mod test_account {
        ...
        use const_str::hex;
        use libzonarosa_core::curve::PublicKey;
        use libzonarosa_core::{Aci, E164};
...
mod test {
    ...
    fn test_search_response() -> TypedSearchResponse {
        let chat_search_response =
            libzonarosa_keytrans::ChatSearchResponse::decode(CHAT_SEARCH_RESPONSE)
