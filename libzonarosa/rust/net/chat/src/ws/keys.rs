...
use libzonarosa_core::{DeviceId, ServiceId, curve};
use libzonarosa_net::chat::Request;
use libzonarosa_net::infra::AsHttpHeader as _;
use libzonarosa_protocol::kem::PublicKey as KemPublicKey;
use libzonarosa_protocol::{IdentityKey, PreKeyBundle, PreKeyId, SignedPreKeyId};
...
mod test {
    ...
    use libzonarosa_core::{DeviceId, ServiceId, curve};
    use libzonarosa_net::chat::Request;
    use libzonarosa_protocol::KyberPreKeyId;
    use libzonarosa_protocol::kem::PublicKey as KemPublicKey;
