...
use libzonarosa_core::{DeviceId, ServiceId};
use libzonarosa_net::chat::{Request, Response};
...
const MULTI_RECIPIENT_MESSAGE_CONTENT_TYPE: http::HeaderValue =
    http::HeaderValue::from_static("application/vnd.zonarosa-messenger.mrm");
...
impl<T: WsConnection> crate::api::messages::UnauthenticatedChatApi for Unauth<T> {
    async fn send_multi_recipient_message(
        &self,
        payload: bytes::Bytes,
        timestamp: libzonarosa_protocol::Timestamp,
