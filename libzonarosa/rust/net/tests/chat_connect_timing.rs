...
use libzonarosa_net::env::{DomainConfig, STAGING};
use libzonarosa_net::infra::errors::TransportConnectError;
use libzonarosa_net_infra::dns::dns_lookup::{DnsLookup, DnsLookupRequest};
use libzonarosa_net_infra::dns::lookup_result::LookupResult;
use libzonarosa_net_infra::dns::{self, DnsResolver};
use libzonarosa_net_infra::host::Host;
use libzonarosa_net_infra::route::PER_CONNECTION_WAIT_DURATION;
use libzonarosa_net_infra::timeouts::{MIN_TLS_HANDSHAKE_TIMEOUT, TCP_CONNECTION_TIMEOUT};
use libzonarosa_net_infra::utils::timed;
...
async fn all_routes_connect_hangs_forever() {
    // Connection attempt timing in libzonarosa-net:
    //
