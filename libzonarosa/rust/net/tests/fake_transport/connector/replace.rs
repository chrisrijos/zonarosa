...
impl ReplaceStatelessConnectorsWithFake for libzonarosa_net::infra::tcp_ssl::proxy::StatelessProxied {
...
impl ReplaceStatelessConnectorsWithFake for libzonarosa_net::infra::tcp_ssl::StatelessTcp {
    type Replacement = FakeTransportConnector;
...
impl ReplaceStatelessConnectorsWithFake for libzonarosa_net::infra::tcp_ssl::StatelessTls {
    type Replacement = FakeTransportConnector;
