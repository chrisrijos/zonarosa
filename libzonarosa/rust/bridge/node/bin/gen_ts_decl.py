...
def main() -> None:
    ...
    convert_to_typescript(
        rust_crates=[
            ...
            Crate(path=os.path.join(our_abs_dir, '..', '..', 'shared'), features=('node', 'zonarosa-media')),
            Crate(path=os.path.join(our_abs_dir, '..', '..', 'shared', 'types'), features=('node', 'zonarosa-media')),
            Crate(path=os.path.join(our_abs_dir, '..', '..', 'shared', 'testing'), features=('node', 'zonarosa-media')),
        ],
