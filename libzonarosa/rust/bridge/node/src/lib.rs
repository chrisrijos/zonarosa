...
use libzonarosa_bridge::node::{AssumedImmutableBuffer, ResultTypeInfo, ZonaRosaNodeError};
use libzonarosa_protocol::SealedSenderV2SentMessage;
...
fn main(mut cx: ModuleContext) -> NeonResult<()> {
    libzonarosa_bridge::node::register(&mut cx)?;
    ...
    let remote_config_keys = libzonarosa_bridge::net::RemoteConfigKey::KEYS.convert_into(&mut cx)?;
