...
/// An implementation of [`log::Log::enabled`] suitable for production ZonaRosa apps.
///
/// Apps may apply additional logging filters on top of what libzonarosa reports.
pub fn log_enabled_in_apps(metadata: &log::Metadata) -> bool {
    ...
    match target.as_bytes()[0] {
        // libzonarosa naming patterns:
        b'l' => target.starts_with("libzonarosa_"),
        b's' => target.starts_with("zonarosa_") || check("spqr"),

        // Other libzonarosa crates:
        b'a' => check("attest"),
