...
use libzonarosa_bridge_types::crypto::{Aes256GcmDecryption, Aes256GcmEncryption, Aes256GcmSiv};
use libzonarosa_core::curve::{PrivateKey, PublicKey};
use zonarosa_crypto::{
...
fn PrivateKey_HpkeOpen(
    ...
    sk.open(info, associated_data, ciphertext)
        .map_err(|e| match e {
            ...
            HpkeError::InvalidConfig => panic!("invalid HPKE config in libzonarosa"),
