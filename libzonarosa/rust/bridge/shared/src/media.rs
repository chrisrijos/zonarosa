...
use libzonarosa_bridge_types::media::SanitizedMetadata;
use zonarosa_media::sanitize::{mp4, webp};
...
/// Exposed so that we have an easy method to invoke from Java to test whether libzonarosa was
/// compiled with zonarosa-media.
#[bridge_fn]
fn ZonaRosaMedia_CheckAvailable() {}
