...
pub use libzonarosa_bridge_types::net::remote_config::RemoteConfigKey;
pub use libzonarosa_bridge_types::net::{
    BuildVariant, ConnectionManager, Environment, TokioAsyncContext,
};
use libzonarosa_net::chat::ConnectionInfo;
use libzonarosa_net::connect_state::infer_proxy_mode_for_config;
use libzonarosa_net::infra::errors::LogSafeDisplay;
use libzonarosa_net::infra::route::ConnectionProxyConfig;
...
fn ConnectionProxyConfig_new(
    ...
    ConnectionProxyConfig::from_parts(&scheme, &host, port, auth).map_err(|e| {
        use libzonarosa_net::infra::route::ProxyFromPartsError;
...
fn ConnectionManager_clear_proxy(connection_manager: &ConnectionManager) {
    connection_manager.set_proxy_mode(libzonarosa_net::infra::route::DirectOrProxyMode::DirectOnly);
}
