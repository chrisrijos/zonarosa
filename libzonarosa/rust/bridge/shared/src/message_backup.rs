...
use libzonarosa_account_keys::{AccountEntropyPool, BACKUP_FORWARD_SECRECY_TOKEN_LEN};
use libzonarosa_bridge_macros::*;
use libzonarosa_bridge_types::message_backup::*;
use libzonarosa_message_backup::backup::Purpose;
use libzonarosa_message_backup::frame::LimitedReaderFactory;
use libzonarosa_message_backup::json::exporter::FrameExportResult as JsonFrameExportResult;
use libzonarosa_message_backup::{BackupReader, FoundUnknownField, ReadError, ReadResult};
...
fn BackupJsonExporter_New(
    ...
    let (exporter, initial_chunk) =
        libzonarosa_message_backup::json::exporter::JsonExporter::new(backup_info, should_validate)
            .map_err(ReadError::with_error_only)?;
