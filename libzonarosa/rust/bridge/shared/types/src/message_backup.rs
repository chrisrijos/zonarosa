...
use libzonarosa_message_backup::frame::ValidationError as FrameValidationError;
use libzonarosa_message_backup::key::MessageBackupKey as MessageBackupKeyInner;
use libzonarosa_message_backup::{Error, FoundUnknownField, backup};
use libzonarosa_protocol::Aci;
...
pub struct BackupJsonExporter {
    inner: libzonarosa_message_backup::json::exporter::JsonExporter,
    initial_chunk: String,
}

pub struct JsonFrameExportResult {
    pub line: Option<String>,
    pub validation_error: Option<libzonarosa_message_backup::Error>,
}

impl From<libzonarosa_message_backup::json::exporter::FrameExportResult> for JsonFrameExportResult {
    fn from(value: libzonarosa_message_backup::json::exporter::FrameExportResult) -> Self {
        Self {
            line: value.line,
...
impl BackupJsonExporter {
    ...
    pub fn inner_mut(&mut self) -> &mut libzonarosa_message_backup::json::exporter::JsonExporter {
        &mut self.inner
    }
