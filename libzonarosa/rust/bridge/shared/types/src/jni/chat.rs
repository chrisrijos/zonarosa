...
const CONNECTION_MANAGER_CLASS: ClassName =
    ClassName("io.zonarosa.libzonarosa.net.Network$ConnectionManager");
...
impl crate::net::registration::ConnectChatBridge for JniConnectChatBridge {
    ...
    ) -> Box<dyn libzonarosa_net_chat::registration::ConnectUnauthChat + Send + Sync + UnwindSafe>
    {
...
impl libzonarosa_net_chat::registration::ConnectUnauthChat for JniConnectChat {
    fn connect_chat(
        &self,
