...
mod test {
    ...
    fn binary_name_conversion() {
        assert_eq!(
            &jni_name_from_binary_name(ClassName("io.zonarosa.libzonarosa.Native")),
            "io.zonarosa/libzonarosa/Native"
        );
        assert_eq!(
            &jni_name_from_binary_name(ClassName("io.zonarosa.libzonarosa.CdsiResponse$Entry")),
            "io.zonarosa/libzonarosa/CdsiResponse$Entry"
        );
    }
}
