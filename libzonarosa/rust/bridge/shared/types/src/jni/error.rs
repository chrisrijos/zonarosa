...
#[error("{0}")]
pub struct ZonaRosaJniError(Box<dyn JniError + Send>);
...
impl<E> From<E> for ZonaRosaJniError
where
...
impl From<WithContext<BridgeLayerError>> for ZonaRosaProtocolError {
    fn from(value: WithContext<BridgeLayerError>) -> Self {
        ...
        match inner {
            ...
            err => ZonaRosaProtocolError::FfiBindingError(err.to_string()),
        }
    }
}

#[cfg(feature = "zonarosa-media")]
impl From<zonarosa_media::sanitize::mp4::Error> for ZonaRosaJniError {
    fn from(e: zonarosa_media::sanitize::mp4::Error) -> Self {
        use zonarosa_media::sanitize::mp4::Error;
        match e {
            Error::Io(e) => e.into(),
...
#[cfg(feature = "zonarosa-media")]
impl From<zonarosa_media::sanitize::webp::Error> for ZonaRosaJniError {
    fn from(e: zonarosa_media::sanitize::webp::Error) -> Self {
        use zonarosa_media::sanitize::webp::Error;
        match e {
            Error::Io(e) => e.into(),
            Error::Parse(e) => e.into(),
        }
...
impl From<libzonarosa_net::cdsi::LookupError> for ZonaRosaJniError {
    fn from(e: libzonarosa_net::cdsi::LookupError) -> ZonaRosaJniError {
        use libzonarosa_net::cdsi::LookupError;
...
pub type ZonaRosaJniResult<T> = Result<T, ZonaRosaJniError>;
