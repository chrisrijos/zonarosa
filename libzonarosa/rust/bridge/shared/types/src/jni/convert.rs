...
use libzonarosa_net::cdsi::LookupResponseEntry;
...
use crate::protocol::storage::{
    JniBridgeKyberPreKeyStore, JniBridgePreKeyStore, JniBridgeSignedPreKeyStore,
};
use crate::support::{
...
///
/// ```no_run
/// # use libzonarosa_bridge_types::jni::*;
/// # use jni::JNIEnv;
/// # struct Foo;
...
impl<'a> SimpleArgTypeInfo<'a> for libzonarosa_core::E164 {
...
impl<'a> SimpleArgTypeInfo<'a> for Option<libzonarosa_core::E164> {
    type ArgType = <String as SimpleArgTypeInfo<'a>>::ArgType;
    fn convert_from(
        env: &mut JNIEnv<'a>,
        foreign: &Self::ArgType,
        ...
        let res = libzonarosa_core::E164::convert_from(env, foreign)?;
        Ok(Some(res))
    }
}
...
impl<'a> SimpleArgTypeInfo<'a>
    for libzonarosa_net_chat::api::messages::MultiRecipientSendAuthorization
{
    ...
    for &'storage libzonarosa_account_keys::BackupKey
{
    ...
    fn borrow(
        ...
        use libzonarosa_account_keys::BACKUP_KEY_LEN;
        ...
        Ok(libzonarosa_account_keys::BackupKey(
...
impl<'a> SimpleArgTypeInfo<'a> for libzonarosa_net::chat::LanguageList {
    type ArgType = JObjectArray<'a>;
    ...
    fn convert_from(
        ...
        libzonarosa_net::chat::LanguageList::parse(&entries)
...
impl<'a> CallbackResultTypeInfo<'a> for Option<PreKeyRecord> {
    ...
    const JNI_RESULT_SIGNATURE: &'static str =
        jni_signature!(io.zonarosa.libzonarosa.internal.NativeHandleGuard::Owner);
    ...
    fn convert_from(env: &mut JNIEnv, foreign: &Self::ArgType) -> Result<Self, BridgeLayerError> {
        ...
        None.or_else(|| {
            map_native_handle_if_matching_jobject(
                env,
                foreign,
                ClassName("io.zonarosa.libzonarosa.protocol.message.ZonaRosaMessage"),
                Self::ZonaRosaMessage,
            )
            .transpose()
        })
        .or_else(|| {
            map_native_handle_if_matching_jobject(
                env,
                foreign,
                ClassName("io.zonarosa.libzonarosa.protocol.message.PreKeyZonaRosaMessage"),
                Self::PreKeyZonaRosaMessage,
            )
            .transpose()
        })
        .or_else(|| {
            map_native_handle_if_matching_jobject(
                env,
                foreign,
                ClassName("io.zonarosa.libzonarosa.protocol.message.SenderKeyMessage"),
        ...
        .or_else(|| {
            map_native_handle_if_matching_jobject(
                env,
                foreign,
                ClassName("io.zonarosa.libzonarosa.protocol.message.PlaintextContent"),
...
impl<'a> ResultTypeInfo<'a> for CiphertextMessage {
    ...
    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        match self {
            CiphertextMessage::ZonaRosaMessage(m) => {
            ...
            CiphertextMessage::PreKeyZonaRosaMessage(m) => {
                let message = m.convert_into(env)?;
                jobject_from_native_handle(
                    env,
                    ClassName("io.zonarosa.libzonarosa.protocol.message.PreKeyZonaRosaMessage"),
...
impl<'a> SimpleArgTypeInfo<'a> for libzonarosa_net_chat::api::registration::CreateSession {
    type ArgType = JObject<'a>;
    ...
    fn convert_from(
        ...
        check_jobject_type(
            env,
            foreign,
            ClassName("io.zonarosa.libzonarosa.net.RegistrationService$CreateSession"),
        )?;
...
impl<'a> SimpleArgTypeInfo<'a> for crate::net::registration::SignedPublicPreKey {
    ...
    fn convert_from(env: &mut JNIEnv<'a>, obj: &Self::ArgType) -> Result<Self, BridgeLayerError> {
        check_jobject_type(
            env,
            obj,
            ClassName("io.zonarosa.libzonarosa.protocol.SignedPublicPreKey"),
        )?;
        ...
        let values = try_scoped(|| {
            ...
            let public_key = env
                .get_field(
                    obj,
                    "publicKey",
                    jni_signature!(io.zonarosa.libzonarosa.protocol.SerializablePublicKey),
                )?
                .l()?;
        ...
        let public_key = {
            None.or_else(|| {
                map_native_handle_if_matching_jobject(
                    env,
                    &public_key,
                    ClassName("io.zonarosa.libzonarosa.protocol.ecc.ECPublicKey"),
                    PublicKey::serialize,
                )
                .transpose()
            })
            .or_else(|| {
                map_native_handle_if_matching_jobject(
                    env,
                    &public_key,
                    ClassName("io.zonarosa.libzonarosa.protocol.kem.KEMPublicKey"),
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_net::cdsi::LookupResponse {
    type ResultType = JObject<'a>;
    ...
    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        ...
        const ENTRY_CLASS: ClassName =
            ClassName("io.zonarosa.libzonarosa.net.CdsiLookupResponse$Entry");
        let entry_class =
        ...
        new_instance(
            env,
            ClassName("io.zonarosa.libzonarosa.net.CdsiLookupResponse"),
            jni_args!((entries_hashmap => java.util.Map, debug_permits_used => int) -> void),
        )
    }
}

impl<'a> ResultTypeInfo<'a> for libzonarosa_net::chat::Response {
    type ResultType = JObject<'a>;
    ...
    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        ...
        new_instance(
            env,
            ClassName("io.zonarosa.libzonarosa.net.ChatConnection$Response"),
            jni_args!((
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_net_chat::api::ChallengeOption {
    type ResultType = JObject<'a>;

    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        try_scoped(|| {
            let class = find_class(env, ClassName("io.zonarosa.libzonarosa.net.ChallengeOption"))?;
            ...
            env.get_static_field(
                class,
                field_name,
                jni_signature!(io.zonarosa.libzonarosa.net.ChallengeOption),
            )?
            .l()
        })
...
impl<'a> ResultTypeInfo<'a> for &'_ [libzonarosa_net_chat::api::ChallengeOption] {
    type ResultType = JObjectArray<'a>;

    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        let element_class = find_class(env, ClassName("io.zonarosa.libzonarosa.net.ChallengeOption"))
            .check_exceptions(env, "ChallengeOption::convert_into")?;
        make_object_array(env, element_class, self.iter().copied())
    }
}

impl<'a> ResultTypeInfo<'a> for Box<[libzonarosa_net_chat::api::ChallengeOption]> {
    type ResultType = JObjectArray<'a>;
...
impl<'a> ResultTypeInfo<'a> for &'_ libzonarosa_net_chat::api::messages::MismatchedDeviceError {
    type ResultType = JObject<'a>;

    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        let libzonarosa_net_chat::api::messages::MismatchedDeviceError {
            account,
            missing_devices,
            extra_devices,
            stale_devices,
        ...
        new_instance(
            env,
            ClassName("io.zonarosa.libzonarosa.net.MismatchedDeviceException$Entry"),
            jni_args!((
                account_bytes => [byte],
                missing_devices => [int],
                extra_devices => [int],
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_net_chat::api::registration::RegisterResponseBadge {
    type ResultType = JObject<'a>;

    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        const CLASS_NAME: ClassName<'_> =
            ClassName("io.zonarosa.libzonarosa.net.RegisterAccountResponse$BadgeEntitlement");
...
impl<'a> ResultTypeInfo<'a>
    for Box<[libzonarosa_net_chat::api::registration::RegisterResponseBadge]>
{
    type ResultType = JObjectArray<'a>;
...
impl<'a> ResultTypeInfo<'a>
    for libzonarosa_net_chat::api::registration::CheckSvr2CredentialsResponse
{
    type ResultType = JObject<'a>;
    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        const RESULT_CLASS_NAME: &str =
            "io.zonarosa.libzonarosa.net.RegistrationService$Svr2CredentialsResult";
        let jobj = new_instance(env, ClassName("java.util.HashMap"), jni_args!(() -> void))?;
        ...
        for (k, v) in matches {
            let k = k.convert_into(env)?;
            let name = match v {
                libzonarosa_net_chat::api::registration::Svr2CredentialsResult::Match => "MATCH",
                libzonarosa_net_chat::api::registration::Svr2CredentialsResult::NoMatch => "NO_MATCH",
                libzonarosa_net_chat::api::registration::Svr2CredentialsResult::Invalid => "INVALID",
            };
            let v = env.get_static_field(&response_class, name, jni_signature!(io.zonarosa.libzonarosa.net.RegistrationService::Svr2CredentialsResult))
            .and_then(|v| v.l())
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_net::chat::server_requests::DisconnectCause {
    ...
    fn convert_into(self, env: &mut JNIEnv<'a>) -> Result<Self::ResultType, BridgeLayerError> {
        match self {
            ...
            Self::Error(err) => ZonaRosaJniError::from(err).to_throwable(env),
        }
    }
}
