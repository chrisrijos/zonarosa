...
/// # use libzonarosa_bridge_types::node::*;
/// # use neon::prelude::*;
/// # extern crate zonarosa_neon_futures;
/// # struct Foo;
/// # impl SimpleArgTypeInfo for Foo {
/// #     type ArgType = JsObject;
/// #     fn convert_from(cx: &mut FunctionContext, _: Handle<JsObject>) -> NeonResult<Self> {
...
/// let promise = zonarosa_neon_futures::promise(&mut cx, async move {
///     let rust_arg = Foo::load_async_arg(&mut js_arg_stored);
///     // ...
///     zonarosa_neon_futures::settle_promise(|cx| {
...
impl SimpleArgTypeInfo for libzonarosa_protocol::Aci {
    type ArgType = JsUint8Array;
    fn convert_from(cx: &mut FunctionContext, foreign: Handle<Self::ArgType>) -> NeonResult<Self> {
        libzonarosa_protocol::ServiceId::convert_from(cx, foreign)?
            .try_into()
...
impl SimpleArgTypeInfo for libzonarosa_net_chat::api::registration::CreateSession {
    type ArgType = JsObject;
...
impl SimpleArgTypeInfo for libzonarosa_net_chat::api::registration::SignedPreKeyBody<Box<[u8]>> {
    type ArgType = JsObject;
    fn convert_from(cx: &mut FunctionContext, foreign: Handle<Self::ArgType>) -> NeonResult<Self> {
    ...
    for &'storage libzonarosa_account_keys::BackupKey
{
    ...
    fn borrow(
        ...
        <&[u8; libzonarosa_account_keys::BACKUP_KEY_LEN]>::borrow(cx, foreign)
    }
    fn load_from(stored: &'storage mut Self::StoredType) -> Self {
        <&[u8; libzonarosa_account_keys::BACKUP_KEY_LEN]>::load_from(stored).into()
    }
}

impl<'storage> AsyncArgTypeInfo<'storage> for &'storage libzonarosa_account_keys::BackupKey {
    type ArgType = JsTypedArray<u8>;
    type StoredType = PersistentAssumedImmutableBuffer;
    fn save_async_arg(
        cx: &mut FunctionContext,
        ...
        <&[u8; libzonarosa_account_keys::BACKUP_KEY_LEN]>::save_async_arg(cx, foreign)
    }
    fn load_async_arg(stored: &'storage mut Self::StoredType) -> Self {
        <&[u8; libzonarosa_account_keys::BACKUP_KEY_LEN]>::load_async_arg(stored).into()
    }
}
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_protocol::ServiceId {
    type ResultType = JsUint8Array;
    fn convert_into(self, cx: &mut impl Context<'a>) -> JsResult<'a, Self::ResultType> {
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_protocol::Aci {
    type ResultType = JsUint8Array;
    fn convert_into(self, cx: &mut impl Context<'a>) -> JsResult<'a, Self::ResultType> {
        libzonarosa_protocol::ServiceId::from(self).convert_into(cx)
    }
}

impl<'a> ResultTypeInfo<'a> for libzonarosa_protocol::Pni {
    type ResultType = JsUint8Array;
    fn convert_into(self, cx: &mut impl Context<'a>) -> JsResult<'a, Self::ResultType> {
        libzonarosa_protocol::ServiceId::from(self).convert_into(cx)
    }
...
impl<'a> ResultTypeInfo<'a> for &[libzonarosa_message_backup::FoundUnknownField] {
    type ResultType = JsArray;
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_net::cdsi::LookupResponse {
    ...
    fn convert_into(self, cx: &mut impl Context<'a>) -> JsResult<'a, Self::ResultType> {
        fn to_key_value<'a>(
            ...
            libzonarosa_net::cdsi::LookupResponseEntry { e164, aci, pni }:
             libzonarosa_net::cdsi::LookupResponseEntry,
...
impl<'a> ResultTypeInfo<'a> for libzonarosa_net_chat::api::messages::MismatchedDeviceError {
    type ResultType = JsObject;
    fn convert_into(self, cx: &mut impl Context<'a>) -> JsResult<'a, Self::ResultType> {
...
///
/// ```no_run
/// # use libzonarosa_bridge_types::node::{BridgeHandle, BorrowedJsBoxedBridgeHandle, Mutable};
/// # use neon::prelude::*;
