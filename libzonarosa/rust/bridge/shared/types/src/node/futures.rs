...
use zonarosa_neon_futures::ChannelEx;
...
where
    ...
    E: ZonaRosaNodeError + Send + 'static,
{
    ...
    /// with a failure. See [`ZonaRosaNodeError`] for more information.
    pub fn new(
...
/// # use futures_util::FutureExt;
/// # use neon::prelude::*;
/// # use libzonarosa_bridge_types::node::*;
...
/// # }
/// # impl DefaultZonaRosaNodeError for MyError {}
...
/// JavaScript thread, and execute them using [`zonarosa_neon_futures::ChannelEx::start_future`], so
