...
use libzonarosa_account_keys::{AccountEntropyPool, InvalidAccountEntropyPool};
use libzonarosa_net_chat::api::ChallengeOption;
use libzonarosa_net_chat::api::registration::PushToken;
...
///
/// ```
/// # use libzonarosa_bridge_types::ffi::*;
/// # struct Foo;
/// # impl SimpleArgTypeInfo for Foo {
/// #     type ArgType = isize;
/// #     fn convert_from(foreign: isize) -> ZonaRosaFfiResult<Self> { Ok(Foo) }
/// # }
/// # fn main() -> ZonaRosaFfiResult<()> {
/// #     let ffi_arg = 2;
...
pub trait ArgTypeInfo<'storage>: Sized {
    ...
    fn borrow(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self::StoredType>;
...
/// impl SimpleArgTypeInfo for Foo {
///     type ArgType = isize;
///     fn convert_from(foreign: isize) -> ZonaRosaFfiResult<Self> {
///         // ...
///         # Ok(Foo)
///     }
/// }
...
pub trait SimpleArgTypeInfo: Sized {
    ...
    fn convert_from(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self>;
}
...
pub trait CallbackResultTypeInfo: Sized {
    ...
    type ResultType;
    /// Converts the data in `foreign` to the Rust type.
    fn convert_from_callback(foreign: Self::ResultType) -> ZonaRosaFfiResult<Self>;
}
...
impl CallbackResultTypeInfo for () {
    ...
    fn convert_from_callback(_foreign: Self::ResultType) -> ZonaRosaFfiResult<Self> {
        Ok(())
    }
}
...
/// #     fn convert_into(self) -> ZonaRosaFfiResult<isize> { Ok(1) }
/// # }
/// # fn main() -> ZonaRosaFfiResult<()> {
/// #     let rust_result = Foo;
...
pub trait ResultTypeInfo: Sized {
    ...
    fn convert_into(self) -> ZonaRosaFfiResult<Self::ResultType>;
}
...
impl<'a> ArgTypeInfo<'a> for &'a mut [u8] {
    ...
    type StoredType = Self::ArgType;
    fn borrow(mut foreign: Self::ArgType) -> ZonaRosaFfiResult<Self::StoredType> {
        // Check preconditions up front.
...
impl<'a> ArgTypeInfo<'a> for Vec<&'a [u8]> {
    ...
    fn borrow(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self> {
...
impl<const LEN: usize> SimpleArgTypeInfo for &mut [u8; LEN] {
    ...
    fn convert_from(input: Self::ArgType) -> ZonaRosaFfiResult<Self> {
...
impl SimpleArgTypeInfo for Option<u32> {
    type ArgType = u32;
    fn convert_from(foreign: u32) -> ZonaRosaFfiResult<Self> {
        if foreign == u32::MAX {
            Ok(None)
        } else {
            Ok(Some(foreign))
...
impl SimpleArgTypeInfo for String {
    ...
    #[allow(clippy::not_unsafe_ptr_arg_deref)]
    fn convert_from(foreign: *const c_char) -> ZonaRosaFfiResult<Self> {
        if foreign.is_null() {
...
impl SimpleArgTypeInfo for libzonarosa_protocol::ServiceId {
    type ArgType = *const libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes;
    #[allow(clippy::not_unsafe_ptr_arg_deref)]
    fn convert_from(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self> {
        match unsafe { foreign.as_ref() } {
            Some(array) => {
                libzonarosa_protocol::ServiceId::parse_from_service_id_fixed_width_binary(array)
                    .ok_or_else(|| {
...
impl ResultTypeInfo for libzonarosa_protocol::ServiceId {
    type ResultType = libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes;
    fn convert_into(self) -> ZonaRosaFfiResult<Self::ResultType> {
        Ok(self.service_id_fixed_width_binary())
    }
}

impl SimpleArgTypeInfo for libzonarosa_protocol::Aci {
    type ArgType = <libzonarosa_protocol::ServiceId as SimpleArgTypeInfo>::ArgType;
    fn convert_from(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self> {
        libzonarosa_protocol::ServiceId::convert_from(foreign)?
            .try_into()
            .map_err(|_| IllegalArgumentError::new("not an ACI").into())
    }
}

impl ResultTypeInfo for libzonarosa_protocol::Aci {
    type ResultType = libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes;
    fn convert_into(self) -> ZonaRosaFfiResult<Self::ResultType> {
        libzonarosa_protocol::ServiceId::from(self).convert_into()
    }
}

impl SimpleArgTypeInfo for libzonarosa_protocol::Pni {
    type ArgType = <libzonarosa_protocol::ServiceId as SimpleArgTypeInfo>::ArgType;
    fn convert_from(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self> {
        libzonarosa_protocol::ServiceId::convert_from(foreign)?
            .try_into()
...
fn parse_e164(s: &str) -> ZonaRosaFfiResult<libzonarosa_core::E164> {
    let parsed = s
        .parse()
...
impl SimpleArgTypeInfo for libzonarosa_core::E164 {
    type ArgType = <String as SimpleArgTypeInfo>::ArgType;
    fn convert_from(e164: Self::ArgType) -> ZonaRosaFfiResult<Self> {
        let e164 = String::convert_from(e164)?;
        parse_e164(&e164)
    }
}

impl SimpleArgTypeInfo for Option<libzonarosa_core::E164> {
...
impl SimpleArgTypeInfo for libzonarosa_net_chat::api::messages::MultiRecipientSendAuthorization {
    type ArgType = BorrowedSliceOf<c_uchar>;
...
impl<const LEN: usize> SimpleArgTypeInfo for &'_ [u8; LEN] {
    ...
    #[allow(clippy::not_unsafe_ptr_arg_deref)]
    fn convert_from(arg: *const [u8; LEN]) -> ZonaRosaFfiResult<Self> {
...
impl<const LEN: usize> SimpleArgTypeInfo for Option<&'_ [u8; LEN]> {
    type ArgType = *const [u8; LEN];
    #[allow(clippy::not_unsafe_ptr_arg_deref)]
    fn convert_from(arg: Self::ArgType) -> ZonaRosaFfiResult<Self> {
...
impl SimpleArgTypeInfo for libzonarosa_net::chat::LanguageList {
    ...
    fn convert_from(foreign: Self::ArgType) -> ZonaRosaFfiResult<Self> {
        let entries: Vec<&str> = unsafe { foreign.iter()? }
            ...
            .try_collect()?;
        Ok(libzonarosa_net::chat::LanguageList::parse(&entries)
            .map_err(|_| IllegalArgumentError::new("invalid language in list"))?)
    }
}

impl SimpleArgTypeInfo for &libzonarosa_account_keys::BackupKey {
...
impl ResultTypeInfo for &'_ [libzonarosa_net_chat::api::messages::MismatchedDeviceError] {
...
impl ResultTypeInfo for Box<[libzonarosa_net_chat::api::registration::RegisterResponseBadge]> {
...
impl ResultTypeInfo for libzonarosa_net_chat::api::registration::RegisterResponseBadge {
...
impl<T: BridgeHandle> SimpleArgTypeInfo for &T {
    ...
    #[allow(clippy::not_unsafe_ptr_arg_deref)]
    fn convert_from(foreign: ConstPointer<T>) -> ZonaRosaFfiResult<Self> {
...
impl<T: BridgeHandle> SimpleArgTypeInfo for &mut T {
    ...
    #[allow(clippy::not_unsafe_ptr_arg_deref)]
    fn convert_from(foreign: MutPointer<T>) -> ZonaRosaFfiResult<Self> {
...
impl<'a> ArgTypeInfo<'a> for &'a ZonaRosaFfiError {
    ...
    // in practice.
    type ArgType = UnwindSafeArg<*const ZonaRosaFfiError>;
    type StoredType = *const ZonaRosaFfiError;
...
impl ResultTypeInfo for libzonarosa_net::cdsi::LookupResponse {
...
impl ResultTypeInfo for libzonarosa_net::chat::Response {
...
impl ResultTypeInfo for libzonarosa_net_chat::api::registration::CheckSvr2CredentialsResponse {
...
impl ResultTypeInfo for libzonarosa_net::chat::server_requests::DisconnectCause {
    type ResultType = *mut ZonaRosaFfiError;

    fn convert_into(self) -> ZonaRosaFfiResult<Self::ResultType> {
        match self {
            Self::LocalDisconnect => Ok(std::ptr::null_mut()),
            Self::Error(c) => Ok(ZonaRosaFfiError::from(c).into_raw_box_for_ffi()),
        }
    }
}
    ...
    ( $typ:ty as $ffi_name:ident ) => {
        ::paste::paste! {
            #[unsafe(export_name = concat!(
                env!("LIBZONAROSA_BRIDGE_FN_PREFIX_FFI"),
                stringify!($ffi_name),
                "_clone",
            ))]
            ...
            ) -> *mut $crate::ffi::ZonaRosaFfiError {
...
macro_rules! ffi_bridge_as_handle {
    ...
    ( $typ:ty as $ffi_name:ident ) => {
        ...
        impl $crate::ffi::CallbackResultTypeInfo for $typ {
            ...
            ) -> $crate::ffi::ZonaRosaFfiResult<Self> {
...
macro_rules! trivial {
    ($typ:ty) => {
        impl SimpleArgTypeInfo for $typ {
            type ArgType = Self;
            fn convert_from(foreign: Self) -> ZonaRosaFfiResult<Self> {
                Ok(foreign)
            }
        }
        impl ResultTypeInfo for $typ {
            type ResultType = Self;
            fn convert_into(self) -> ZonaRosaFfiResult<Self> {
                Ok(self)
            }
        }
    };
...
macro_rules! ffi_arg_type {
    ...
    (Timestamp) => (u64);
    (Uuid) => (ffi::Uuid);
    (ServiceId) => (*const libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes);
    (Aci) => (*const libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes);
    (Pni) => (*const libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes);
    ...
    (&ZonaRosaFfiError) => (ffi::UnwindSafeArg<*const ZonaRosaFfiError>);
...
macro_rules! ffi_result_type {
    ...
    (ServiceId) => (libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes);
    (Aci) => (libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes);
    (Pni) => (libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes);
    ([u8; $len:expr]) => ([u8; $len]);
    ...
    (Vec<ServiceId>) => (ffi::OwnedBufferOf<libzonarosa_protocol::ServiceIdFixedWidthBinaryBytes>);
    ...
    (DisconnectCause) => (*mut ffi::ZonaRosaFfiError);
