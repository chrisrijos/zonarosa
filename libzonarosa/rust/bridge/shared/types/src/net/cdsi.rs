...
use libzonarosa_net::cdsi::{self, CdsiConnection, ClientResponseCollector, Token};
...
#[cfg(feature = "jni")]
/// CDSI-protocol-specific subset of [`libzonarosa_net::cdsi::LookupError`] cases.
///
        ...
        let (connection_resources, route_provider) = connection_manager
            ...
            .map_err(|InvalidProxyConfig| {
                cdsi::LookupError::ConnectTransport(
                    libzonarosa_net::infra::errors::TransportConnectError::InvalidConfiguration,
                )
            })?;
