...
use libzonarosa_bridge_types::net::chat::{
...
use libzonarosa_net::infra::errors::RetryLater;

use crate::net::make_error_testing_enum;
use crate::*;

pub struct FakeChatConnection {
    chat: std::sync::Mutex<Option<libzonarosa_bridge_types::net::chat::FakeChatConnection>>,
...
fn TESTING_FakeChatConnection_Create(
    ...
    let (chat, remote) = libzonarosa_bridge_types::net::chat::FakeChatConnection::new(
        tokio.handle(),
...
fn TESTING_ChatConnectErrorConvert(
    ...
    Err(match error_description.into_inner() {
        TestingChatConnectError::WebSocketConnectionFailed => {
            ConnectError::WebSocket(libzonarosa_net::infra::ws::WebSocketConnectError::Transport(
                libzonarosa_net::infra::errors::TransportConnectError::TcpConnectionFailed,
            ))
        }
        ...
        TestingChatConnectError::PossibleCaptiveNetwork => {
            ConnectError::WebSocket(libzonarosa_net::infra::ws::WebSocketConnectError::Transport(
                libzonarosa_net::infra::errors::TransportConnectError::SslFailedHandshake(
                    libzonarosa_net::infra::errors::FailedHandshakeReason::Cert {
...
fn TESTING_ChatSendErrorConvert(
    ...
    Err(match error_description.into_inner() {
        ...
        TestingChatSendError::WebSocketConnectionReset => {
            SendError::WebSocket(libzonarosa_net::infra::ws::WebSocketError::Io(
