...
use libzonarosa_bridge_types::support::*;
...
#[cfg(feature = "jni")]
impl From<CustomErrorType> for crate::jni::ZonaRosaJniError {
    fn from(CustomErrorType: CustomErrorType) -> Self {
        crate::jni::TestingError {
            exception_class: crate::jni::ClassName(
                "io.zonarosa.libzonarosa.internal.TestingException",
            ),
        }
        .into()
    }
...
#[cfg(feature = "jni")]
impl From<PoisonErrorType> for crate::jni::ZonaRosaJniError {
    fn from(PoisonErrorType: PoisonErrorType) -> Self {
        crate::jni::TestingError {
            exception_class: crate::jni::ClassName(
                "io.zonarosa.libzonarosa.internal.GuaranteedNonexistentException",
            ),
        }
        .into()
    }
...
fn TESTING_FingerprintVersionMismatchError(
    theirs: u32,
    ours: u32,
) -> Result<(), libzonarosa_protocol::FingerprintError> {
    Err(libzonarosa_protocol::FingerprintError::VersionMismatch { theirs, ours })
}
