...
impl ffi::SimpleArgTypeInfo for NeedsCleanup {
    ...
    fn convert_from(_foreign: Self::ArgType) -> ffi::ZonaRosaFfiResult<Self> {
...
impl<'storage> ffi::ArgTypeInfo<'storage> for PanicOnLoad {
    ...
    fn borrow(_foreign: Self::ArgType) -> ffi::ZonaRosaFfiResult<Self::StoredType> {
        Ok(())
    }
...
impl ffi::ResultTypeInfo for ErrorOnReturn {
    ...
    fn convert_into(self) -> ffi::ZonaRosaFfiResult<Self::ResultType> {
        Err(IllegalArgumentError::new("deliberate error").into())
    }
}
...
impl ffi::SimpleArgTypeInfo for TestingFutureCancellationGuard {
    ...
    fn convert_from(foreign: Self::ArgType) -> ffi::ZonaRosaFfiResult<Self> {
