...
use libzonarosa_bridge_types::net::chat::ServerMessageAck;
use libzonarosa_bridge_types::net::{BuildVariant, ConnectionManager, TokioAsyncContext};
use libzonarosa_core::E164;
use libzonarosa_net::cdsi::{CdsiProtocolError, LookupError, LookupResponse, LookupResponseEntry};
use libzonarosa_net::infra::errors::RetryLater;
use libzonarosa_net::infra::ws::attested::AttestedProtocolError;
use libzonarosa_protocol::{Aci, Pni};
...
fn TESTING_CdsiLookupErrorConvert(
    ...
    Err(match error_description.into_inner() {
        ...
        TestingCdsiLookupError::WebSocketIdleTooLong => {
            LookupError::WebSocket(libzonarosa_net::infra::ws::WebSocketError::ChannelIdleTooLong)
        }
...
fn TESTING_CreateOTP(username: String, secret: &[u8]) -> String {
    libzonarosa_net::auth::Auth::otp(&username, secret, std::time::SystemTime::now())
}
