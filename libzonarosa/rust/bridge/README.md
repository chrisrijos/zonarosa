...
In order for `libzonarosa` to be used from Java, Swift, and TypeScript, the Rust
...
[`libzonarosa-bridge`](./shared/) defines functions that are callable from Java,
...
[`libzonarosa-bridge-macros`](./shared/macros/) is a [proc-macro] crate that
...
The [`libzonarosa-bridge-types`](./shared/types/) crate defines traits and
...
submodule ([`libzonarosa_bridge_types::ffi`], [`libzonarosa_bridge_types::jni`], and
[`libzonarosa_bridge_types::node`]). To make a type usable as an  argument to a
...
async runtime to be used. `libzonarosa_bridge_types` defines traits that support
this.
...
[`libzonarosa-ffi`](./ffi/) and [`libzonarosa-jni`](./jni/) crates to produce a list
...
For TypeScript, the [`libzonarosa-node`] crate is expanded and processed by
...
[`libzonarosa_bridge_types::ffi`]: ./shared/ffi/
[`libzonarosa_bridge_types::jni`]: ./shared/jni/
[`libzonarosa_bridge_types::node`]: ./shared/node/
[`libzonarosa-node`]: ./shared/node/
