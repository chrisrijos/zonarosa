...
use libzonarosa_bridge::jni::*;
use libzonarosa_bridge::net::TokioAsyncContext;
use libzonarosa_bridge::{jni_args, jni_signature};
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Java_io.zonarosa_libzonarosa_internal_Native_initializeLibrary<'local>(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Java_io.zonarosa_libzonarosa_internal_Native_AsyncLoadClass<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
...
#[cfg(not(target_os = "android"))]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Java_io.zonarosa_libzonarosa_internal_Native_SealedSender_1MultiRecipientParseSentMessage<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ...
    run_ffi_safe(&mut env, |env| {
        ...
        const RECIPIENT_CLASS_NAME: ClassName<'_> =
            ClassName("io.zonarosa.libzonarosa.protocol.SealedSenderMultiRecipientMessage$Recipient");
        let (recipient_map, recipient_class, service_id_class) = try_scoped(|| {
            Ok((
                ...
                find_class(env, ClassName("io.zonarosa.libzonarosa.protocol.ServiceId"))?,
            ))
        })
        .check_exceptions(env, "MultiRecipientParseSentMessage")?;
        ...
        let parse_from_fixed_width_binary_method = env
            .get_static_method_id(
                ...
                jni_signature!(([byte]) -> io.zonarosa.libzonarosa.protocol.ServiceId),
            )
        ...
        Ok(new_instance(
            env,
            ClassName("io.zonarosa.libzonarosa.protocol.SealedSenderMultiRecipientMessage"),
            jni_args!((
                data => [byte],
...
/// cbindgen:ignore
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Java_io.zonarosa_libzonarosa_internal_Native_keepAlive(
    _env: JNIEnv,
    _class: JClass,
    _obj: JObject,
) {
