...
pub(crate) const USERNAME_LINK_LABEL_ENCRYPTION_KEY: &[u8] = b"ZonaRosa Username Link Encryption Key";
pub(crate) const USERNAME_LINK_LABEL_AUTHENTICATION_KEY: &[u8] =
    b"ZonaRosa Username Link Authentication Key";
...
mod test {
    ...
    #[test]
    fn generate_points() {
        let mut sho = Sho::new(b"ZonaRosa_Username_20230130_Constant_Points_Generate", b"");
