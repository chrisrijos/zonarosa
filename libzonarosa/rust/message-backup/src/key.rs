...
use hkdf::Hkdf;
use libzonarosa_account_keys::{BackupForwardSecrecyToken, BackupId, BackupKey};
    ...
    pub fn derive<const VERSION: u8>(
        ...
        let (hmac_key, aes_key, []) = derive_arrays(|full_bytes| {
            ...
            match VERSION {
                ...
                <BackupKey>::VERSION => {
                    const OLD_DST: &[u8] = b"20241007_ZONAROSA_BACKUP_ENCRYPT_MESSAGE_BACKUP:";
                    const NEW_DST: &[u8] = b"20250708_ZONAROSA_BACKUP_ENCRYPT_MESSAGE_BACKUP:";
