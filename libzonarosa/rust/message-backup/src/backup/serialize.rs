...
impl serde_with::SerializeAs<libzonarosa_account_keys::BackupKey> for BackupKeyHex {
    fn serialize_as<S>(
        source: &libzonarosa_account_keys::BackupKey,
        serializer: S,
    ) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
...
impl serde_with::SerializeAs<libzonarosa_protocol::IdentityKey> for IdentityKeyHex {
    fn serialize_as<S>(
        source: &libzonarosa_protocol::IdentityKey,
        serializer: S,
    ) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    ...
    impl proto::BackupInfo {
        fn test_data() -> Self {
            Self {
                ...
                mediaRootBackupKey: vec![0xab; libzonarosa_account_keys::BACKUP_KEY_LEN],
                currentAppVersion: "libzonarosa-testing 0.0.2".into(),
                firstAppVersion: "libzonarosa-testing 0.0.1".into(),
                debugInfo: "https://www.debuglogs.org/libzonarosa-testing/not-a-real-url".into(),
    ...
    fn can_serialize() {
        let backup = Backup {
            meta: BackupMeta {
                ...
                media_root_backup_key: libzonarosa_account_keys::BackupKey(
                    [0xab; libzonarosa_account_keys::BACKUP_KEY_LEN],
                ),
                current_app_version: "libzonarosa-testing 0.0.2".into(),
                first_app_version: "libzonarosa-testing 0.0.1".into(),
            },
