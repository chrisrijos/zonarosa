...
//! independent; for ZonaRosa, the _issuing server_ is usually the main chat server (which knows who
...
//!
//! This model is based on "[The ZonaRosa Private Group System and Anonymous Credentials Supporting
...
/// arguments because it makes it easier to write expected-output tests in the languages libzonarosa
