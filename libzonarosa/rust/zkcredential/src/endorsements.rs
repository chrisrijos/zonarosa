...
impl ServerRootKeyPair {
    ...
    pub fn generate(randomness: [u8; RANDOMNESS_LEN]) -> Self {
        let mut sho = poksho::ShoHmacSha256::new(
            b"ZonaRosa_ZKCredential_Endorsements_ServerRootKeyPair_generate_20240207",
        );
...
impl EndorsementResponse {
    ...
    fn generate_weights_for_proof(
        ...
        let mut hasher = poksho::ShoHmacSha256::new(
            b"ZonaRosa_ZKCredential_Endorsements_EndorsementResponse_ProofWeights_20240207",
        );
