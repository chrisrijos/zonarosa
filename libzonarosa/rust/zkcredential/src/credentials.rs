...
impl CredentialPrivateKey {
    ...
    fn generate(randomness: [u8; RANDOMNESS_LEN]) -> Self {
        let mut sho =
            ShoHmacSha256::new(b"ZonaRosa_ZKCredential_CredentialPrivateKey_generate_20230410");
...
impl SystemParams {
    ...
    /// operations.
    fn generate() -> Self {
        let mut sho = ShoSha256::new(b"ZonaRosa_ZKCredential_ConstantSystemParams_generate_20230410");
