...
pub fn derive_default_generator_points<D: Domain>(
    ...
    fn derive_impl<D: Domain>() -> [RistrettoPoint; 2] {
        let mut sho = poksho::ShoHmacSha256::new(b"ZonaRosa_ZKCredential_Domain_20231011");
...
/// have other purposes, such as the encryption of UUIDs and profile keys in a ZonaRosa group, and
