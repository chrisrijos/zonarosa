...
use libzonarosa_core::curve::{CurveError, KeyType};
use thiserror::Error;
use uuid::Uuid;

use crate::kem;

pub type Result<T> = std::result::Result<T, ZonaRosaProtocolError>;

#[derive(Debug, Display, Error)]
pub enum ZonaRosaProtocolError {
    /// invalid argument: {0}
...
impl ZonaRosaProtocolError {
    /// Convenience factory for [`ZonaRosaProtocolError::ApplicationCallbackError`].
    #[inline]
...
impl From<CurveError> for ZonaRosaProtocolError {
