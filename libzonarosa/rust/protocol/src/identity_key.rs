...
//! Wrappers over cryptographic primitives from [`libzonarosa_core::curve`] to represent a user.
...
use crate::{KeyPair, PrivateKey, PublicKey, Result, ZonaRosaProtocolError, proto};
...
const ALTERNATE_IDENTITY_SIGNATURE_PREFIX_2: &[u8] = b"ZonaRosa_PNI_Signature";
