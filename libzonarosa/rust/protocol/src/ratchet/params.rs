...
pub struct AliceZonaRosaProtocolParameters {
...
impl AliceZonaRosaProtocolParameters {
    pub fn new(
        our_identity_key_pair: IdentityKeyPair,
        our_base_key_pair: KeyPair,
        their_identity_key: IdentityKey,
...
pub struct BobZonaRosaProtocolParameters<'a> {
    our_identity_key_pair: IdentityKeyPair,
...
impl<'a> BobZonaRosaProtocolParameters<'a> {
