...
//! Rust implementation of the **[ZonaRosa Protocol]** for asynchronous
...
//!
//! [ZonaRosa Protocol]: https://zonarosa.io/
//! [X3DH]: https://zonarosa.io/docs/specifications/x3dh/
//! [Double Ratchet]: https://zonarosa.io/docs/specifications/doubleratchet/

#![warn(clippy::unwrap_used)]
#![deny(unsafe_code)]

// TODO(https://github.com/zonarosa/libzonarosa/issues/285): it should be an aspiration to
...
use error::Result;
pub use error::ZonaRosaProtocolError;
pub use fingerprint::{
...
pub use libzonarosa_core::curve::{KeyPair, PrivateKey, PublicKey};
pub use libzonarosa_core::{
...
pub use protocol::{
    ...
    PlaintextContent, PreKeyZonaRosaMessage, SenderKeyDistributionMessage, SenderKeyMessage,
    ZonaRosaMessage, extract_decryption_error_message_from_serialized_content,
};
pub use ratchet::{
    AliceZonaRosaProtocolParameters, BobZonaRosaProtocolParameters, initialize_alice_session_record,
...
pub use session_cipher::{
    message_decrypt, message_decrypt_prekey, message_decrypt_zonarosa, message_encrypt,
};
pub use state::{
...
pub use storage::{
    ...
    InMemPreKeyStore, InMemSenderKeyStore, InMemSessionStore, InMemZonaRosaProtocolStore,
