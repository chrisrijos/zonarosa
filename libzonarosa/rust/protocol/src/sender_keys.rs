...
use crate::{PrivateKey, PublicKey, ZonaRosaProtocolError, consts};
...
impl SenderChainKey {
    ...
    pub(crate) fn next(&self) -> Result<SenderChainKey, ZonaRosaProtocolError> {
...
impl SenderKeyRecord {
    ...
    pub fn deserialize(buf: &[u8]) -> Result<SenderKeyRecord, ZonaRosaProtocolError> {
...
mod sender_chain_key_iteration_tests {
    ...
    use crate::ZonaRosaProtocolError;
    ...
    fn when_sender_chain_key_iteration_overflows() {
        ...
        assert_matches!(
            ...
            Err(ZonaRosaProtocolError::InvalidState { .. })
        );
    }
}
