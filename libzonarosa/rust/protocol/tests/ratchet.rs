...
#[test]
fn test_alice_and_bob_agree_on_chain_keys_with_kyber() -> Result<(), ZonaRosaProtocolError> {
    ...
    let alice_parameters = AliceZonaRosaProtocolParameters::new(
    ...
    let bob_parameters = BobZonaRosaProtocolParameters::new(
...
#[test]
fn test_bob_rejects_torsioned_basekey() -> Result<(), ZonaRosaProtocolError> {
    let mut csprng = rand::rngs::OsRng.unwrap_err();
...
#[test]
fn test_bob_rejects_highbit_basekey() -> Result<(), ZonaRosaProtocolError> {
    let mut csprng = rand::rngs::OsRng.unwrap_err();
