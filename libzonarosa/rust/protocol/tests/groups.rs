...
#[test]
fn group_no_send_session() -> Result<(), ZonaRosaProtocolError> {
...
#[test]
fn group_no_recv_session() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err().unwrap_err();
...
#[test]
fn group_basic_encrypt_decrypt() -> Result<(), ZonaRosaProtocolError> {
    async {
...
#[test]
fn group_sealed_sender() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
...
#[test]
fn group_sealed_sender_multiple_devices() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
...
#[test]
fn group_sealed_sender_multiple_devices_and_excluded_recipients() -> Result<(), ZonaRosaProtocolError>
{
    async {
        let mut csprng = OsRng.unwrap_err();
...
#[test]
fn group_large_messages() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
...
#[test]
fn group_basic_ratchet() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
        ...
        assert!(matches!(
            ...
            .await,
            Err(ZonaRosaProtocolError::DuplicatedMessage(1, 0))
        ));
...
#[test]
fn group_late_join() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
...
#[test]
fn group_out_of_order() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
...
fn group_too_far_in_the_future() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
...
#[test]
fn group_message_key_limit() -> Result<(), ZonaRosaProtocolError> {
    async {
        let mut csprng = OsRng.unwrap_err();
