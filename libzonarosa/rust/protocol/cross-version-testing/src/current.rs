...
use libzonarosa_protocol_current::*;
use rand::{Rng, rng};
...
pub struct LibZonaRosaProtocolCurrent(InMemZonaRosaProtocolStore);

impl LibZonaRosaProtocolCurrent {
    pub fn new() -> Self {
        let mut csprng = rng();
...
impl super::LibZonaRosaProtocolStore for LibZonaRosaProtocolCurrent {
