...
use libzonarosa_protocol_cross_version_testing::*;
...
fn make_alice_sender_cert(alice_store: &mut dyn LibZonaRosaProtocolStore) -> SenderCertificate {
...
#[test]
fn ssv1() {
    try_all_combinations(run, &[|| Box::new(LibZonaRosaProtocolV70::new())]);

    fn run(
        alice_store: &mut dyn LibZonaRosaProtocolStore,
