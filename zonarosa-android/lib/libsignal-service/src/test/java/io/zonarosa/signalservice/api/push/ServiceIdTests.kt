...
import io.zonarosa.libzonarosa.protocol.ServiceId.Aci as LibZonaRosaAci
import io.zonarosa.libzonarosa.protocol.ServiceId.Pni as LibZonaRosaPni
...
class ServiceIdTests {
  ...
  fun `ServiceId parseOrNull ByteArray`() {
    ...
    assertEquals(PNI.from(UUID.fromString(uuidString)), ServiceId.parseOrNull(LibZonaRosaPni(uuid).toServiceIdBinary()))
    assertEquals(ACI.from(UUID.fromString(uuidString)), ServiceId.parseOrNull(LibZonaRosaAci(uuid).toServiceIdFixedWidthBinary()))
    assertEquals(PNI.from(UUID.fromString(uuidString)), ServiceId.parseOrNull(LibZonaRosaPni(uuid).toServiceIdFixedWidthBinary()))
  }
  ...
  fun `ACI parseOrNull String`() {
    ...
    assertNull(ACI.parseOrNull(LibZonaRosaPni(uuid).toServiceIdString()))
  ...
  fun `ACI parseOrNull ByteArray`() {
    ...
    assertNull(ACI.parseOrNull(LibZonaRosaPni(uuid).toServiceIdBinary()))

    assertEquals(ACI.from(UUID.fromString(uuidString)), ACI.parseOrNull(uuidBytes))
    assertEquals(ACI.from(UUID.fromString(uuidString)), ACI.parseOrNull(LibZonaRosaAci(uuid).toServiceIdBinary()))
    assertEquals(ACI.from(UUID.fromString(uuidString)), ACI.parseOrNull(LibZonaRosaAci(uuid).toServiceIdFixedWidthBinary()))
  }
  ...
  fun `PNI parseOrNull ByteArray`() {
    ...
    assertNull(PNI.parseOrNull(LibZonaRosaAci(uuid).toServiceIdFixedWidthBinary()))

    assertEquals(PNI.from(UUID.fromString(uuidString)), PNI.parseOrNull(uuidBytes))
    assertEquals(PNI.from(UUID.fromString(uuidString)), PNI.parseOrNull(LibZonaRosaPni(uuid).toServiceIdBinary()))
  }
