...
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.admin;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.approveMember;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.bannedMember;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.demoteAdmin;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.encrypt;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.encryptedMember;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.encryptedRequestingMember;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.member;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.pendingMember;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.pendingMemberRemoval;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.pendingPniAciMember;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.presentation;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.promoteAdmin;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.randomProfileKey;
import static io.zonarosa.service.api.groupsv2.ProtoTestUtils.requestingMember;
import static io.zonarosa.service.api.groupsv2.ProtobufTestUtils.getMaxDeclaredFieldNumber;
...
public final class GroupChangeUtil_resolveConflict_Test {
  ...
  public void field_26__modify_member_label__remove_if_member_not_in_group() {
    ...
    DecryptedModifyMemberLabel modifyLabelAction = new io.zonarosa.storageservice.storage.protos.groups.local.DecryptedModifyMemberLabel.Builder()
