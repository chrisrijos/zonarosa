...
import io.zonarosa.libzonarosa.zkgroup.backups.BackupAuthCredential
import io.zonarosa.libzonarosa.zkgroup.backups.BackupAuthCredentialRequestContext
import io.zonarosa.libzonarosa.zkgroup.backups.BackupAuthCredentialResponse
import io.zonarosa.service.api.NetworkResult
import io.zonarosa.service.api.archive.ArchiveGetMediaItemsResponse.StoredMediaObject
...
class ArchiveApi(
   ...
   */
  fun uploadBackupFile(uploadForm: AttachmentUploadForm, resumableUploadUrl: String, data: InputStream, dataLength: Long, progressListener: ZonaRosaServiceAttachment.ProgressListener? = null): NetworkResult<Unit> {
    return NetworkResult.fromFetch {
   ...
   *
   * This is basically the same as [io.zonarosa.service.api.attachment.AttachmentApi.getAttachmentV4UploadForm], but with a relaxed rate limit
