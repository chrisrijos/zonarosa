...
import io.zonarosa.core.models.storageservice.StorageCipherKey
...
object ZonaRosaStorageCipher {
  ...
  @JvmStatic
  @Throws(io.zonarosa.libzonarosa.protocol.InvalidKeyException::class)
  fun decrypt(key: StorageCipherKey, data: ByteArray): ByteArray {
    try {
      ...
      throw io.zonarosa.libzonarosa.protocol.InvalidKeyException(e)
    } catch (e: BadPaddingException) {
      throw io.zonarosa.libzonarosa.protocol.InvalidKeyException(e)
    } catch (e: IllegalBlockSizeException) {
      throw io.zonarosa.libzonarosa.protocol.InvalidKeyException(e)
