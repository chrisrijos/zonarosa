...
import io.zonarosa.service.internal.push.CheckRepeatedUsedPreKeysRequest
...
import io.zonarosa.service.internal.push.PreKeyState
...
class KeysApi(
   ...
   */
  fun getPreKeys(
    destination: ZonaRosaServiceAddress,
   ...
   * - 429: Rate limited
   */
  fun getPreKey(destination: ZonaRosaServiceAddress, deviceId: Int): NetworkResult<PreKeyBundle> {
   ...
   * - 429: Rate limited
   */
  private fun getPreKeysBySpecifier(destination: ZonaRosaServiceAddress, sealedSenderAccess: SealedSenderAccess?, deviceSpecifier: String): NetworkResult<List<PreKeyBundle>> {
