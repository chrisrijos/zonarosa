...
import io.zonarosa.service.internal.push.BankMandate
...
/**
 * One-stop shop for ZonaRosa service calls related to in-app payments.
 *
 * Be sure to check for cached versions of these methods in DonationsService before calling these methods elsewhere.
 */
class DonationsApi(private val authWebSocket: ZonaRosaWebSocket.AuthenticatedWebSocket, private val unauthWebSocket: ZonaRosaWebSocket.UnauthenticatedWebSocket) {
  ...
  /**
   * Creates a subscriber record on the zonarosa server.
   *
