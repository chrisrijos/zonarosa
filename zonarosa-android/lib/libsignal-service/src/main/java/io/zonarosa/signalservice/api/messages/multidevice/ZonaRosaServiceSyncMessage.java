...
import io.zonarosa.service.internal.push.SyncMessage.AttachmentBackfillResponse;
import io.zonarosa.service.internal.push.SyncMessage.DeviceNameChange;
import io.zonarosa.service.internal.push.SyncMessage.CallEvent;
...
public class ZonaRosaServiceSyncMessage {
  ...
  private ZonaRosaServiceSyncMessage(Optional<SentTranscriptMessage> sent,
  ...
  public static ZonaRosaServiceSyncMessage forSentTranscript(SentTranscriptMessage sent) {
    return new ZonaRosaServiceSyncMessage(Optional.of(sent),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forContacts(ContactsMessage contacts) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forRequest(RequestMessage request) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.of(request),
  ...
  public static ZonaRosaServiceSyncMessage forRead(List<ReadMessage> reads) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forViewed(List<ViewedMessage> views) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forViewOnceOpen(ViewOnceOpenMessage timerRead) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forRead(ReadMessage read) {
  ...
  public static ZonaRosaServiceSyncMessage forVerified(VerifiedMessage verifiedMessage) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forBlocked(BlockedListMessage blocked) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.of(blocked),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forConfiguration(ConfigurationMessage configuration) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forStickerPackOperations(List<StickerPackOperationMessage> stickerPackOperations) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forFetchLatest(FetchType fetchType) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forKeys(KeysMessage keys) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forMessageRequestResponse(MessageRequestResponseMessage messageRequestResponse) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forOutgoingPayment(OutgoingPaymentMessage outgoingPaymentMessage) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forCallEvent(@Nonnull CallEvent callEvent) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forCallLinkUpdate(@Nonnull CallLinkUpdate callLinkUpdate) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forCallLogEvent(@Nonnull CallLogEvent callLogEvent) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forDeviceNameChange(@Nonnull DeviceNameChange deviceNameChange) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage forAttachmentBackfillResponse(@Nonnull AttachmentBackfillResponse backfillResponse) {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static ZonaRosaServiceSyncMessage empty() {
    return new ZonaRosaServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
