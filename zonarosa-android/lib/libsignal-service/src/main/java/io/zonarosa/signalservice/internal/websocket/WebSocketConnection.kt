 ...
 *  - LibZonaRosaChatConnection - the wrapper around libzonarosa's [io.zonarosa.libzonarosa.net.ChatService]
 */
interface WebSocketConnection {
   ...
   * This is specifically for LibZonaRosa-based connections to access the native connection.
   *
  ...
  suspend fun <T> runWithChatConnection(callback: (io.zonarosa.libzonarosa.net.ChatConnection) -> T): T {
    // Default implementation for non-LibZonaRosa connections
