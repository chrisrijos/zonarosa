...
import static io.zonarosa.core.util.CryptoUtil.hmacSha256;
import static io.zonarosa.util.ByteArrayUtil.concat;
import static io.zonarosa.util.ByteArrayUtil.xor;
