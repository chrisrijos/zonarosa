...
import io.zonarosa.service.api.buildOkHttpClient
import io.zonarosa.service.api.chooseUrl
...
import io.zonarosa.service.internal.push.ProvisioningAddress
import io.zonarosa.service.internal.websocket.WebSocketMessage
...
class ProvisioningSocket<T> private constructor(
  ...
  configuration: ZonaRosaServiceConfiguration,
  ...
  private val serviceUrl = configuration.zonarosaServiceUrls.chooseUrl()
