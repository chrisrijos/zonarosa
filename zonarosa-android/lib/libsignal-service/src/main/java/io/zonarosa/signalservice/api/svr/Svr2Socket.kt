...
import io.zonarosa.libzonarosa.sgxsession.SgxCommunicationFailureException
import io.zonarosa.libzonarosa.svr2.Svr2Client
...
import io.zonarosa.svr2.proto.Request as Svr2Request
import io.zonarosa.svr2.proto.Response as Svr2Response
...
internal class Svr2Socket(
  ...
  private val svr2Url: ZonaRosaSvr2Url = configuration.zonarosaSvr2Urls.chooseUrl()
