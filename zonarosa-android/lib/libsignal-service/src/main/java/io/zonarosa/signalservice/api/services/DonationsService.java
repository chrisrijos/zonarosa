...
/**
 * One-stop shop for ZonaRosa service calls related to donations.
 */
public class DonationsService {
  ...
  /**
   * Creates a subscriber record on the zonarosa server and stripe. Can be called idempotently as-is. After receiving 200 from this endpoint,
