package io.zonarosa.service.api.messages.shared;
...
public class SharedContact {
  ...
  public static class Avatar {
    private final ZonaRosaServiceAttachment attachment;
    private final boolean                 isProfile;

    public Avatar(ZonaRosaServiceAttachment attachment, boolean isProfile) {
      this.attachment = attachment;
      this.isProfile  = isProfile;
    }

    public ZonaRosaServiceAttachment getAttachment() {
      return attachment;
    }
    ...
    public static class Builder {
      private ZonaRosaServiceAttachment attachment;
      private boolean                 isProfile;

      public Builder withAttachment(ZonaRosaServiceAttachment attachment) {
        this.attachment = attachment;
        return this;
      }
