...
import io.zonarosa.service.api.NetworkResult.ApplicationError
...
sealed class NetworkResult<T>(
  ...
  companion object {
    ...
    fun fromWebSocketRequest(
      zonarosaWebSocket: ZonaRosaWebSocket,
    ...
    fun <T : Any> fromWebSocketRequest(
      ...
      return fromWebSocket(webSocketResponseConverter) { zonarosaWebSocket.request(request, timeout) }
    }
