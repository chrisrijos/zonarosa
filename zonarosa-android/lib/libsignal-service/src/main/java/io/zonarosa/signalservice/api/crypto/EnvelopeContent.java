...
import io.zonarosa.service.internal.push.Envelope.Type;
...
public interface EnvelopeContent {
   ...
   */
  OutgoingPushMessage processSealedSender(ZonaRosaSessionCipher sessionCipher,
                                          ZonaRosaSealedSessionCipher sealedSessionCipher,
                                          ZonaRosaProtocolAddress destination,
   ...
   */
  OutgoingPushMessage processUnsealedSender(ZonaRosaSessionCipher sessionCipher, ZonaRosaProtocolAddress destination) throws UntrustedIdentityException, NoSessionException;
  ...
  class Encrypted implements EnvelopeContent {
    ...
    @Override
    public OutgoingPushMessage processSealedSender(ZonaRosaSessionCipher sessionCipher,
                                                   ZonaRosaSealedSessionCipher sealedSessionCipher,
                                                   ZonaRosaProtocolAddress destination,
                                                   SenderCertificate senderCertificate)
        throws UntrustedIdentityException, InvalidKeyException, NoSessionException
    ...
    @Override
    public OutgoingPushMessage processUnsealedSender(ZonaRosaSessionCipher sessionCipher, ZonaRosaProtocolAddress destination) throws UntrustedIdentityException, NoSessionException {
      PushTransportDetails transportDetails     = new PushTransportDetails();
      CiphertextMessage    message              = sessionCipher.encrypt(transportDetails.getPaddedMessageBody(content.encode()));
  ...
  class Plaintext implements EnvelopeContent {
    ...
    @Override
    public OutgoingPushMessage processUnsealedSender(ZonaRosaSessionCipher sessionCipher, ZonaRosaProtocolAddress destination) {
