...
import io.zonarosa.messenger.video.exceptions.VideoSizeException;
...
import io.zonarosa.messenger.video.videoconverter.MediaConverter;
...
public final class StreamingTranscoder {
  ...
  public long transcode(@NonNull Progress progress,
                        ...
                        @Nullable TranscoderCancelationZonaRosa cancelationZonaRosa)
      throws IOException, EncodingException
  {
    ...
    converter.setListener(percent -> {
      ...
      return cancelationZonaRosa != null && cancelationZonaRosa.isCanceled();
    });
