...
package io.zonarosa.debuglogsviewer.app.webview
...
import io.zonarosa.debuglogsviewer.app.R
...
fun setupWebView(
  ...
  copyButton.setOnClickListener {
    // In ZonaRosa app, use Util.writeTextToClipboard(context, value) instead
