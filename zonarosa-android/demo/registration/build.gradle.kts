...
android {
  namespace = "io.zonarosa.registration.sample"

  defaultConfig {
    // IMPORTANT: We use the same package name as the zonarosa staging app so that FCM works.
    applicationId = "io.zonarosa.messenger.staging"
    versionCode = 1
    versionName = "1.0"
...
dependencies {
  ...
  // libzonarosa-protocol for PreKeyCollection types
  implementation(libs.libzonarosa.client)
