package io.zonarosa.devicetransfer.app;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    final TextView libzonarosaVersion = findViewById(R.id.libzonarosa_version);
    libzonarosaVersion.setText(BuildConfig.LIBZONAROSA_VERSION);
