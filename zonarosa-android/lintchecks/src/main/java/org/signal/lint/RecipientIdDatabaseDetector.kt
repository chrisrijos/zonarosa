...
class RecipientIdDatabaseDetector : Detector(), SourceCodeScanner {
  ...
  override fun createUastHandler(context: JavaContext): UElementHandler {
    return object : UElementHandler() {
      override fun visitClass(node: UClass) {
        ...
        val implementsReference = node.interfaces.any { it.qualifiedName == "io.zonarosa.messenger.database.RecipientIdDatabaseReference" }
  ...
  companion object {
    ...
    private val EXEMPTED_CLASSES = setOf("io.zonarosa.messenger.database.RecipientDatabase")
  }
}