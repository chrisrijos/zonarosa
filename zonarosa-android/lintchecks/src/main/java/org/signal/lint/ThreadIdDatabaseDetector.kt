...
class ThreadIdDatabaseDetector : Detector(), SourceCodeScanner {
    ...
    return object : UElementHandler() {
      override fun visitClass(node: UClass) {
        ...
        val implementsReference = node.interfaces.any { nodeInterface ->
          "io.zonarosa.messenger.database.ThreadIdDatabaseReference" == nodeInterface.qualifiedName
        }
  ...
  companion object {
    ...
    private val EXEMPTED_CLASSES = setOf("io.zonarosa.messenger.database.ThreadDatabase")
  }
}
