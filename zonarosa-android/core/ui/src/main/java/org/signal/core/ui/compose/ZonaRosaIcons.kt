...
/**
 * ZonaRosa icon library with all available icons.
 */
enum class ZonaRosaIcons(private val icon: ZonaRosaIcon) : ZonaRosaIcon by icon {
...
private fun icon(@DrawableRes id: Int) = ZonaRosaIcon.DrawableIcon(id)
private fun icon(image: ImageVector) = ZonaRosaIcon.ImageVectorIcon(image)

sealed interface ZonaRosaIcon {
  @get:Composable
  val painter: Painter
   ...
   */
  @JvmInline
  value class DrawableIcon(@get:DrawableRes private val drawableId: Int) : ZonaRosaIcon {
    @get:Composable
   ...
   */
  @JvmInline
  value class ImageVectorIcon(val image: ImageVector) : ZonaRosaIcon {
    @get:Composable
    override val painter: Painter
...
@DayNightPreviews
@Composable
private fun ZonaRosaIconsPreview() {
  Previews.Preview {
    LazyVerticalGrid(
      ...
      items(ZonaRosaIcons.entries.sortedBy { it.name }) { icon ->
        Column(
