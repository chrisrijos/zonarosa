package io.zonarosa.core.ui.util;
...
public class StorageUtil {
  ...
  private static final String PRODUCTION_PACKAGE_ID = "io.zonarosa.messenger";
  ...
  public static File getBackupDirectory() throws NoExternalStorageException {
    File   storage   = Environment.getExternalStorageDirectory();
    File   zonarosa    = new File(storage, "ZonaRosa");
    File   backups   = new File(zonarosa, "Backups");
  ...
  public static File getBackupV2Directory() throws NoExternalStorageException {
    File   storage   = Environment.getExternalStorageDirectory();
    File   backups   = new File(storage, "ZonaRosa");
    String packageId = CoreUiDependencies.INSTANCE.getPackageId();
  ...
  private static File getZonaRosaStorageDir() throws NoExternalStorageException {
  ...
  public static boolean canWriteInZonaRosaStorageDir() {
    File storage;

    try {
      storage = getZonaRosaStorageDir();
