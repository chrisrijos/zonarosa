...
public final class ZonaRosaExecutors {

  public static final ExecutorService UNBOUNDED  = Executors.newCachedThreadPool(new NumberedThreadFactory("zonarosa-unbounded", ThreadUtil.PRIORITY_BACKGROUND_THREAD));
  public static final ExecutorService BOUNDED    = Executors.newFixedThreadPool(4, new NumberedThreadFactory("zonarosa-bounded", ThreadUtil.PRIORITY_BACKGROUND_THREAD));
  public static final ExecutorService SERIAL     = Executors.newSingleThreadExecutor(new NumberedThreadFactory("zonarosa-serial", ThreadUtil.PRIORITY_BACKGROUND_THREAD));
  public static final ExecutorService BOUNDED_IO = newCachedBoundedExecutor("zonarosa-io-bounded", ThreadUtil.PRIORITY_IMPORTANT_BACKGROUND_THREAD, 1, 32, 30);

  private ZonaRosaExecutors() {}
