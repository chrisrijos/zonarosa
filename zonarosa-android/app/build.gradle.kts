...
wire {
  ...
  protoPath {
    srcDir("${project.rootDir}/lib/libzonarosa-service/src/main/protowire")
  }
  // Handled by libzonarosa
  prune("zonarosaservice.DecryptionErrorMessage")
}
...
android {
  namespace = "io.zonarosa.messenger"
  ...
  defaultConfig {
    ...
    project.ext.set("archivesBaseName", "ZonaRosa")

    manifestPlaceholders["mapsKey"] = "AIzaSyCSx9xea86GwDKGznCAULE9Y5a8b-TfN9U"

    buildConfigField("long", "BUILD_TIMESTAMP", getLastCommitTimestamp() + "L")
    buildConfigField("String", "GIT_HASH", "\"${getGitHash()}\"")
    buildConfigField("String", "ZONAROSA_URL", "\"https://chat.zonarosa.io\"")
    buildConfigField("String", "STORAGE_URL", "\"https://storage.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_CDN_URL", "\"https://cdn.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_CDN2_URL", "\"https://cdn2.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_CDN3_URL", "\"https://cdn3.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_CDSI_URL", "\"https://cdsi.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_SERVICE_STATUS_URL", "\"uptime.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_SVR2_URL", "\"https://svr2.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_SFU_URL", "\"https://sfu.voip.zonarosa.io\"")
    buildConfigField("String", "ZONAROSA_STAGING_SFU_URL", "\"https://sfu.staging.voip.zonarosa.io\"")
    buildConfigField("String[]", "ZONAROSA_SFU_INTERNAL_NAMES", "new String[]{\"Test\", \"Staging\", \"Development\"}")
    buildConfigField("String[]", "ZONAROSA_SFU_INTERNAL_URLS", "new String[]{\"https://sfu.test.voip.zonarosa.io\", \"https://sfu.staging.voip.zonarosa.io\", \"https://sfu.staging.test.voip.zonarosa.io\"}")
    buildConfigField("String", "CONTENT_PROXY_HOST", "\"contentproxy.zonarosa.io\"")
    buildConfigField("int", "CONTENT_PROXY_PORT", "443")
    buildConfigField("String[]", "ZONAROSA_SERVICE_IPS", rootProject.extra["service_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_STORAGE_IPS", rootProject.extra["storage_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_CDN_IPS", rootProject.extra["cdn_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_CDN2_IPS", rootProject.extra["cdn2_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_CDN3_IPS", rootProject.extra["cdn3_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_SFU_IPS", rootProject.extra["sfu_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_CONTENT_PROXY_IPS", rootProject.extra["content_proxy_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_CDSI_IPS", rootProject.extra["cdsi_ips"] as String)
    buildConfigField("String[]", "ZONAROSA_SVR2_IPS", rootProject.extra["svr2_ips"] as String)
    buildConfigField("String", "ZONAROSA_AGENT", "\"OWA\"")
    ...
    buildConfigField("String", "ZONAROSA_CAPTCHA_URL", "\"https://zonarosacaptchas.org/registration/generate.html\"")
    buildConfigField("String", "RECAPTCHA_PROOF_URL", "\"https://zonarosacaptchas.org/challenge/generate.html\"")
    buildConfigField("io.zonarosa.libzonarosa.net.Network.Environment", "LIBZONAROSA_NET_ENV", "io.zonarosa.libzonarosa.net.Network.Environment.PRODUCTION")
    buildConfigField("int", "LIBZONAROSA_LOG_LEVEL", "io.zonarosa.libzonarosa.protocol.logging.ZonaRosaProtocolLogger.INFO")

    buildConfigField("String", "BUILD_DISTRIBUTION_TYPE", "\"unset\"")
    buildConfigField("String", "BUILD_ENVIRONMENT_TYPE", "\"unset\"")
    buildConfigField("String", "BUILD_VARIANT_TYPE", "\"unset\"")
    buildConfigField("String", "BADGE_STATIC_ROOT", "\"https://updates2.zonarosa.io/static/badges/\"")
    ...
    testInstrumentationRunner = "io.zonarosa.messenger.testing.ZonaRosaTestRunner"
  ...
  buildTypes {
    ...
    create("benchmark") {
      ...
      manifestPlaceholders["applicationClass"] = "io.zonarosa.messenger.BenchmarkApplicationContext"
    }
    ...
    create("mocked") {
      ...
      manifestPlaceholders["applicationClass"] = "io.zonarosa.messenger.ApplicationContext"
    }
  ...
  productFlavors {
    ...
    create("website") {
      ...
      buildConfigField("String", "APK_UPDATE_MANIFEST_URL", "\"https://updates.zonarosa.io/android/latest.json\"")
    ...
    create("staging") {
      ...
      buildConfigField("String", "ZONAROSA_URL", "\"https://chat.staging.zonarosa.io\"")
      buildConfigField("String", "STORAGE_URL", "\"https://storage-staging.zonarosa.io\"")
      buildConfigField("String", "ZONAROSA_CDN_URL", "\"https://cdn-staging.zonarosa.io\"")
      buildConfigField("String", "ZONAROSA_CDN2_URL", "\"https://cdn2-staging.zonarosa.io\"")
      buildConfigField("String", "ZONAROSA_CDN3_URL", "\"https://cdn3-staging.zonarosa.io\"")
      buildConfigField("String", "ZONAROSA_CDSI_URL", "\"https://cdsi.staging.zonarosa.io\"")
      buildConfigField("String", "ZONAROSA_SVR2_URL", "\"https://svr2.staging.zonarosa.io\"")
      ...
      buildConfigField("String", "ZONAROSA_CAPTCHA_URL", "\"https://zonarosacaptchas.org/staging/registration/generate.html\"")
      buildConfigField("String", "RECAPTCHA_PROOF_URL", "\"https://zonarosacaptchas.org/staging/challenge/generate.html\"")
      buildConfigField("io.zonarosa.libzonarosa.net.Network.Environment", "LIBZONAROSA_NET_ENV", "io.zonarosa.libzonarosa.net.Network.Environment.STAGING")
      buildConfigField("int", "LIBZONAROSA_LOG_LEVEL", "io.zonarosa.libzonarosa.protocol.logging.ZonaRosaProtocolLogger.DEBUG")
  ...
  androidComponents {
    ...
    onVariants(selector().all()) { variant: com.android.build.api.variant.ApplicationVariant ->
      ...
      if (variant.buildType != "instrumentation") {
        variant.packaging.jniLibs.excludes.add("**/libzonarosa_jni_testing.so")
      }
...
dependencies {
  ...
  implementation(project(":lib:libzonarosa-service"))
  ...
  implementation(libs.zonarosa.aesgcmprovider)
  implementation(libs.libzonarosa.android)
  implementation(libs.mobilecoin)
  implementation(libs.zonarosa.ringrtc)
