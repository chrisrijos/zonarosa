package io.zonarosa.messenger.components.spoiler
...
import io.zonarosa.messenger.components.spoiler.SpoilerAnnotation.SpoilerClickableSpan
import io.zonarosa.messenger.util.AccessibilityUtil
import io.zonarosa.messenger.util.getLifecycle
...
class SpoilerRendererDelegate @JvmOverloads constructor(
  ...
  init {
    ...
    renderer = SpoilerRenderer(
      ...
      padding = 2.dp,
      composeBackgroundColor = ContextCompat.getColor(view.context, CoreUiR.color.zonarosa_colorOnSurfaceVariant1)
    )
