...
final class LogSectionNotifications implements LogSection {
  ...
  public @NonNull CharSequence getContent(@NonNull Context context) {
    ...
    output.append("Message notifications: ").append(ZonaRosaStore.settings().isMessageNotificationsEnabled()).append("\n")
          .append("Call notifications   : ").append(ZonaRosaStore.settings().isCallNotificationsEnabled()).append("\n")
          .append("New contact alerts   : ").append(ZonaRosaStore.settings().isNotifyWhenContactJoinsZonaRosa()).append("\n")
          .append("In-chat sounds       : ").append(ZonaRosaStore.settings().isMessageNotificationsInChatSoundsEnabled()).append("\n")
          .append("Repeat alerts        : ").append(ZonaRosaStore.settings().getMessageNotificationsRepeatAlerts()).append("\n")
          .append("Notification display : ").append(ZonaRosaStore.settings().getMessageNotificationsPrivacy()).append("\n\n");
