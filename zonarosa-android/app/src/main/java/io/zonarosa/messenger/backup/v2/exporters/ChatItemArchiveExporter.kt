...
import io.zonarosa.core.util.ParallelEventTimer
...
import io.zonarosa.core.util.emptyIfNull
...
import io.zonarosa.messenger.backup.v2.proto.AdminDeletedMessage
...
import io.zonarosa.messenger.backup.v2.proto.ContactMessage
import io.zonarosa.messenger.backup.v2.proto.DirectStoryReplyMessage
import io.zonarosa.messenger.backup.v2.proto.ExpirationTimerChatUpdate
import io.zonarosa.messenger.backup.v2.proto.GenericGroupUpdate
import io.zonarosa.messenger.backup.v2.proto.GroupCall
import io.zonarosa.messenger.backup.v2.proto.GroupChangeChatUpdate
import io.zonarosa.messenger.backup.v2.proto.GroupExpirationTimerUpdate
import io.zonarosa.messenger.backup.v2.proto.GroupV2MigrationUpdate
import io.zonarosa.messenger.backup.v2.proto.IndividualCall
import io.zonarosa.messenger.backup.v2.proto.LearnedProfileChatUpdate
...
import io.zonarosa.messenger.backup.v2.proto.PinMessageUpdate
import io.zonarosa.messenger.backup.v2.proto.Poll
import io.zonarosa.messenger.backup.v2.proto.PollTerminateUpdate
import io.zonarosa.messenger.backup.v2.proto.ProfileChangeChatUpdate
import io.zonarosa.messenger.backup.v2.proto.Quote
import io.zonarosa.messenger.backup.v2.proto.Reaction
import io.zonarosa.messenger.backup.v2.proto.RemoteDeletedMessage
import io.zonarosa.messenger.backup.v2.proto.SendStatus
import io.zonarosa.messenger.backup.v2.proto.SessionSwitchoverChatUpdate
...
import io.zonarosa.messenger.backup.v2.proto.StickerMessage
import io.zonarosa.messenger.backup.v2.proto.Text
import io.zonarosa.messenger.backup.v2.proto.ThreadMergeChatUpdate
...
import io.zonarosa.messenger.backup.v2.util.toRemoteFilePointer
...
import io.zonarosa.messenger.util.mb
...
import io.zonarosa.messenger.backup.v2.proto.BodyRange as BackupBodyRange
...
class ChatItemArchiveExporter(
  private val db: ZonaRosaDatabase,
    ...
    for ((id, record) in records) {
      ...
      when {
        ...
        MessageTypes.isJoinedType(record.type) -> {
          builder.updateMessage = simpleUpdate(SimpleChatUpdate.Type.JOINED_ZONAROSA)
  ...
  private fun fetchExtraMessageData(db: ZonaRosaDatabase, messageIds: Set<Long>): ExtraMessageData {
...
private fun BackupMessageRecord.toRemoteGroupUpdate(): ChatUpdateMessage? {
  ...
  body?.let { body ->
    return try {
      ...
      ChatUpdateMessage(
        groupChange = GroupsV2UpdateMessageConverter.translateDecryptedChange(selfIds = ZonaRosaStore.account.getServiceIds(), context)
      )
    } catch (e: IOException) {
...
private fun BackupMessageRecord.toRemotePaymentNotificationUpdate(db: ZonaRosaDatabase): PaymentNotification {
...
private fun LinkPreview.toRemoteLinkPreview(backupMode: BackupMode): io.zonarosa.messenger.backup.v2.proto.LinkPreview {
  return io.zonarosa.messenger.backup.v2.proto.LinkPreview(
    url = url,
...
private fun BackupMessageRecord.getBodyText(attachments: List<DatabaseAttachment>?): Pair<String, DatabaseAttachment?> {
  val longTextAttachment = attachments?.firstOrNull { it.contentType == "text/x-zonarosa-plain" && !it.quote }
...
private fun ChatUpdateMessage.isOnlyForIndividualChats(): Boolean {
  return this.simpleUpdate?.type == SimpleChatUpdate.Type.JOINED_ZONAROSA ||
