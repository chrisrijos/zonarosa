...
public final class ReactionsBottomSheetDialogFragment extends BottomSheetDialogFragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    setStyle(DialogFragment.STYLE_NORMAL, R.style.Theme_ZonaRosa_BottomSheetDialog_Fixed_ReactWithAny);
  ...
  public @NonNull Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
    ...
    WindowUtil.setNavigationBarColor(requireContext(), dialog.getWindow(), ContextCompat.getColor(requireContext(), io.zonarosa.core.ui.R.color.zonarosa_colorSurface1));
