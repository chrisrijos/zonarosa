...
import io.zonarosa.messenger.groups.memberlabel.MemberLabelPillView
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    viewModel.recipient.observe(viewLifecycleOwner) { recipient ->
      ...
      if (recipient.showVerified) {
        ...
        val systemContactGlyph = ZonaRosaSymbols.getSpannedString(
          requireContext(),
          ZonaRosaSymbols.Weight.BOLD,
          ZonaRosaSymbols.Glyph.PERSON_CIRCLE
        )
      ...
      if (!recipient.isSelf && recipient.isIndividual) {
        ...
        val chevronGlyph = ZonaRosaSymbols.getSpannedString(
          requireContext(),
          ZonaRosaSymbols.Weight.BOLD,
          if (isLtr) ZonaRosaSymbols.Glyph.CHEVRON_RIGHT else ZonaRosaSymbols.Glyph.CHEVRON_LEFT,
          CoreUiR.color.zonarosa_colorOutline
        )
