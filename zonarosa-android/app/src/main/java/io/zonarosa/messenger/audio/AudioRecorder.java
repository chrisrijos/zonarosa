...
import io.zonarosa.messenger.notifications.v2.InChatNotificationSoundSuppressor;
...
public class AudioRecorder {
  ...
  private static final ExecutorService executor = ZonaRosaExecutors.newCachedSingleThreadExecutor("zonarosa-AudioRecorder", ThreadUtil.PRIORITY_UI_BLOCKING_THREAD);
