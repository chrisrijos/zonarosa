...
import io.zonarosa.messenger.conversation.colors.ColorizerView;
...
import io.zonarosa.messenger.wallpaper.ChatWallpaperPreviewActivity;
...
public final class WallpaperCropActivity extends BaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    supportActionBar.setHomeAsUpIndicator(ContextCompat.getDrawable(this, io.zonarosa.core.ui.R.drawable.symbol_arrow_start_24));
  ...
  private void setupImageEditor(@NonNull Uri imageUri) {
    ...
    EditorModel editorModel = EditorModel.createForWallpaperEditing(ratio, ContextCompat.getColor(this, io.zonarosa.core.ui.R.color.zonarosa_colorBackground));
  ...
  private static final class DynamicWallpaperTheme extends DynamicTheme {
    protected @StyleRes int getTheme() {
      return R.style.ZonaRosa_DayNight_WallpaperCropper;
    }
  }
}
