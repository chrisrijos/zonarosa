...
import io.zonarosa.messenger.scribbles.HSVColorSlider
...
class TextStoryPostTextEntryFragment : KeyboardEntryDialogFragment(
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    requireDialog().window?.attributes?.windowAnimations = R.style.ZonaRosa_Animation_TextStoryPostEntryDialog
  ...
  private fun initializeInput() {
    ...
    input.setIncognitoKeyboardEnabled(ZonaRosaPreferences.isIncognitoKeyboardEnabled(requireContext()))
  }
