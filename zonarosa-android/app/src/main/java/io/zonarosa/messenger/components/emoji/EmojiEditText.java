package io.zonarosa.messenger.components.emoji;
...
import io.zonarosa.messenger.components.emoji.EmojiProvider.EmojiDrawable;
import io.zonarosa.messenger.keyvalue.ZonaRosaStore;
import io.zonarosa.messenger.util.EditTextExtensionsKt;
...
public class EmojiEditText extends AppCompatEditText {
  ...
  public EmojiEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (!isInEditMode() && !ZonaRosaStore.settings().isPreferSystemEmoji()) {
    ...
    if (!isInEditMode()) {
      EditTextExtensionsKt.setIncognitoKeyboardEnabled(this, ZonaRosaPreferences.isIncognitoKeyboardEnabled(context));
    }
  }
  ...
  public boolean onTextContextMenuItem(int id) {
    if (id == android.R.id.paste) {
      ...
      if (clipData != null) {
        ...
        if (TextUtils.equals(Util.COPY_LABEL, label) && shouldPersistZonaRosaStylingWhenPasting()) {
