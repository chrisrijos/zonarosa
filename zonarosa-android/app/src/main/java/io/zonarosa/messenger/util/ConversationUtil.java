...
import io.zonarosa.messenger.components.settings.app.appearance.appicon.util.AppIconUtility;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "io.zonarosa.messenger.sharing.CATEGORY_SHARE_TARGET";
                                                               ...
                                                               @NonNull Direction direction)
  {
    ...
    long      threadId   = ZonaRosaDatabase.threads().getOrCreateThreadIdFor(resolved);
  ...
  private static @NonNull Person[] buildPersonsForGroup(@NonNull Context context, @NonNull GroupId groupId) {
    List<Recipient> members = ZonaRosaDatabase.groups().getGroupMembers(groupId, GroupTable.MemberSet.FULL_MEMBERS_EXCLUDING_SELF);
