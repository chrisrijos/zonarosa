...
class FilterCircleView @JvmOverloads constructor(
  ...
  private val circleBackgroundColor = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorSurface1)
  private val strokeColor = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorSecondary)
  private val circleActiveBackgroundColor = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorSecondaryContainer)
  private val strokeActiveColor = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorPrimary)
