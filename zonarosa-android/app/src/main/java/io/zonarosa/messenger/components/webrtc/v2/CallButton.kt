  ...
  IconButtons.IconToggleButton(
    ...
    colors = IconButtons.run {
      iconToggleButtonColors(
        ...
        checkedContentColor = colorResource(id = CoreUiR.color.zonarosa_light_colorOnPrimary),
        containerColor = colorResource(id = CoreUiR.color.zonarosa_light_colorSecondaryContainer),
        contentColor = colorResource(id = CoreUiR.color.zonarosa_light_colorOnSecondaryContainer)
      )
    }
  ) {
    Icon(
...
private fun CallButton(
  ...
  contentColor: Color = colorResource(id = CoreUiR.color.zonarosa_light_colorOnPrimary),
...
fun StartCallButton(
  ...
  Buttons.LargePrimary(
    ...
    colors = ButtonDefaults.buttonColors(
      containerColor = colorResource(id = CoreUiR.color.zonarosa_light_colorPrimary),
      contentColor = colorResource(id = CoreUiR.color.zonarosa_light_colorOnPrimary)
    ),
