...
import io.zonarosa.core.ui.compose.DayNightPreviews as DayNightPreview
      ...
      item {
        Text(
          ...
          modifier = Modifier.padding(
            horizontal = dimensionResource(id = io.zonarosa.core.ui.R.dimen.gutter),
            vertical = 16.dp
          )
        )
      }
  ...
  Previews.Preview {
    LocalBackupsSettingsScreen(
      state = LocalBackupsSettingsState(
        ...
        folderDisplayName = "/storage/emulated/0/ZonaRosa/Backups",
  ...
  Previews.Preview {
    LocalBackupsSettingsScreen(
      state = LocalBackupsSettingsState(
        backupsEnabled = true,
        lastBackupLabel = "Last backup: 1 hour ago",
        folderDisplayName = "ZonaRosa Backups",
        scheduleTimeLabel = "1:00 AM",
        progress = BackupProgressState.Idle
      ),
      callback = LocalBackupsSettingsCallback.Empty
