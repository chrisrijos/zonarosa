...
class LogSectionNotificationProfiles : LogSection {
  ...
  override fun getContent(context: Context): CharSequence {
    val profiles: List<NotificationProfile> = ZonaRosaDatabase.notificationProfiles.getProfiles()

    val output = StringBuilder()

    output.append("Manually enabled profile: ${ZonaRosaStore.notificationProfile.manuallyEnabledProfile}\n")
    output.append("Manually enabled until  : ${ZonaRosaStore.notificationProfile.manuallyEnabledUntil}\n")
    output.append("Manually disabled at    : ${ZonaRosaStore.notificationProfile.manuallyDisabledAt}\n")
