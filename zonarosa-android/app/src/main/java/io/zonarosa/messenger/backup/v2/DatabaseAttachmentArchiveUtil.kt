...
/**
 * Creates a [ZonaRosaServiceAttachmentPointer] for the archived attachment of the given [DatabaseAttachment].
 */
@Throws(InvalidAttachmentException::class)
fun DatabaseAttachment.createArchiveAttachmentPointer(useArchiveCdn: Boolean): ZonaRosaServiceAttachmentPointer {
  ...
  return try {
    val (remoteId, cdnNumber) = if (useArchiveCdn) {
      ...
      val id = ZonaRosaServiceAttachmentRemoteId.Backup(
      ...
      ZonaRosaServiceAttachmentRemoteId.from(remoteLocation) to cdn.cdnNumber
    }
...
/**
 * Creates a [ZonaRosaServiceAttachmentPointer] for an archived thumbnail of the given [DatabaseAttachment].
 */
@Throws(InvalidAttachmentException::class)
fun DatabaseAttachment.createArchiveThumbnailPointer(): ZonaRosaServiceAttachmentPointer {
  ...
  return try {
    ...
    ZonaRosaServiceAttachmentPointer(
      ...
      remoteId = ZonaRosaServiceAttachmentRemoteId.Backup(
        mediaCdnPath = mediaCdnPath,
        mediaId = mediaId
      ),
      contentType = null,
