...
import io.zonarosa.messenger.color.ViewColorSet
...
import io.zonarosa.messenger.contacts.paged.ContactSearchError
...
import io.zonarosa.messenger.sharing.ShareSelectionAdapter
import io.zonarosa.messenger.sharing.ShareSelectionMappingModel
import io.zonarosa.messenger.stories.GroupStoryEducationSheet
import io.zonarosa.messenger.stories.Stories
import io.zonarosa.messenger.stories.Stories.getHeaderAction
...
class MultiselectForwardFragment :
  ...
  private fun displayFirstSendConfirmation() {
    ZonaRosaStore.tooltips.markMultiForwardDialogSeen()
