...
import io.zonarosa.messenger.jobs.RebuildMessageSearchIndexJob
...
class SearchTable(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper) {
  companion object {
