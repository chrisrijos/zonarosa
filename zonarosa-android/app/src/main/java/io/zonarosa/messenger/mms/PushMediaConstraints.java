...
import io.zonarosa.messenger.video.videoconverter.utils.DeviceCapabilities;
...
public class PushMediaConstraints extends MediaConstraints {
  ...
  private static @NonNull MediaConfig getCurrentConfig(@NonNull Context context, @Nullable SentMediaQuality sentMediaQuality) {
    ...
    if (sentMediaQuality == SentMediaQuality.HIGH) {
      if (DeviceCapabilities.canEncodeHevc() && (RemoteConfig.useHevcEncoder() || ZonaRosaStore.internal().getHevcEncoding())) {
