...
import io.zonarosa.messenger.qr.QrScanScreens
  ...
  when (qrScanResult) {
    ...
    QrScanResult.QrNotFound -> {
      QrScanResultDialog(
        ...
        message = stringResource(R.string.UsernameLinkSettings_try_scanning_another_image_containing_a_zonarosa_qr_code),
  ...
  Column(
    ...
    Box(
      ...
      FloatingActionButton(
        shape = CircleShape,
        containerColor = ZonaRosaTheme.colors.colorSurface1,
