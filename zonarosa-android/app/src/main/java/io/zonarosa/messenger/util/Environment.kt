...
object Environment {
  private const val GOOGLE_PLAY_BILLING_APPLICATION_ID = "io.zonarosa.messenger"
  ...
  object Calling {
    ...
    fun defaultSfuUrl(): String {
      return if (IS_STAGING) BuildConfig.ZONAROSA_STAGING_SFU_URL else BuildConfig.ZONAROSA_SFU_URL
    }
  }
}
