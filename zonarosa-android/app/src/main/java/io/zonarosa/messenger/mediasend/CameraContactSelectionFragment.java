...
/**
 * Fragment that selects ZonaRosa contacts. Intended to be used in the camera-first capture flow.
 */
public class CameraContactSelectionFragment extends LoggingFragment implements CameraContactAdapter.CameraContactListener {
  ...
  public @Nullable View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    int            theme          = DynamicTheme.isDarkTheme(inflater.getContext()) ? R.style.ZonaRosa_DarkTheme
