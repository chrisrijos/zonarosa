...
class MultiDeviceBlockedUpdateJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  public override fun onRun() {
    ...
    val blocked: List<RecipientRecord> = ZonaRosaDatabase.recipients.getBlocked()
    ...
    AppDependencies.zonarosaServiceMessageSender.sendSyncMessage(
      ZonaRosaServiceSyncMessage.forBlocked(BlockedListMessage(blockedIndividuals, blockedGroups))
    )
  }
