package io.zonarosa.messenger.util.task;
...
public abstract class ProgressDialogAsyncTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
  ...
  private       ZonaRosaProgressDialog   progress;
  ...
  protected void onPreExecute() {
    ...
    if (context != null) progress = ZonaRosaProgressDialog.show(context, title, message, true);
  }
