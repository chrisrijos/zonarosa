...
import io.zonarosa.messenger.components.BoldSelectionTabItem;
import io.zonarosa.messenger.components.ControllableTabLayout;
...
public final class MediaOverviewActivity extends PassphraseRequiredActivity {
  ...
  private void initializeToolbar() {
    ...
    if (threadId == MediaTable.ALL_THREADS) {
      ...
      SimpleTask.run(() -> ZonaRosaDatabase.threads().getRecipientForThreadId(threadId),
        (recipient) -> {
          if (recipient != null) {
