...
import io.zonarosa.messenger.database.PaymentTable.PaymentTransaction;
...
import io.zonarosa.messenger.payments.PaymentTransactionLiveData;
import io.zonarosa.messenger.payments.PaymentsAddressException;
import io.zonarosa.messenger.payments.confirm.ConfirmPaymentRepository.ConfirmPaymentResult;
...
final class ConfirmPaymentViewModel extends ViewModel {
                          ...
                          @NonNull ConfirmPaymentRepository confirmPaymentRepository)
  {
    ...
    this.store.update(ZonaRosaStore.payments().liveMobileCoinBalance(), (balance, state) -> state.updateBalance(balance.getFullAmount()));
    ...
    LiveData<ConfirmPaymentState.Status> timeoutZonaRosa  = Transformations.switchMap(statusLiveData,
                                                                                    s -> {
    ...
    this.store.update(timeoutZonaRosa, this::handleTimeout);
  }
