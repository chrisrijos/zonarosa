...
class StatusBarColorAnimator(
  ...
  private val normalColor = ContextCompat.getColor(activity, CoreUiR.color.zonarosa_colorBackground)
  private val scrollColor = ContextCompat.getColor(activity, CoreUiR.color.zonarosa_colorSurface2)
