...
class EditProfileViewModel extends ViewModel {
  ...
  public boolean isRegisteredAndUpToDate() {
    return !ZonaRosaPreferences.isUnauthorizedReceived(AppDependencies.getApplication()) && ZonaRosaStore.account().isRegistered() && !ZonaRosaStore.misc().isClientDeprecated();
  }
  ...
  private void onRecipientChanged(@NonNull Recipient recipient) {
    ...
    username.postValue(ZonaRosaStore.account().getUsername());
