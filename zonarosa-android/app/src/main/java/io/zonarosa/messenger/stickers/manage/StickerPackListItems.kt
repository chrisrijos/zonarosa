...
import io.zonarosa.messenger.components.compose.RoundCheckbox
import io.zonarosa.messenger.components.transfercontrols.TransferProgressIndicator
import io.zonarosa.messenger.components.transfercontrols.TransferProgressState
import io.zonarosa.messenger.stickers.StickerPreviewDataFactory
import io.zonarosa.messenger.stickers.manage.AvailableStickerPack.DownloadStatus
...
fun AvailableStickerPackRow(
  ...
  Row(
    ...
    DropdownMenus.Menu(
      ...
      offsetX = 0.dp,
      offsetY = 12.dp,
      modifier = modifier.background(ZonaRosaTheme.colors.colorSurface2)
    ) {
      MenuItem(
...
fun InstalledStickerPackRow(
  ...
  Row(
    ...
    modifier = modifier
      .padding(horizontal = 16.dp)
      .background(
        color = if (selected) ZonaRosaTheme.colors.colorSurface2 else MaterialTheme.colorScheme.surface,
        shape = RoundedCornerShape(18.dp)
      )
    ...
    DropdownMenus.Menu(
      ...
      MenuItem(
        icon = ZonaRosaIcons.CheckCircle.imageVector,
