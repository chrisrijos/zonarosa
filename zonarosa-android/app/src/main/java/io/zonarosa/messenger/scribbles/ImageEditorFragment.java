...
import io.zonarosa.core.util.FontUtil;
...
import io.zonarosa.imageeditor.core.ColorableRenderer;
import io.zonarosa.imageeditor.core.ImageEditorView;
import io.zonarosa.imageeditor.core.Renderer;
import io.zonarosa.imageeditor.core.SelectableRenderer;
import io.zonarosa.imageeditor.core.model.EditorElement;
import io.zonarosa.imageeditor.core.model.EditorModel;
import io.zonarosa.imageeditor.core.renderers.BezierDrawingRenderer;
import io.zonarosa.imageeditor.core.renderers.FaceBlurRenderer;
import io.zonarosa.imageeditor.core.renderers.MultiLineTextRenderer;
import io.zonarosa.imageeditor.core.renderers.UriGlideRenderer;
import io.zonarosa.messenger.R;
import io.zonarosa.messenger.animation.ResizeAnimation;
import io.zonarosa.messenger.attachments.AttachmentSaver;
import io.zonarosa.messenger.dependencies.AppDependencies;
import io.zonarosa.messenger.fonts.FontTypefaceProvider;
import io.zonarosa.messenger.keyvalue.ZonaRosaStore;
import io.zonarosa.messenger.mediasend.MediaSendPageFragment;
import io.zonarosa.messenger.mediasend.v2.MediaAnimations;
import io.zonarosa.messenger.mms.MediaConstraints;
import io.zonarosa.messenger.mms.PushMediaConstraints;
...
import io.zonarosa.messenger.scribbles.stickers.AnalogClockStickerRenderer;
import io.zonarosa.messenger.scribbles.stickers.DigitalClockStickerRenderer;
import io.zonarosa.messenger.scribbles.stickers.FeatureSticker;
import io.zonarosa.messenger.scribbles.stickers.TappableRenderer;
                                                                   ...
                                                                   TextEntryDialogFragment.Controller
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    @ColorInt int blackoutColor = ContextCompat.getColor(requireContext(), io.zonarosa.core.ui.R.color.zonarosa_colorBackground);
    if (editorModel == null) {
      switch (mode) {
        case AVATAR_EDIT:
    ...
    if (!ZonaRosaStore.tooltips().hasSeenBlurHudIconTooltip()) {
      imageEditorHud.showBlurHudTooltip();
      ZonaRosaStore.tooltips().markBlurHudIconTooltipSeen();
    }
  ...
  private void startTextEntityEditing(@NonNull EditorElement textElement, boolean selectAll) {
    ...
    TextEntryDialogFragment.Companion.show(
        ...
        textElement,
        ZonaRosaPreferences.isIncognitoKeyboardEnabled(requireContext()),
        selectAll,
