...
import io.zonarosa.messenger.database.MessageTable.Companion.DATE_RECEIVED
import io.zonarosa.messenger.database.MessageTable.Companion.EXPIRES_IN
import io.zonarosa.messenger.database.MessageTable.Companion.PARENT_STORY_ID
import io.zonarosa.messenger.database.MessageTable.Companion.SCHEDULED_DATE
import io.zonarosa.messenger.database.MessageTable.Companion.STORY_TYPE
...
fun MessageTable.getMessagesForBackup(db: ZonaRosaDatabase, backupTime: Long, selfRecipientId: RecipientId, messageInclusionCutoffTime: Long, exportState: ExportState): ChatItemArchiveExporter {
