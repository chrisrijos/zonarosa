...
import io.zonarosa.messenger.compose.StatusBarColorAnimator
  ...
  Scaffold(
    topBar = {
      TopAppBar(
        ...
        colors = if (listState.canScrollBackward) TopAppBarDefaults.topAppBarColors(containerColor = ZonaRosaTheme.colors.colorSurface2) else TopAppBarDefaults.topAppBarColors()
      )
    }
  ) {
        ...
        item {
          Image(
            ...
            modifier = Modifier
              .size(72.dp)
              .background(
                ZonaRosaTheme.colors.colorSurface2,
                CircleShape
              )
              .padding(18.dp)
          )
