 ...
 */
class EmojiSearchTable(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper) {
  ...
  fun setSearchIndex(
    ...
    databaseHelper.zonarosaReadableDatabase.withinTransaction { db ->
