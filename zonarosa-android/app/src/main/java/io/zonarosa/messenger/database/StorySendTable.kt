 ...
 */
class StorySendTable(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun applySentStoryManifest(remoteManifest: SentStorySyncManifest, sentTimestamp: Long) {
    writableDatabase.withinTransaction {
      ...
      messagesWithoutAnyReceivers.forEach {
        ZonaRosaDatabase.messages.markAsDeleteBySelf(it)
        ZonaRosaDatabase.messages.deleteRemotelyDeletedStory(it)
      }
    }
  }
