...
import io.zonarosa.messenger.util.IOFunction;
import io.zonarosa.core.util.Util;
import io.zonarosa.messenger.video.ByteArrayMediaDataSource;
...
public class BlobProvider {
  ...
  private static void deleteOrphanedDraftFiles(@NonNull Context context) {
    ...
    DraftTable        draftDatabase   = ZonaRosaDatabase.drafts();
      ...
      throws IOException
  {
    ...
    return ZonaRosaExecutors.BOUNDED.submit(() -> {
      try {
