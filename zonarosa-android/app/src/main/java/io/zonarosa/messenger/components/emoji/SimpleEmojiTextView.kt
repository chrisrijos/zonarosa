...
open class SimpleEmojiTextView @JvmOverloads constructor(
  ...
  init {
    isEmojiCompatEnabled = isInEditMode || ZonaRosaStore.settings.isPreferSystemEmoji
  ...
  override fun setText(text: CharSequence?, type: BufferType?) {
    ...
    if (ZonaRosaStore.settings.isPreferSystemEmoji || candidates == null || candidates.size() == 0) {
