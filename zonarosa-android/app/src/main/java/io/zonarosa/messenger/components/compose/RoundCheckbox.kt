...
fun RoundCheckbox(
  ...
  val contentDescription = if (checked) {
    stringResource(R.string.ZonaRosaCheckbox_accessibility_checked_description)
  } else {
    stringResource(R.string.ZonaRosaCheckbox_accessibility_unchecked_description)
  }
