...
public final class WebRtcControls {
  ...
  public static final WebRtcControls PIP  = new WebRtcControls(false,
                                                               ...
                                                               null,
                                                               FoldableState.flat(),
                                                               ZonaRosaAudioManager.AudioDevice.NONE,
                                                               emptySet(),
                                                               false,
                                                               false);
  ...
  private final ZonaRosaAudioManager.AudioDevice      activeDevice;
  private final Set<ZonaRosaAudioManager.AudioDevice> availableDevices;
  ...
  public WebRtcControls(boolean isLocalVideoEnabled,
                 ...
                 @NonNull ZonaRosaAudioManager.AudioDevice activeDevice,
                 @NonNull Set<ZonaRosaAudioManager.AudioDevice> availableDevices,
                 boolean isCallLink,
  ...
  public boolean isBluetoothHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(ZonaRosaAudioManager.AudioDevice.BLUETOOTH);
  }

  public boolean isWiredHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(ZonaRosaAudioManager.AudioDevice.WIRED_HEADSET);
  }
