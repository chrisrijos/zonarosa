package io.zonarosa.messenger.mediaoverview;
...
import io.zonarosa.messenger.database.loaders.GroupedThreadMediaLoader;
import io.zonarosa.messenger.database.loaders.MediaLoader;
...
import io.zonarosa.messenger.util.BottomOffsetDecoration;
  ...
  private void updateMultiSelect() {
    if (actionMode != null) {
      ...
      bottomActionBar.setItems(Arrays.asList(
          ...
          new ActionItem(io.zonarosa.core.ui.R.drawable.symbol_check_circle_24, getString(R.string.MediaOverviewActivity_select_all), this::handleSelectAllMedia),
          new ActionItem(io.zonarosa.core.ui.R.drawable.symbol_trash_24, getResources().getQuantityString(R.plurals.MediaOverviewActivity_delete_plural, selectionCount), this::handleDeleteSelectedMedia)
      ));
    }
  }
