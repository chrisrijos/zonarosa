...
import io.zonarosa.messenger.recipients.ui.sharablegrouplink.qr.GroupLinkShareQrDialogFragment;
...
public final class GroupLinkBottomSheetDialogFragment extends BottomSheetDialogFragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    setStyle(DialogFragment.STYLE_NORMAL,
             ThemeUtil.isDarkTheme(requireContext()) ? R.style.Theme_ZonaRosa_RoundedBottomSheet
                                                     : R.style.Theme_ZonaRosa_RoundedBottomSheet_Light);
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    View     shareViaZonaRosaButton = view.findViewById(R.id.group_link_bottom_sheet_share_via_zonarosa_button);
    ...
    liveGroup.getGroupLink().observe(getViewLifecycleOwner(), groupLink -> {
      ...
      shareViaZonaRosaButton.setOnClickListener(v -> {
