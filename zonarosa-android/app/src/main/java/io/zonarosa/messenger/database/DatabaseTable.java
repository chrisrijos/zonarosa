...
public abstract class DatabaseTable {
  ...
  protected       ZonaRosaDatabase databaseHelper;
  ...
  public DatabaseTable(Context context, ZonaRosaDatabase databaseHelper) {
  ...
  public void reset(ZonaRosaDatabase databaseHelper) {
    this.databaseHelper = databaseHelper;
  }

  public SQLiteDatabase getReadableDatabase() {
    return databaseHelper.getZonaRosaReadableDatabase();
  }

  public SQLiteDatabase getWritableDatabase() {
    return databaseHelper.getZonaRosaWritableDatabase();
  }
}
