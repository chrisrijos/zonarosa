...
public class EmojiTextView extends AppCompatTextView {
  ...
  private Executor     backgroundExecutor = new SerialMonoLifoExecutor(ZonaRosaExecutors.UNBOUNDED);
  ...
  private boolean useSystemEmoji() {
    return isInEditMode() || ZonaRosaStore.settings().isPreferSystemEmoji();
  }
