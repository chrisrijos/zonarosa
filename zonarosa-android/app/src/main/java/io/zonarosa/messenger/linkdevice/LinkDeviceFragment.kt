...
import io.zonarosa.messenger.DevicePinAuthEducationSheet
...
fun DeviceListScreen(
  ...
  Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = modifier.verticalScroll(rememberScrollState())) {
    ...
    Text(
      text = stringResource(id = R.string.LinkDeviceFragment__use_zonarosa_on_desktop_ipad),
      ...
      val (messageText, messageInline) = remember(message) {
        ...
        val inlineContentMap = mapOf(
          "icon" to InlineTextContent(Placeholder(16.sp, 16.sp, PlaceholderVerticalAlign.Center)) {
            Image(
              imageVector = ZonaRosaIcons.Lock.imageVector,
