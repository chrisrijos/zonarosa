...
public class AttachmentSecretProvider {
  ...
  public synchronized AttachmentSecret getOrCreateAttachmentSecret() {
    ...
    String unencryptedSecret = ZonaRosaPreferences.getAttachmentUnencryptedSecret(context);
    String encryptedSecret   = ZonaRosaPreferences.getAttachmentEncryptedSecret(context);
  ...
  private AttachmentSecret getUnencryptedAttachmentSecret(@NonNull Context context, @NonNull String unencryptedSecret)
  {
    ...
    ZonaRosaPreferences.setAttachmentEncryptedSecret(context, encryptedSecret.serialize());
    ZonaRosaPreferences.setAttachmentUnencryptedSecret(context, null);
