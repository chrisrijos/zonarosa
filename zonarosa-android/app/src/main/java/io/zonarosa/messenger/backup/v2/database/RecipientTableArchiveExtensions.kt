...
import io.zonarosa.messenger.backup.v2.exporters.ContactArchiveExporter
import io.zonarosa.messenger.backup.v2.exporters.GroupArchiveExporter
...
fun RecipientTable.restoreReleaseNotes(): RecipientId {
  ...
  setProfileName(releaseChannelId, ProfileName.asGiven("ZonaRosa"))
