...
import io.zonarosa.messenger.database.DatabaseTable
import io.zonarosa.messenger.database.ZonaRosaDatabase
import io.zonarosa.messenger.database.model.databaseprotos.CustomAvatar
import io.zonarosa.messenger.groups.GroupId

/**
 * Database which manages the record keeping for custom created avatars.
 */
class AvatarPickerDatabase(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper) {
