...
import io.zonarosa.core.ui.compose.Animations
...
import io.zonarosa.messenger.billing.upgrade.UpgradeToEnableOptimizedStorageSheet
...
import io.zonarosa.messenger.preferences.widgets.StorageGraphView
      ...
      NavHost(
        ...
        dialog("confirm-delete-chat-history") {
          Dialogs.SimpleAlertDialog(
            ...
            body = if (ZonaRosaStore.account.isMultiDevice) {
      ...
      Rows.RadioRow(
        content = {
          ...
          if (customSelected) {
            ...
            Icon(
              painter = ZonaRosaIcons.Settings.painter,
