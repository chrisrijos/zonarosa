...
import io.zonarosa.messenger.webrtc.audio.OutgoingRinger;
...
public class ActiveCallActionProcessorDelegate extends WebRtcActionProcessor {
  ...
  protected @NonNull WebRtcServiceState handleLocalHangup(@NonNull WebRtcServiceState currentState) {
    ...
    AppDependencies.getZonaRosaServiceAccountManager().cancelInFlightRequests();
    AppDependencies.getZonaRosaServiceMessageSender().cancelInFlightRequests();
                                                          ...
                                                          @NonNull RemotePeer remotePeer)
  {
    ...
    if (callEndReason == CallEndReason.REMOTE_HANGUP || callEndReason == CallEndReason.REMOTE_HANGUP_BUSY) {
      ...
      ThreadUtil.runOnMainDelayed(ringer::stop, ZonaRosaCallManager.BUSY_TONE_LENGTH);
