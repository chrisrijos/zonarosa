package io.zonarosa.messenger.stories.viewer.first
...
import io.zonarosa.messenger.stories.StoryFirstTimeNavigationView
import io.zonarosa.messenger.stories.viewer.StoryViewerState
...
class StoryFirstTimeNavigationFragment : DialogFragment(R.layout.story_viewer_first_time_navigation_stub), StoryFirstTimeNavigationView.Callback {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setStyle(STYLE_NO_FRAME, R.style.ZonaRosa_DayNight_Dialog_FullScreen)
    isCancelable = false
  }
  ...
  override fun userHasSeenFirstNavigationView(): Boolean {
    return ZonaRosaStore.story.userHasSeenFirstNavView
  }

  override fun onGotItClicked() {
    dismissAllowingStateLoss()

    ZonaRosaStore.story.userHasSeenFirstNavView = true
