  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (fileInfo != null) {
      ...
      if (extensionText.length <= 3) {
        ...
        extension.setTextAppearance(requireContext(), CoreUiR.style.ZonaRosa_Text_BodySmall)
      } else if (extensionText.length == 4) {
        extension.text = extensionText
        extension.setTextAppearance(requireContext(), CoreUiR.style.ZonaRosa_Text_Caption)
      }
    } else {
