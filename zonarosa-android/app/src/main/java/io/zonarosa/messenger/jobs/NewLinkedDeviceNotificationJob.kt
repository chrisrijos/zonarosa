...
import io.zonarosa.messenger.jobs.protos.NewLinkedDeviceNotificationJobData
...
class NewLinkedDeviceNotificationJob private constructor(
  ...
  override fun run(): Result {
    ...
    ZonaRosaStore.misc.newLinkedDeviceId = data.deviceId
    ZonaRosaStore.misc.newLinkedDeviceCreatedTime = data.deviceCreatedAt
