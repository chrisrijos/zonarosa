package io.zonarosa.messenger.video.exo;
...
/**
 * This class is responsible for creating a MediaSource object for a given Uri, using {@link ZonaRosaDataSource.Factory}.
 */
@OptIn(markerClass = UnstableApi.class)
public final class ZonaRosaMediaSourceFactory implements MediaSource.Factory {

  private final ProgressiveMediaSource.Factory progressiveMediaSourceFactory;

  public ZonaRosaMediaSourceFactory(@NonNull Context context) {
    DataSource.Factory attachmentDataSourceFactory = new ZonaRosaDataSource.Factory(context, null, ExoPlayerPool.DataSourceTransferListener.INSTANCE);
