...
interface Colorizer {
  ...
  fun getIncomingBodyTextColor(context: Context, hasWallpaper: Boolean): Int {
    return if (hasWallpaper) {
      ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorNeutralInverse)
    } else {
      ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorOnSurface)
    }
  }
  ...
  fun getIncomingFooterTextColor(context: Context, hasWallpaper: Boolean): Int {
    return if (hasWallpaper) {
      ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorNeutralVariantInverse)
    } else {
