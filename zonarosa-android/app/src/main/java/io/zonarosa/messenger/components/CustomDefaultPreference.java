...
import io.zonarosa.messenger.components.CustomDefaultPreference.CustomDefaultPreferenceDialogFragmentCompat.CustomPreferenceValidator;
...
public class CustomDefaultPreference extends DialogPreference {
  ...
  private boolean isCustom() {
    return ZonaRosaPreferences.getBooleanPreference(getContext(), customToggle, false);
  }

  private void setCustom(boolean custom) {
    ZonaRosaPreferences.setBooleanPreference(getContext(), customToggle, custom);
  }

  private String getCustomValue() {
    return ZonaRosaPreferences.getStringPreference(getContext(), customPreference, "");
  }

  private void setCustomValue(String value) {
    ZonaRosaPreferences.setStringPreference(getContext(), customPreference, value);
  }
