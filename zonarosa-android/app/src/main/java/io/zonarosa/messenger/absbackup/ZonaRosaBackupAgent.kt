package io.zonarosa.messenger.absbackup
...
import io.zonarosa.messenger.absbackup.backupables.SvrAuthTokens
 ...
 */
class ZonaRosaBackupAgent : BackupAgent() {
  ...
  companion object {
    private val TAG = Log.tag(ZonaRosaBackupAgent::class)
  }
}
