...
import io.zonarosa.messenger.components.settings.app.internal.donor.DonationErrorValueCodeSelector
import io.zonarosa.messenger.components.settings.app.internal.donor.DonationErrorValueTypeSelector
...
class InternalPendingOneTimeDonationConfigurationFragment : ComposeFragment() {
  ...
  override fun FragmentContent() {
    ...
    Content(
      ...
      onSave = {
        ZonaRosaStore.inAppPayments.setPendingOneTimeDonation(viewModel.state.value)
        findNavController().popBackStack()
      }
    )
  }
