...
class InternalStorageServicePlaygroundViewModel : ViewModel() {
  ...
  private val _manifest: MutableState<ZonaRosaStorageManifest> = mutableStateOf(ZonaRosaStorageManifest.EMPTY)
  val manifest: State<ZonaRosaStorageManifest>
    get() = _manifest

  private val _storageItems: MutableState<List<ZonaRosaStorageRecord>> = mutableStateOf(emptyList())
  val storageRecords: State<List<ZonaRosaStorageRecord>>
    get() = _storageItems
  ...
  fun onViewTabSelected() {
    viewModelScope.launch {
      withContext(Dispatchers.IO) {
        ...
        val storageKey = ZonaRosaStore.storageService.storageKeyForInitialDataRestore ?: ZonaRosaStore.storageService.storageKey
  ...
  private fun ZonaRosaStorageRecord.sizeInBytes(): Int {
