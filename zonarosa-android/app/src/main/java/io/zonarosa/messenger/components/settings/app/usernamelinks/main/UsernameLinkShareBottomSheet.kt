...
class UsernameLinkShareBottomSheet : ComposeBottomSheetDialogFragment() {
  ...
  override fun SheetContent() {
    Content(
      usernameLink = ZonaRosaStore.account.usernameLink?.toLink() ?: "",
...
private fun Content(
  ...
  Column(horizontalAlignment = Alignment.CenterHorizontally) {
    ...
    ButtonRow(
      icon = ZonaRosaIcons.Copy.painter,
    ...
    ButtonRow(
      icon = ZonaRosaIcons.Share.painter,
...
private fun ContentPreview() {
  Previews.Preview {
    Surface {
      Content(
        usernameLink = "https://zonarosa.me#eufzLWmFFUYAOqnVJ4Zlt0KqXf87r59FC1hZ3r7WipjKvgzMBg7DBlY5DB5hQTjsw0"
      )
    }
  }
}
...
private fun ButtonRowPreview() {
  Previews.Preview {
    Surface {
      ButtonRow(icon = ZonaRosaIcons.Share.painter, text = "Share")
    }
  }
}
