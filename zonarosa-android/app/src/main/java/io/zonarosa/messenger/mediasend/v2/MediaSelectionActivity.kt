...
import io.zonarosa.core.util.OVERRIDE_TRANSITION_CLOSE_COMPAT
...
import io.zonarosa.core.util.overrideActivityTransitionCompat
...
import io.zonarosa.messenger.mediasend.CameraDisplay
import io.zonarosa.messenger.mediasend.MediaSendActivityResult
import io.zonarosa.messenger.mediasend.v2.review.MediaReviewFragment
import io.zonarosa.messenger.mediasend.v2.text.TextStoryPostCreationViewModel
import io.zonarosa.messenger.mediasend.v2.text.send.TextStoryPostSendRepository
...
class MediaSelectionActivity :
  ...
  private fun animateTextStyling(selectedSwitch: TextView, unselectedSwitch: TextView, duration: Long) {
    val offTextColor = ContextCompat.getColor(this, CoreUiR.color.zonarosa_colorOnSurface)
    val onTextColor = ContextCompat.getColor(this, CoreUiR.color.zonarosa_colorSecondaryContainer)
  ...
  companion object {
    ...
    private fun buildIntent(
      context: Context,
      startAction: Int = -1,
      messageSendType: MessageSendType = MessageSendType.ZonaRosaMessageSendType,
