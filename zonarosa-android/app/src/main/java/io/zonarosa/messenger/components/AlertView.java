...
public class AlertView extends AppCompatImageView {
  ...
  public void setFailed() {
    ...
    setColorFilter(ContextCompat.getColor(getContext(), io.zonarosa.core.ui.R.color.zonarosa_colorError));
  ...
  public void setRateLimited() {
    setVisibility(View.VISIBLE);
    setColorFilter(ContextCompat.getColor(getContext(), io.zonarosa.core.ui.R.color.zonarosa_colorOnSurfaceVariant));
