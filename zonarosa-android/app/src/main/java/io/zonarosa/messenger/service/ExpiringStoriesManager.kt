...
class ExpiringStoriesManager(
  ...
  private val mmsDatabase = ZonaRosaDatabase.messages
  ...
  override fun getNextClosestEvent(): Event? {
    val oldestTimestamp = mmsDatabase.getOldestStorySendTimestamp(ZonaRosaStore.story.userHasViewedOnboardingStory) ?: return null
  ...
  override fun executeEvent(event: Event) {
    ...
    val deletes = mmsDatabase.deleteStoriesOlderThan(threshold, ZonaRosaStore.story.userHasViewedOnboardingStory)
