...
import io.zonarosa.messenger.components.settings.app.routes.AppSettingsRoute
import io.zonarosa.messenger.components.settings.app.routes.AppSettingsRouter
      ...
      LazyColumn(
        ...
        when (state.backupFailureState) {
          BackupFailureState.SUBSCRIPTION_STATE_MISMATCH -> {
            item {
              ...
              BackupsWarningRow(
                text = stringResource(R.string.AppSettingsFragment__renew_your_zonarosa_backups_subscription),
                onClick = {
          ...
          BackupFailureState.OUT_OF_STORAGE_SPACE -> {
            item {
              ...
              Rows.TextRow(
                ...
                icon = ZonaRosaIcons.ErrorCircle.imageVector,
        ...
        if (state.isPrimaryDevice) {
          ...
          item {
            ...
            Rows.TextRow(
              text = {
                Text(
                  text = stringResource(R.string.preferences__donate_to_zonarosa),
                ...
                if (state.hasExpiredGiftBadge) {
                  Icon(
                    ...
                    tint = colorResource(R.color.zonarosa_accent_primary),
        ...
        item {
          Rows.TextRow(
            ...
            icon = ZonaRosaIcons.Lock.painter,
            onClick = {
  ...
  Row(
    ...
    Column(
      ...
      val prettyPhoneNumber = if (LocalInspectionMode.current) {
        ...
        remember(self.e164) {
          ZonaRosaE164Util.prettyPrint(self.e164)
        }
      }
    ...
    if (hasUsername) {
      IconButtons.IconButton(
        ...
        colors = IconButtons.iconButtonColors(
          containerColor = ZonaRosaTheme.colors.colorSurface4
        )
      ) {
        Icon(
          painter = ZonaRosaIcons.QrCode.painter,
          contentDescription = null,
