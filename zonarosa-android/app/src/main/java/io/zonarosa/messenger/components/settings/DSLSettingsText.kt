...
sealed class DSLSettingsText {
  ...
  object TitleLargeModifier : TextAppearanceModifier(CoreUiR.style.ZonaRosa_Text_TitleLarge)
  object TitleMediumModifier : TextAppearanceModifier(CoreUiR.style.ZonaRosa_Text_TitleMedium)
  object BodyLargeModifier : TextAppearanceModifier(CoreUiR.style.ZonaRosa_Text_BodyLarge)
