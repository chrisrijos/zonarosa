...
import io.zonarosa.glide.compose.GlideImageScaleType
import io.zonarosa.messenger.R
import io.zonarosa.messenger.avatar.AvatarImage
import io.zonarosa.messenger.components.emoji.EmojiTextView
import io.zonarosa.messenger.components.settings.app.subscription.BadgeImageLarge
import io.zonarosa.messenger.components.webrtc.TextureViewRenderer
...
private fun RaiseHandIndicator(
  ...
  Row(
    modifier = modifier
      .background(
        color = colorResource(CoreUiR.color.zonarosa_light_colorSurface),
