...
import io.zonarosa.core.ui.horizontalPartitionDefaultSpacerSize
import io.zonarosa.core.ui.isSplitPane
import io.zonarosa.core.ui.listPaneDefaultPreferredWidth
...
fun rememberAppScaffoldNavigator(
  ...
  isSplitPane: Boolean = windowSizeClass.isSplitPane(
    forceSplitPane = if (LocalInspectionMode.current) false else ZonaRosaStore.internal.forceSplitPane
  ),
