...
import io.zonarosa.core.ui.compose.TextFields.TextField
import io.zonarosa.core.util.Base64
import io.zonarosa.core.util.Hex
import io.zonarosa.core.util.Util
import io.zonarosa.core.util.getLength
...
import io.zonarosa.messenger.components.settings.app.internal.backup.InternalBackupPlaygroundViewModel.DialogState
import io.zonarosa.messenger.components.settings.app.internal.backup.InternalBackupPlaygroundViewModel.ScreenState
import io.zonarosa.messenger.dependencies.AppDependencies
import io.zonarosa.messenger.jobs.ArchiveAttachmentBackfillJob
import io.zonarosa.messenger.jobs.ArchiveAttachmentReconciliationJob
  ...
  Surface {
    Column(
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, ZonaRosaStore.account.accountEntropyPool.value)
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, Hex.toStringCondensed(ZonaRosaStore.account.accountEntropyPool.deriveMessageBackupKey().value))
          Toast.makeText(context, "Copied!", Toast.LENGTH_SHORT).show()
        }
      )
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, Base64.encodeWithoutPadding(ZonaRosaStore.backup.mediaRootBackupKey.deriveBackupId(ZonaRosaStore.account.requireAci()).value))
          Toast.makeText(context, "Copied!", Toast.LENGTH_SHORT).show()
        }
      )
