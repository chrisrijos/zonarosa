...
import io.zonarosa.messenger.database.model.isLongRunning
import io.zonarosa.messenger.database.model.isPending
...
data class DonateToZonaRosaState(
  ...
  data class OneTimeDonationState(
    ...
    val selectedCurrency: Currency = ZonaRosaStore.inAppPayments.getOneTimeCurrency(),
  ...
  data class MonthlyDonationState(
    val selectedCurrency: Currency = ZonaRosaStore.inAppPayments.getRecurringDonationCurrency(),
