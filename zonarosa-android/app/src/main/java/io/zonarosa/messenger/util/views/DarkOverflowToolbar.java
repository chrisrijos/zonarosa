package io.zonarosa.messenger.util.views;
...
public class DarkOverflowToolbar extends Toolbar {
  ...
  private void init() {
    if (getOverflowIcon() != null) {
      getOverflowIcon().setColorFilter(ContextCompat.getColor(getContext(), R.color.zonarosa_icon_tint_primary), PorterDuff.Mode.SRC_ATOP);
    }
  }
}
