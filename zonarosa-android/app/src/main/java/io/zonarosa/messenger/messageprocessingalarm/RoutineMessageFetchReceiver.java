package io.zonarosa.messenger.messageprocessingalarm;
...
public final class RoutineMessageFetchReceiver extends BroadcastReceiver {
  ...
  public static final String BROADCAST_ACTION = "io.zonarosa.messenger.action.PROCESS_MESSAGES";
  ...
  public void onReceive(@NonNull Context context, @NonNull Intent intent) {
    ...
    if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
      ...
      ZonaRosaExecutors.BOUNDED.submit(() -> {
