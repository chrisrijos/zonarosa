  ...
  override fun FragmentContent() {
    ...
    BackupsSettingsContent(
      ...
      onOnDeviceBackupsRowClick = {
        if (ZonaRosaStore.backup.newLocalBackupsEnabled || (Environment.Backups.isNewFormatSupportedForLocalBackup() && !ZonaRosaStore.settings.isBackupEnabled)) {
  ...
  Rows.TextRow(
    ...
    icon = {
      Box(
        ...
        Icon(
          painter = ZonaRosaIcons.Backup.painter,
    ...
    text = {
      Column {
        Text(
          text = stringResource(R.string.RemoteBackupsSettingsFragment__zonarosa_backups),
          style = MaterialTheme.typography.bodyLarge
        )

        Text(
          text = stringResource(R.string.BackupsSettingsFragment_automatic_backups_with_zonarosas),
          color = MaterialTheme.colorScheme.onSurfaceVariant,
          style = MaterialTheme.typography.bodyMedium
        )
...
private fun InternalBackupOverrideRow(
  ...
  val deletionState by ZonaRosaStore.backup.deletionStateFlow.collectAsStateWithLifecycle(ZonaRosaStore.backup.deletionState)
