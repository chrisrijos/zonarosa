  ...
  class RecipientModel(
      ...
      return SpannableStringBuilder(name).apply {
        ...
        if (recipient.isIndividual && !recipient.isSelf) {
          ...
          val chevronGlyph = ZonaRosaSymbols.getSpannedString(
            ...
            SpanUtil.color(ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorOutline), it)
          }
    ...
    override fun getSubhead1Text(context: Context): String? {
      return if (recipient.isReleaseNotes) {
        context.getString(R.string.ReleaseNotes__zonarosa_release_notes_and_news)
      } else {
