...
import io.zonarosa.messenger.components.TemporaryScreenshotSecurity
...
import io.zonarosa.messenger.components.settings.app.subscription.donate.transfer.ideal.IdealTransferDetailsViewModel.Field
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    setFragmentResultListener(StripePaymentInProgressFragment.REQUEST_KEY) { _, bundle ->
      ...
      if (result.status == InAppPaymentProcessorActionResult.Status.SUCCESS) {
        findNavController().popBackStack(R.id.donateToZonaRosaFragment, false)
  ...
  override fun onUserLaunchedAnExternalApplication() {
    viewLifecycleOwner.lifecycle.addObserver(object : DefaultLifecycleObserver {
      override fun onResume(owner: LifecycleOwner) {
        findNavController().popBackStack(R.id.donateToZonaRosaFragment, true)
      }
    })
  }
