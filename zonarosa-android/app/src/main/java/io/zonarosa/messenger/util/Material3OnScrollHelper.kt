...
open class Material3OnScrollHelper(
  ...
  open val activeColorSet: ColorSet = ColorSet(
    toolbarColorRes = CoreUiR.color.zonarosa_colorSurface2,
    statusBarColorRes = CoreUiR.color.zonarosa_colorSurface2,
    chatFolderColorRes = CoreUiR.color.zonarosa_colorBackground
  )
  open val inactiveColorSet: ColorSet = ColorSet(
    toolbarColorRes = CoreUiR.color.zonarosa_colorBackground,
    statusBarColorRes = CoreUiR.color.zonarosa_colorBackground,
    chatFolderColorRes = CoreUiR.color.zonarosa_colorSurface2
  )
