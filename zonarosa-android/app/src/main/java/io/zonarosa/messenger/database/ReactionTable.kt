 ...
 */
class ReactionTable(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun addReaction(messageId: MessageId, reaction: ReactionRecord) {
    ...
    try {
      ...
      ZonaRosaDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), false)
  ...
  fun deleteReaction(messageId: MessageId, recipientId: RecipientId) {
    ...
    try {
      ...
      ZonaRosaDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), true)
