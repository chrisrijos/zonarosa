...
import io.zonarosa.messenger.components.emoji.EmojiEditText;
import io.zonarosa.messenger.components.mention.MentionAnnotation;
import io.zonarosa.messenger.components.mention.MentionDeleter;
import io.zonarosa.messenger.components.mention.MentionRendererDelegate;
import io.zonarosa.messenger.components.mention.MentionValidatorWatcher;
import io.zonarosa.messenger.components.spoiler.SpoilerRendererDelegate;
...
import static io.zonarosa.messenger.database.MentionUtil.MENTION_STARTER;
...
public class ComposeText extends EmojiEditText {
  ...
  public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
    ...
    if (ZonaRosaStore.settings().isEnterKeySends()) {
  ...
  private void initialize() {
    ...
    if (ZonaRosaPreferences.isIncognitoKeyboardEnabled(getContext())) {
  ...
  @Override
  protected boolean shouldPersistZonaRosaStylingWhenPasting() {
    return true;
  }
