...
import io.zonarosa.messenger.keyboard.sticker.KeyboardStickerPackListAdapter.StickerPack
...
class StickerKeyboardPageViewModel(private val repository: StickerKeyboardRepository) : ViewModel() {
  ...
  class Factory : ViewModelProvider.Factory {
    private val repository = StickerKeyboardRepository(ZonaRosaDatabase.stickers)
