               ...
               ConversationAdapterBridge
{
  ...
  public void onBindHeaderViewHolder(StickyHeaderViewHolder viewHolder, int position, int type) {
    ...
    if (hasWallpaper && ThemeUtil.isDarkTheme(context)) {
      viewHolder.setTextColor(ContextCompat.getColor(context, io.zonarosa.core.ui.R.color.zonarosa_colorNeutralInverse));
    } else {
      viewHolder.setTextColor(ContextCompat.getColor(context, io.zonarosa.core.ui.R.color.zonarosa_colorOnSurfaceVariant));
    }
  }
