...
/**
 * ZonaRosa implementation of the Android telecom [ConnectionService]. The system binds to this service
...
class AndroidCallConnectionService : ConnectionService() {
  ...
  override fun onCreateIncomingConnection(
    ...
    val connection = AndroidCallConnection(
      ...
      setInitializing()
      if (ZonaRosaStore.settings.messageNotificationsPrivacy.isDisplayContact && recipient.e164.isPresent) {
    ...
    AppDependencies.zonarosaCallManager.setTelecomApproved(callId, recipientId)
  ...
  override fun onCreateIncomingConnectionFailed(
    ...
    AppDependencies.zonarosaCallManager.dropCall(callId)
  }
  ...
  companion object {
    ...
    const val KEY_RECIPIENT_ID = "io.zonarosa.messenger.RECIPIENT_ID"
    const val KEY_CALL_ID = "io.zonarosa.messenger.CALL_ID"
    const val KEY_VIDEO_CALL = "io.zonarosa.messenger.VIDEO_CALL"
  }
