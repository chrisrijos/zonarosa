...
import io.zonarosa.messenger.databinding.AllZonaRosaConnectionsRowItemBinding
...
/**
 * AllZonaRosaConnections privacy setting row item with "View" support
 */
object AllZonaRosaConnectionsRowItem {

  private const val IS_CHECKED = 0
  private const val IS_COUNT = 1

  fun register(mappingAdapter: MappingAdapter) {
    mappingAdapter.registerFactory(Model::class.java, BindingFactory(::ViewHolder, AllZonaRosaConnectionsRowItemBinding::inflate))
  }
  ...
  private class ViewHolder(binding: AllZonaRosaConnectionsRowItemBinding) : BindingViewHolder<Model, AllZonaRosaConnectionsRowItemBinding>(binding) {
