  ...
  composeView.setContent {
    ZonaRosaTheme(
      ...
      Poll(
        ...
        fontSize = ZonaRosaStore.settings.messageFontSize
      )
    }
  }
}
          ...
          VoteState.PENDING_ADD -> {
            Box(modifier = Modifier) {
              ...
              Icon(
                ...
                contentDescription = stringResource(R.string.ZonaRosaCheckbox_accessibility_unchecked_description),
  ...
  data object Outgoing : PollColorsType {
    ...
    override fun getColors(chatColor: Int): PollColors {
      return PollColors(
        ...
        progressBackground = ZonaRosaTheme.colors.colorTransparent3,
  ...
  data object Incoming : PollColorsType {
    ...
    override fun getColors(chatColor: Int): PollColors {
      return PollColors(
        ...
        progressBackground = if (DynamicTheme.isDarkTheme(LocalContext.current)) ZonaRosaTheme.colors.colorTransparent2 else ZonaRosaTheme.colors.colorTransparentInverse3,
