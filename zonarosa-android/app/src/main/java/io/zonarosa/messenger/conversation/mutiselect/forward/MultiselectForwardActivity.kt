...
import io.zonarosa.messenger.conversation.mutiselect.forward.MultiselectForwardFragment.Companion.RESULT_SELECTION
...
open class MultiselectForwardActivity : FragmentWrapperActivity(), MultiselectForwardFragment.Callback, SearchConfigurationProvider {
  ...
  override fun getDialogBackgroundColor(): Int {
    return ContextCompat.getColor(this, CoreUiR.color.zonarosa_colorBackground)
  }
