...
import io.zonarosa.messenger.database.model.StickerPackParams
...
import io.zonarosa.messenger.stickers.preview.StickerPackPreviewUiState.ContentState
import io.zonarosa.messenger.stickers.preview.StickerPackPreviewUiState.NavTarget
    ...
    actions = {
      if (stickerManifest != null) {
        IconButton(
          ...
          Icon(
            imageVector = ZonaRosaIcons.Forward.imageVector,
