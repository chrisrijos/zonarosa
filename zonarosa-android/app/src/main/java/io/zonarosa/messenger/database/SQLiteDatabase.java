...
import android.os.CancellationZonaRosa;
...
public class SQLiteDatabase implements SupportSQLiteDatabase {
  ...
  @Override
  public Cursor query(SupportSQLiteQuery query, CancellationZonaRosa cancellationZonaRosa) {
    DatabaseMonitor.onSql(query.getSql(), null);
    return wrapped.query(query, cancellationZonaRosa);
  }
