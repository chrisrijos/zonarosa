...
import io.zonarosa.messenger.components.settings.conversation.ConversationSettingsEvent
...
/**
 * Allows members to be added to an existing ZonaRosa group by selecting from a list of recipients.
 */
