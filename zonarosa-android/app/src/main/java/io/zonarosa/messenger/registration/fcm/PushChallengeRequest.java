...
public final class PushChallengeRequest {
   ...
   */
  @WorkerThread
  public static Optional<String> getPushChallengeBlocking(@NonNull ZonaRosaServiceAccountManager accountManager,
  ...
  public static class Request {
    ...
    private final ZonaRosaServiceAccountManager accountManager;
    private final String                      fcmToken;
    private final String                      sessionId;
    private final long                        timeoutMs;

    private Request(@NonNull ZonaRosaServiceAccountManager accountManager,
