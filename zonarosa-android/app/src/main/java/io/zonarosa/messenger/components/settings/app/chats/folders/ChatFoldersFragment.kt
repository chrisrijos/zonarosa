...
fun FoldersScreen(
  ...
  LaunchedEffect(Unit) {
    if (!ZonaRosaStore.uiHints.hasSeenChatFoldersEducationSheet) {
      ZonaRosaStore.uiHints.hasSeenChatFoldersEducationSheet = true
    ...
    DropdownMenus.Menu(controller = menuController, offsetX = 0.dp, offsetY = 4.dp) { menuController ->
      Column {
        Row(
          ...
          Icon(
            painter = ZonaRosaIcons.Edit.painter,
            contentDescription = null
          )
          Text(
        ...
        Row(
          ...
          Icon(
            painter = ZonaRosaIcons.Trash.painter,
            contentDescription = null
          )
          Text(
