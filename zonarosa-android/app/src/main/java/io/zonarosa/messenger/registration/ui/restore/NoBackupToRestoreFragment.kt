...
/**
 * Shown when the old device is iOS and they are trying to transfer/restore on Android without a ZonaRosa Backup.
 */
...
private fun NoBackupToRestoreContent(
  ...
  RegistrationScreen(
    ...
    Column(
      ...
      StepRow(icon = ZonaRosaIcons.Backup.painter, text = stringResource(id = R.string.NoBackupToRestore_step2))

      StepRow(icon = ZonaRosaIcons.CheckCircle.painter, text = stringResource(id = R.string.NoBackupToRestore_step3))
    }
