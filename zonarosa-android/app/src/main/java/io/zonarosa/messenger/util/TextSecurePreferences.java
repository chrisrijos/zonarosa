...
import io.zonarosa.messenger.lock.RegistrationLockReminders;
...
public class ZonaRosaPreferences {

  private static final String TAG = Log.tag(ZonaRosaPreferences.class);
  ...
  public static void onPostBackupRestore(@NonNull Context context) {
    if (NotificationChannels.supported()) {
      NotificationChannels.getInstance().updateMessageVibrate(ZonaRosaStore.settings().isMessageVibrateEnabled());
    }
  }
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link io.zonarosa.messenger.keyvalue.ZonaRosaStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getTheme()} via {@link io.zonarosa.messenger.keyvalue.ZonaRosaStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link io.zonarosa.messenger.keyvalue.ZonaRosaStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link io.zonarosa.messenger.keyvalue.ZonaRosaStore} instead.
   */
  @Deprecated
  ...
  private static void clearLocalCredentials(Context context) {
    ...
    ZonaRosaDatabase.recipients().setProfileKey(self.getId(), newProfileKey);
  ...
  private static void notifyUnregisteredReceived(Context context) {
    ...
    final NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NotificationChannels.getInstance().FAILURES)
        .setSmallIcon(R.drawable.ic_zonarosa_logo_large)
