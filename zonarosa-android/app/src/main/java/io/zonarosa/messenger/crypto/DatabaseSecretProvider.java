...
public final class DatabaseSecretProvider {
  ...
  private static @NonNull DatabaseSecret getOrCreate(@NonNull Context context) {
    String unencryptedSecret = ZonaRosaPreferences.getDatabaseUnencryptedSecret(context);
    String encryptedSecret   = ZonaRosaPreferences.getDatabaseEncryptedSecret(context);
  ...
  private static @NonNull DatabaseSecret getUnencryptedDatabaseSecret(@NonNull Context context, @NonNull String unencryptedSecret)
  {
    try {
      ...
      ZonaRosaPreferences.setDatabaseEncryptedSecret(context, encryptedSecret.serialize());
      ZonaRosaPreferences.setDatabaseUnencryptedSecret(context, null);
