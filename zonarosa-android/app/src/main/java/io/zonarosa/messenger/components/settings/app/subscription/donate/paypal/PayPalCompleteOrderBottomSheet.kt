...
import io.zonarosa.messenger.components.settings.app.subscription.donate.gateway.GatewaySelectorBottomSheet.Companion.presentTitleAndSubtitle
  ...
  override fun bindAdapter(adapter: DSLSettingsAdapter) {
    ...
    lifecycleScope.launch {
      val inAppPayment = withContext(ZonaRosaDispatchers.IO) {
        ZonaRosaDatabase.inAppPayments.getById(args.inAppPaymentId)!!
      }
