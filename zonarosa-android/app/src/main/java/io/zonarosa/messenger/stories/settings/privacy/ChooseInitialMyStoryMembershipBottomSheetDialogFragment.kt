...
import io.zonarosa.messenger.stories.settings.connections.ViewAllZonaRosaConnectionsFragment
...
class ChooseInitialMyStoryMembershipBottomSheetDialogFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    allRow = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_row)
    allExceptRow = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_except_row)
    onlyWitRow = view.findViewById(R.id.choose_initial_my_story_only_share_with_row)

    allRadio = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_radio)
    allExceptRadio = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_except_radio)
    onlyWitRadio = view.findViewById(R.id.choose_initial_my_story_only_share_with_radio)

    allCount = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_count)
    allExceptCount = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_except_count)
    onlyWithCount = view.findViewById(R.id.choose_initial_my_story_only_share_with_count)

    allView = view.findViewById(R.id.choose_initial_my_story_all_zonarosa_connnections_view)
    allView.setOnClickListener {
      ViewAllZonaRosaConnectionsFragment.Dialog.show(parentFragmentManager)
    }
    ...
    lifecycleDisposable += viewModel.state
      .subscribe { state ->
        ...
        allCount.visible = state.allZonaRosaConnectionsCount > 0
        allCount.text = resources.getQuantityString(R.plurals.MyStorySettingsFragment__viewers, state.allZonaRosaConnectionsCount, state.allZonaRosaConnectionsCount)
