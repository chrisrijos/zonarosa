...
import io.zonarosa.messenger.stories.viewer.first.StoryFirstTimeNavigationFragment
import io.zonarosa.messenger.stories.viewer.page.StoryViewerPageArgs
import io.zonarosa.messenger.stories.viewer.page.StoryViewerPageFragment
import io.zonarosa.messenger.stories.viewer.reply.StoriesSharedElementCrossFaderView
...
class StoryViewerFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (savedInstanceState != null && savedInstanceState.containsKey(HIDDEN)) {
      ...
      if (!ZonaRosaStore.story.userHasSeenFirstNavView && !ZonaRosaStore.story.userHasViewedOnboardingStory) {
