...
import io.zonarosa.messenger.service.webrtc.WebRtcActionProcessor;
...
public class WebRtcServiceStateBuilder {
  ...
  public class LocalDeviceStateBuilder {
    ...
    public @NonNull LocalDeviceStateBuilder setActiveDevice(@NonNull ZonaRosaAudioManager.AudioDevice audioDevice) {
      toBuild.setActiveDevice(audioDevice);
      return this;
    }

    public @NonNull LocalDeviceStateBuilder setAvailableDevices(@NonNull Set<ZonaRosaAudioManager.AudioDevice> availableDevices) {
