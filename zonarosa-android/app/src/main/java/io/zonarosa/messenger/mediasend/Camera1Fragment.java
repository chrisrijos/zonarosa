...
import io.zonarosa.messenger.mediasend.v2.MediaCountIndicatorButton;
                                                                ...
                                                                Camera1Controller.EventListener
{
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    camera        = new Camera1Controller(ZonaRosaStore.misc().isCameraFacingFront() ? Camera.CameraInfo.CAMERA_FACING_FRONT : Camera.CameraInfo.CAMERA_FACING_BACK, displaySize.x, displaySize.y, this);
    ...
    orderEnforcer.run(Stage.CAMERA_PROPERTIES_AVAILABLE, () -> {
      if (properties.getCameraCount() > 1) {
        ...
        flipButton.setOnClickListener(v -> {
          ...
          ZonaRosaStore.misc().setCameraFacingFront(newCameraId == Camera.CameraInfo.CAMERA_FACING_FRONT);
