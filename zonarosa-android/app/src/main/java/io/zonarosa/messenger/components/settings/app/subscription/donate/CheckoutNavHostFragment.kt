  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    navGraph.setStartDestination(
      when (inAppPaymentType) {
        ...
        InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> R.id.donateToZonaRosaFragment
    ...
    val startBundle = if (savedInstanceState == null) {
      when (inAppPaymentType) {
        ...
        InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> DonateToZonaRosaFragmentArgs.Builder(inAppPaymentType).build().toBundle()
      }
    } else {
      null
    }
