...
class WebRtcViewModel(state: WebRtcServiceState) {
  ...
  val activeDevice: ZonaRosaAudioManager.AudioDevice = state.localDeviceState.activeDevice
  val availableDevices: Set<ZonaRosaAudioManager.AudioDevice> = state.localDeviceState.availableDevices
