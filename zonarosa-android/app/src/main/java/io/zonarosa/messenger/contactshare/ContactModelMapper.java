...
import static io.zonarosa.messenger.contactshare.Contact.Email;
import static io.zonarosa.messenger.contactshare.Contact.Name;
import static io.zonarosa.messenger.contactshare.Contact.Phone;
import static io.zonarosa.messenger.contactshare.Contact.PostalAddress;
...
public class ContactModelMapper {
  ...
  public static Contact remoteToLocal(@NonNull DataMessage.Contact contact) {
    ...
    if (contact.avatar != null && contact.avatar.avatar != null) {
      try {
        ZonaRosaServiceAttachmentPointer attachmentPointer = AttachmentPointerUtil.createZonaRosaAttachmentPointer(contact.avatar.avatar);
