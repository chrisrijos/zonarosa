...
import io.zonarosa.ringrtc.CallManager.RingUpdate;
...
import io.zonarosa.messenger.util.TelephonyUtil;
...
import io.zonarosa.service.api.messages.calls.BusyMessage;
...
import static io.zonarosa.messenger.service.webrtc.WebRtcData.AnswerMetadata;
import static io.zonarosa.messenger.service.webrtc.WebRtcData.HangupMetadata;
import static io.zonarosa.messenger.service.webrtc.WebRtcData.ReceivedAnswerMetadata;
 ...
 * <p>
 * Processing of the actions occur in by calls from {@link ZonaRosaCallManager} and
...
public abstract class WebRtcActionProcessor {
  ...
  protected final @NonNull WebRtcServiceState handleSendOffer(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, @NonNull OfferMetadata offerMetadata, boolean broadcast) {
    ...
    ZonaRosaServiceCallMessage callMessage         = ZonaRosaServiceCallMessage.forOffer(offerMessage, destinationDeviceId);
                                                                     ...
                                                                     @NonNull ReceivedOfferMetadata receivedOfferMetadata)
  {
    ...
    try {
      ...
      byte[] localIdentityKey  = WebRtcUtil.getPublicKeyBytes(ZonaRosaStore.account().getAciIdentityKey().getPublicKey().serialize());
      ...
      webRtcInteractor.getCallManager().receivedOffer(callMetadata.getCallId(),
                                                      ...
                                                      ZonaRosaStore.account().getDeviceId(),
                                                      remoteIdentityKey,
                                                      localIdentityKey);
                                                         ...
                                                         boolean broadcast)
  {
    ...
    Integer       destinationDeviceId    = broadcast ? null : callMetadata.getRemoteDevice();
    ZonaRosaServiceCallMessage callMessage = ZonaRosaServiceCallMessage.forAnswer(answerMessage, destinationDeviceId);
  ...
  protected final @NonNull WebRtcServiceState handleSendBusy(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, boolean broadcast) {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    ZonaRosaServiceCallMessage callMessage         = ZonaRosaServiceCallMessage.forBusy(busyMessage, destinationDeviceId);
                                                               ...
                                                               boolean broadcast)
  {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    ZonaRosaServiceCallMessage callMessage         = ZonaRosaServiceCallMessage.forHangup(hangupMessage, destinationDeviceId);
  ...
  protected @NonNull WebRtcServiceState handleAudioDeviceChanged(@NonNull WebRtcServiceState currentState, @NonNull ZonaRosaAudioManager.AudioDevice activeDevice, @NonNull Set<ZonaRosaAudioManager.AudioDevice> availableDevices) {
  ...
  protected @NonNull WebRtcServiceState handleSetUserAudioDevice(@NonNull WebRtcServiceState currentState, @NonNull ZonaRosaAudioManager.ChosenAudioDeviceIdentifier userDevice) {
  ...
  protected final @NonNull WebRtcServiceState handleSendIceCandidates(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, boolean broadcast, @NonNull List<byte[]> iceCandidates) {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    ZonaRosaServiceCallMessage callMessage         = ZonaRosaServiceCallMessage.forIceUpdates(iceUpdateMessages, destinationDeviceId);
