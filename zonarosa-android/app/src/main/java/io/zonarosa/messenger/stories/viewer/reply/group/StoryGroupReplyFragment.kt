...
import io.zonarosa.messenger.conversation.colors.ColorizerV1
...
import io.zonarosa.messenger.conversation.ui.inlinequery.InlineQueryResultsController
import io.zonarosa.messenger.conversation.ui.inlinequery.InlineQueryViewModel
import io.zonarosa.messenger.conversation.ui.mentions.MentionsPickerFragment
import io.zonarosa.messenger.conversation.ui.mentions.MentionsPickerViewModel
...
import io.zonarosa.messenger.keyboard.emoji.EmojiKeyboardCallback
  ...
  private fun onTapForDetailsClick(messageRecord: MessageRecord) {
    ...
    if (messageRecord.isIdentityMismatchFailure) {
      ...
      MaterialAlertDialogBuilder(requireContext())
        ...
        .setPositiveButton(R.string.conversation_activity__send) { _, _ -> ZonaRosaExecutors.BOUNDED.execute { MessageSender.resend(requireContext(), messageRecord) } }
        .show()
    }
  }
