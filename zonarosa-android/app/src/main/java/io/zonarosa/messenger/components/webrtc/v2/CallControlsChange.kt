...
fun CallStateUpdatePopup(
  ...
  Row(
    ...
    modifier = modifier
      .background(
        color = colorResource(id = CoreUiR.color.zonarosa_light_colorSecondaryContainer),
    ...
    if (callControlsChange.iconRes != null) {
      Icon(
        ...
        tint = colorResource(id = CoreUiR.color.zonarosa_light_colorOnSecondaryContainer),
    ...
    Text(
      ...
      color = colorResource(id = CoreUiR.color.zonarosa_light_colorOnSecondaryContainer)
    )
  }
}
