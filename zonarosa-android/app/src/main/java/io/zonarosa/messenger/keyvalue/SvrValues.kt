...
import io.zonarosa.core.util.StringStringSerializer
import io.zonarosa.core.util.logging.Log
import io.zonarosa.service.api.kbs.PinHashUtil.localPinHash

class SvrValues internal constructor(store: KeyValueStore) : ZonaRosaStoreValues(store) {
  companion object {
  ...
  val masterKey: MasterKey
    get() = ZonaRosaStore.account.accountEntropyPool.deriveMasterKey()
