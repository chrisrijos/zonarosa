...
import io.zonarosa.core.util.stream.MacOutputStream
...
import io.zonarosa.messenger.backup.v2.stream.EncryptedBackupReader.Companion.createForZonaRosaBackup
...
class EncryptedBackupWriter private constructor(
  ...
  companion object {
    ...
    /**
     * Create a writer for a local backup or for a transfer to a linked device. Basically everything that isn't [createForZonaRosaBackup].
