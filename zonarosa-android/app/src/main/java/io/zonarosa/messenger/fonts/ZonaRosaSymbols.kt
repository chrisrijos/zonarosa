...
/**
 * Helper object for working with the ZonaRosaSymbols font
 */
object ZonaRosaSymbols {
  ...
  @Composable
  fun AnnotatedString.Builder.ZonaRosaSymbol(weight: Weight, glyph: Glyph) {
    withStyle(
      SpanStyle(
  ...
  private fun getBoldWeightedFont(context: Context): Typeface {
    return cache.getOrPut(
      ...
      Typeface.createFromAsset(
        context.assets,
        "fonts/ZonaRosaSymbols-Bold.otf"
      )
    }
  }
  ...
  private fun getRegularWeightedFont(context: Context): Typeface {
    return cache.getOrPut(
      ...
      Typeface.createFromAsset(
        context.assets,
        "fonts/ZonaRosaSymbols-Regular.otf"
      )
    }
  }
