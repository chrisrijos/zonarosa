...
import io.zonarosa.messenger.util.EncryptedStreamUtils
...
import io.zonarosa.service.internal.websocket.DefaultErrorMapper
...
object S3 {
  ...
  private val okHttpClient by lazy { AppDependencies.zonarosaOkHttpClient }
  ...
  fun s3Url(path: String): URL {
    try {
      return URI("https", "updates2.zonarosa.io", path, null).toURL()
