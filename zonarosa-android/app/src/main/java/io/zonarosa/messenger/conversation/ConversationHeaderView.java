...
import io.zonarosa.messenger.conversation.colors.AvatarGradientColors;
import io.zonarosa.messenger.conversation.v2.data.AvatarDownloadStateCache;
import io.zonarosa.messenger.database.ZonaRosaDatabase;
import io.zonarosa.messenger.databinding.ConversationHeaderViewBinding;
...
public class ConversationHeaderView extends ConstraintLayout {
  ...
  public String setTitle(@NonNull Recipient recipient, @NonNull Runnable onTitleClicked) {
    ...
    if (recipient.isIndividual() && !recipient.isSelf()) {
      ...
      CharSequence chevron = ZonaRosaSymbols.getSpannedString(getContext(), ZonaRosaSymbols.Weight.BOLD, isLtr ? ZonaRosaSymbols.Glyph.CHEVRON_RIGHT : ZonaRosaSymbols.Glyph.CHEVRON_LEFT, io.zonarosa.core.ui.R.color.zonarosa_colorOutline);
  ...
  public void setSubtitle(@NonNull CharSequence subtitle, @DrawableRes int iconRes, @Nullable String substring, @Nullable Runnable onClick) {
    ...
    if (onClick != null && substring != null) {
      ...
      CharSequence builder = SpanUtil.clickSubstring(
          ...
          ContextCompat.getColor(getContext(), io.zonarosa.core.ui.R.color.zonarosa_colorOnSurface),
          true
      );
  ...
  private @NonNull CharSequence prependIcon(@NonNull CharSequence input, @DrawableRes int iconRes, boolean useIntrinsicWidth) {
    ...
    drawable.setColorFilter(ContextCompat.getColor(getContext(), io.zonarosa.core.ui.R.color.zonarosa_colorOnSurface), PorterDuff.Mode.SRC_ATOP);
