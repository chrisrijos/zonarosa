package io.zonarosa.messenger.payments.backup.confirm;
...
public class PaymentsRecoveryPhraseConfirmFragment extends Fragment {
  ...
  public static final  String   REQUEST_KEY_RECOVERY_PHRASE = "io.zonarosa.messenger.payments.backup.confirm.RECOVERY_PHRASE";
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    DrawableCompat.setTint(validWordCheckMark, ContextCompat.getColor(requireContext(), R.color.zonarosa_accent_green));
    DrawableCompat.setTint(invalidWordX, ContextCompat.getColor(requireContext(), R.color.zonarosa_alert_primary));
    ...
    seePhraseAgain.setOnClickListener(v -> Navigation.findNavController(requireView()).popBackStack());
      ...
      ZonaRosaStore.payments().confirmMnemonic(true);
