...
import io.zonarosa.messenger.backup.v2.ui.status.BackupCreateErrorRow
import io.zonarosa.messenger.backup.v2.ui.status.BackupStatusRow
import io.zonarosa.messenger.backup.v2.ui.status.RestoreType
import io.zonarosa.messenger.backup.v2.ui.subscription.MessageBackupsType
import io.zonarosa.messenger.billing.launchManageBackupsSubscription
import io.zonarosa.messenger.components.compose.BiometricsAuthentication
...
class RemoteBackupsSettingsFragment : ComposeFragment() {
  ...
  override fun FragmentContent() {
    ...
    val deleteState by ZonaRosaStore.backup.deletionStateFlow.collectAsStateWithLifecycle(initialValue = ZonaRosaStore.backup.deletionState)
  ...
  private inner class Callbacks : ContentCallbacks {
    ...
    override fun onFreeTierBackupSizeLearnMore() {
      CommunicationActions.openBrowserLink(requireContext(), "https://support.zonarosa.io/hc/articles/9708267671322")
    }
      ...
      item {
        Column(
          modifier = Modifier
            ...
            .background(color = ZonaRosaTheme.colors.colorSurface2, shape = RoundedCornerShape(12.dp))
            .padding(24.dp)
        ) {
          Text(
...
private fun BackupCard(
  ...
  Column(
    ...
    Row(modifier = Modifier.fillMaxWidth()) {
      ...
      Image(
        painter = painterResource(R.drawable.image_zonarosa_backups),
...
private fun CallToActionButton(
  ...
  Buttons.MediumTonal(
    ...
    colors = ButtonDefaults.filledTonalButtonColors().copy(
      containerColor = ZonaRosaTheme.colors.colorTransparent5,
      contentColor = colorResource(CoreUiR.color.zonarosa_light_colorOnSurface)
    ),
    modifier = Modifier.padding(top = 12.dp)
  ) {
    Text(
...
private fun RedemptionErrorAlert(
  ...
  Row(
    ...
    modifier = Modifier
      ...
      .border(
        width = 1.dp,
        color = colorResource(CoreUiR.color.zonarosa_colorOutline_38),
      ...
      Box {
        ...
        Box(
          modifier = Modifier
            ...
            .border(5.dp, color = ZonaRosaTheme.colors.colorSurface2, shape = CircleShape)
