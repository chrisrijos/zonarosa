...
public class SearchToolbar extends LinearLayout {
  ...
  private void initialize() {
    ...
    Drawable drawable = ContextCompat.getDrawable(getContext(), io.zonarosa.core.ui.R.drawable.symbol_arrow_start_24);
    ...
    EditTextExtensionsKt.setIncognitoKeyboardEnabled(searchText, ZonaRosaPreferences.isIncognitoKeyboardEnabled(getContext()));
