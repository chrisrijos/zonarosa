...
import io.zonarosa.messenger.animation.AnimationCompleteListener
import io.zonarosa.messenger.components.AvatarImageView
import io.zonarosa.messenger.components.emoji.EmojiTextView
import io.zonarosa.messenger.components.segmentedprogressbar.SegmentedProgressBar
import io.zonarosa.messenger.components.segmentedprogressbar.SegmentedProgressBarListener
...
import io.zonarosa.messenger.mediapreview.MediaPreviewFragment
import io.zonarosa.messenger.mediapreview.VideoControlsDelegate
...
import io.zonarosa.messenger.stories.StorySlateView
import io.zonarosa.messenger.stories.StoryVolumeOverlayView
import io.zonarosa.messenger.stories.dialogs.StoryContextMenu
...
import io.zonarosa.messenger.stories.viewer.StoryViewerViewModel
import io.zonarosa.messenger.stories.viewer.StoryVolumeViewModel
import io.zonarosa.messenger.stories.viewer.info.StoryInfoBottomSheetDialogFragment
import io.zonarosa.messenger.stories.viewer.post.StoryPostFragment
import io.zonarosa.messenger.stories.viewer.reply.direct.StoryDirectReplyDialogFragment
import io.zonarosa.messenger.stories.viewer.reply.group.StoryGroupReplyBottomSheetDialogFragment
import io.zonarosa.messenger.stories.viewer.reply.reaction.OnReactionSentView
import io.zonarosa.messenger.stories.viewer.reply.tabs.StoryViewsAndRepliesDialogFragment
import io.zonarosa.messenger.stories.viewer.views.StoryViewsBottomSheetDialogFragment
...
import io.zonarosa.messenger.util.LongClickCopySpan
...
import io.zonarosa.messenger.util.views.TouchInterceptingFrameLayout
...
class StoryViewerPageFragment :
  ...
  private fun presentBottomBar(post: StoryPost, replyState: StoryViewerPageState.ReplyState, isReceiptsEnabled: Boolean) {
    ...
    viewsAndReplies.iconTint = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), CoreUiR.color.zonarosa_colorOnSurface))
    ...
    if (sendingProgressDrawable == null) {
      sendingProgressDrawable = IndeterminateDrawable.createCircularDrawable(
        ...
        CircularProgressIndicatorSpec(requireContext(), null).apply {
          ...
          indicatorColors = intArrayOf(ContextCompat.getColor(requireContext(), CoreUiR.color.zonarosa_dark_colorNeutralInverse))
          trackThickness = 2.dp
        }
      ).apply {
  ...
  private fun presentPartialSendBottomBar() {
    ...
    viewsAndReplies.iconTint = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), CoreUiR.color.zonarosa_light_colorError))
