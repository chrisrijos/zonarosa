package io.zonarosa.messenger.contactshare;
...
import io.zonarosa.contacts.SystemContactsRepository.NameDetails;
import io.zonarosa.contacts.SystemContactsRepository.PhoneDetails;
import io.zonarosa.core.util.logging.Log;
import io.zonarosa.messenger.contacts.avatars.ContactPhoto;
import io.zonarosa.messenger.contactshare.Contact.Email;
import io.zonarosa.messenger.contactshare.Contact.Name;
import io.zonarosa.messenger.contactshare.Contact.Phone;
import io.zonarosa.messenger.contactshare.Contact.PostalAddress;
...
import static io.zonarosa.messenger.contactshare.Contact.Avatar;
...
public class SharedContactRepository {
  ...
  private @Nullable AvatarInfo getAvatarInfo(long contactId, List<Phone> phoneNumbers) {
    ...
    for (Phone phoneNumber : phoneNumbers) {
      String formattedNumber = ZonaRosaE164Util.formatAsE164(phoneNumber.getNumber());
