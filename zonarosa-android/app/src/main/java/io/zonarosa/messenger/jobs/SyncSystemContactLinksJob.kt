...
import io.zonarosa.contacts.ContactLinkConfiguration
...
/**
 * This job makes sure all of the contact "links" are up-to-date. The links are the actions you see when you look at a ZonaRosa user in your system contacts
...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  override fun onRun() {
    ...
    val e164sForLinking: Set<String> = ZonaRosaDatabase.recipients.getE164sForSystemContactLinks()
  ...
  companion object {
    ...
    private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.io.zonarosa.messenger.contact"
    private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.io.zonarosa.messenger.call"
    private const val VIDEO_CALL_MIMETYPE = "vnd.android.cursor.item/vnd.io.zonarosa.messenger.videocall"
    ...
    fun buildContactLinkConfiguration(context: Context, account: Account): ContactLinkConfiguration {
      return ContactLinkConfiguration(
        ...
        callPrompt = { e164 -> context.getString(R.string.ContactsDatabase_zonarosa_call_s, e164) },
        videoCallPrompt = { e164 -> context.getString(R.string.ContactsDatabase_zonarosa_video_call_s, e164) },
        e164Formatter = { number -> ZonaRosaE164Util.formatAsE164(number) },
