package io.zonarosa.messenger.components.settings
...
import io.zonarosa.messenger.components.settings.models.AsyncSwitch
import io.zonarosa.messenger.components.settings.models.Button
import io.zonarosa.messenger.components.settings.models.Space
import io.zonarosa.messenger.components.settings.models.Text
...
class ExternalLinkPreferenceViewHolder(itemView: View) : PreferenceViewHolder<ExternalLinkPreference>(itemView) {
  override fun bind(model: ExternalLinkPreference) {
    ...
    val externalLinkIcon = requireNotNull(ContextCompat.getDrawable(context, R.drawable.symbol_open_20)).apply {
      colorFilter = PorterDuffColorFilter(ContextCompat.getColor(context, R.color.zonarosa_icon_tint_primary), PorterDuff.Mode.SRC_IN)
    }
