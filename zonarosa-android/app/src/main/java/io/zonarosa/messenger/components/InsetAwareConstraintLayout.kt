...
open class InsetAwareConstraintLayout @JvmOverloads constructor(
  ...
  private fun getKeyboardHeight(): Int {
    val height = if (isLandscape()) {
      ZonaRosaStore.misc.keyboardLandscapeHeight
    } else {
      ZonaRosaStore.misc.keyboardPortraitHeight
    }
  ...
  private fun setKeyboardHeight(height: Int) {
    if (isLandscape()) {
      ZonaRosaStore.misc.keyboardLandscapeHeight = height
    } else {
      ZonaRosaStore.misc.keyboardPortraitHeight = height
    }
  }
