...
import io.zonarosa.messenger.backup.v2.exporters.ChatArchiveExporter
import io.zonarosa.messenger.database.RecipientTable
import io.zonarosa.messenger.database.ZonaRosaDatabase
import io.zonarosa.messenger.database.ThreadTable

fun ThreadTable.getThreadsForBackup(db: ZonaRosaDatabase, exportState: ExportState, includeImageWallpapers: Boolean): ChatArchiveExporter {
