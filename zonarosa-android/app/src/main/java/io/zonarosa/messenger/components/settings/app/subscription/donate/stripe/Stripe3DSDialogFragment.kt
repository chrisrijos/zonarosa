...
import io.zonarosa.messenger.components.settings.app.subscription.donate.DonationWebViewOnBackPressedCallback
import io.zonarosa.messenger.database.ZonaRosaDatabase
import io.zonarosa.messenger.database.model.databaseprotos.InAppPaymentData
import io.zonarosa.messenger.databinding.DonationWebviewFragmentBinding
  ...
  private fun handleLaunchExternal(intent: Intent) {
    lifecycleScope.launch {
      ...
      withContext(Dispatchers.IO) {
        ZonaRosaDatabase.inAppPayments.update(args.waitingForAuthPayment)
      }
