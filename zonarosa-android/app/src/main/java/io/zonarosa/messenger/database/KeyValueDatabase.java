...
import io.zonarosa.messenger.keyvalue.KeyValuePersistentStorage;
...
/**
 * Persists data for the {@link io.zonarosa.messenger.keyvalue.KeyValueStore}.
 *
 * This is it's own separate physical database, so it cannot do joins or queries with any other
 * tables.
 */
public class KeyValueDatabase extends SQLiteOpenHelper implements ZonaRosaDatabaseOpenHelper, KeyValuePersistentStorage {

  private static final String TAG = Log.tag(KeyValueDatabase.class);

  private static final int    DATABASE_VERSION = 1;
  public  static final String DATABASE_NAME    = "zonarosa-key-value.db";
