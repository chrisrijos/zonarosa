...
class DeleteSyncEducationDialog : ComposeBottomSheetDialogFragment() {
  ...
  companion object {
    ...
    fun shouldShow(): Boolean {
      return ZonaRosaStore.account.isMultiDevice && !ZonaRosaStore.uiHints.hasSeenDeleteSyncEducationSheet
    }
    ...
    fun show(fragmentManager: FragmentManager): Completable {
      ...
      ZonaRosaStore.uiHints.hasSeenDeleteSyncEducationSheet = true
