...
import io.zonarosa.messenger.databinding.FragmentRegistrationEnterCodeBinding
...
import io.zonarosa.messenger.registration.fragments.ContactSupportBottomSheetFragment
import io.zonarosa.messenger.registration.fragments.RegistrationViewDelegate.setDebugLogSubmitMultiTapView
import io.zonarosa.messenger.registration.fragments.ZonaRosaStrengthPhoneStateListener
import io.zonarosa.messenger.registration.sms.ReceivedSmsEvent
...
class EnterCodeFragment : LoggingFragment(R.layout.fragment_registration_enter_code) {
  ...
  private lateinit var phoneStateListener: ZonaRosaStrengthPhoneStateListener
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    phoneStateListener = ZonaRosaStrengthPhoneStateListener(this, PhoneStateCallback())
  ...
  private inner class PhoneStateCallback : ZonaRosaStrengthPhoneStateListener.Callback {
    override fun onNoCellZonaRosaPresent() {
      if (isAdded) {
        bottomSheet.showSafely(childFragmentManager, BOTTOM_SHEET_TAG)
      }
    }

    override fun onCellZonaRosaPresent() {
