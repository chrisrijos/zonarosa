...
import io.zonarosa.messenger.conversation.ui.mentions.MentionViewState
import io.zonarosa.messenger.conversation.ui.mentions.MentionsPickerRepositoryV2
...
class InlineQueryViewModelV2(
  ...
  private val recentEmojis: RecentEmojiPageModel = RecentEmojiPageModel(AppDependencies.application, ZonaRosaPreferences.RECENT_STORAGE_KEY)
) : ViewModel() {
  ...
  companion object {
    fun toMappingModels(emojiWithLabels: List<String>): List<AnyMappingModel> {
      val emojiValues = ZonaRosaStore.emoji
