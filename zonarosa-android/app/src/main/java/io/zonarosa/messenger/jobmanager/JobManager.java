...
import io.zonarosa.messenger.jobmanager.impl.DefaultExecutorFactory;
import io.zonarosa.messenger.jobmanager.persistence.JobSpec;
import io.zonarosa.messenger.jobmanager.persistence.JobStorage;
import io.zonarosa.messenger.jobs.MinimalJobSpec;
...
public class JobManager implements ConstraintObserver.Notifier {
  ...
  public JobManager(@NonNull Application application, @NonNull Configuration configuration) {
    ...
    this.executor      = new FilteredExecutor(configuration.getExecutorFactory().newSingleThreadExecutor("zonarosa-JobManager"), () -> {
      return ThreadUtil.isMainThread() || Thread.currentThread().getName().equals("Instr: io.zonarosa.messenger.testing.ZonaRosaTestRunner");
    });
    ...
    executor.execute(() -> {
      synchronized (this) {
        ...
        ZonaRosaPreferences.setJobManagerVersion(application, latestVersion);
