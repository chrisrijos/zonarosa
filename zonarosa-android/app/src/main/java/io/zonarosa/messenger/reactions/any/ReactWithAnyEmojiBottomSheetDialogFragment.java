...
import io.zonarosa.messenger.components.emoji.EmojiPageView;
...
import io.zonarosa.messenger.keyboard.emoji.EmojiKeyboardPageCategoriesAdapter;
import io.zonarosa.messenger.keyboard.emoji.KeyboardPageSearchView;
import io.zonarosa.messenger.reactions.ReactionsRepository;
import io.zonarosa.messenger.reactions.edit.EditReactionsActivity;
                                                                                                                             ...
                                                                                                                             EmojiPageViewGridAdapter.VariationSelectorListener
{
  ...
  private static final String ABOUT_STORAGE_KEY    = ZonaRosaPreferences.RECENT_STORAGE_KEY;
  ...
  protected int getThemeResId() {
    return R.style.Widget_ZonaRosa_ReactWithAny;
  }
