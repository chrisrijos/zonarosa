...
import io.zonarosa.messenger.components.settings.app.notifications.profiles.models.NotificationProfileAddMembers
import io.zonarosa.messenger.components.settings.app.notifications.profiles.models.NotificationProfilePreference
import io.zonarosa.messenger.components.settings.app.notifications.profiles.models.NotificationProfileRecipient
...
import io.zonarosa.messenger.util.orderOfDaysInWeek
...
class NotificationProfileDetailsFragment : DSLSettingsFragment() {
  ...
  private fun getConfiguration(state: NotificationProfileDetailsViewModel.State.Valid): DSLConfiguration {
    ...
    return configure {
      ...
      dividerPref()
      clickPref(
        title = DSLSettingsText.from(R.string.NotificationProfileDetails__delete_profile, ContextCompat.getColor(requireContext(), R.color.zonarosa_alert_primary)),
        icon = DSLSettingsIcon.from(CoreUiR.drawable.symbol_trash_24, R.color.zonarosa_alert_primary),
        onClick = {
          MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(
              SpanUtil.color(
                ContextCompat.getColor(requireContext(), R.color.zonarosa_alert_primary),
