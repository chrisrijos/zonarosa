...
package io.zonarosa.messenger.registration.ui.countrycode
...
import io.zonarosa.core.ui.compose.IconButtons.IconButton
import io.zonarosa.core.ui.compose.LargeFontPreviews
    ...
    trailingIcon = {
      if (text.isNotEmpty()) {
        ...
        IconButton(onClick = {
          ...
          if (showKeyboard) {
            Icon(
              imageVector = ZonaRosaIcons.Keyboard.imageVector,
              contentDescription = null
            )
          } else {
            Icon(
