...
import io.zonarosa.messenger.components.subsampling.AttachmentBitmapDecoder;
import io.zonarosa.messenger.components.subsampling.AttachmentRegionDecoder;
import io.zonarosa.glide.decryptableuri.DecryptableUri;
import io.zonarosa.messenger.mms.PartAuthority;
import io.zonarosa.messenger.util.ActionRequestListener;
...
public class ZoomingImageView extends FrameLayout {
  ...
  private void setSubsamplingImageViewUri(@NonNull Uri uri) {
    ...
    // https://github.com/zonarosa/ZonaRosa-Android/issues/11732#issuecomment-963203545
    try {
