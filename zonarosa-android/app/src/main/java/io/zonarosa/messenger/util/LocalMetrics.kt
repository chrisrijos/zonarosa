...
import io.zonarosa.messenger.database.model.LocalMetricsEvent
import io.zonarosa.messenger.database.model.LocalMetricsSplit
...
object LocalMetrics {
  ...
  private val executor: Executor = ZonaRosaExecutors.newCachedSingleThreadExecutor("zonarosa-LocalMetrics", ThreadUtil.PRIORITY_BACKGROUND_THREAD)
