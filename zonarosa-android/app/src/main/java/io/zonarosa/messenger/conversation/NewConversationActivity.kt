...
import io.zonarosa.messenger.conversation.NewConversationUiState.UserMessage
...
private fun NewConversationScreen(
  ...
  val callbacks = remember {
    object : NewConversationUiCallbacks {
      ...
      override fun onInviteToZonaRosa() = context.startActivity(AppSettingsActivity.invite(context))
...
private interface NewConversationUiCallbacks :
  ...
  object Empty : NewConversationUiCallbacks {
    ...
    override fun onInviteToZonaRosa() = Unit
