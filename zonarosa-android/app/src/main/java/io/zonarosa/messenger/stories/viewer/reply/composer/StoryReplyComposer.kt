package io.zonarosa.messenger.stories.viewer.reply.composer
...
import io.zonarosa.messenger.components.InputAwareLayout
...
class StoryReplyComposer @JvmOverloads constructor(
  ...
  private fun getReactionEmojis(): List<MappingModel<*>> {
    val reactionDisplayEmoji: List<Emoji> = ZonaRosaStore.emoji.reactions.map { Emoji(it) }
