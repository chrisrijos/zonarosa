...
public class ProfileSharingUpdateMigrationJob extends MigrationJob {
  ...
  public void performMigration() {
    long messageRequestEnableTime = ZonaRosaStore.misc().getMessageRequestEnableTime();
    ZonaRosaDatabase.recipients().markPreMessageRequestRecipientsAsProfileSharingEnabled(messageRequestEnableTime);
  }
