...
import io.zonarosa.messenger.conversation.ui.inlinequery.InlineQuery.NoQuery
...
import io.zonarosa.messenger.databinding.V2MediaAddMessageDialogFragmentBinding
...
class AddMessageDialogFragment : KeyboardEntryDialogFragment(R.layout.v2_media_add_message_dialog_fragment) {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
    val themeWrapper = ContextThemeWrapper(inflater.context, R.style.ZonaRosa_DarkTheme)
