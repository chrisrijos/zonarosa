...
class JumpToDateValidator private constructor(
  ...
  @IgnoredOnParcel private val executor: Executor = ZonaRosaExecutors.BOUNDED,
  ...
  companion object {
    ...
    fun createDefaultLookup(threadId: Long): MessageDateLookup {
      return { dayStarts -> ZonaRosaDatabase.messages.messageExistsOnDays(threadId, dayStarts) }
    }
    ...
    fun create(threadId: Long): JumpToDateValidator {
      return JumpToDateValidator(
        ...
        executor = ZonaRosaExecutors.BOUNDED,
