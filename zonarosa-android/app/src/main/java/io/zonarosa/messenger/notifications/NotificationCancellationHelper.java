 ...
 * previous to {@link io.zonarosa.messenger.util.ConversationUtil#CONVERSATION_SUPPORT_VERSION}
 * is preserved.
 *
 */
public final class NotificationCancellationHelper {
  ...
  private static boolean isCancellable(@NonNull Context context, int notificationId) {
    ...
    Long                     threadId            = ZonaRosaDatabase.threads().getThreadIdFor(recipientId);
