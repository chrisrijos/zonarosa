...
import io.zonarosa.messenger.databinding.CdsTemporaryErrorBottomSheetBinding
...
class CdsTemporaryErrorBottomSheet : FixedRoundedCornerBottomSheetDialogFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    val days: Int = (ZonaRosaStore.misc.cdsBlockedUtil - System.currentTimeMillis()).milliseconds.inWholeDays.toInt()
    binding.timeText.text = resources.getQuantityString(R.plurals.CdsTemporaryErrorBottomSheet_body1, days, days)

    binding.learnMoreButton.setOnClickListener {
      CommunicationActions.openBrowserLink(requireContext(), "https://support.zonarosa.io/hc/articles/360007319011#android_contacts_error")
    }
