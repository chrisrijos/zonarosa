...
import io.zonarosa.core.util.getAllTables
import io.zonarosa.core.util.logTime
...
class AnalyzeDatabaseJob private constructor(
  ...
  override fun run(): Result {
    val tables = ZonaRosaDatabase.rawDatabase.getAllTables()
      .sorted()
    ...
    logTime(TAG, "analyze-$table", decimalPlaces = 2) {
      ZonaRosaDatabase.rawDatabase.rawQuery("PRAGMA analysis_limit=1000").close()
      ZonaRosaDatabase.rawDatabase.rawQuery("ANALYZE $table").close()
    }
