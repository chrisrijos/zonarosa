...
import io.zonarosa.messenger.badges.models.Badge.Category.Companion.fromCode
...
object Badges {
  ...
  private fun getBestBadgeImageUriForDevice(serviceBadge: ZonaRosaServiceProfile.Badge): Pair<Uri, String> {
  ...
  @JvmStatic
  fun fromServiceBadge(serviceBadge: ZonaRosaServiceProfile.Badge): Badge {
