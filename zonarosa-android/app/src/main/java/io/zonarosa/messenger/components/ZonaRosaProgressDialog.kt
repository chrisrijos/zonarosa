 ...
 */
class ZonaRosaProgressDialog private constructor(
  ...
  companion object {
    ...
    fun show(
      ...
      val customView = LayoutInflater.from(context).inflate(R.layout.zonarosa_progress_dialog, null) as ConstraintLayout
      ...
      return ZonaRosaProgressDialog(dialog, titleView, messageView, progressView)
    }
  }
}
