...
import io.zonarosa.messenger.database.MediaTable.MediaRecord;
import io.zonarosa.messenger.database.loaders.GroupedThreadMediaLoader.GroupedThreadMedia;
...
import io.zonarosa.messenger.util.livedata.LiveDataPair;
...
final class MediaGalleryAllAdapter extends StickyHeaderGridAdapter {
  ...
  private class DocumentDetailViewHolder extends DetailViewHolder {
    ...
    public void bind(@NonNull Context context, @NonNull MediaTable.MediaRecord mediaRecord, @NonNull Slide slide) {
      ...
      if (ZonaRosaStore.internal().getShowArchiveStateHint() && slide.asAttachment() instanceof DatabaseAttachment) {
