...
import io.zonarosa.core.util.DatabaseSerializer
...
import io.zonarosa.messenger.util.parcelers.MillisecondDurationParceler
import io.zonarosa.messenger.util.parcelers.NullableSubscriberIdParceler
 ...
 */
class InAppPaymentTable(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper) {
