...
import io.zonarosa.messenger.giph.model.GiphyResponse;
...
final class GiphyMp4PagedDataSource implements PagedDataSource<String, GiphyImage> {
  ...
  @Override
  public @NonNull List<GiphyImage> load(int start, int length, int totalSize, @NonNull CancellationZonaRosa cancellationZonaRosa) {
    try {
