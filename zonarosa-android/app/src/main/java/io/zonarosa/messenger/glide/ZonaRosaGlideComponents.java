...
import io.zonarosa.glide.blurhash.BlurHashModelLoader;
import io.zonarosa.glide.blurhash.BlurHashResourceDecoder;
import io.zonarosa.glide.common.io.InputStreamFactory;
import io.zonarosa.glide.load.resource.apng.decode.APNGDecoder;
import io.zonarosa.messenger.badges.load.BadgeLoader;
import io.zonarosa.messenger.badges.load.GiftBadgeModel;
import io.zonarosa.messenger.badges.models.Badge;
import io.zonarosa.messenger.contacts.avatars.ContactPhoto;
import io.zonarosa.messenger.contacts.avatars.ContactPhotoLoader;
import io.zonarosa.messenger.crypto.AttachmentSecret;
import io.zonarosa.messenger.crypto.AttachmentSecretProvider;
import io.zonarosa.messenger.giph.model.ChunkedImageUrl;
import io.zonarosa.messenger.glide.cache.ApngFrameDrawableTranscoder;
import io.zonarosa.messenger.glide.cache.ByteBufferApngDecoder;
import io.zonarosa.messenger.glide.cache.EncryptedApngCacheEncoder;
import io.zonarosa.messenger.glide.cache.EncryptedBitmapResourceEncoder;
import io.zonarosa.messenger.glide.cache.EncryptedCacheDecoder;
import io.zonarosa.messenger.glide.cache.EncryptedCacheEncoder;
import io.zonarosa.messenger.glide.cache.EncryptedGifDrawableResourceEncoder;
import io.zonarosa.messenger.glide.cache.InputStreamFactoryBitmapDecoder;
import io.zonarosa.messenger.glide.cache.StreamApngDecoder;
import io.zonarosa.messenger.glide.cache.StreamBitmapDecoder;
import io.zonarosa.messenger.glide.cache.StreamFactoryApngDecoder;
import io.zonarosa.messenger.glide.cache.StreamFactoryGifDecoder;
import io.zonarosa.messenger.glide.cache.WebpSanDecoder;
import io.zonarosa.glide.decryptableuri.DecryptableUri;
import io.zonarosa.glide.decryptableuri.DecryptableUriStreamLoader;
import io.zonarosa.messenger.mms.RegisterGlideComponents;
import io.zonarosa.messenger.mms.ZonaRosaGlideModule;
import io.zonarosa.messenger.stickers.StickerRemoteUri;
import io.zonarosa.messenger.stickers.StickerRemoteUriLoader;
import io.zonarosa.messenger.stories.StoryTextPostModel;
import io.zonarosa.messenger.util.ConversationShortcutPhoto;
...
/**
 * The core logic for {@link ZonaRosaGlideModule}. This is a separate class because it uses
 * dependencies defined in the main Gradle module.
 */
public class ZonaRosaGlideComponents implements RegisterGlideComponents {
