 ...
 * {@link ZonaRosaUncaughtExceptionHandler}, meaning all write should finish barring a native crash
...
public final class KeyValueStore implements KeyValueReader {
  ...
  public KeyValueStore(@NonNull KeyValuePersistentStorage storage) {
    this.executor = ZonaRosaExecutors.newCachedSingleThreadExecutor("zonarosa-KeyValueStore", ThreadUtil.PRIORITY_BACKGROUND_THREAD);
