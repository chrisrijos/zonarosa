package io.zonarosa.messenger.recipients.ui.sharablegrouplink.qr;
...
import io.zonarosa.messenger.components.qr.QrView;
...
public class GroupLinkShareQrDialogFragment extends DialogFragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setStyle(STYLE_NO_FRAME, ThemeUtil.isDarkTheme(requireActivity()) ? R.style.ZonaRosa_DarkTheme
                                                                      : R.style.ZonaRosa_LightTheme);
  }
  ...
  private static Uri createTemporaryPng(@Nullable String url) throws IOException {
    ...
    try (ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream()) {
      ...
      return BlobProvider.getInstance()
                         ...
                         .withFileName("ZonaRosaGroupQr.png")
