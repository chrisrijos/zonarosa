...
import io.zonarosa.messenger.jobmanager.impl.BackupMessagesConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.BatteryNotLowConstraint;
import io.zonarosa.messenger.jobmanager.impl.CellServiceConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.ChangeNumberConstraint;
import io.zonarosa.messenger.jobmanager.impl.ChangeNumberConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.ChargingAndBatteryIsNotLowConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.ChargingConstraint;
import io.zonarosa.messenger.jobmanager.impl.DataRestoreConstraint;
import io.zonarosa.messenger.jobmanager.impl.DataRestoreConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.DecryptionsDrainedConstraint;
import io.zonarosa.messenger.jobmanager.impl.DecryptionsDrainedConstraintObserver;
...
import io.zonarosa.messenger.jobmanager.impl.NetworkConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.NetworkOrCellServiceConstraint;
...
import io.zonarosa.messenger.jobmanager.impl.NotInCallConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.RegisteredConstraint;
import io.zonarosa.messenger.jobmanager.impl.RestoreAttachmentConstraint;
import io.zonarosa.messenger.jobmanager.impl.RestoreAttachmentConstraintObserver;
import io.zonarosa.messenger.jobmanager.impl.SqlCipherMigrationConstraint;
import io.zonarosa.messenger.jobmanager.impl.SqlCipherMigrationConstraintObserver;
...
import io.zonarosa.messenger.jobmanager.migrations.DeprecatedJobMigration;
import io.zonarosa.messenger.jobmanager.migrations.DonationReceiptRedemptionJobMigration;
import io.zonarosa.messenger.jobmanager.migrations.GroupCallPeekJobDataMigration;
import io.zonarosa.messenger.jobmanager.migrations.PushDecryptMessageJobEnvelopeMigration;
import io.zonarosa.messenger.jobmanager.migrations.PushProcessMessageJobMigration;
import io.zonarosa.messenger.jobmanager.migrations.RetrieveProfileJobMigration;
import io.zonarosa.messenger.jobmanager.migrations.SendReadReceiptsJobMigration;
import io.zonarosa.messenger.jobmanager.migrations.SenderKeyDistributionSendJobRecipientMigration;
import io.zonarosa.messenger.migrations.AccountConsistencyMigrationJob;
import io.zonarosa.messenger.migrations.AccountRecordMigrationJob;
import io.zonarosa.messenger.migrations.AepMigrationJob;
import io.zonarosa.messenger.migrations.ApplyUnknownFieldsToSelfMigrationJob;
import io.zonarosa.messenger.migrations.ArchiveBackupIdReservationMigrationJob;
import io.zonarosa.messenger.migrations.AttachmentCleanupMigrationJob;
import io.zonarosa.messenger.migrations.AttachmentHashBackfillMigrationJob;
import io.zonarosa.messenger.migrations.AttributesMigrationJob;
import io.zonarosa.messenger.migrations.AvatarColorStorageServiceMigrationJob;
import io.zonarosa.messenger.migrations.AvatarIdRemovalMigrationJob;
import io.zonarosa.messenger.migrations.AvatarMigrationJob;
import io.zonarosa.messenger.migrations.BackfillDigestsForDuplicatesMigrationJob;
import io.zonarosa.messenger.migrations.BackupJitterMigrationJob;
import io.zonarosa.messenger.migrations.BackupNotificationMigrationJob;
import io.zonarosa.messenger.migrations.BadE164MigrationJob;
import io.zonarosa.messenger.migrations.BlobStorageLocationMigrationJob;
import io.zonarosa.messenger.migrations.CachedAttachmentsMigrationJob;
import io.zonarosa.messenger.migrations.ClearGlideCacheMigrationJob;
import io.zonarosa.messenger.migrations.ContactLinkRebuildMigrationJob;
import io.zonarosa.messenger.migrations.CopyUsernameToZonaRosaStoreMigrationJob;
import io.zonarosa.messenger.migrations.DatabaseMigrationJob;
import io.zonarosa.messenger.migrations.DeleteDeprecatedLogsMigrationJob;
import io.zonarosa.messenger.migrations.DirectoryRefreshMigrationJob;
import io.zonarosa.messenger.migrations.DuplicateE164MigrationJob;
import io.zonarosa.messenger.migrations.E164FormattingMigrationJob;
import io.zonarosa.messenger.migrations.EmojiDownloadMigrationJob;
import io.zonarosa.messenger.migrations.EmojiSearchEnglishLabelsMigrationJob;
import io.zonarosa.messenger.migrations.EmojiSearchIndexCheckMigrationJob;
import io.zonarosa.messenger.migrations.FixChangeNumberErrorMigrationJob;
import io.zonarosa.messenger.migrations.GooglePlayBillingPurchaseTokenMigrationJob;
import io.zonarosa.messenger.migrations.IdentityTableCleanupMigrationJob;
import io.zonarosa.messenger.migrations.LegacyMigrationJob;
import io.zonarosa.messenger.migrations.MigrationCompleteJob;
import io.zonarosa.messenger.migrations.OptimizeMessageSearchIndexMigrationJob;
import io.zonarosa.messenger.migrations.PassingMigrationJob;
import io.zonarosa.messenger.migrations.PinOptOutMigration;
import io.zonarosa.messenger.migrations.PinReminderMigrationJob;
import io.zonarosa.messenger.migrations.PniAccountInitializationMigrationJob;
import io.zonarosa.messenger.migrations.PniMigrationJob;
import io.zonarosa.messenger.migrations.PnpLaunchMigrationJob;
import io.zonarosa.messenger.migrations.PreKeysSyncMigrationJob;
import io.zonarosa.messenger.migrations.ProfileMigrationJob;
import io.zonarosa.messenger.migrations.ProfileSharingUpdateMigrationJob;
import io.zonarosa.messenger.migrations.QuoteThumbnailBackfillMigrationJob;
import io.zonarosa.messenger.migrations.RebuildMessageSearchIndexMigrationJob;
import io.zonarosa.messenger.migrations.RecheckPaymentsMigrationJob;
import io.zonarosa.messenger.migrations.RecipientSearchMigrationJob;
import io.zonarosa.messenger.migrations.ResetArchiveTierMigrationJob;
import io.zonarosa.messenger.migrations.SelfRegisteredStateMigrationJob;
import io.zonarosa.messenger.migrations.StickerAdditionMigrationJob;
import io.zonarosa.messenger.migrations.StickerDayByDayMigrationJob;
import io.zonarosa.messenger.migrations.StickerPackAddition2MigrationJob;
import io.zonarosa.messenger.migrations.StickerLaunchMigrationJob;
import io.zonarosa.messenger.migrations.StickerMyDailyLifeMigrationJob;
import io.zonarosa.messenger.migrations.StorageCapabilityMigrationJob;
import io.zonarosa.messenger.migrations.StorageFixLocalUnknownMigrationJob;
import io.zonarosa.messenger.migrations.StorageServiceMigrationJob;
import io.zonarosa.messenger.migrations.StorageServiceSystemNameMigrationJob;
import io.zonarosa.messenger.migrations.StoryViewedReceiptsStateMigrationJob;
import io.zonarosa.messenger.migrations.SubscriberIdMigrationJob;
import io.zonarosa.messenger.migrations.Svr2MirrorMigrationJob;
import io.zonarosa.messenger.migrations.SyncCallLinksMigrationJob;
import io.zonarosa.messenger.migrations.SyncChatFoldersMigrationJob;
import io.zonarosa.messenger.migrations.SyncDistributionListsMigrationJob;
import io.zonarosa.messenger.migrations.SyncKeysMigrationJob;
import io.zonarosa.messenger.migrations.TrimByLengthSettingsMigrationJob;
import io.zonarosa.messenger.migrations.UpdateSmsJobsMigrationJob;
import io.zonarosa.messenger.migrations.UserNotificationMigrationJob;
import io.zonarosa.messenger.migrations.UuidMigrationJob;
import io.zonarosa.messenger.migrations.WallpaperCleanupMigrationJob;
import io.zonarosa.messenger.migrations.WallpaperStorageMigrationJob;
...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<>() {{
      ...
      put(CopyUsernameToZonaRosaStoreMigrationJob.KEY,      new CopyUsernameToZonaRosaStoreMigrationJob.Factory());
  ...
  public static List<JobMigration> getJobMigrations(@NonNull Application application) {
    return Arrays.asList(new DeprecatedJobMigration(2),
                         ...
                         new SendReadReceiptsJobMigration(ZonaRosaDatabase.messages()),
