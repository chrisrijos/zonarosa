...
public final class StorageSyncValidations {
  ...
  public static void validate(@NonNull StorageSyncHelper.WriteOperationResult result,
                              @NonNull ZonaRosaStorageManifest previousManifest,
  ...
  public static void validateForcePush(@NonNull ZonaRosaStorageManifest manifest, @NonNull List<ZonaRosaStorageRecord> inserts, @NonNull Recipient self) {
    validateManifestAndInserts(manifest, inserts, self);
  }

  private static void validateManifestAndInserts(@NonNull ZonaRosaStorageManifest manifest, @NonNull List<ZonaRosaStorageRecord> inserts, @NonNull Recipient self) {
    int accountCount = 0;
    ...
    Set<StorageId>  insertSet = new HashSet<>(Stream.of(inserts).map(ZonaRosaStorageRecord::getId).toList());
