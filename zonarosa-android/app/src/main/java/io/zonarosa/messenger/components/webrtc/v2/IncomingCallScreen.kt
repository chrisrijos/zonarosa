  ...
  Scaffold { contentPadding ->
    ...
    Column(
      ...
      Row(
        ...
        Icon(
          imageVector = ImageVector.vectorResource(R.drawable.ic_zonarosa_logo_small),
        ...
        Text(
          text = if (isVideoCall) {
            stringResource(R.string.WebRtcCallView__zonarosa_video_call)
          } else {
            stringResource(R.string.WebRtcCallView__zonarosa_call)
          },
