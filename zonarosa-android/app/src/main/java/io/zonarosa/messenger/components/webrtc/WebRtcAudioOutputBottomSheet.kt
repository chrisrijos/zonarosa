...
private fun getDrawableResourceForDeviceType(deviceType: ZonaRosaAudioManager.AudioDevice): Int {
  return when (deviceType) {
    ZonaRosaAudioManager.AudioDevice.WIRED_HEADSET -> R.drawable.symbol_headphones_outline_24
    ZonaRosaAudioManager.AudioDevice.EARPIECE -> R.drawable.symbol_phone_speaker_outline_24
    ZonaRosaAudioManager.AudioDevice.BLUETOOTH -> R.drawable.symbol_speaker_bluetooth_fill_white_24
    ZonaRosaAudioManager.AudioDevice.SPEAKER_PHONE, ZonaRosaAudioManager.AudioDevice.NONE -> R.drawable.symbol_speaker_outline_24
  }
}

private fun getDescriptionStringResourceForDeviceType(deviceType: ZonaRosaAudioManager.AudioDevice): Int {
  return when (deviceType) {
    ZonaRosaAudioManager.AudioDevice.WIRED_HEADSET -> R.string.WebRtcAudioOutputBottomSheet__headset_icon_content_description
    ZonaRosaAudioManager.AudioDevice.EARPIECE -> R.string.WebRtcAudioOutputBottomSheet__earpiece_icon_content_description
    ZonaRosaAudioManager.AudioDevice.BLUETOOTH -> R.string.WebRtcAudioOutputBottomSheet__bluetooth_icon_content_description
    ZonaRosaAudioManager.AudioDevice.SPEAKER_PHONE, ZonaRosaAudioManager.AudioDevice.NONE -> R.string.WebRtcAudioOutputBottomSheet__speaker_icon_content_description
  }
}

data class AudioOutputOption(val friendlyName: String, val deviceType: ZonaRosaAudioManager.AudioDevice, val deviceId: Int)

@Preview
@Composable
private fun SampleOutputBottomSheet() {
  val outputs: ImmutableList<AudioOutputOption> = listOf(
    AudioOutputOption("Earpiece", ZonaRosaAudioManager.AudioDevice.EARPIECE, 0),
    AudioOutputOption("Speaker", ZonaRosaAudioManager.AudioDevice.SPEAKER_PHONE, 1),
    AudioOutputOption("BT Headset", ZonaRosaAudioManager.AudioDevice.BLUETOOTH, 2),
    AudioOutputOption("Wired Headset", ZonaRosaAudioManager.AudioDevice.WIRED_HEADSET, 3)
  ).toImmutableList()
