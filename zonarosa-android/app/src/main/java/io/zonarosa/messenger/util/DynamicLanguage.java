...
/**
 * @deprecated Use a base activity that uses the {@link io.zonarosa.messenger.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
public class DynamicLanguage {
  ...
  private static Locale getSelectedLocale(Context context) {
    Locale locale = LanguageString.parseLocale(ZonaRosaStore.settings().getLanguage());
    if (locale == null) {
      return Locale.getDefault();
    } else {
      return locale;
