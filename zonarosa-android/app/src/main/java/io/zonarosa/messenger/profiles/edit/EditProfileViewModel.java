...
import io.zonarosa.messenger.profiles.edit.EditProfileRepository.UploadResult;
...
class EditProfileViewModel extends ViewModel {
  ...
  public void submitProfile() {
    ...
    if (!isGroup() && ZonaRosaStore.phoneNumberPrivacy().getPhoneNumberDiscoverabilityMode() == PhoneNumberDiscoverabilityMode.UNDECIDED) {
