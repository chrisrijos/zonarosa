...
import io.zonarosa.messenger.components.settings.app.subscription.InAppPaymentsRepository.toDonationProcessor
  ...
  override fun onRun() {
    ...
    if (serviceResponse.applicationError.isPresent) {
      ...
      if (isCredentialValid(inAppPayment, receiptCredential)) {
        ...
        ZonaRosaDatabase.donationReceipts.addReceipt(inAppPaymentReceiptRecord)
