...
object AudioWaveForms {
  ...
  private fun generateWaveForm(context: Context, uri: Uri, cacheKey: String, attachmentId: AttachmentId): CacheCheckResult {
    try {
      ...
      ZonaRosaDatabase.attachments.writeAudioHash(attachmentId, AudioWaveFormData())
      ...
      ZonaRosaDatabase.attachments.writeAudioHash(attachmentId, fileInfo.toDatabaseProtobuf())
