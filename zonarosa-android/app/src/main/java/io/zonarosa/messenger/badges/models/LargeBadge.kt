...
data class LargeBadge(
  ...
  class ViewHolder(itemView: View) : MappingViewHolder<Model>(itemView) {
    ...
    override fun bind(model: Model) {
      ...
      name.text = context.getString(R.string.ViewBadgeBottomSheetDialogFragment__s_supports_zonarosa, model.shortName)
  ...
  companion object {
    fun getDescription(context: Context, isSubscriptionBadge: Boolean, shortName: String): String {
      return if (isSubscriptionBadge) {
        context.getString(R.string.ViewBadgeBottomSheetDialogFragment__s_supports_zonarosa_with_a_monthly, shortName)
      } else {
        context.getString(R.string.ViewBadgeBottomSheetDialogFragment__s_supports_zonarosa_with_a_donation, shortName)
      }
    }
