...
import io.zonarosa.messenger.jobs.InAppPaymentOneTimeContextJob
...
object OneTimeInAppPaymentRepository {
  ...
  /**
   * Get the one-time donation badge from the ZonaRosa service
   */
   ...
   * zonarosa service. This is scheduled on the io thread-pool.
   */
