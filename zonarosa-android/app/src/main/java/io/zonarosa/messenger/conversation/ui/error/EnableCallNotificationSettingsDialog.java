...
public final class EnableCallNotificationSettingsDialog extends DialogFragment {
  ...
  public static void fixAutomatically(@NonNull Context context) {
    if (areCallNotificationsDisabled(context)) {
      ZonaRosaStore.settings().setCallNotificationsEnabled(true);
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    MaterialAlertDialogBuilder dialogBuilder = new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_ZonaRosa_MaterialAlertDialog);
  ...
  private static boolean areCallNotificationsDisabled(Context context) {
    return !ZonaRosaStore.settings().isCallNotificationsEnabled();
  }
