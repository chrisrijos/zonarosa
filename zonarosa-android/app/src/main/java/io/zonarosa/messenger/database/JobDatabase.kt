...
import io.zonarosa.messenger.jobmanager.persistence.ConstraintSpec
import io.zonarosa.messenger.jobmanager.persistence.DependencySpec
import io.zonarosa.messenger.jobmanager.persistence.FullSpec
...
class JobDatabase(
  ...
  companion object {
    ...
    private const val DATABASE_NAME = "zonarosa-jobmanager.db"
