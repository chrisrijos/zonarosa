...
class BackupValues(store: KeyValueStore) : ZonaRosaStoreValues(store) {
  companion object {
  ...
  val messageBackupKey: MessageBackupKey
    get() = ZonaRosaStore.account.accountEntropyPool.deriveMessageBackupKey()
  ...
  /**
   * Denotes if there was a mismatch detected between the user's ZonaRosa subscription, on-device Google Play subscription,
