package io.zonarosa.messenger.components.settings.app.appearance.navbar
...
import io.zonarosa.messenger.databinding.ChooseNavigationBarStyleFragmentBinding
...
class ChooseNavigationBarStyleFragment : DialogFragment(R.layout.choose_navigation_bar_style_fragment) {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    presentToggleState(ZonaRosaStore.settings.useCompactNavigationBar)
    ...
    binding.ok.setOnClickListener {
      ...
      ZonaRosaStore.settings.useCompactNavigationBar = isCompact
