...
class TransferProgressView @JvmOverloads constructor(
  ...
  init {
    ...
    val zonarosaCustomColor = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorOnCustom)
    val zonarosaTransparent2 = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorTransparent2)

    iconColor = typedArray.getColor(R.styleable.TransferProgressView_transferIconColor, zonarosaCustomColor)
    progressColor = typedArray.getColor(R.styleable.TransferProgressView_progressColor, zonarosaCustomColor)
    trackColor = typedArray.getColor(R.styleable.TransferProgressView_trackColor, zonarosaTransparent2)
