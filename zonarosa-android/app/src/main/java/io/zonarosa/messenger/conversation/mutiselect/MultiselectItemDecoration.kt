...
import io.zonarosa.messenger.conversation.ConversationAdapterBridge.PulseRequest
...
class MultiselectItemDecoration(
  ...
  private val ultramarine = ContextCompat.getColor(context, R.color.zonarosa_accent_primary)
