...
public final class SettingsValues extends ZonaRosaStoreValues {
  ...
  private static final String ZONAROSA_BACKUP_DIRECTORY        = "settings.zonarosa.backup.directory";
  private static final String ZONAROSA_LATEST_BACKUP_DIRECTORY = "settings.zonarosa.backup.directory,latest";
  private static final String CALL_DATA_MODE                 = "settings.zonarosa.call.bandwidth.mode";
  ...
  public static final  String ZONAROSA_BACKUPS_SCHEDULE_HOUR            = "settings.zonarosa.backups.schedule.hour";
  public static final  String ZONAROSA_BACKUPS_SCHEDULE_MINUTE          = "settings.zonarosa.backups.schedule.minute";
  ...
  public static final  String NOTIFY_WHEN_CONTACT_JOINS_ZONAROSA        = "settings.notify.when.contact.joins.zonarosa";
  ...
  private void migrateFromSharedPrefsV1(@NonNull Context context) {
    ...
    putBoolean(PASSPHRASE_DISABLED, ZonaRosaPreferences.getBooleanPreference(context, "pref_disable_passphrase", true));
    putBoolean(PASSPHRASE_TIMEOUT_ENABLED, ZonaRosaPreferences.getBooleanPreference(context, "pref_timeout_passphrase", false));
    putInteger(PASSPHRASE_TIMEOUT, ZonaRosaPreferences.getIntegerPreference(context, "pref_timeout_interval", 5 * 60));
    putBoolean(SCREEN_LOCK_ENABLED, ZonaRosaPreferences.getBooleanPreference(context, "pref_android_screen_lock", false));
    putLong(SCREEN_LOCK_TIMEOUT, ZonaRosaPreferences.getLongPreference(context, "pref_android_screen_lock_timeout", 0));
  }
  ...
  void onFirstEverAppLaunch() {
    ...
    if (!store.containsKey(ZONAROSA_BACKUPS_SCHEDULE_HOUR)) {
      initZonaRosaBackupsSchedule();
    }
  }
  ...
  @NonNull List<String> getKeysToIncludeInBackup() {
    return Arrays.asList(LINK_PREVIEWS,
                         ...
                         NOTIFY_WHEN_CONTACT_JOINS_ZONAROSA,
  ...
  public void setZonaRosaBackupDirectory(@NonNull Uri uri) {
    putString(ZONAROSA_BACKUP_DIRECTORY, uri.toString());
    putString(ZONAROSA_LATEST_BACKUP_DIRECTORY, uri.toString());
  }
  ...
  public @Nullable Uri getZonaRosaBackupDirectory() {
    return getUri(ZONAROSA_BACKUP_DIRECTORY);
  }

  public @Nullable Uri getLatestZonaRosaBackupDirectory() {
    return getUri(ZONAROSA_LATEST_BACKUP_DIRECTORY);
  }

  public void clearZonaRosaBackupDirectory() {
    putString(ZONAROSA_BACKUP_DIRECTORY, null);
  }
  ...
  public @NonNull Theme getTheme() {
    return Theme.deserialize(getString(THEME, ZonaRosaPreferences.getTheme(AppDependencies.getApplication())));
  }
  ...
  public int getMessageFontSize() {
    return getInteger(MESSAGE_FONT_SIZE, ZonaRosaPreferences.getMessageBodyTextSize(AppDependencies.getApplication()));
  }
  ...
  public @NonNull String getLanguage() {
    return ZonaRosaPreferences.getLanguage(AppDependencies.getApplication());
  }

  public void setLanguage(@NonNull String language) {
    ZonaRosaPreferences.setLanguage(AppDependencies.getApplication(), language);
    onConfigurationSettingChanged.postValue(LANGUAGE);
  }

  public boolean isPreferSystemEmoji() {
    return getBoolean(PREFER_SYSTEM_EMOJI, ZonaRosaPreferences.isSystemEmojiPreferred(AppDependencies.getApplication()));
  }
  ...
  public boolean isEnterKeySends() {
    return getBoolean(ENTER_KEY_SENDS, ZonaRosaPreferences.isEnterSendsEnabled(AppDependencies.getApplication()));
  }
  ...
  public boolean isBackupEnabled() {
    return getBoolean(BACKUPS_ENABLED, ZonaRosaPreferences.isBackupEnabled(AppDependencies.getApplication()));
  }
  ...
  public int getZonaRosaBackupHour() {
    int hour = getInteger(ZONAROSA_BACKUPS_SCHEDULE_HOUR, -1);
    if (hour < 0) {
      initZonaRosaBackupsSchedule();
      return getInteger(ZONAROSA_BACKUPS_SCHEDULE_HOUR, BACKUP_DEFAULT_HOUR);
    } else {
      return hour;
    }
  }

  public int getZonaRosaBackupMinute() {
    int minute = getInteger(ZONAROSA_BACKUPS_SCHEDULE_MINUTE, -1);
    if (minute < 0) {
      initZonaRosaBackupsSchedule();
      return getInteger(ZONAROSA_BACKUPS_SCHEDULE_MINUTE, BACKUP_DEFAULT_MINUTE);
    } else {
      return minute;
    }
  }
  ...
  private void initZonaRosaBackupsSchedule() {
    setZonaRosaBackupSchedule(new Random().nextInt(5) + 1, new Random().nextInt(12) * 5);
  }

  public void setZonaRosaBackupSchedule(int hour, int minute) {
    putInteger(ZONAROSA_BACKUPS_SCHEDULE_HOUR, hour);
    putInteger(ZONAROSA_BACKUPS_SCHEDULE_MINUTE, minute);
  }

  public boolean isSmsDeliveryReportsEnabled() {
    return getBoolean(SMS_DELIVERY_REPORTS_ENABLED, ZonaRosaPreferences.isSmsDeliveryReportsEnabled(AppDependencies.getApplication()));
  }
  ...
  public boolean isWifiCallingCompatibilityModeEnabled() {
    return getBoolean(WIFI_CALLING_COMPATIBILITY_MODE_ENABLED, ZonaRosaPreferences.isWifiSmsEnabled(AppDependencies.getApplication()));
  }
  ...
  public boolean isMessageNotificationsEnabled() {
    return getBoolean(MESSAGE_NOTIFICATIONS_ENABLED, ZonaRosaPreferences.isNotificationsEnabled(AppDependencies.getApplication()));
  }
  ...
  public @NonNull Uri getMessageNotificationSound() {
    String result = getString(MESSAGE_NOTIFICATION_SOUND, ZonaRosaPreferences.getNotificationRingtone(AppDependencies.getApplication()).toString());
  ...
  public boolean isMessageVibrateEnabled() {
    return getBoolean(MESSAGE_VIBRATE_ENABLED, ZonaRosaPreferences.isNotificationVibrateEnabled(AppDependencies.getApplication()));
  }
  ...
  public @NonNull String getMessageLedColor() {
    return getString(MESSAGE_LED_COLOR, ZonaRosaPreferences.getNotificationLedColor(AppDependencies.getApplication()));
  }
  ...
  public @NonNull String getMessageLedBlinkPattern() {
    return getString(MESSAGE_LED_BLINK_PATTERN, ZonaRosaPreferences.getNotificationLedPattern(AppDependencies.getApplication()));
  }
  ...
  public boolean isMessageNotificationsInChatSoundsEnabled() {
    return getBoolean(MESSAGE_IN_CHAT_SOUNDS_ENABLED, ZonaRosaPreferences.isInThreadNotifications(AppDependencies.getApplication()));
  }
  ...
  public int getMessageNotificationsRepeatAlerts() {
    return getInteger(MESSAGE_REPEAT_ALERTS, ZonaRosaPreferences.getRepeatAlertsCount(AppDependencies.getApplication()));
  }
  ...
  public @NonNull NotificationPrivacyPreference getMessageNotificationsPrivacy() {
    return new NotificationPrivacyPreference(getString(MESSAGE_NOTIFICATION_PRIVACY, ZonaRosaPreferences.getNotificationPrivacy(AppDependencies.getApplication()).toString()));
  }
  ...
  public boolean isCallNotificationsEnabled() {
    return getBoolean(CALL_NOTIFICATIONS_ENABLED, ZonaRosaPreferences.isCallNotificationsEnabled(AppDependencies.getApplication()));
  }
  ...
  public @NonNull Uri getCallRingtone() {
    String result = getString(CALL_RINGTONE, ZonaRosaPreferences.getCallNotificationRingtone(AppDependencies.getApplication()).toString());
  ...
  public boolean isCallVibrateEnabled() {
    return getBoolean(CALL_VIBRATE_ENABLED, ZonaRosaPreferences.isCallNotificationVibrateEnabled(AppDependencies.getApplication()));
  }
  ...
  public boolean isNotifyWhenContactJoinsZonaRosa() {
    return getBoolean(NOTIFY_WHEN_CONTACT_JOINS_ZONAROSA, ZonaRosaPreferences.isNewContactsNotificationEnabled(AppDependencies.getApplication()));
  }

  public void setNotifyWhenContactJoinsZonaRosa(boolean notifyWhenContactJoinsZonaRosa) {
    putBoolean(NOTIFY_WHEN_CONTACT_JOINS_ZONAROSA, notifyWhenContactJoinsZonaRosa);
  }
