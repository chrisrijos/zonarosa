...
import io.zonarosa.messenger.databinding.ConversationListFilterPullViewBinding
import io.zonarosa.messenger.util.VibrateUtil
import io.zonarosa.messenger.util.doAfterNextLayout
import io.zonarosa.messenger.util.doOnEachLayout
...
class ConversationListFilterPullView @JvmOverloads constructor(
  ...
  private val pillDefaultBackgroundTint = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorSecondaryContainer)
  private val pillWillCloseBackgroundTint = ContextCompat.getColor(context, CoreUiR.color.zonarosa_colorSurface1)
