...
object AvatarBundler {
  ...
  private const val TEXT = "io.zonarosa.messenger.avatar.TEXT"
  private const val COLOR = "io.zonarosa.messenger.avatar.COLOR"
  private const val URI = "io.zonarosa.messenger.avatar.URI"
  private const val KEY = "io.zonarosa.messenger.avatar.KEY"
  private const val DATABASE_ID = "io.zonarosa.messenger.avatar.DATABASE_ID"
  private const val SIZE = "io.zonarosa.messenger.avatar.SIZE"
