...
import io.zonarosa.messenger.avatar.photo.PhotoEditorActivity
import io.zonarosa.messenger.avatar.photo.PhotoEditorFragment
import io.zonarosa.messenger.avatar.text.TextAvatarCreationFragment
import io.zonarosa.messenger.avatar.vector.VectorAvatarCreationFragment
import io.zonarosa.messenger.components.ButtonStripItemView
import io.zonarosa.messenger.components.recyclerview.GridDividerDecoration
import io.zonarosa.messenger.mediasend.AvatarSelectionActivity
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "io.zonarosa.messenger.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "io.zonarosa.messenger.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "io.zonarosa.messenger.avatar.picker.SELECT_AVATAR_CLEAR"
