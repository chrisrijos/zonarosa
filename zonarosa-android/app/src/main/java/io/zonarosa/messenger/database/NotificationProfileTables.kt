...
import io.zonarosa.messenger.storage.StorageSyncModels.toLocal
 ...
 */
class NotificationProfileTables(context: Context, databaseHelper: ZonaRosaDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun insertNotificationProfileFromStorageSync(notificationProfileRecord: ZonaRosaNotificationProfileRecord) {
  ...
  fun updateNotificationProfileFromStorageSync(notificationProfileRecord: ZonaRosaNotificationProfileRecord) {
    val profile = notificationProfileRecord.proto
