...
import io.zonarosa.messenger.components.settings.app.backups.remote.BackupKeyDisplayFragment
import io.zonarosa.messenger.lock.v2.CreateSvrPinActivity
import io.zonarosa.messenger.payments.backup.PaymentsRecoveryStartFragmentArgs.Builder
  ...
  Scaffolds.Settings(
    ...
    if (hasOptedOutOfPin) {
      Rows.TextRow(
        ...
        label = stringResource(R.string.preferences__pins_keep_information_stored_with_zonarosa_encrypted_so_only_you_can_access_it),
        onClick = listener,
