 ...
 */
abstract class DefaultStorageRecordProcessor<E : ZonaRosaRecord<*>> : StorageRecordProcessor<E>, Comparator<E> {
  companion object {
   ...
   * general we rely on ZonaRosaRecords to implement an equals() that includes the StorageId, so using
