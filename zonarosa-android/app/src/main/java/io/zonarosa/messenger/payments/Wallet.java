...
public final class Wallet {
  ...
  public @NonNull Balance getCachedBalance() {
    return ZonaRosaStore.payments().mobileCoinLatestBalance();
  }

  @AnyThread
  public @NonNull MobileCoinLedgerWrapper getCachedLedger() {
    return ZonaRosaStore.payments().mobileCoinLatestFullLedger();
  }
    ...
    try {
      ...
      builder.spentTxos(spentTxos)
             ...
             .highestBlock(new MobileCoinLedger.Block.Builder()
                                                     ...
                                                     .build());
      ZonaRosaStore.payments().setEnclaveFailure(false);
      ...
      ZonaRosaStore.payments().setEnclaveFailure(true);
