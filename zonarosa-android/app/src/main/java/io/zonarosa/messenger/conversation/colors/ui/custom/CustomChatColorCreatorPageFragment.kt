...
import io.zonarosa.messenger.conversation.colors.ui.ChatColorPreviewView
import io.zonarosa.messenger.conversation.colors.ui.ChatColorSelectionViewModel
import io.zonarosa.messenger.keyvalue.ZonaRosaStore
import io.zonarosa.messenger.util.ViewUtil
import io.zonarosa.messenger.util.customizeOnDraw
...
class CustomChatColorCreatorPageFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (page == 1 && ZonaRosaStore.chatColors.shouldShowGradientTooltip) {
      view.post {
        ZonaRosaStore.chatColors.shouldShowGradientTooltip = false
  ...
  private class ThumbDrawable(context: Context) : Drawable() {
    ...
    private val borderPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
      color = ContextCompat.getColor(context, R.color.zonarosa_background_primary)
    }
