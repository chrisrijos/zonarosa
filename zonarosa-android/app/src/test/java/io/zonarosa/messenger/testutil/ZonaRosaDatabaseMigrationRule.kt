...
import io.zonarosa.messenger.testing.TestZonaRosaSQLiteDatabase

class ZonaRosaDatabaseMigrationRule(private val upgradedVersion: Int = 286) : ExternalResource() {
  ...
  override fun before() {
    ...
    ZonaRosaDatabaseMigrations.migrate(
  ...
  companion object {
    ...
    private fun inMemoryUpgradedDatabase(): SQLiteDatabase {
      ...
      return TestZonaRosaSQLiteDatabase(helper.writableDatabase)
    }
