...
import static io.zonarosa.messenger.testutil.SecureRandomTestUtil.mockRandom;
import static io.zonarosa.service.test.LibZonaRosaLibraryUtil.assumeLibZonaRosaSupportedOnOS;
...
public final class GroupIdTest {
  ...
  public void can_create_for_gv1() {
    ...
    assertEquals("__zonarosa_group__!000102030405060708090a0b0c0d0e0f", groupId.toString());
    assertFalse(groupId.isMms());
  }

  @Test
  public void can_parse_gv1() {
    GroupId groupId = GroupId.parseOrThrow("__zonarosa_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void can_create_for_gv2_from_GroupIdentifier() throws IOException, InvalidInputException {
    ...
    assertEquals("__zonarosa_group__v2__!0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", groupId.toString());
    assertFalse(groupId.isMms());
  ...
  public void can_create_for_gv2_from_GroupMasterKey() throws IOException, InvalidInputException {
    ...
    assertEquals("__zonarosa_group__v2__!8c4a5ec277691282f64b965b1b9affc0285380c993c413f7560967d502dcf2e6", groupId.toString());
    assertFalse(groupId.isMms());
    assertFalse(groupId.isV1());
    assertTrue(groupId.isV2());
    assertTrue(groupId.isPush());
  ...
  public void can_parse_gv2() throws IOException {
    GroupId groupId = GroupId.parseOrThrow("__zonarosa_group__v2__!9f475f59b2518bff6df22e820803f0e3585bd99e686fa7e7fbfc2f92fd5d953e");

    assertEquals("__zonarosa_group__v2__!9f475f59b2518bff6df22e820803f0e3585bd99e686fa7e7fbfc2f92fd5d953e", groupId.toString());
  ...
  public void can_create_for_mms() {
    ...
    assertEquals("__zonarosa_mms_group__!000102030405060708090a0b0c0d0e0f", groupId.toString());
  ...
  public void can_parse_mms() {
    GroupId groupId = GroupId.parseOrThrow("__zonarosa_mms_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void can_parse_gv1_with_parseNullable() {
    GroupId groupId = GroupId.parseNullableOrThrow("__zonarosa_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void bad_encoding__odd_hex__parseNullable() {
    GroupId.parseNullableOrThrow("__zonarosa_group__!0001020305060708090bODD_HEX");
  }
  ...
  public void bad_encoding__odd_hex__parse() {
    GroupId.parseOrThrow("__zonarosa_group__!0001020305060708090b0c0d0e0fODD_HEX");
  }

  @Test(expected = BadGroupIdException.class)
  public void bad_encoding__gv2_prefix_with_wrong_length() throws BadGroupIdException {
    GroupId.parse("__zonarosa_group__v2__!000102030405060708090a0b0c0d0e0f");
  }
  ...
  public void cannot_require_push_of_mms() throws BadGroupIdException {
    GroupId groupId = GroupId.parse("__zonarosa_mms_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void cannot_require_v1_of_v2() throws BadGroupIdException {
    GroupId groupId = GroupId.parse("__zonarosa_group__v2__!9f475f59b2518bff6df22e820803f0e3585bd99e686fa7e7fbfc2f92fd5d953e");
  ...
  public void cannot_require_v2_of_v1() throws BadGroupIdException {
    GroupId groupId = GroupId.parse("__zonarosa_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void create_mms() {
    ...
    assertEquals("__zonarosa_mms_group__!090a0b0c0d0e0f000102030405060708", mms.toString());
  ...
  public void create_v1() {
    ...
    assertEquals("__zonarosa_group__!090a0b0c0d0e0f000102030405060708", v1.toString());
    assertTrue(v1.isV1());
  }
  ...
  public void parse_bytes_to_v2_via_by_push() throws BadGroupIdException {
    ...
    assertEquals("__zonarosa_group__v2__!000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f", v2.toString());
  }
}
