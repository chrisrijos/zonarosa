...
class CallEventCacheTest {
  ...
  fun setUp() {
    ...
    val zonarosaCallManagerMock: ZonaRosaCallManager = mockk()
    every { zonarosaCallManagerMock.peekInfoSnapshot } returns emptyMap()

    mockkStatic(AppDependencies::class)
    every { AppDependencies.zonarosaCallManager } returns zonarosaCallManagerMock
  }
