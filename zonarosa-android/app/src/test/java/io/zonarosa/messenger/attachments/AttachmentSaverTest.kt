...
import io.zonarosa.messenger.attachments.AttachmentSaver.Host
import io.zonarosa.messenger.attachments.AttachmentSaver.RequestPermissionResult
import io.zonarosa.messenger.attachments.AttachmentSaver.SaveToStorageWarningResult
import io.zonarosa.messenger.keyvalue.ZonaRosaStore
import io.zonarosa.messenger.keyvalue.UiHintValues
...
class AttachmentSaverTest {
  ...
  private val testAttachments: Set<SaveAttachmentUtil.SaveAttachment> = setOf(
    SaveAttachmentUtil.SaveAttachment(
      uri = Uri.parse("content://io.zonarosa.messenger/part/111"),
    ...
    SaveAttachmentUtil.SaveAttachment(
      uri = Uri.parse("content://io.zonarosa.messenger/part/222"),
      contentType = "image/jpeg",
      date = 1742234384758,
      fileName = null
    )
  ...
  private fun setUpTestEnvironment(
    ...
    every { ZonaRosaStore.uiHints } returns uiHints
