...
public final class LinkPreviewUtilTest_findValidPreviewUrls {
  ...
  public void contains_a_link() {
    LinkPreviewUtil.Links links = LinkPreviewUtil.findValidPreviewUrls("https://zonarosa.io");

    assertEquals(1, links.size());

    assertTrue(links.containsUrl("https://zonarosa.io"));
  }
  ...
  public void does_not_contain_link() {
    ...
    assertFalse(links.containsUrl("https://zonarosa.io/page"));
  }

  @Test
  public void contains_two_links() {
    LinkPreviewUtil.Links links = LinkPreviewUtil.findValidPreviewUrls("Links https://zonarosa.io https://android.com");
