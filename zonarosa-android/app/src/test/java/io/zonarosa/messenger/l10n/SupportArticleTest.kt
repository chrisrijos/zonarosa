package io.zonarosa.messenger.l10n
...
class SupportArticleTest {
  ...
  companion object {
    ...
    private val SUPPORT_ARTICLE = Regex(".*://support.zonarosa.io/.*articles/.*")
    private val CORRECT_SUPPORT_ARTICLE = Regex("https://support.zonarosa.io/hc/articles/\\d+(#[a-z_]+)?")
  }
}
