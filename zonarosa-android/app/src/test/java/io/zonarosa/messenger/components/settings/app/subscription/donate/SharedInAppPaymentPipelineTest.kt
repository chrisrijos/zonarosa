...
import io.zonarosa.donations.CreditCardPaymentSource
import io.zonarosa.donations.InAppPaymentType
import io.zonarosa.donations.PayPalPaymentSource
import io.zonarosa.donations.SEPADebitPaymentSource
...
import io.zonarosa.messenger.jobs.InAppPaymentPayPalOneTimeSetupJob
import io.zonarosa.messenger.jobs.InAppPaymentPayPalRecurringSetupJob
import io.zonarosa.messenger.jobs.InAppPaymentStripeOneTimeSetupJob
import io.zonarosa.messenger.jobs.InAppPaymentStripeRecurringSetupJob
...
class SharedInAppPaymentPipelineTest {
  ...
  fun `Given a recurring PayPal donation, when I awaitTransaction, then I expect to add InAppPaymentPayPalRecurringSetupJob`() {
    ...
    every { ZonaRosaDatabase.inAppPayments.getById(inAppPayment.id) } returns inAppPayment
