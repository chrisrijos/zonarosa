...
/**
 * Partial implementation of [ZonaRosaSQLiteDatabase] using an instance of [AndroidSQLiteDatabase] instead
 * of SQLCipher.
 */
class TestZonaRosaSQLiteDatabase(private val database: SupportSQLiteDatabase) : ZonaRosaSQLiteDatabase(null) {
