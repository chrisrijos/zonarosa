...
class AccountSettingsScreenTest {
  ...
  @Test
  fun givenDeprecatedClient_whenUpdateZonaRosaDisplayed_thenCallbackInvoked() {
    val callback = mockk<AccountSettingsScreenCallbacks>(relaxUnitFun = true)
    ...
    composeTestRule.onNodeWithTag(AccountSettingsTestTags.SCROLLER)
      .performScrollToNode(hasTestTag(AccountSettingsTestTags.ROW_UPDATE_ZONAROSA))

    composeTestRule.onNodeWithTag(AccountSettingsTestTags.ROW_UPDATE_ZONAROSA)
      .assertIsDisplayed()
