...
class OneTimePreKeyTableTest {
  ...
  fun markAllStaleIfNecessary_onlyUpdatesMatchingAccountAndZeroValues() {
    ...
    ZonaRosaDatabase.oneTimePreKeys.markAllStaleIfNecessary(aci, now)
  ...
  fun deleteAllStaleBefore_neverDeleteStaleOfZero() {
    ...
    ZonaRosaDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 10, minCount = 0)
  ...
  fun deleteAllStaleBefore_respectMinCount() {
    ...
    ZonaRosaDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 3)
  ...
  fun deleteAllStaleBefore_respectAccount() {
    ...
    ZonaRosaDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 2)
  ...
  private fun insertTestRecord(account: ServiceId, id: Int, staleTime: Long = 0) {
    ZonaRosaDatabase.oneTimePreKeys.insert(
      serviceId = account,
      keyId = id,
