...
import io.zonarosa.messenger.messages.TestMessage
...
object MessageContentFuzzer {
  ...
  private val mediaTypes = listOf("image/png", "image/jpeg", "image/heic", "image/heif", "image/avif", "image/webp", "image/gif", "audio/aac", "audio/*", "video/mp4", "video/*", "text/x-vcard", "text/x-zonarosa-plain", "application/x-zonarosa-view-once", "*/*", "application/octet-stream")
