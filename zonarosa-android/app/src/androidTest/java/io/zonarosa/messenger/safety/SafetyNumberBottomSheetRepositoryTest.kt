...
class SafetyNumberBottomSheetRepositoryTest {
  ...
  fun givenIHaveADistributionListDestination_whenIGetBuckets_thenIOnlyHaveDistributionListDestinationWithCorrespondingMembers() {
    ...
    val distributionList = ZonaRosaDatabase.distributionLists.createList("ListA", distributionListMembers)!!
    val destinationKey = ContactSearchKey.RecipientSearchKey(ZonaRosaDatabase.distributionLists.getRecipientId(distributionList)!!, true)
