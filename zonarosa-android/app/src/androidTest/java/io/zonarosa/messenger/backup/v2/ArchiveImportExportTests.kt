...
import io.zonarosa.libzonarosa.messagebackup.ComparableBackup
...
//  @Test
  ...
  private fun resetAllData() {
    ...
    ZonaRosaStore.resetCache()

    ZonaRosaStore.account.resetAccountEntropyPool()
    ZonaRosaStore.account.setE164(SELF_E164)
    ZonaRosaStore.account.setAci(SELF_ACI)
    ZonaRosaStore.account.setPni(SELF_PNI)
