...
import io.zonarosa.buildtools.SmartlingClient
import io.zonarosa.buildtools.StaticIpResolver
...
tasks.register("pushTranslations") {
  ...
  doLast {
    ...
    logger.lifecycle("Using ZonaRosa-Android root directory of $rootDir")
...
tasks.register("resolveStaticIps") {
  ...
  doLast {
    ...
    val tripleQuote = "\"\"\""
    val content = """
      rootProject.extra["service_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("chat.zonarosa.io")}$tripleQuote
      rootProject.extra["storage_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("storage.zonarosa.io")}$tripleQuote
      rootProject.extra["cdn_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("cdn.zonarosa.io")}$tripleQuote
      rootProject.extra["cdn2_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("cdn2.zonarosa.io")}$tripleQuote
      rootProject.extra["cdn3_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("cdn3.zonarosa.io")}$tripleQuote
      rootProject.extra["sfu_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("sfu.voip.zonarosa.io")}$tripleQuote
      rootProject.extra["content_proxy_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("contentproxy.zonarosa.io")}$tripleQuote
      rootProject.extra["svr2_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("svr2.zonarosa.io")}$tripleQuote
      rootProject.extra["cdsi_ips"] = $tripleQuote${staticIpResolver.resolveToBuildConfig("cdsi.zonarosa.io")}$tripleQuote
    """.trimIndent() + "\n"
