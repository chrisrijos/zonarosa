...
gradle.projectsEvaluated {
  val appTestTask = tasks.findByPath(":ZonaRosa-Android:testPlayProdPerfUnitTest")
  val appLintTask = tasks.findByPath(":ZonaRosa-Android:lintPlayProdRelease")
  ...
  tasks.named("qa") {
    ...
    subprojects.filter { it.name != "ZonaRosa-Android" }.forEach { subproject ->
